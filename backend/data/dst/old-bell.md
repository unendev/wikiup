...
source_url: https://dontstarve.fandom.com/wiki/Old_Bell
---
...
| --- |
| Glommer's Wings**×1** Glommer's Flower**×1** |
...
|  |
| --- |
| Summons a giant creature to smash things in its path. |
...
**“**It oscillates at an unusual wavelength.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I prefer the ringing resönance öf clashing blades.**”**
...
**“**What if we put it on your collar Woby?**”**
...
The **Old Bell** is a craftable [Item](/wiki/Item "Item") from the *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* DLC. The two ways to gain access to the crafting recipe is to locate and mine a [Glommer's Statue](/wiki/Glommer%27s_Statue "Glommer's Statue") - which will drop the Old Bell's [Blueprint](/wiki/Blueprint "Blueprint") as loot - or to find the blueprint from a [Tumbleweed](/wiki/Tumbleweed "Tumbleweed"). The player must then combine [Glommer's Wings](/wiki/Glommer%27s_Wings "Glommer's Wings") and [Glommer's Flower](/wiki/Glommer%27s_Flower "Glommer's Flower") together. The Old Bell is renewable as the materials to craft it are available during each [Full Moon](/wiki/Full_Moon "Full Moon") (mining [Glommer's Statue](/wiki/Glommer%27s_Statue "Glommer's Statue") does not destroy it).

## Contents

* [1 Biiigfoot](#Biiigfoot)
...
**“**It must be infatuated with the soundwaves of a particular frequency.**”**
...
**“**Just look at that goofy footed weirdo!**”**
...
**“**Watch oot ye big trottin' devil ye!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**BIG FOOTS 'TIS A FOOTS!**”**
...
**“**I can't even see this guy's head, he's so big.**”**
...
The creature's enormous foot takes a few seconds to reach the player. The screen will shake and a shadow will appear where the foot is about to touchdown. Biiigfoot destroys anything it steps on, dealing 1000 damage. Keep in mind that the shockwave caused by it does not deal any damage. It will aim for where the player was standing when the bell was rung, and can easily kill an insufficiently-armored player who doesn't move out of the way in time. When Biiigfoot stomps, the impact causes [sleeping](/wiki/Sleeping "Sleeping") [mobs](/wiki/Mobs "Mobs") to awaken.

Biiigfoot doesn't deal damage to [Shadow Creatures](/wiki/Shadow_Creatures "Shadow Creatures"), the [Pig King](/wiki/Pig_King "Pig King"), [Fireflies](/wiki/Fireflies "Fireflies"), or [Worm Holes](/wiki/Worm_Holes "Worm Holes").

## Don't Starve Together Don't Starve Together[]

Unlike most *Reign of Giants* items, the Old Bell cannot be crafted in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* as its Blueprint does not drop from Glommer's Statue, despite all of its ingredients being available.

## Usage[]

 https://static.wikia.nocookie.net/dont-starve-game/images/c/cf/Bigfoot Chopping.gif/revision/latest?cb=20140422181447 https://static.wikia.nocookie.net/dont-starve-game/images/c/cf/Bigfoot Chopping.gif/revision/latest?cb=20140422181447 

Biiigfoot being used for mass production of logs.

 

Although the Old Bell has a considerably large delay, with good timing or a fixation of the target(s) the Old Bell can deal a significant amount of damage to high health mobs, making it the perfect item to deal with the likes of the [Deerclops](/wiki/Deerclops "Deerclops"), [Moose/Goose](/wiki/Moose/Goose "Moose/Goose"), [Dragonfly](/wiki/Dragonfly "Dragonfly"), and [Bearger](/wiki/Bearger "Bearger"), among others.

In addition to being used as a weapon, the Old Bell can be an effective alternate to chopping [Trees](/wiki/Trees "Trees") with an [Axe](/wiki/Axe "Axe") or using allied [Pigs](/wiki/Pig "Pig") as it doesn't require [Gold](/wiki/Gold "Gold") or [Flint](/wiki/Flint "Flint") and takes less time. Planting [Pine Cones](/wiki/Pine_Cones "Pine Cones") in an area as close as possible to each other should enable Biiigfoot to chop over 80 trees at once with a single step.

The Old Bell can be used to kill a herd of [Beefalo](/wiki/Beefalo "Beefalo") at night. They will wake up as soon as they hear Biiigfoot approaching, but will not have enough time to move away.

Old Bells will cause [Earthquakes](/wiki/Earthquake "Earthquake") when used in [caves](/wiki/Cave "Cave") instead of summoning Biiigfoot.

A great combination to kill bosses is to first freeze them with an [Ice Staff](/wiki/Ice_Staff "Ice Staff"), then use the Old Bell next to them. This deals 1000 damage while the victim is immobilized.

Note that the shaking ground causes [sleeping](/wiki/Sleep "Sleep") monsters to wake up and often move out of the way of Biiigfoot, thus avoiding the damage entirely.

## Tips[]

* When a [Moleworm](/wiki/Moleworm "Moleworm") or [Krampus](/wiki/Krampus "Krampus") steals an Old Bell, the bell will activate, consuming one of its uses and summoning Biiigfoot.
* Due to his curse, [Woodie](/wiki/Woodie "Woodie") can only receive the Old Bell through inconvenient means. The only renewable method is planting a [Fleshy Bulb](/wiki/Fleshy_Bulb "Fleshy Bulb") near Glommer's Statue, letting the [Eyeplants](/wiki/Eyeplant "Eyeplant") take Glommer's Flower off the statue, and quickly killing the [Lureplant](/wiki/Lureplant "Lureplant") before it digests the flower. Players can also switch characters to Woodie after using the [Teleportato](/wiki/Teleportato "Teleportato") with the Old Bell in their inventory, however this method is more time-consuming and does not provide a renewable way of obtaining the item, without multiple additional Teleportato uses.
* Since the Old Bell has limited uses, make sure to only use it against swarms of strong enemies or when fighting powerful bosses.
...
* It is possible to survive a stomp attack from Biiigfoot using a [Football Helmet](/wiki/Football_Helmet "Football Helmet") and a [Marble Suit](/wiki/Marble_Suit "Marble Suit") or [Night Armor](/wiki/Night_Armor "Night Armor"). This will break the helmet, no matter its durability.
* The Old Bell's original color was teal.
* The Old Bell used to be learned at a [Shadow Manipulator](/wiki/Shadow_Manipulator "Shadow Manipulator").
* Wigfrid's quote "That's something completely different!" is a reference to the British comedy group [Monty Python](https://en.wikipedia.org/wiki/Monty_Python "wikipedia:Monty Python") and their movie *And Now for Something Completely Different*. Commonly, at the end of skits and during the movie, the Monty Python logo would be seen being crushed by a giant foot, after the words "And now, for something completely different!".
* Despite the Old Bell and Biiigfoot not being present in *Don't Starve Together*, most of the DST Exclusive characters all have examination quotes for both.

## Blueprint Gallery[]

Giant's Foot.jpg (124 KB)

The foot called by the Old Bell.

Bigfootprint.png (84 KB)

The giant's footprint.

Unphased..PNG (344 KB)

The Pig King unfazed by getting stomped.

Reign of Giants promo.jpg (160 KB)

The giant's footprint in the *Reign of Giants* promo.

Don't Starve Reign of Giants - New Giant (29 KB)

Don't Starve Reign of Giants - New Giant

Original Old Bell.png (17 KB)

Original color of the Old Bell.

Bigfoot+Tallfort=Destruction.png (587 KB)

Biiigfoot crushing a [Tallfort](/wiki/Set_Piece#Tallfort "Set Piece").

Bigfoot Trailer.jpg (239 KB)

Biiigfoot, as seen in the *Reign of Giants* trailer.
