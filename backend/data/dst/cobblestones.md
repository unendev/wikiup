...
source_url: https://dontstarve.fandom.com/wiki/Cobblestones
---
...
| --- | --- |
| Rocky Turf**×1** Boards**×1 Don't Starve Magma Turf ×1 Boards** **×1 Shipwrecked Cut Stone ×1 Flint ×2 Don't Starve Together** | 1 Don't Starve 4 Don't Starve Together |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| **Structures Tab** | Decorations Filter | Alchemy Engine |

## Properties

### [Fuel Value](/wiki/Fire#Fuel_Values "Fire")

90/45 sec Don't Starve  
...
**Cobblestones** are a craftable [Turf](/wiki/Turf "Turf") [Item](/wiki/Item "Item") found in the [Structures Tab](/wiki/Structures_Tab "Structures Tab"). They require 1 [Rocky Turf](/wiki/Rocky_Turf "Rocky Turf") and 1 [Board](/wiki/Board "Board") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. Like other Turfs, it can be placed on any bare ground tile or used as [fuel](/wiki/Fire#Fuel "Fire").

Cobblestones allow players to lay down their own [Roads](/wiki/Roads "Roads"). Similar to natural Roads, they will [speed up](/wiki/Player_Speed "Player Speed") the player by 30%. Unlike natural Roads, Cobblestones can be moved using the [Pitchfork](/wiki/Pitchfork "Pitchfork"). Small patches of it can be found in [Mosaic](/wiki/Mosaic "Mosaic") biomes.

Plants like [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Saplings](/wiki/Saplings "Saplings"), [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), [Pine Cones](/wiki/Pine_Cone "Pine Cone"), and [Birchnuts](/wiki/Birchnut "Birchnut") can't be planted on these Turfs, unless they were planted before the Turfs were placed. It will also stop the [Lureplants](/wiki/Lureplants "Lureplants")' [Eyeplants](/wiki/Lureplant#Eyeplant "Lureplant") from spawning.

When placed on the [Surface World](/wiki/Surface_World "Surface World") covering a large enough area, [Crows](/wiki/Crow "Crow") are the only [Birds](/wiki/Birds "Birds") that will spawn and land on these turfs.

### Shipwrecked Shipwrecked[]

In the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, the crafting recipe for Cobblestone requires [Magma Turf](/wiki/Magma_Turf "Magma Turf") instead of Rocky Turf. During [Monsoon Season](/wiki/Monsoon_Season "Monsoon Season"), this Turf will not spawn Puddles. Expanding Puddles can still flood this Turf, however.

When placed on the Surface World covering a large enough area, [Toucans](/wiki/Toucan "Toucan") are the only Birds that will spawn and land on these turfs. During [Hurricane Season](/wiki/Hurricane_Season "Hurricane Season"), there are no birds that spawn and land on these turfs.

### Don't Starve Together Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Cobblestone turf is crafted in sets of 4 which require 1 [Cut Stone](/wiki/Cut_Stone "Cut Stone"), and 2 [Flint](/wiki/Flint "Flint") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. It is found in the [Decorations](/wiki/Category:Decorations_Filter "Category:Decorations Filter") filter.
...
"Individual bricks, brought together to serve a greater purpose."

Crafting

| [Recipe](/wiki/Crafting "Crafting") | Amount produced |
| --- | --- |
| Cut Stone**×1** Flint**×2** | 4 |

| [Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Decorations Filter | Blueprint (rare)(Antlion) |
...
**“**Bricks are the building blocks of the floor.**”**
...
**“**BRICKS FOR THE GROUND**”**

–[WX-78](/wiki/WX-78 "WX-78")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Brickwork, to be applied to the ground.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I prefer wooden floorboards.**”**

–[Woodie](/wiki/Woodie "Woodie")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Some quality stonework.**”**
...
**“**You've seen one brick, you've seen them all.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Brick Flooring** is a craftable [Turf](/wiki/Turf "Turf") [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in the *[Cult of the Lamb Crossover](/wiki/Cult_of_the_Lamb_Crossover "Cult of the Lamb Crossover")* update. Its rare [Blueprint](/wiki/Blueprint "Blueprint") can be obtained by contributing a [Red Crown](/wiki/Red_Crown "Red Crown") to the [Antlion](/wiki/Antlion "Antlion"). It is crafted with 1 [Cut Stone](/wiki/Cut_Stone "Cut Stone") and 2 [Flint](/wiki/Flint "Flint"), producing 4 turf items.

Like the Cobblestones turf the Brick Flooring is providing a 30% speed boost.

## Trivia[]

* Before the introduction of [Stone Road Turf](/wiki/Stone_Road_Turf "Stone Road Turf") in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, Cobblestones were the only craftable Turf that provides a faster movement speed.
* Before Cobblestones were implemented, players were able to dig up [Road Turf](/wiki/Road_Turf "Road Turf").
* Don't Starve Together Brick Flooring was added in the *[Cult of the Lamb Crossover](/wiki/Cult_of_the_Lamb_Crossover "Cult of the Lamb Crossover")* update.

## Gallery[]

Cobblestones Texture.png (173 KB)

Cobblestones texture.

Cobblestone.jpg (14 KB)

A patch of player-placed Cobblestones.
