...
source_url: https://dontstarve.fandom.com/wiki/Grasslands
---
...
|  |
| --- |
| EvergreenBirchnut TreeGrass TuftSaplingFlowerCarrotCrowRedbird  (Twiggy TreeDon't Starve Together icon) |

Occasional

|  |
| --- |
| Berry BushMushroomsFlintMini GlacierBeehiveKiller Bee HiveFrog PondRabbit HoleBurrowFireflies  (Juicy Berry BushDon't Starve Together icon) |

Rare

|  |
| --- |
| MandrakeSpider DenWalrus CampSinkholeWorm Hole  (Gigantic BeehiveDon't Starve Together icon) |

**“**The ground is boring.**”**

–[Willow](/wiki/Willow "Willow")

**Grasslands** are a common [Biome](/wiki/Biomes "Biomes") found in the world. They are generally safe areas with many types of useful resources. The player always spawns in a Grassland upon entry to a world, whether it be a small, zigzagged patch of green or a whole biome. Grasslands often mingle with areas of [Forest](/wiki/Forest "Forest") and occasionally [Marsh](/wiki/Marsh "Marsh").

Grasslands are characterized by their green [Grass Turf](/wiki/Grass_Turf "Grass Turf") and scattered [Evergreens](/wiki/Evergreen "Evergreen"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Saplings](/wiki/Sapling "Sapling"), [Carrots](/wiki/Carrot "Carrot") , [Flowers](/wiki/Flower "Flower"), and [Berry Bushes](/wiki/Berry_Bush "Berry Bush"). [Flint](/wiki/Flint "Flint") can also be found on the ground occasionally. [Beehives](/wiki/Beehive "Beehive") and [Pig Villages](/wiki/Pig_Village "Pig Village") are commonly found on Grassland terrain. [Rabbit](/wiki/Rabbit "Rabbit") holes appear sparsely in Grasslands, as do [Ponds](/wiki/Pond "Pond") which spawn [Frogs](/wiki/Frog "Frog"). [Butterflies](/wiki/Butterflies "Butterflies") are commonly found here due to the abundant Flowers.

The primary dangers in Grasslands are [Spider Dens](/wiki/Spider_Den "Spider Den"), which are typically spread out, and [Killer Bee Hives](/wiki/Killer_Bee_Hive "Killer Bee Hive"), which can sometimes be found in dense formations along with regular Beehives and many Flowers. [Walrus Camps](/wiki/Walrus_Camps "Walrus Camps") are also more likely to spawn here than in any other biome, creating a hazard in [Winter](/wiki/Winter "Winter").

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the [Gigantic Beehive](/wiki/Gigantic_Beehive "Gigantic Beehive") that can be [Hammered](/wiki/Hammer "Hammer") to spawn the [Bee Queen](/wiki/Bee_Queen "Bee Queen") can be found in the Grasslands biome. [Juicy Berry Bushes](/wiki/Juicy_Berry_Bush "Juicy Berry Bush") and [Twiggy Trees](/wiki/Twiggy_Tree "Twiggy Tree") will sometimes replace all Berry Bushes and Saplings respectively in the entire world, including in this biome.

## Blueprint Gallery[]

GRasslandTerrain.jpg (220 KB)

An example of a Grasslands biome.

A Mandrake at spawn.png (1.42 MB)

The player spawns on a piece of Grassland.

Etho playing don't starve pre alpha.png (1.23 MB)
