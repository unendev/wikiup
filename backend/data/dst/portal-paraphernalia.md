...
source_url: https://dontstarve.fandom.com/wiki/Portal_Paraphernalia
---
...
**“**I'm good at following instructions! I have a badge for it!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**What's a little more tampering going to hurt?"**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Portal Paraphernalia** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It is found in the [Celestial Filter](/wiki/Celestial_Filter "Celestial Filter"), and requires a [Board](/wiki/Boards "Boards") and a [Rope](/wiki/Rope "Rope") to craft. Portal Paraphernalia is required to start construction on upgrading the [Florid Postern](/wiki/Florid_Postern "Florid Postern") to the [Celestial Portal](/wiki/Celestial_Portal "Celestial Portal").

## Trivia[]

* [Paraphernalia](https://en.wikipedia.org/wiki/Paraphernalia "wikipedia:Paraphernalia") is defined as a group of apparatus, equipment, or furnishing used for a particular activity.
* The Portal Paraphernalia's crafting description is a possible reference to a [Poem](https://en.wikipedia.org/wiki/To_a_Mouse "wikipedia:To a Mouse") by [Robert Burns](https://en.wikipedia.org/wiki/Robert_Burns "wikipedia:Robert Burns").

## Gallery[]

Portal Paraphernalia on ground.PNG (42 KB)

[Wilson](/wiki/Wilson "Wilson") standing next to the Portal Paraphernalia.

Portal Paraphernalia on Florid Postern.PNG (95 KB)

The Portal Paraphernalia when placed on the [Florid Postern](/wiki/Florid_Postern "Florid Postern").
