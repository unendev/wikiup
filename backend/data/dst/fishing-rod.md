...
source_url: https://dontstarve.fandom.com/wiki/Fishing_Rod
---
...
| --- | --- | --- |
| **Survival Tab** | Tools Filter Fishing Filter | Science Machine |

Combat attributes

| [Damage](/wiki/Damage "Damage") |
| --- |
| 4.25  3.2 WendyWes  ---  5.3 Wigfrid  ---  2.1WolfgangDon't Starve/3.2WolfgangDon't Starve Together/4.25Wolfgang/8.5 Wolfgang  ---  2.1 Wanda (elderly) |
...
|  |
| --- |
| Allows the player to catch [Fish](/wiki/Fish "Fish") and [Trinkets](/wiki/Trinkets "Trinkets"). |
...
Pigg and Pigglet's General Store (Oinc ×10) Hamlet icon
...
A **Fishing Rod** is a [Survival](/wiki/Survival "Survival") [Item](/wiki/Item "Item") used to catch [Fish](/wiki/Fish "Fish") or [Eels](/wiki/Eel "Eel") at a [Pond](/wiki/Pond "Pond"). It requires 2 [Twigs](/wiki/Twigs "Twigs") and 2 [Silk](/wiki/Silk "Silk") to craft and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. The Fishing Rod can be used to catch up to 9 fish/eels before breaking. Fishing does not count towards [Naughtiness](/wiki/Naughtiness "Naughtiness"), so the player is in no danger from [Krampus](/wiki/Krampus "Krampus").

The Fishing Rod can also be used to catch [Flotsam](/wiki/Flotsam "Flotsam") from the coast, which returns various resources and [Trinkets](/wiki/Trinkets "Trinkets"). This action also degrades the Fishing Rod.The magnifying glass,bug net and fishing rod are the weakest weapons in the game, dealing 4.25 damage.

## Icon Tools Usage[]

 https://static.wikia.nocookie.net/dont-starve-game/images/3/33/FishingRod.jpg/revision/latest?cb=20130322071753 https://static.wikia.nocookie.net/dont-starve-game/images/3/33/FishingRod.jpg/revision/latest?cb=20130322071753 



 

[Ponds](/wiki/Pond "Pond") can be found in any part of the map, but they are most common in [Marshes](/wiki/Marsh "Marsh"), [Forests](/wiki/Forest "Forest"), and [Grasslands](/wiki/Grassland "Grassland"). To begin fishing, drag and drop the Fishing Rod on the pond or equip the rod and click the pond, and the character will cast a line into the pond. After 5–40 seconds, the line will tug and the "Hook" option will appear. Clicking the left mouse button on the pond will hook the fish, and an additional click will reel it in.
...
In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, [Shoals](/wiki/Shoal "Shoal") and [Tidal Pools](/wiki/Tidal_Pool "Tidal Pool") can also be fished. Both yield [Tropical Fish](/wiki/Tropical_Fish "Tropical Fish"), though Shoals have a chance of additionally spawning [Crocodogs](/wiki/Crocodog "Crocodog").

In the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, Fishing Rods can be used to retrieve sunken [Lost Relics](/wiki/Lost_Relics "Lost Relics") in the [Lily Pond](/wiki/Lily_Pond "Lily Pond") [Biome](/wiki/Biomes "Biomes"). They can be bought for ten [Oincs](/wiki/Oinc "Oinc") in the [Pigg and Pigglet's General Store](/wiki/Pig_Shops#Pigg_and_Pigglet's_General_Store "Pig Shops") in the [Pig City](/wiki/Pig_City "Pig City").

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the [Lake](/wiki/Lake "Lake") at the [Oasis](/wiki/Set_Pieces#Oasis "Set Pieces") can also be fished, yielding [Fish](/wiki/Fish "Fish") or [Crumpled Packages](/wiki/Crumpled_Package "Crumpled Package") which contain [Trinkets](/wiki/Trinkets "Trinkets") and rare [Blueprints](/wiki/Blueprint "Blueprint"). It's name has also been changed to **Freshwater Fishing Rod**. To go fishing in the ocean, a [Sea Fishing Rod](/wiki/Sea_Fishing_Rod "Sea Fishing Rod") is needed instead of a normal one. Attempting to fish in the ocean will result in a unique character quote.

## Silver Bowl The Gorge[]

In *[The Gorge](/wiki/The_Gorge "The Gorge")* [event](/wiki/Category:Events "Category:Events"), Fishing Rods can be bought from [Billy](/wiki/Billy "Billy") for 3 Old Coins each. They are used to catch [Salmon](/wiki/Salmon "Salmon") from [Salt Ponds](/wiki/Salt_Pond "Salt Pond"). Unlike in normal gameplay, Fishing Rods in *The Gorge* do not have a limited durability and can be used an infinite amount of times.

## Prototype Tips[]

* When trying to fish in surface ponds, dangerous creatures will be present depending on the time of day. Grasslands Ponds will spawn [Frogs](/wiki/Frog "Frog") during the day time, while Marsh Ponds will spawn [Mosquitos](/wiki/Mosquito "Mosquito") during dusk and night.
...
Fishing stage 1.png (164 KB)

Wilson fishing.

Fishing stage 2.png (164 KB)

The Fish took the bait.

Wilson fishing hooking.png (77 KB)

The Fish is hooked and ready to get reeled in.

Wickerbottom eyes while fishing.png (50 KB)

Wickerbottom getting a bite while fishing, with the "Hook" prompt.

Fishing Glitch.png (274 KB)

The lure is in the ground rather than the water.
