...
source_url: https://dontstarve.fandom.com/wiki/Potter's_Wheel
---
...
"Marble will be like clay in your hands."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Cut Stone**×2** Boards**×2** Twigs**×4** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Prototypers & Stations Filter Decorations Filter Structures Filter | Science Machine |

Perk

|  |
| --- |
| Unlocks the [Sculptures Filter](/wiki/Sculptures_Filter "Sculptures Filter"). |
...
**“**Artist's block. Hyuyu!**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Make things outta rocks!**”**
...
**“**I've got more pressing things to do than arts and crafts.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Potter's Wheel** is a [Crafting Station](/wiki/Category:Crafting_Stations "Category:Crafting Stations") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It requires 2 [Cut Stone](/wiki/Cut_Stone "Cut Stone"), 2 [Boards](/wiki/Boards "Boards") and 4 [Twigs](/wiki/Twigs "Twigs") to build, and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. It allows players to access the [Sculptures Filter](/wiki/Sculptures_Filter "Sculptures Filter") and build 37 different [sculptures](/wiki/Chess_Pieces "Chess Pieces"), mostly based on the naturally-spawning [Marble Sculptures](/wiki/Marble_Sculptures "Marble Sculptures") and [Giants](/wiki/Giants "Giants"). 7 of these sculptures are only available to craft during their associated seasonal [Event](/wiki/Category:Events "Category:Events").

## Usage[]

The [Bubble Pipe Carving](/wiki/Chess_Pieces#Bubble_Pipe_Carving "Chess Pieces") and [Carved Hornucopia](/wiki/Chess_Pieces#Carved_Hornucopia "Chess Pieces") sculptures are available near any Potter's Wheel, while the others must be unlocked by giving the Potter's Wheel the respective [Sketches](/wiki/Sketch "Sketch"), which will be returned if the Wheel is hammered.

After being placed, a Potter's Wheel requires [Marble](/wiki/Marble "Marble"), [Cut Stone](/wiki/Cut_Stone "Cut Stone"), or a [Moon Shard](/wiki/Moon_Shard "Moon Shard") to be placed on top it to work. After the chosen material is placed, the player can turn it into the chosen [sculpture](/wiki/Chess_Pieces "Chess Pieces") with 2 [Rocks](/wiki/Rocks "Rocks"). Based on the material used, the sculpture will be white if Marble was used, black if Cut Stone was used, and a translucent green if a Moon Shard was used. After the sculpture is made, players can pick it up and carry it similar to [Suspicious Marble](/wiki/Suspicious_Marble "Suspicious Marble").

The sculpture may be broken with a [hammer](/wiki/Hammer "Hammer").

## Tips[]

* Much like a [Suspicious Marble](/wiki/Suspicious_Marble "Suspicious Marble"), sculptures may be quickly moved by riding a [Beefalo](/wiki/Beefalo "Beefalo"), as they aren't affected by the player's speed, or by riding [Big Woby](/wiki/Woby "Woby") as [Walter](/wiki/Walter "Walter").
* Sculptures may be slightly challenging to place in appropriate places. It is recommended to: 1. stand near desired spot and 2. quick drop (Shift + Right Click item, previously a mod, now in DST) OR equip a chest item.
* These sculptures, when placed adjacent to one another, can serve as the best option for a wall against most mobs. Their pathfinding sees sculptures are separate structures, and thus try to walk between them (to no avail) rather than go around them, like walls. Thus one must only worry about those capable of destroying said structures (mostly [Boss Monsters](/wiki/Category:Boss_Monsters "Category:Boss Monsters")) , such as [Clockwork Rook](/wiki/Clockwork_Rook "Clockwork Rook"), [Deerclops](/wiki/Deerclops "Deerclops") and [Bearger](/wiki/Bearger "Bearger").

## Trivia[]

* The Potter's Wheel was introduced in the *[Arts and Crafts](/wiki/A_New_Reign#October_13.2C_2016_-_Arts_and_Crafts "A New Reign")* update.

## Gallery[]

DSTupdate artsandcrafts.png (2.54 MB)

Potter's Wheel as seen in the poster for the *[Arts and Crafts](/wiki/A_New_Reign#October_13,_2016_-_Arts_and_Crafts "A New Reign")* update.

Potter's Wheel Burnt.png (28 KB)

A burnt Potter's Wheel.

Sculpture Slot.png (4 KB)

The icon for a sculpting material on the Potter's Wheel.
