...
source_url: https://dontstarve.fandom.com/wiki/Marble_Pillar
---
...
**Marble Pillars** are naturally spawning [Structures](/wiki/Structures "Structures") found around the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") in a [Chess](/wiki/Chess "Chess") [biome](/wiki/Biome "Biome") in [Sandbox Mode](/wiki/Sandbox_Mode "Sandbox Mode") or in various Chess [biomes](/wiki/Biome "Biome") in [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode"). Usually, there are [Clockwork Monsters](/wiki/Category:Clockwork_Monsters "Category:Clockwork Monsters") and [Evil Flowers](/wiki/Evil_Flower "Evil Flower") near them. They can be mined with a [Pickaxe](/wiki/Pickaxe "Pickaxe") or the [Pick/Axe](/wiki/Pick/Axe "Pick/Axe") to acquire 2-3 [Marble](/wiki/Marble "Marble") pieces (2 + 33% chance to get 1 extra). The pickaxe requires 10 hits to break a Marble Pillar down, whereas the Pick/Axe only requires 8. Though it may use a lot of durability off a pickaxe, it is recommended to mine Marble Pillars so the player can make a [Marble Suit](/wiki/Marble_Suit "Marble Suit") for fighting.

## Placeholder Trivia[]

* Marble Pillars were introduced in the *[A Little Rain Must Fall](/wiki/Version_History#March_12,_2013_-_A_Little_Rain_Must_Fall "Version History")* update.
* Marble Pillars used to spawn around [Maxwell's Door](/wiki/Maxwell%27s_Door "Maxwell's Door") in the old versions of *Don't Starve*.

## Blueprint Gallery[]

MarbleBreakdown.jpg (11 KB)

The three stages of a broken down pillar.

MArble.jpg (313 KB)

Wilson using his [Pick/Axe](/wiki/Pick/Axe "Pick/Axe") on a Marble Pillar.

Maxwell's Door old.jpg (137 KB)

An older version of *Don't Starve* showing Maxwell's Door on [Carpeted Flooring](/wiki/Carpeted_Flooring "Carpeted Flooring") surrounded by Marble Pillars.

Chess Icon.png (89 KB)

Marble pillars as they appear on the map.

Chess Biome ingame.png (1.8 MB)

An X with 4 marble pillars and several [Clockwork Knights](/wiki/Clockwork_Knight "Clockwork Knight").
