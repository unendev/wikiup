...
source_url: https://dontstarve.fandom.com/wiki/Sulfuric_Experiment
---
...
"Crystalized incandescence."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Charcoal**×1** Rotten Egg**×1** Sanity Decrease**×10** |
...
|  |
| --- |
| Adds sparkling effects to a Fire. |

[Code](/wiki/Console "Console")

|  |
| --- |
| `"halloweenpotion_embers"` `"halloweenpotion_sparks"` |
...
**“**It should only be handled by someone who knows fire safety. Like me!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This might have been a frivolous use of my time..."**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Sulfuric Experiment** is a feature exclusive to the [Hallowed Nights](/wiki/Hallowed_Nights "Hallowed Nights") [event](/wiki/Category:Events "Category:Events") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It can be conducted at the [Mad Scientist Lab](/wiki/Hallowed_Nights#Mad_Scientist_Lab "Hallowed Nights"), using [Charcoal](/wiki/Charcoal "Charcoal") and a [Rotten Egg](/wiki/Rotten_Egg "Rotten Egg"), and depleting 10 Sanity for the player. The experiment has a 50% chance to result in **Sulfuric Crystals of Lime** and a 50% chance to result in **Sulfuric Crystals of Saltpeter**.

Both potions can be used as [Fuel](/wiki/Fuel "Fuel") for a [Fire](/wiki/Fire "Fire"), causing different sparkling effects each.

## Placeholder Trivia[]

* The Mad Scientist Lab and all related craftable Items except for the [Lunar Experiment](/wiki/Lunar_Experiment "Lunar Experiment") were introduced to the Hallowed Nights event in 2018.
