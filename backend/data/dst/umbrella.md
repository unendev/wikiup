...
source_url: https://dontstarve.fandom.com/wiki/Umbrella
---
...
"Keep the sun and rain at bay!"

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Twigs**×6** Pig Skin**×1** Silk**×2** |

| [Tab](/wiki/Tabs "Tabs") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| **Survival Tab** | Science Machine |
...
**“**A handy little rain napper.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Umbrella** is a [Survival](/wiki/Survival "Survival") item that negates [Sanity](/wiki/Sanity "Sanity") loss caused by the [Rain](/wiki/Rain "Rain") while equipped. If playing as [WX-78](/wiki/WX-78 "WX-78"), the Umbrella will prevent damage caused by Rain and prevent being struck by [Lightning](/wiki/Lightning "Lightning"). It requires 6 [Twigs](/wiki/Twigs "Twigs"), 1 [Pig Skin](/wiki/Pig_Skin "Pig Skin"), and 2 [Silk](/wiki/Silk "Silk") to craft and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype.

The Umbrella can also be used as a [Melee Weapon](/wiki/Category:Weapons#Melee_Weapons "Category:Weapons"), but this is not recommended as it deals only 17 damage and breaks after 20 uses. Otherwise, the Umbrella will never break no matter how often the player uses it.
...
| --- | --- | --- |
| **Survival Tab** | Clothing FilterSummer Items FilterRain Gear Filter | Science Machine |
...
|  |
| --- |
| Protects from rain and the sun. |

## Sources

### Dropped by

Slotmachine Steamer Trunk Shipwrecked

### Sold by

Pigg and Pigglet's General Store (Oinc ×10) Hamlet
...
In [DLCs](/wiki/DLC "DLC") as well as *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the Umbrella slows the rate at which the player gains [Wetness](/wiki/Wetness "Wetness") by 90% and provides moderate protection from [Overheating](/wiki/Overheating "Overheating"). It now also loses durability when passively held, like other [Dress](/wiki/Dress "Dress") items. It can be repaired with a [Sewing Kit](/wiki/Sewing_Kit "Sewing Kit") for 83% durability. It will no longer prevent WX-78 from being struck by Lightning.

Because the durability has been tied to time being equipped, the umbrella is no longer a weapon, and attacking with it causes a generic punch damage (10 by default), costing no extra durability when used this way.

In the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, Umbrellas can be bought for 10 [Oincs](/wiki/Oinc "Oinc") at the [Pigg and Pigglet's General Store](/wiki/Pigg_and_Pigglet%27s_General_Store "Pigg and Pigglet's General Store").
...
* For 100% water resistance, a player can hold an umbrella while wearing a [Battle Helm](/wiki/Battle_Helm "Battle Helm"), [Beefalo Hat](/wiki/Beefalo_Hat "Beefalo Hat"), [Breezy Vest](/wiki/Breezy_Vest "Breezy Vest"), [Football Helmet](/wiki/Football_Helmet "Football Helmet"), [Miner Hat](/wiki/Miner_Hat "Miner Hat"), [Rain Hat](/wiki/Rain_Hat "Rain Hat"), [Shelmet](/wiki/Shelmet "Shelmet"), [Spiderhat](/wiki/Spiderhat "Spiderhat"), [Straw Hat](/wiki/Straw_Hat "Straw Hat"), [Summer Frest](/wiki/Summer_Frest "Summer Frest"), or [Top Hat](/wiki/Top_Hat "Top Hat").

## Trivia[]

* The Umbrella was added during *[A Little Rain Must Fall](/wiki/Version_History#March_12,_2013_-_A_Little_Rain_Must_Fall "Version History")* update of *Don't Starve's* beta testing period.
* Using Pig Skin to make an Umbrella may be a reference to [Robinson Crusoe's](https://en.wikipedia.org/wiki/Robinson_Crusoe "wikipedia:Robinson Crusoe") umbrella.

## Gallery[]

WilsonUmbrella.png (162 KB)

The Umbrella on the ground and equipped.

Umbrella during rain.png (1.17 MB)

Wilson with an Umbrella in the rain so Sanity stays intact.

A Little Rain Must Fall.jpg (755 KB)

The update *A Little Rain Must Fall* introduced rain and the Umbrella.

Wes-Umbrella.png (917 KB)

Wes figurine with an Umbrella.
