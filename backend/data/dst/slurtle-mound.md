...
source_url: https://dontstarve.fandom.com/wiki/Slurtle_Mound
---
...
Slurtle Slime (x3), Broken Shell

### Spawns

Slurtle (90%), Snurtle (10%)
...
**“**Are you guys doing okay in there?**”**
...
**“**It appears to be fashioned from combustible materials.**”**
...
**“**The snail things come out of there.**”**
...
**“**They slurtle their way in there, d'they?**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS LAIR OF SLIME BEASTIES.**”**
...
**“**The hole where all the slurtles go!**”**
...
**“**Strange. Anyway, moving on...**”**

–[Wanda](/wiki/Wanda "Wanda")

A **Slurtle Mound** is a large, slimy rock pillar found in [Caves](/wiki/Caves "Caves") which spawns [Slurtles](/wiki/Slurtle "Slurtle") (90%) and [Snurtles](/wiki/Snurtle "Snurtle") (10%) when hit or after an [Earthquake](/wiki/Earthquake "Earthquake"). Slurtles/Snurtles emerge from the mound after earthquakes to eat the fallen [Rocks](/wiki/Rocks "Rocks"), [Flint](/wiki/Flint "Flint"), [Nitre](/wiki/Nitre "Nitre"), [Gold](/wiki/Gold "Gold"), and [Gems](/wiki/Gems "Gems"). Snurtles rarely spawn from the Mound and flee immediately instead of attacking the player. Snurtles, when given the opportunity, will eat Earthquake items in the same fashion as the Slurtle.

When destroyed, the mound yields [Slurtle Slime](/wiki/Slurtle_Slime "Slurtle Slime"), which can be used to fuel [Lanterns](/wiki/Lantern "Lantern") or act as an alternative to [Gunpowder](/wiki/Gunpowder "Gunpowder"), dealing 50 damage per explosion.

## Tentacle Spike Strategy[]

* Slurtles, when attacked, will either strike back or hide in their shells. Their Mounds can be destroyed by using a group of [Bunnymen](/wiki/Bunnymen "Bunnymen") or [Rock Lobsters](/wiki/Rock_Lobster "Rock Lobster"), or even kite them away and attack.
* One can make an explosive farm with Slurtle Mounds. Both Slurtles and Snurtles are flammable and explosive, and they'll follow the player if they have any minerals. Guiding them to any dangerous monster and making them explode with the [Fire Staff](/wiki/Fire_Staff "Fire Staff") can take out the larger monsters.

## Blueprint Gallery[]

Slurtle.png (15 KB)

A Slurtle, which can spawn from a Slurtle Mound.

Snurtle.png (13 KB)

A Snurtle, which can also spawn, although more rarely, from a Slurtle Mound.

Some mounds.png (674 KB)

Some Slurtle Mounds.

Destroyed Slurtle Mound.png (440 KB)

A destroyed Slurtle Mound.
