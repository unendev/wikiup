...
source_url: https://dontstarve.fandom.com/wiki/Pick/Axe
---
...
| --- |
| Luxury Axe**×1** Opulent Pickaxe**×1** Thulecite**×2** |
...
The **Pick/Axe** is a craftable [Item](/wiki/Items "Items") found in the [Ancient Tab](/wiki/Ancient_Tab "Ancient Tab"). It requires 1 [Luxury Axe](/wiki/Luxury_Axe "Luxury Axe"), 1 [Opulent Pickaxe](/wiki/Opulent_Pickaxe "Opulent Pickaxe") and 2 [Thulecite](/wiki/Thulecite "Thulecite"), and an [Ancient Pseudoscience Station](/wiki/Ancient_Pseudoscience_Station "Ancient Pseudoscience Station") to craft. It also has a 5% or 50% chance to be found inside an [Ornate Chest](/wiki/Ornate_Chest "Ornate Chest") or a Large Ornate Chest respectively. Like all items from the Ancient Tab, Pick/Axes cannot be prototyped and [Characters](/wiki/Characters "Characters") always need to be near an Ancient Pseudoscience Station to craft them again.

The Pick/Axe can be used as both a Pickaxe and an Axe, but takes 20% fewer swings to accomplish the same work. A Large [Evergreen](/wiki/Evergreen "Evergreen") will take 12 swings instead of 15. A standard [Boulder](/wiki/Boulder "Boulder"), 5 hits instead of 6. You can't save a fraction of a swing, so without other bonuses, only individual items that take 5 swings or more will benefit from this work reduction. [Antlion](/wiki/Antlion "Antlion")'s cave-in boulders take 3 swings, and stone fruits take one, so neither is affected by this.
...
The Pick/Axe is one of only 2 tools that can mine the pillars to free the [Nightmare Werepig](/wiki/Nightmare_Werepig "Nightmare Werepig") in [Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together"), the other being the [Brightshade Smasher](/wiki/Brightshade_Smasher "Brightshade Smasher").

The Pick/Axe has a chance to be found in a sunken chest

## Tips[]

* The Luxury Axe and Opulent Pickaxe used in the recipe can be in any [condition](/wiki/Durability "Durability") without affecting the durability of the resulting Pick/Axe.
* When a Pick/Axe is low on durability, players can use a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff") to get both the Luxury Axe and Opulent Pickaxe back each at 100% durability, plus one thulecite.

## Trivia[]

* The Pick/Axe used to be called "Multitool" and had a different look before being implemented with the *[Stuff of Nightmares](/wiki/Version_History#August_20.2C_2013_-_The_Stuff_of_Nightmares "Version History")* update.

## Gallery[]

PickSlashAxe In-Game.png (207 KB)

[Wolfgang](/wiki/Wolfgang "Wolfgang") holding a Pick/Axe.

PickAxe chop.jpg (28 KB)

[Woodie](/wiki/Woodie "Woodie") cutting a tree using the Pick/Axe.

PickAxe mining.jpg (34 KB)

Woodie mining using the Pick/Axe.

Old PickAxe.png (4 KB)

Pick/Axe's previous design, before it was released.

Multi chop.png (65 KB)

[Wilson](/wiki/Wilson "Wilson") chopping a tree with the old version of the Pick/Axe.

Multi mining.png (79 KB)

Wilson mining with the old version of the Pick/Axe.
