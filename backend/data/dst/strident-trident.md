...
source_url: https://dontstarve.fandom.com/wiki/Strident_Trident
---
...
"Rock out in rocky waters."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Gnarwail Horn**×3** Kelp Fronds**×4** Twigs**×2** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Weapons Filter | Rare Blueprint |

Combat attributes

| [Damage](/wiki/Damage "Damage") |
| --- |
| 51 (melee on land)  38.3 WendyWes  ---  63.8 Wigfrid  ---  38.3Wolfgang/51Wolfgang/102 Wolfgang  ---  25.5 Wanda (elderly)  76.5 (melee on ocean)  57.4 WendyWes  ---  95.6 Wigfrid  ---  57.4Wolfgang/76.5Wolfgang/153 Wolfgang  ---  38.3 Wanda (elderly)  85 (spell) |

## Properties

### [Durability](/wiki/Durability "Durability")

150 Uses (melee), 50 uses (spell)
...
**“**It's three times as pokey.**”**

–[Willow](/wiki/Willow "Willow")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is good fork for Wolfgang-sized meals!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It was stolen from the sea, but it still holds power over the waves.**”**

–[Wendy](/wiki/Wendy "Wendy")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**HIGH FREQUENCY TABLEWARE**”**

–[WX-78](/wiki/WX-78 "WX-78")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It produces quite literal sound waves!**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Don't worry Lucy, I'm not trading you in anytime soon.**”**
...
**“**I shall lay waste tö my enemies with the weapön öf Pöseidön!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**We don't know how to play, but we can try!**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**What dish could accomodate a fork of that size?**”**
...
**“**I ain't afraid to make waves! Ha!**”**

–[Winona](/wiki/Winona "Winona")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Holding a pitchfork feels disturbingly natural.**”**
...
**“**This looks like it could cause some damage.**”**
...
The **Strident Trident** is a cratftable [Weapon](/wiki/Weapon "Weapon") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in the *[Return of Them](/wiki/Return_of_Them "Return of Them")* updates. The Strident Trident [Blueprint](/wiki/Blueprint "Blueprint") is dropped by the [Crab King](/wiki/Crab_King "Crab King") upon death. It requires 3 [Gnarwail Horns](/wiki/Gnarwail_Horn "Gnarwail Horn"), 4 [Kelp Fronds](/wiki/Kelp_Fronds "Kelp Fronds"), and 2 [Twigs](/wiki/Twigs "Twigs") to craft.

The Strident Trident can be used as a weapon to deal 51 damage on land and 76.5 damage at sea with 150 uses. It can also cast spells, consuming 3 weapon uses (for a maximum of 50 casts).

The spell will cause the player to play a short rock chord and summon geysers in the [Ocean](/wiki/Ocean "Ocean") around the cast location, dealing 85 damage each. It mines for the equivalent of 10 [Pickaxe](/wiki/Pickaxe "Pickaxe") hits. It can create leaks in a [Boat](/wiki/Boat "Boat"), push [Items](/wiki/Items "Items") into the ocean, and launch fish into the air to catch them without a [Sea Fishing Rod](/wiki/Sea_Fishing_Rod "Sea Fishing Rod"), provided they can fall onto nearby land or a boat. It uproots [Bull Kelp](/wiki/Bull_Kelp "Bull Kelp").

## Tips[]

* With 50 casts, this weapon has the ability to catch a lot of live fish in a short amount of time. However, using the trident as a weapon may be considered a waste, as it only gets a damage bonus at sea equal to a [Dark Sword](/wiki/Dark_Sword "Dark Sword") or [Glass Cutter](/wiki/Glass_Cutter "Glass Cutter") with only 50% more durability.
* The trident's cast can also be used to mine [Salt Formations](/wiki/Salt_Formation "Salt Formation") in the ocean and kill nearby [Cookie Cutters](/wiki/Cookie_Cutter "Cookie Cutter"), if one does not wish to risk damaging their boat.
* After two [Gnarwail horns](/wiki/Gnarwail_Horn "Gnarwail Horn") have been collected, the trident can be crafted with a [Construction Amulet](/wiki/Construction_Amulet "Construction Amulet"). Using a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff") on a trident before its durability hits 33% will return two horns, so the same trident can be crafted again without the need to farm more horns.

## Trivia[]

* The Strident Trident was introduced in the *[She Sells Sea Shells](/wiki/Return_of_Them#She_Sells_Sea_Shells "Return of Them")* update.
* It shares the same debug spawn name as the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* item [Trident](/wiki/Trident "Trident"). However, its appearance and mechanics differ.
  + Still, they both share the same mechanic of dealing dramatically more damage while on a boat.
* Despite being a trident, when its spell is cast, a character using it appears to strum it like an electric guitar. It even produces a similar sound.
  + This is reiterated in the description, "*Rock out* in rocky waters."
* Wortox's quote is a reference to demons often being depicted with pitchforks, as he is an imp.
* Before the *[Staying Afloat](/wiki/Staying_Afloat "Staying Afloat")* update, the Strident Trident dealt 27.2 damage on land and 68 damage at sea.
