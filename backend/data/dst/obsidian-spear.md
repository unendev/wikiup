...
source_url: https://dontstarve.fandom.com/wiki/Obsidian_Spear
---
...
| --- |
| Spear**×1** Obsidian**×3** Dragoon Heart**×1** |

| [Tab](/wiki/Tabs "Tabs") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| **Volcanic Tab** | Obsidian Workbench |

Combat attributes

| [Damage](/wiki/Damage "Damage") |
| --- |
| 51 - 102 Volcanic  38.25 - 76.5 Volcanic WendyWes  ---  63.75 - 127 Volcanic Wigfrid  ---  25.5 - 204 Volcanic Wolfgang |
...
|  |
| --- |
| Ignites target outside [Hurricane Season](/wiki/Hurricane_Season "Hurricane Season"). Increased damage when charged. Emits light when charged. |
...
**“**Initial observations suggest the obsidian gets really hot.**”**
...
The **Obsidian Spear** is a craftable [Weapon](/wiki/Weapon "Weapon") exclusive to the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It requires 1 [Spear](/wiki/Spear "Spear"), 3 [Obsidian](/wiki/Obsidian "Obsidian"), and 1 [Dragoon Heart](/wiki/Dragoon_Heart "Dragoon Heart") to craft. It can also be found as a reward from [X Marks the Spot](/wiki/X_Marks_the_Spot "X Marks the Spot") treasure chests. Like all items in the [Volcanic Tab](/wiki/Volcanic_Tab "Volcanic Tab"), it cannot be prototyped and the player must be wearing a [Brain of Thought](/wiki/Brain_of_Thought "Brain of Thought") or be near an [Obsidian Workbench](/wiki/Obsidian_Workbench "Obsidian Workbench") to craft it again.

Initially, the Obsidian Spear deals the same damage as a [Tentacle Spike](/wiki/Tentacle_Spike "Tentacle Spike") per hit, but as the Obsidian Spear is used to attack, it will become charged causing it to deal up to 2x damage when fully charged. It takes approximately 30 hits to reach full charge. As the charge level increases, the Obsidian Spear will also produce more heat and light, which protects the players from [Charlie](/wiki/Charlie "Charlie"), but can rapidly cause [Overheating](/wiki/Overheating "Overheating") when unequipped. If dropped into water while sailing, the Obsidian Spear will lose all of its charge. It should be noted that it has a very high durability, 2.5x that of the regular Spear.

Players should take caution when using an Obsidian Spear with high levels of charge, as the targeted [Mob](/wiki/Mob "Mob") is likely to be killed and burn, causing [Meat](/wiki/Meat "Meat") to be cooked and the loots to ignite. Like other Obsidian tools, the Obsidian Spear will not gain any charges during [Hurricane Season](/wiki/Hurricane_Season "Hurricane Season").
...
* The Obsidian Spear, along with the [Obsidian Axe](/wiki/Obsidian_Axe "Obsidian Axe") and [Obsidian Machete](/wiki/Obsidian_Machete "Obsidian Machete"), will still gain charges when used in [Winter](/wiki/Winter "Winter").
  + As the weapon gains charges, the heat and light that it provides makes it an effective weapon to use during the long and cold winter nights. However, since it requires an attackable target to be charged, it may be preferable to carry around an Obsidian Axe and cut down [Trees](/wiki/Trees "Trees") instead.
* The weapon can be charged safely by attacking passive [Creatures](/wiki/Creatures "Creatures") that can regenerate health such as [Chester](/wiki/Chester "Chester") or [Packim Baggims](/wiki/Packim_Baggims "Packim Baggims"). However, the high damage of the weapon combined with the relatively low health and slow regeneration of the companions makes this process impractical. However, a more practical method is attacking a [Lureplant](/wiki/Meat_Bulb_(Lureplant) "Meat Bulb (Lureplant)") and replanting the [Fleshy Bulb](/wiki/Fleshy_Bulb "Fleshy Bulb") when it dies, this way the weapons can be charged with little to no risk.
  + In the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC, a better way to charge this weapon is attacking a [Gnat Swarm](/wiki/Gnat_Swarm "Gnat Swarm"), doing so also does not reduce the weapon's durability.

* This weapon can be used to fight mobs that cannot be ignited, such as [Dragonflies](/wiki/Dragonflies "Dragonflies"), [Frogs](/wiki/Frog "Frog"), and [Depths Worms](/wiki/Depths_Worm "Depths Worm"), and is very powerful against them when charged since it is the highest damage-dealing melee weapon in the game.

## Placeholder Trivia[]

* A charged Obsidian Spear placed inside [Chester](/wiki/Chester "Chester"), [Packim Baggims](/wiki/Packim_Baggims "Packim Baggims"), or [Ro Bin](/wiki/Ro_Bin "Ro Bin") will cause the follower to glow until the charge fades.

## Blueprint Gallery[]

DsswSpearbright.jpg (59 KB)

Charged Obsidian Spear during night.

Warly Obsidian Armor.png (122 KB)

[Warly](/wiki/Warly "Warly") holding an Obsidian Spear.
