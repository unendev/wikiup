...
source_url: https://dontstarve.fandom.com/wiki/Wooden_Potato_Thing
---

*Exclusive to:* Shipwrecked

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 See also: [Metal Potato Thing](/wiki/Metal_Potato_Thing "Metal Potato Thing") and [Relic Thing](/wiki/Relic_Thing "Relic Thing")*
...
**“**A wooden automaton head?! Extraordinary!**”**
...
**“**Whut a potatey needs a helmet fer me never be knowin'.**”**
...
The **Wooden Potato Thing** is the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* equivalent to the [Metal Potato Thing](/wiki/Metal_Potato_Thing "Metal Potato Thing") in both [Sandbox Mode](/wiki/Sandbox_Mode "Sandbox Mode") and [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode"). It serves the same purpose as the Metal Potato Thing, and is used with the other [Things](/wiki/Things "Things") on the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") to create a portal that lets players generate a new [World](/wiki/World_Generation "World Generation"), deleting everything except the items in their inventory.

It spawns naturally in the world in its own [Set Piece](/wiki/Set_Piece "Set Piece"). The player will find a [Drying Rack](/wiki/Drying_Rack "Drying Rack"), a [Fire Pit](/wiki/Fire_Pit "Fire Pit"), a [Skeleton](/wiki/Skeleton "Skeleton"), and some [Rocks](/wiki/Rocks "Rocks") atop [Magma Turf](/wiki/Magma_Turf "Magma Turf").

As it is an important gameplay Item, it cannot be destroyed or stolen by [Mobs](/wiki/Mobs "Mobs") (e.g. [Krampus](/wiki/Krampus "Krampus"), [Prime Apes](/wiki/Prime_Ape "Prime Ape") etc.)

## Tips[]

* If the player manages to find the Wooden Potato Thing [Set Piece](/wiki/Set_Piece "Set Piece") when starting in a world, this is a rather good place to take shelter. The area around is usually safe from dangers, and can even be "upgraded" to a better base.

## Trivia[]

* The Wooden Potato Thing is a wooden version of [Maxwell's](/wiki/Maxwell_(NPC) "Maxwell (NPC)") head.
* The Wooden Potato thing is the reason the [Wooden Platform Thing](/wiki/Wooden_Thing "Wooden Thing"), when fully constructed, is more commonly referred to as the 'Teleportato'.

## Gallery[]

Wooden Potato Thing ingame.png (808 KB)

Woodie near the Wooden Potato Thing.

Shipwreckednewsetpiece.png (324 KB)

Another variant of the Wooden Potato Thing's Set Piece.

|  |  |
| --- | --- |
| **Teleportato Pieces** [view](/wiki/Template:Navbox "Template:Navbox") | |
| **[Things](/wiki/Things "Things")** | [Crank Thing](/wiki/Crank_Thing "Crank Thing") • [Box Thing](/wiki/Box_Thing "Box Thing") • [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") • [Ring Thing](/wiki/Ring_Thing "Ring Thing") • [Metal Potato Thing](/wiki/Metal_Potato_Thing "Metal Potato Thing")  (*[Grassy Thing](/wiki/Grassy_Thing "Grassy Thing") • [Screw Thing](/wiki/Screw_Thing "Screw Thing") • [Wooden Platform Thing](/wiki/Wooden_Platform_Thing "Wooden Platform Thing") • **Wooden Potato Thing*** Don't Starve: Shipwrecked) (*[Lever Thing](/wiki/Lever_Thing "Lever Thing") • [Rock Thing](/wiki/Rock_Thing "Rock Thing") • [Stone Thing](/wiki/Stone_Thing "Stone Thing") • [Iron Thing](/wiki/Iron_Thing "Iron Thing") • [Relic Thing](/wiki/Relic_Thing "Relic Thing")* Don't Starve: Hamlet) |
