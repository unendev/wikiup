...
source_url: https://dontstarve.fandom.com/wiki/Rainometer
---
...
| --- |
| Boards**×2** Gold Nugget**×2** Rope**×2** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| Science Tab | Structures FilterWinter Items FilterSummer Items FilterRain Gear Filter | Science Machine |

Perk

|  |
| --- |
| Indicates the probability of [Rain](/wiki/Rain "Rain") and [Snow](/wiki/Seasons/Winter#Snow "Seasons/Winter") |
...
**“**Those elements would never make a barometer at home.**”**
...
**“**Sailor's arre walkin' rain-thingies!**”**
...
**“**A good aeronaut always has a barometer handy.**”**
...
**“**A Pinetree Pioneer can smell rain coming a mile away.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Pfft. I could just check the weather myself if I felt like it.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Rainometer** is a craftable [Structure](/wiki/Structure "Structure") that predicts precipitation ([Rain](/wiki/Rain "Rain") and [Snow](/wiki/Seasons/Winter#Snow "Seasons/Winter")).
It requires 2 [Boards](/wiki/Boards "Boards"), 2 [Gold Nuggets](/wiki/Gold_Nuggets "Gold Nuggets") and 2 [Rope](/wiki/Rope "Rope") to craft and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype.

The Rainometer has 3 stages, *Sunny*, *Cloudy*, and *Raining*. The arrow in the middle shows what weather is imminent or occurring at the time.

## Downloadable Content[]

In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, Rainometer can be [flooded](/wiki/Flooding "Flooding"). When flooded, it will visually emit sparks and cease to function.

## Tips[]

* This [Structure](/wiki/Structure "Structure") is most useful while playing as [WX-78](/wiki/WX-78 "WX-78"), who takes damage in rain.

## Trivia[]

* The Rainometer was added in *[A Little Rain Must Fall](/wiki/Version_History#A_Little_Rain_Must_Fall "Version History")* update.

## Gallery[]

Rainometer Burnt.png (23 KB)

Burnt Rainometer.

Rainometer Cloudy.png (78 KB)

A Rainometer in cloudy weather.

Rainy weather Rainometer.jpg (76 KB)

A Rainometer in rainy weather.

Burnt Rainometer.png (51 KB)

A burnt Rainometer from the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC.

Flooded Rainometer.png (67 KB)

A flooded Rainometer in the *Shipwrecked* DLC.

A Little Rain Must Fall.jpg (755 KB)

Rainometer as seen in the poster for *[A Little Rain Must Fall](/wiki/Don%27t_Starve/Version_History#March_12,_2013_-_A_Little_Rain_Must_Fall "Don't Starve/Version History")* update.
