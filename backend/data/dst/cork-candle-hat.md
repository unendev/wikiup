...
source_url: https://dontstarve.fandom.com/wiki/Cork_Candle_Hat
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Cork_Candle_Hat?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
**“**Presumably the cork will act as an insulator so my head doesn't burn.**”**
...
**“**Swell. I feel completely safe with an open flame on my head.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Cork Candle Hat** is a craftable [Hat](/wiki/Category:Hats "Category:Hats") [Item](/wiki/Item "Item") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is found in the [Light Tab](/wiki/Light_Tab "Light Tab"), requires 4 [Cork](/wiki/Cork "Cork") and 2 [Iron Ore](/wiki/Iron_Ore "Iron Ore") to craft, and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. It serves as a light source providing a slightly smaller radius of light than the [Torch](/wiki/Torch "Torch").

The greatest differences from the [Torch](/wiki/Torch "Torch"), and what justifies the use of better ingredients, is that it can be refueled with [Cork](/wiki/Cork "Cork") for 37.5% (45s) and be worn on the head. This allows for infinite use and frees the handslot for other [Tools](/wiki/Tools "Tools") or [Weapons](/wiki/Weapons "Weapons").

Unlike the [Torch](/wiki/Torch "Torch"), the durability drainage is not affected by [Rain](/wiki/Rain "Rain"), however it still provides 20% [wetness](/wiki/Wetness "Wetness") resistance when equipped.
...
* Cork Candle Hat Wilson.png

  [Wilson](/wiki/Wilson "Wilson") wearing a Cork Candle Hat.
* Cork Candle Hat Willow.png

  [Willow](/wiki/Willow "Willow") wearing a Cork Candle Hat.
* Cork Candle Hat Wolfgang.png

  [Wolfgang](/wiki/Wolfgang "Wolfgang") wearing a Cork Candle Hat.
* Cork Candle Hat Wendy.png

  [Wendy](/wiki/Wendy "Wendy") wearing a Cork Candle Hat.
* Cork Candle Hat WX-78.png

  [WX-78](/wiki/WX-78 "WX-78") wearing a Cork Candle Hat.
* Cork Candle Hat Wickerbottom.png

  [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing a Cork Candle Hat.
* Cork Candle Hat Woodie.png

  [Woodie](/wiki/Woodie "Woodie") wearing a Cork Candle Hat.
* Cork Candle Hat Wes.png

  [Wes](/wiki/Wes "Wes") wearing a Cork Candle Hat.
* Cork Candle Hat Maxwell.png

  [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing a Cork Candle Hat.
* Cork Candle Hat Wagstaff.png

  [Wagstaff](/wiki/Wagstaff "Wagstaff") wearing a Cork Candle Hat.
* Cork Candle Hat Wigfrid.png

  [Wigfrid](/wiki/Wigfrid "Wigfrid") wearing a Cork Candle Hat.
* Cork Candle Hat Webber.png

  [Webber](/wiki/Webber "Webber") wearing a Cork Candle Hat.
* Cork Candle Hat Walani.png

  [Walani](/wiki/Walani "Walani") wearing a Cork Candle Hat.
* Cork Candle Hat Warly.png

  [Warly](/wiki/Warly "Warly") wearing a Cork Candle Hat.
* Cork Candle Hat Wilbur.png

  [Wilbur](/wiki/Wilbur "Wilbur") wearing a Cork Candle Hat.
* Cork Candle Hat Woodlegs.png

  [Woodlegs](/wiki/Woodlegs "Woodlegs") wearing a Cork Candle Hat.
* Expand slideshow

  [Wilba](/wiki/Wilba "Wilba") wearing a Cork Candle Hat.
* Cork Candle Hat Wormwood.png

  [Wormwood](/wiki/Wormwood "Wormwood") wearing a Cork Candle Hat.
* Expand slideshow

  [Wheeler](/wiki/Wheeler "Wheeler") wearing a Cork Candle Hat.
