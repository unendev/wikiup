...
source_url: https://dontstarve.fandom.com/wiki/Astral_Detector
---
...
| --- |
| Moon Rock**×1** Thulecite**×1** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Tools Filter Light Sources Filter Structures Filter | Rare Blueprint |
...
The **Astral Detector** is an [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It requires 1 [Moon Rock](/wiki/Moon_Rock "Moon Rock") and 1 [Thulecite](/wiki/Thulecite "Thulecite") to craft and requires the [Blueprint](/wiki/Blueprint "Blueprint") unlocked by the [Distilled Knowledge](/wiki/Distilled_Knowledge "Distilled Knowledge") from a blue [Fountain of Knowledge](/wiki/Fountain_of_Knowledge "Fountain of Knowledge") to prototype.

It can be placed on the ground to indicate the direction of the nearest buried [Celestial Sanctum Piece](/wiki/Celestial_Sanctum#Celestial_Sanctum_Pieces "Celestial Sanctum"), the [Celestial Altar Pieces](/wiki/Celestial_Altar#Celestial_Altar_Pieces "Celestial Altar") or the [Celestial Tribute](/wiki/Celestial_Tribute "Celestial Tribute") (in the form of Crab King, who will drop the Inactive form of the tribute the first time it is killed).
...
|  |
| --- |
| Reveal buried [Celestial Sanctum Pieces](/wiki/Celestial_Sanctum_Pieces "Celestial Sanctum Pieces") location. Emits light. |
...
–[Wilson](/wiki/Wilson "Wilson"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Nothing left to find, I guess.**”**

–[Willow](/wiki/Willow "Willow"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is pointing way no more.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**There's nothing left to look for.**”**

–[Wendy](/wiki/Wendy "Wendy"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**OBJECTIVE COMPLETE**”**

–[WX-78](/wiki/WX-78 "WX-78"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It appears there are no more artifacts to find.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Nothin' left to point us to.**”**

–[Woodie](/wiki/Woodie "Woodie"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It fulfilled its purpose.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Its quest is cömplete.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Aw, I guess we found them all.**”**

–[Webber](/wiki/Webber "Webber"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**C'est fini.**”**

–[Warly](/wiki/Warly "Warly"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Done**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Guess we got 'em all!**”**

–[Winona](/wiki/Winona "Winona"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**We've finished the deed, nowhere left to lead.**”**

–[Wortox](/wiki/Wortox "Wortox"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It not point way anymore.**”**

–[Wurt](/wiki/Wurt "Wurt"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**We must've found them all!**”**

–[Walter](/wiki/Walter "Walter"), when all pieces have been found.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's finally found something!**”**

–[Wanda](/wiki/Wanda "Wanda"), when all pieces have been found.

Once placed on the ground, the Astral Detector will point a beam in the direction of the nearest Celestial Piece 5 seconds later. The direction arrow stays visible for 1 [day](/wiki/Day "Day"). The order of detection is the following:

1. Buried [Celestial Sanctum Pieces](/wiki/Celestial_Sanctum_Pieces "Celestial Sanctum Pieces").
2. Any sunk Celestial Pieces as [Underwater Salvageable](/wiki/Underwater_Salvageable "Underwater Salvageable").
3. [Inviting Formation](/wiki/Inviting_Formation "Inviting Formation").
4. The [Crab King](/wiki/Crab_King "Crab King") if the [Inactive Celestial Tribute](/wiki/Inactive_Celestial_Tribute "Inactive Celestial Tribute") has not yet dropped.
...
Both Celestial Sanctum Pieces are buried on the main island. The Astral Detector does not indicate anything underground if it is used in the [Caves](/wiki/Cave "Cave").
...
* The Astral Detector was introduced in the *[Forgotten Knowledge](/wiki/Return_of_Them#Forgotten_Knowledge "Return of Them")* update.
...
* Initially the Astral detector required 1 [Moon Rock](/wiki/Moon_Rock "Moon Rock") and 2 [Thulecite Fragments](/wiki/Thulecite_Fragments "Thulecite Fragments") to craft.

## Blueprint Gallery[]

Astral Detector Packed Build.png (39 KB)

Inactive Astral Detector.

Astral Detector Place Animation.gif (1.15 MB)

Astral Detector after placed on the ground.

Astral Detector Locating Animation.gif (1.1 MB)

Astral Detector locating for the nearest Celestial Piece.

Astral Detector Beam Animation.gif (1.17 MB)

Astral Detector beaming in the direction of the nearest Celestial Piece.

Astral Detector Drill Animation.gif (2.67 MB)

Astral Detector drilling for a Celestial Piece.

Astral Detector Idle Animation.gif (560 KB)

Astral Detector idling.

Astral Detector Pack Animation.gif (419 KB)

Astral Detector turning into its item.
