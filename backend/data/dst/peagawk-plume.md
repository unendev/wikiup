...
source_url: https://dontstarve.fandom.com/wiki/Peagawk_Plume
---
...
**“**Theoretically, there's an intact nervous system that keeps the eye moving.**”**
...
**“**Gubble Gubble Tweeter clothes**”**

–[Wormwood](/wiki/Wormwood "Wormwood")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Normally I don't mind feathers, but this one keeps staring at me.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Peagawk Plume** is an [Item](/wiki/Item "Item") dropped by [Peagawks](/wiki/Peagawk "Peagawk") in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. They can be obtained either by killing the bird or by picking its feathers while it is asleep or confined. A single Peagawk can provide up to seven Plumes the first time it is picked. A Peagawk will regrow one Plume after one [Day](/wiki/Day-Night_Cycle#day "Day-Night Cycle"), and can never regrow more. 2 Plumes are also received when digging a [Secret Bandit Camp](/wiki/Secret_Bandit_Camp "Secret Bandit Camp").

Four Peagawk Plumes are required to craft the [Gas Mask](/wiki/Gas_Mask "Gas Mask"). Peagawk Plumes can also be traded with the [Beautician](/wiki/Pig_Traders/Beautician "Pig Traders/Beautician") [Pig Trader](/wiki/Pig_Traders "Pig Traders") for two [Oincs](/wiki/Oinc "Oinc"), but the Gas Mask is usually more important.
