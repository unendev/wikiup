...
source_url: https://dontstarve.fandom.com/wiki/Parasitic_Shadeling
---
...
|  |  |
| --- | --- |
|  | This article is a [**stub**](/wiki/Category:Article_stubs "Category:Article stubs"). You can help Don't Starve Wiki by [expanding it.](https://dontstarve.fandom.com/wiki/Parasitic_Shadeling?action=edit) |
...
**Parasitic Shadelings** are [Shadow Creatures](/wiki/Shadow_Creatures "Shadow Creatures") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in the [Wilson Rework](/wiki/Wilson_Refresh "Wilson Refresh") update. They have 100 [Health](/wiki/Health "Health"), an [Insanity Aura](/wiki/Insanity_Aura "Insanity Aura") of -40/min and are [Shadow Aligned](/wiki/Shadow_Aligned "Shadow Aligned"). When killed, they drop [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel").

Parasitic Shadelings only spawn after the [Nightmare Werepig](/wiki/Nightmare_Werepig "Nightmare Werepig") is being freed. They spawn in a group of four and don't attack [characters](/wiki/Characters "Characters"), but instead the Nightmare Werepig. The Parasitic Shadelings can be attacked once the character reaches their insanity treshhold. They must be killed in order to start the [boss](/wiki/Boss "Boss") fight with the Nightmare Werepig.
