...
source_url: https://dontstarve.fandom.com/wiki/Magma
---
...
|  |
| --- |
| `"lava_pond" "lava_pond_rock" "lava_pond_rock[2-7]"` |

Scrapbook [Scrapbook](/wiki/Scrapbook "Scrapbook")

|  |
| --- |
| Raises the heat of Survivors nearby and will ignite nearby objects on fire. |
...
**“**I won't dip my toe in.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Too hot for swimming, florp.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Probably not the best swimming hole.**”**
...
**Magma** is an environmental feature found in the [Desert](/wiki/Desert "Desert") biome and exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. These pools are a part of a [Set Piece](/wiki/Set_Piece "Set Piece") found in the Desert, which serves as a spawn point for the [Dragonfly](/wiki/Dragonfly "Dragonfly"). They are used by the Dragonfly to spawn [Lavae](/wiki/Lavae "Lavae").

Magma is often surrounded by small rocks, much like [Ponds](/wiki/Pond "Pond") are surrounded by Plants or Algae. The Set Piece also has burnt [Spiky Trees](/wiki/Tree "Tree") and [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), [Crispy Skeletons](/wiki/Skeleton "Skeleton") that cannot be destroyed for resources, and numerous scorch marks on the ground.

Standing too close to Magma will cause the player, mobs, and most items to catch [Fire](/wiki/Fire "Fire"). However, it should be noted that there is a slightly larger radius in which the player will take fire damage but will not be set on fire.

Magma also glows in the dark, but the pool's light radius is too small to be useful, as it doesn't reach past the "burn zone". Its heat radius is much larger than its light radius, so a player staying near one during [Winter](/wiki/Winter "Winter") can avoid [Freezing](/wiki/Freezing "Freezing"). This heat radius can warm thermal stones, which can provide light outside the "burn zone" and allow a player to survive the [night](/wiki/Night "Night") with no other light sources.

It is possible to [Overheat](/wiki/Overheating "Overheating") from standing near a magma pool even during the winter, which can be very useful to allow for more time away from a heat source. Magma can be used to [Cook](/wiki/Cooking "Cooking") [Food](/wiki/Food "Food"), but the player will always catch fire in doing so. The only way to prevent this is to wear [Scalemail](/wiki/Scalemail "Scalemail") or to play as [Willow](/wiki/Willow "Willow").

## Gallery[]

Dragonfly Arena.PNG (2.04 MB)

The Dragonfly's set piece at Dusk featuring pools of Magma.

Magma fire damage.png (1.36 MB)

The player taking fire damage from standing near Magma.

Tumbleweed on fire.png (380 KB)

[Tumbleweed](/wiki/Tumbleweed "Tumbleweed") on fire after bouncing across a Magma pool.
