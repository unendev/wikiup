...
source_url: https://dontstarve.fandom.com/wiki/Willow's_Lighter
---
...
"Burns through the night and in the rain."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Rope**×1** Gold Nugget**×1** Petals**×3** (only craftable by Willow in Don't Starve Together) |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Light Sources Filter Willow Filter Cooking Filter | Always available |
...
100 uses (cooking food) Don't Starve Together

### Discharge Rate

Infinite Don't Starve  
1.25 days Don't Starve Together
...
|  |
| --- |
| * Provides light * Can set objects on fire * Can cook food in inventory (Don't Starve Together) |
...
**“**A tool to set fire, if you desire.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This very special to fire lady, florp.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Way easier than rubbing sticks together, but not as fun.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Oh the havoc you've wreaked across timelines...**”**

–[Wanda](/wiki/Wanda "Wanda")

**Willow's Lighter** is a portable light source exclusive to [Willow](/wiki/Willow "Willow"). It can be equipped in the 'Hand' slot and is able to set flammable objects on [Fire](/wiki/Fire "Fire"). Used as a weapon, Willow's Lighter deals 17 damage per hit and has infinite uses.

Willow's Lighter has a very small radius of light (less than a [Torch](/wiki/Torch "Torch")), though it can still prevent attacks from [Charlie](/wiki/Charlie "Charlie"). Willow receives a small [Sanity](/wiki/Sanity "Sanity") boost from the fire, specifically (+0.6/min). It also provides a small amount of [Warmth](/wiki/Category:Warmth "Category:Warmth") (to slow [Freezing](/wiki/Freezing "Freezing")).
...
In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, Willow's Lighter no longer provides warmth.

## Don't Starve Together Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the Lighter loses durability while equipped and lasts a total of 600 seconds (10 minutes). It can be crafted only by Willow. It requires 1 [Rope](/wiki/Rope "Rope"), 1 [Gold Nugget](/wiki/Gold_Nugget "Gold Nugget") and 3 [Petals](/wiki/Petals "Petals") to craft, and is available from the start. Willow can cook [Food](/wiki/Food "Food") with the Lighter by selecting a Food Item and right clicking above the lighter in the inventory, which costs 1% of its durability per use. In [Rain](/wiki/Rain "Rain"), the Lighter may burn up to 100% faster (depending on *precipitation rate*), unless the player is sheltered.

Lighters can be used by other non-Willow players, but only [Walter](/wiki/Walter "Walter") and [Warly](/wiki/Warly "Warly") can cook food with them. No other character receives the sanity gain from it, either.

### Insight Skill Upgrades[]

In *DST*, Willow has a [Skill Tree](/wiki/Willow/Don%27t_Starve_Together#Skill_Tree "Willow/Don't Starve Together") where following upgrades can be unlocked for the Lighter:

When [Brighter Lighter I](/wiki/Brighter_Lighter_I "Brighter Lighter I") or [Brighter Lighter II](/wiki/Brighter_Lighter_II "Brighter Lighter II") is unlocked, the light radius of Willow's Lighter is increased.

When [Hungry Lighter](/wiki/Hungry_Lighter "Hungry Lighter") is unlocked, Willow can stop fires with her Lighter by absorbing the flame (even when they are only smoldering).

When [Ember Tender](/wiki/Ember_Tender "Ember Tender") skill is unlocked, Willow can collect [Ethereal Embers](/wiki/Ethereal_Embers "Ethereal Embers") with her Lighter and use them to refill it by 45%.

## Trivia[]

* Willow's Lighter was added in the *[Strange New Powers](/wiki/Version_History#Strange_New_Powers "Version History")* update. It was introduced in the June 25, 2013 preview.
...
* Willow's Lighter is a [lift arm lighter](https://www.google.com/search?hl=en&site=imghp&tbm=isch&source=hp&biw=1517&bih=714&q=lift+arm+lighter&oq=lift+arm&gs_l=img.1.1.0l4j0i5l6.1682.7348.0.9276.8.8.0.0.0.0.895.2322.0j5j2j6-1.8.0.msedr...0...1ac.1.62.img..0.8.2317.Cj5pMaq2krE).
  + Coincidentally, there was a manufacturer of these automatic lighters named Willow. [[1]](#cite_note-1)

## Bugs[]

* In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, equipping Willow's Lighter while rowing on a [Boat](/wiki/Boats "Boats") may cause the lighter to still give off light without actually having the lighter equipped. This is fixed by restarting the game or dying.
* In the *Shipwrecked* DLC, if the player has the lighter equipped while rowing a boat, and then leaves the boat, the lighter will not appear equipped and will not give off light. This can be fixed by unequipping and re-equipping the lighter.
* Due to a code error, striking a Mob with the Willow's Lighter won't set it on fire. If Shipwrecked or Hamlet DLC is enabled, this problem can be fixed. In Don't Starve Together this has already been fixed.

## Gallery[]

Willow holding.png (173 KB)

Willow holding her lighter.

Lighter on ground.png (213 KB)

Willow's lighter on the ground.

Wolfgang lighter.png (386 KB)

If any character but Willow is given her lighter via [Console](/wiki/Console "Console").

2015-11-27 00006.jpg (98 KB)

Willow's lighter has a very small light radius, barely keeping Chester inside it even though he's right next to her.
...
Willow's Lighter as seen in the *[Year of the Gobbler](/wiki/A_New_Reign#January_19th,_2017_-_Year_of_the_Gobbler "A New Reign")* update poster.
...
Willow's Lighter as seen in the poster for the *[Strange New Powers](/wiki/Don%27t_Starve/Version_History#July_2nd,_2013_-_Strange_New_Powers "Don't Starve/Version History")* update.

Page bg english.jpg (500 KB)

Willow's Lighter in a promotional poster for the release of *Don't Starve Together*.

Willow's Lighter in Klei Office.png (136 KB)

Willow's Lighter in Klei Office

## References[]

1. [↑](#cite_ref-1) <http://www.toledo-bend.us/VCL/lighters/index.asp?request=lighters211>
