...
source_url: https://dontstarve.fandom.com/wiki/Coral_Nubbin
---
...
"There's nubbin better!"

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Limestone**×3** Coral Larva**×1** |
...
The **Coral Nubbin** is a craftable [Item](/wiki/Item "Item") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is found in the [Refine Tab](/wiki/Refine_Tab "Refine Tab"), requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype, and 3 [Limestones](/wiki/Limestone "Limestone") and a [Coral Larva](/wiki/Coral_Larva "Coral Larva") to craft. The Coral Nubbin will spoil after 20 days once crafted, but can be placed in an [Ice Box](/wiki/Ice_Box "Ice Box") to slow spoilage. It allows the player to plant a new [Coral Reef](/wiki/Coral_Reef "Coral Reef") at a chosen location in [Shallow Ocean](/wiki/Ocean#Shallow_Ocean "Ocean"). Once planted, the Reef will first be in an empty state, but will slowly grow [Corals](/wiki/Coral "Coral") over time. After 12 [Days](/wiki/Day "Day"), a Coral Reef is fully regrown.

## Prototype Tips[]

* As the Coral Nubbin spoils, but the Coral Larva does not, it may be better to refrain from crafting the Coral Nubbin until the player is ready to place it.

## Placeholder Trivia[]

* Coral Nubbins were added to the *Shipwrecked* DLC more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.
