...
source_url: https://dontstarve.fandom.com/wiki/Grass_Tuft
---
...
Cut Grass Grass Tuft Dug

### Spawns

Grass Gekko (Don't Starve Together)
...
Grass Tuft (Shovel Regal Shovel)

Tall Grass (Shovel Regal Shovel) (Hamlet)
...
[Savanna](/wiki/Savanna "Savanna")  
[Grassland](/wiki/Grassland "Grassland")  
[Mangrove](/wiki/Mangrove "Mangrove") (Shipwrecked)  
[Beach](/wiki/Beach "Beach") (Shipwrecked)  
[Meadow](/wiki/Meadow "Meadow") (Shipwrecked)  
[Cultivated](/wiki/Cultivated "Cultivated") (Hamlet)  
[Suburbs](/wiki/Suburbs "Suburbs") (Hamlet)

[Code](/wiki/Console "Console")

|  |
| --- |
| `"grass" "grass_water"(Shipwrecked) "dug_grass"` |
...
**“**A patch of grass. With bugs in it, if we're lucky.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Grass. You do tend to find a lot of it outside.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Grass Tufts** are [Plants](/wiki/Plants "Plants") commonly found in [Savanna](/wiki/Savanna "Savanna") and [Grasslands](/wiki/Grasslands "Grasslands"), but they can also appear in other [biomes](/wiki/Biome "Biome"). They can also be found in a few [Caves](/wiki/Caves "Caves") biomes, notably the [Sunken Forest](/wiki/Sunken_Forest "Sunken Forest").

Grass Tufts can be harvested to receive 1 [Cut Grass](/wiki/Cut_Grass "Cut Grass"), after which they will need three days to regrow ([Rain](/wiki/Rain "Rain") will reduce this time).

Grass Tufts can be dug up with a [Shovel](/wiki/Shovel "Shovel") or Regal Shovel and replanted in a new location (typically closer to a base camp). Doing this will give it a shorter, withered appearance, requiring the tuft to be [fertilized](/wiki/Fertilizer "Fertilizer") before it will regrow any new grass. It must be fertilized again after 20 harvests. Grass will not grow during [Winter](/wiki/Winter "Winter"). Grass Tufts can't be planted on [Checkerboard Floorings](/wiki/Checkerboard_Flooring "Checkerboard Flooring"), [Wooden Floorings](/wiki/Wooden_Flooring "Wooden Flooring"), [Cobblestones](/wiki/Cobblestone "Cobblestone"), [Carpeted Floorings](/wiki/Carpeted_Flooring "Carpeted Flooring"), [Rocky Turfs](/wiki/Rocky_Turf "Rocky Turf"), [Sandy Turfs](/wiki/Sandy_Turf "Sandy Turf"), and [Cave Rock Turfs](/wiki/Cave_Rock_Turf "Cave Rock Turf"), unless it has been planted before these [Turfs](/wiki/Turf "Turf") were placed.

These plants are flammable and can be used as long-lasting fuel in [Campfires](/wiki/Campfires "Campfires") and Fire Pits, but that is not recommended since Grass Tufts are a nonrenewable resource (however, they are renewable in the Caves by using the [Seed of Ruin](/wiki/Seed_of_Ruin "Seed of Ruin")). When unpicked Grass Tufts are burned, they will leave behind 1 [Ash](/wiki/Ashes "Ashes") and no plantable tuft. The same applies to dug-up tufts.

Because they burn easily and are usually planted very close together in a large cluster, Grass Tufts are very susceptible to [Lightning](/wiki/Lightning "Lightning") strikes which occur during heavy Rain. This can be prevented by building [Lightning Rods](/wiki/Lightning_Rod "Lightning Rod") near them.

## Downloadable Content[]

In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, Grass Tufts will turn into Withered Grass Tufts (with a similar appearance as those that need fertilization) during [Summer](/wiki/Summer "Summer"). During this condition, Grass Tufts are unharvestable for their Grass, and digging these will yield 1 Cut Grass and no replantable Tuft. A way of curing or preventing these from withering is to simply apply fertilizers or build an [Ice Flingomatic](/wiki/Ice_Flingomatic "Ice Flingomatic") nearby.

In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, Grass Tufts appear greener and can also be found in [Mangrove](/wiki/Mangrove "Mangrove"), [Beach](/wiki/Beach "Beach") and [Meadow](/wiki/Meadow "Meadow") Biome. They will turn into Withered Grass Tufts during [Dry Season](/wiki/Dry_Season "Dry Season") unless they are growing in Mangrove Biome.

In the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC, Grass Tufts are dropped by [Tall Grass](/wiki/Tall_Grass "Tall Grass") dug up by a Shovel. Unless they are planted on [Wild Plains Turf](/wiki/Wild_Plains_Turf "Wild Plains Turf"), [Rainforest Turf](/wiki/Rainforest_Turf "Rainforest Turf"), [Deep Rainforest Turf](/wiki/Deep_Rainforest "Deep Rainforest") or [Dense Turf](/wiki/Dense_Turf "Dense Turf"), they will grow into regular Grass Tuft instead of a Tall Grass.

## Don't Starve Together Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Grass Tufts will sometimes transform into living [Grass Gekkos](/wiki/Grass_Gekko "Grass Gekko") when being picked.

Grass Tufts are renewable in *Endless* and *Wilderness* [Game Modes](/wiki/Don%27t_Starve_Together#Game_Modes "Don't Starve Together") through [Resource Renewal](/wiki/Regrowth#Resource_Renewal "Regrowth"), or in the other game modes when enabling Basic Resources Regrowth in the [World Customization](/wiki/World_Customization/Don%27t_Starve_Together "World Customization/Don't Starve Together").

## Trivia[]

* Grass Tufts were worth 20 [research points](/wiki/Research_points "Research points") before that feature was removed.
* Although Grass Tufts in [Hamlet](/wiki/Hamlet "Hamlet") are Green, Grass appears Yellow.

## Gallery[]

Grass tuft growing.png (23 KB)

A Grass Tuft in game.

Grass Tufts harvested.png (144 KB)

Fertilized and Withered Grass Tufts.

Grasspigtorch.jpg (742 KB)

Guardian Pigs guarding patches of Grass.

Grass Tufts map.png (198 KB)

A Savanna with several Grass Tufts, as seen on the [Map](/wiki/Map "Map").

SW Grass Tuft.png (10 KB)

A Grass Tuft in the *Shipwrecked* DLC.

SW Grass Picked.png (4 KB)

A picked Grass Tuft in the *Shipwrecked* DLC.

Grass Tuft Item SW.png (5 KB)

A dug Grass Tuft in *Shipwrecked*.

Diseased Grass Tuft.png (72 KB)

A Diseased Grass Tuft in *Don't Starve Together*.

Diseased Grass Tuft Withered.png (20 KB)
