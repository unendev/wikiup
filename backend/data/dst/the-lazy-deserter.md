...
source_url: https://dontstarve.fandom.com/wiki/The_Lazy_Deserter
---
...
"Gather your friends with sand power."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Desert Stone**×1** Orange Moonlens**×1** Cut Stone**×3** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Shadow Magic Filter Structures Filter | Blueprint |
...
-40/min (when activated)

Perk

|  |
| --- |
| Quick travel between players. |
...
**“**Soul delivery machine.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Take me where friends are!**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Ready for a journey into the unknown Woby?**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A bit redundant, but it'll work in a pinch.**”**

–[Wanda](/wiki/Wanda "Wanda")

**The Lazy Deserter** is a [Structure](/wiki/Structure "Structure") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It is found in the [Shadow Magic Filter](/wiki/Shadow_Magic_Filter "Shadow Magic Filter") and [Structures Filter](/wiki/Structures_Filter "Structures Filter"), and requires a [Desert Stone](/wiki/Desert_Stone "Desert Stone"), an [Orange Moonlens](/wiki/Moonlens "Moonlens") and three [Cut Stone](/wiki/Cut_Stone "Cut Stone") to craft. Its rare [Blueprint](/wiki/Blueprint "Blueprint") can be obtained by giving a [Beach Toy](/wiki/Trinkets#Beach_Toy "Trinkets") Trinket to the [Antlion](/wiki/Antlion "Antlion"), by killing the Antlion, or as a random drop from a [Loot Stash](/wiki/Loot_Stash "Loot Stash"), after killing [Klaus](/wiki/Klaus "Klaus"). The Lazy Deserter's main use is to teleport one player to another when both are connected by using two of them.

In order to teleport, one player must first activate the Deserter from the destination side. This will initially take 15 Sanity, then lock the player in place and generate a constant drain of 40 Sanity/min. The second person, right after, must either activate the Deserter on the other side, or right-click on a Desert Stone. This will make this player teleport to the first player that started channeling.

Teleporting will take 50 Sanity, just like using the [Telelocator Staff](/wiki/Telelocator_Staff "Telelocator Staff"). If the Desert Stone was used, it will get consumed in the process.

## Prototype Tips[]

* Aside from teleporting, the Lazy Deserter can be used to rapidly lower the player's sanity at no cost. This makes it very useful for farming Nightmare Creatures for their valuable [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel").
...
* In a similar manner, the above method can be used on [Lunar Island](/wiki/Lunar_Island "Lunar Island") to keep the player's [Enlightenment](/wiki/Enlightenment "Enlightenment") low.
* The Lazy Deserter works well when combined with [Wanda](/wiki/Wanda "Wanda")'s [Backtrek Watch](/wiki/Backtrek_Watch "Backtrek Watch"). A Wanda player can teleport to one of their waypoints then use a Lazy Deserter to teleport other players to the same location. This allows multi-person teleportation to various locations without using up any Purple Gems.

## Placeholder Trivia[]

* The Lazy Deserter was introduced in the *[Against the Grain](/wiki/A_New_Reign#February_2,_2017_-_Against_the_Grain "A New Reign")* update.
* When channeling a Lazy Deserter, any nearby Desert Stones will levitate and have their "Spikes" jut out.
* The teleporting effect is called "townportalsandcoffin\_fx" in the game's code.
* The Lazy Deserter can be used as a tool to rapidly drain Sanity. This can be used to farm Nightmare Fuel or to reduce Enlightenment on the Lunar Island or in the Lunar Grotto.

## Blueprint Gallery[]

DST Update Against the Grain.png (1.18 MB)

The Lazy Deserter as seen in the poster for the *[Against the Grain](/wiki/A_New_Reign#February_2,_2017_-_Against_the_Grain "A New Reign")* update.
