...
source_url: https://dontstarve.fandom.com/wiki/Tooth_Trap
---
...
Slotmachine X Marks The Spot Shipwrecked icon

### Sold by

The Boar's Tusk Weapon Shop (Oinc ×10) Hamlet icon
...
**“**We didn't make traps like these in the Pinetree Pioneers...**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**That would be a painful misstep to make.**”**

–[Wanda](/wiki/Wanda "Wanda")

 https://static.wikia.nocookie.net/dont-starve-game/images/a/a3/WilsonToothTrap.jpg/revision/latest?cb=20130412062654 https://static.wikia.nocookie.net/dont-starve-game/images/a/a3/WilsonToothTrap.jpg/revision/latest?cb=20130412062654 



 

A **Tooth Trap** is a craftable [Weapon](/wiki/Weapon "Weapon") that can be placed on the ground and deals 60 damage to any [Mob](/wiki/Mob "Mob") that steps on it. It has 10 uses and must be reset after each use. Tooth Traps are found in the [Fight Tab](/wiki/Fight_Tab "Fight Tab"), require a [Log](/wiki/Log "Log"), a [Rope](/wiki/Rope "Rope") and a [Hound's Tooth](/wiki/Hound%27s_Tooth "Hound's Tooth") to craft, and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

Tooth Trap damage will not aggro nearby mobs, nor will it increase a player's [Naughtiness](/wiki/Krampus#Naughtiness "Krampus"). Tooth Traps are also fireproof in all versions of the game. A Tooth Trap can be picked up and placed elsewhere at any time, regardless of having been triggered or not.

The following [Mobs](/wiki/Mob "Mob") cannot activate Tooth Traps:

* [Abigail](/wiki/Abigail "Abigail")
* [Bees](/wiki/Bees "Bees") and Killer Bees
* [Butterflies](/wiki/Butterflies "Butterflies")
* [Batilisks](/wiki/Batilisk "Batilisk")
* [Mosquitoes](/wiki/Mosquito "Mosquito")
* [Birds](/wiki/Birds "Birds")
* [Chester](/wiki/Chester "Chester")
* [Lureplants](/wiki/Meat_Bulb_(Lureplant) "Meat Bulb (Lureplant)") (and their Eyeplants)
* [Splumonkeys](/wiki/Splumonkey "Splumonkey")
* [Dragonfly](/wiki/Dragonfly "Dragonfly")
* [Glommer](/wiki/Glommer "Glommer")
* Mounted [Beefalo](/wiki/Beefalo "Beefalo")
...
* Tooth Traps are ineffective against Lureplants and their Eyeplants; Eyeplants will eat Tooth Traps.
  + Placing man-made [Turf](/wiki/Turf "Turf") will prevent Eyeplants from spawning.
* A useful way to kill [Pigs](/wiki/Pig "Pig"), or other mobs, without increasing Naughtiness, is to place food near the Tooth Traps (ideally so the trap will kill the victim before it reaches the food).
* Surrounding small groups of about 4 [Berry Bushes](/wiki/Berry_Bush "Berry Bush") with [Walls](/wiki/Walls "Walls") and Tooth Traps allow farming [Gobblers](/wiki/Gobbler "Gobbler"), which also protects unharvested [Berries](/wiki/Berries "Berries") from them. When the Gobbler tries to exit, one of the Tooth Traps will kill it instantly.
  + Alternatively, 1 Tooth Trap can be placed in front of a Berry Bush, instantly killing a Gobbler that spawns from the bush.
* Tooth Traps can be an effective way to kill [Boss Monsters](/wiki/Boss_Monsters "Boss Monsters"), or other tough enemies, if they are densely packed into one area.
* A "panic room" can be made with as little as 10 Tooth Traps. It should be made of [Stone Walls](/wiki/Stone_Wall "Stone Wall"), with as few entrances as possible; more Tooth Traps should be placed near the entrance, as opposed to evenly spread throughout the room. A panic room can be effective against [Hound](/wiki/Hound "Hound") attacks.
* In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, players' [Ghosts](/wiki/Ghost_Characters "Ghost Characters") can reset Tooth Traps.

## Placeholder Trivia[]

* The Tooth Trap used to cost 100 points under the old [Research Points](/wiki/Research_Points_List "Research Points List") system.
* Tooth Traps were first added in the [Long Live The Queen!](/wiki/Don%27t_Starve/Version_History#December_19,_2012_–_Long_Live_the_Queen "Don't Starve/Version History") update.

## Mosquito Bugs[]

* Though it is impossible to plant Tooth Traps above each other (because of the [radius](/wiki/Structures "Structures") mechanic), when a [Dragoon Egg](/wiki/Dragoon_Egg "Dragoon Egg") falls in a field of very tightly placed Tooth Traps in the *Shipwrecked* DLC, it can push them above the others. Despite that, the trap still functions normally.

## Blueprint Gallery[]

Tooth trap planted.png (64 KB)

A "planted" Tooth Trap.

Tooth trap deployed.png (80 KB)

A triggered Tooth Trap.

Tooth Trap Placed.jpg (5 KB)

Either a triggered Tooth Trap on its last use or a Tooth Trap that has been dropped, but not planted.

GobblerTrap.png (114 KB)

Tooth Traps set up to hunt Gobblers.

Corridor of Death - Imgur.jpg (169 KB)

A "panic room" corridor, lined with Tooth Traps.

Teeth trapes.png (431 KB)

An area dense with Tooth Traps to repel Hounds.

Long Live the Queen.jpg (166 KB)

Tooth Trap as seen in the poster for the *[Long Live the Queen!](/wiki/Don%27t_Starve/Version_History#December_19,_2012_–_Long_Live_the_Queen! "Don't Starve/Version History")* update.
