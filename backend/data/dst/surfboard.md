...
source_url: https://dontstarve.fandom.com/wiki/Surfboard
---
...
|  |
| --- |
| Sailing Speed: 6.5 Grants 1 Sanity and large speed boost for riding Waves |

[Code](/wiki/Console "Console")

|  |
| --- |
| `"surfboard" "surfboard_item" (item)` |

**“**My love for you is deeper than the ocean.**”**

–[Walani](/wiki/Walani "Walani")

The **Surfboard** is a [Boat](/wiki/Boats "Boats") [item](/wiki/Item "Item") in the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, and is exclusive to [Walani](/wiki/Walani "Walani"). Walani starts the game with it in her inventory, and is the only [character](/wiki/Character "Character") able to craft it. It can be crafted with 1 [Board](/wiki/Boards "Boards") and 2 [Seashells](/wiki/Seashell "Seashell") from the [Nautical Tab](/wiki/Nautical_Tab "Nautical Tab").

It has the highest base movement speed of all [Boats](/wiki/Boats "Boats") at 6.5, but also has the lowest durability at 100. It restores 1 Sanity Sanity to Walani for every [Wave](/wiki/Waves "Waves") that she rides correctly, and gives a ×5 (Small Waves) or ×7 (Big Waves) speed boost from riding Waves compared to most other Boats (excluding the [Encrusted Boat](/wiki/Encrusted_Boat "Encrusted Boat")). It will also suffer a ×1.5 [Wetness](/wiki/Wetness "Wetness") penalty and grant no speed boost when hitting Waves incorrectly.

The Surfboard does not require paddling, so Walani can hold tools (including [Torches](/wiki/Torch "Torch") and [Bottle Lanterns](/wiki/Bottle_Lantern "Bottle Lantern")) while surfing. Surfboards can be retrieved from both land and sea and placed into the inventory, thus making it possible to pick up and re-deploy the Surfboard after placing it.
...
* Riding [Waves](/wiki/Waves "Waves") correctly can give a large boost in speed and sanity over time, making Walani much faster when she moves with the current.
* Because it is the only sea-craft capable of riding Big Waves, the Surfboard is often the fastest vessel for Walani during [Hurricane Season](/wiki/Hurricane_Season "Hurricane Season").
* [Purple Grouper](/wiki/Purple_Grouper "Purple Grouper") and [Tropical Bouillabaisse](/wiki/Tropical_Bouillabaisse "Tropical Bouillabaisse")'s effects cause Walani to gain the speed boost and sanity bonuses even from hitting Waves incorrectly, negating the Wetness and damage penalties for doing so.
* [Pierrot Fish](/wiki/Pierrot_Fish "Pierrot Fish") and [Tropical Bouillabaisse](/wiki/Tropical_Bouillabaisse "Tropical Bouillabaisse") can be used to dry off rapidly if the player is suffering from high Wetness after crashing into a few waves - even during an ongoing storm.
* While the Surfboard does not require prototyping, Boards do require a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. However, Boards can also be obtained by [Hammering](/wiki/Hammer "Hammer") [Crates](/wiki/Crate "Crate"), allowing more Surfboards to be crafted before building a Science Machine.
* If hammered down with a [Hammer](/wiki/Hammer "Hammer") returns one board and one Seashell.
...
* In [Pocket Edition](/wiki/Pocket_Edition "Pocket Edition"), the option to retrieve the Surfboard will not appear, making it more useless to the Player.

## Blueprint Gallery[]

Walani.png (353 KB)

The Surfboard as featured in Walani's poster.

Walani special.png (122 KB)

Walani surfing on the Surfboard.

Surfboard Dropped.png (77 KB)

The Surfboard when dropped on land.

Walani Surfing Trailer.jpg (281 KB)

Walani riding a big wave with her Surfboard, as seen in the *Shipwrecked* trailer.
