...
source_url: https://dontstarve.fandom.com/wiki/Mini_Sign
---
...
"Draw on these with a Feather Pencil."
...
| --- | --- | --- |
| Structures Tab | Decorations FilterStructures Filter | Science Machine |
...
**“**A wonderfully effective way to categorize my things.**”**
...
**“**A sign. Always useful for organizing.**”**
...
**“**Someone obviously thought it was important enough to put on a sign.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Mini Sign** is a craftable [Item](/wiki/Item "Item") located in the [Structures Tab](/wiki/Structures_Tab "Structures Tab"). 1 [Board](/wiki/Boards "Boards") is used to craft 4 Mini Signs, requiring a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. By placing an item near a Mini Sign, the player can draw that item on it once by using a [Feather Pencil](/wiki/Feather_Pencil "Feather Pencil").

Unlike other structures, Mini Signs cannot be destroyed with a [Hammer](/wiki/Hammer "Hammer") to return their crafting resources, but can be dug up with any kind of [Shovel](/wiki/Shovel "Shovel"). Digging them up will not remove images that have already been drawn on them, but a new image can be drawn when they are placed.

## Tips[]

* Mini Signs can be used to sort [Chests](/wiki/Chest "Chest") or other containers in the players' base, as they can be placed very close to them.

## Trivia[]

* Mini Signs were introduced to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* in the *[Herd Mentality](/wiki/A_New_Reign#November_24,_2016_-_Herd_Mentality "A New Reign")* update during *[A New Reign](/wiki/A_New_Reign "A New Reign")*. They were later added to *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")* in the *[Quality of Life](/wiki/Don%27t_Starve/Version_History "Don't Starve/Version History")* update.
* Although seems Mini Signs can picture only droppable items, uncaught [Fireflies](/wiki/Fireflies "Fireflies") can be drawn on the sign if located near enough, even when invisible during daytime.
* Item [Skins](/wiki/Belongings "Belongings") will show on a Mini Sign.

## Gallery[]

DST Update Herd Mentality.png (2.6 MB)

Mini Sign as seen in the poster for the *[Herd Mentality](/wiki/A_New_Reign#November_24,_2016_-_Herd_Mentality "A New Reign")* update.

MiniSigns.png (589 KB)

Mini Signs used to sort several chests.

MiniSign2.png (376 KB)

The prompt that appears while drawing a nearby item on a sign.
