...
source_url: https://dontstarve.fandom.com/wiki/Magma_Turf
---
...
[Magma Field](/wiki/Magma_Field "Magma Field") tiles (Pitchfork)
...
**Magma Turf** is one of the [Turf](/wiki/Turf "Turf") [Items](/wiki/Item "Item") exclusive to the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, acquired by digging [Magma Field](/wiki/Magma_Field "Magma Field") tiles with a [Pitchfork](/wiki/Pitchfork "Pitchfork"). Like other Turfs, it can be placed on any bare ground tile or used as [fuel](/wiki/Fire#Fuel "Fire"). It can also be used to craft [Cobblestones](/wiki/Cobblestones "Cobblestones"), which are placeable [Roads](/wiki/Roads "Roads").

Plants like [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Saplings](/wiki/Saplings "Saplings"), [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), [Bamboo Roots](/wiki/Bamboo_Root "Bamboo Root"), [Viney Bush Roots](/wiki/Viney_Bush_Root "Viney Bush Root"), [Coconuts](/wiki/Coconut "Coconut"), and [Jungle Tree Seeds](/wiki/Jungle_Tree_Seed "Jungle Tree Seed") cannot be planted on these Turfs.

[Lureplants](/wiki/Lureplant "Lureplant") and [Coffee Plants](/wiki/Coffee_Plant "Coffee Plant") can be planted on this Turf, but [Eyeplants](/wiki/Eyeplant "Eyeplant") cannot spawn, so it is great for Lureplant farms while not spending any more resources than those used to craft the Pitchfork.

Floods can start on this turf.

When placed on the [Surface World](/wiki/Surface_World "Surface World") in a large enough area, Toucans are the only [Birds](/wiki/Birds "Birds") that will spawn and land on these turfs. During [Hurricane Season](/wiki/Hurricane_Season "Hurricane Season"), there are no birds that spawn and land on these turfs.
