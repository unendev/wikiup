...
source_url: https://dontstarve.fandom.com/wiki/Brightshade_Gestalt
---
...
**Brightshade Gestalts** are [mobs](/wiki/Mobs "Mobs") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[From Beyond](/wiki/From_Beyond "From Beyond")*. They periodically appear from [Rifts](/wiki/Rift "Rift") in their final stage and will take over harvestable plants to create [Deadly Brightshades](/wiki/Deadly_Brightshade "Deadly Brightshade").

## Behavior[]

When a [Rift](/wiki/Rift "Rift") reaches its third and final stage, waves of **Brightshade Gestalts** begin to emerge every 3-4 in-game days, with the first immediately appearing when the Rift reaches its final stage. Brightshade Gestalts will seek out and inhabit harvestable plants in groups of three, which then spawns a [Deadly Brightshade](/wiki/Deadly_Brightshade "Deadly Brightshade") for each Brightshade Gestalt. Up to 5 patches (referred to as "herds" in the code) of plants will be infested per wave, and will prioritize plants placed by players over naturally-generated ones. Brightshade Gestalts can inhabit the following plants: [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Saplings](/wiki/Sapling "Sapling"), [Weeds](/wiki/Weeds "Weeds") and [Farm Plants](/wiki/Farm_Plant "Farm Plant"), with the latter two having the highest priority. Each Rift will spawn between 4-6 waves of Brightshade Gestalts before closing.

Brightshade Gestalts will automatically move to their intended plant target no matter how far away they are. Brightshade Gestalts can also move over the [ocean](/wiki/Ocean "Ocean") and take over plants on islands.

As of the *[Host of Horrors](/wiki/From_Beyond "From Beyond")* update, Brightshade Gestalts are able to reanimate [Deerclops](/wiki/Deerclops "Deerclops"), [Bearger](/wiki/Bearger "Bearger") and [Varg](/wiki/Varg "Varg") corpses, turning them into [Crystal Deerclops](/wiki/Crystal_Deerclops "Crystal Deerclops"), [Armored Bearger](/wiki/Armored_Bearger "Armored Bearger") and [Possessed Varg](/wiki/Possessed_Varg "Possessed Varg") respectively. This can be prevented by burning down the corpses before Brighshade Gestalts can get to them.
