...
source_url: https://dontstarve.fandom.com/wiki/Tail_o'_Three_Cats
---
...
"Dish out some constructive feedback."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Cat Tail**×3** Tentacle Spots**×1** |

| [Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Weapons Filter | Alchemy Engine |

Combat attributes

| [Damage](/wiki/Damage "Damage") | Range |
| --- | --- |
| 27.2  20.4 WendyWes  ---  34 Wigfrid  ---  20.4Wolfgang/27.2Wolfgang/54.4 Wolfgang  ---  13.6 Wanda (elderly) | 2 |
...
|  |
| --- |
| Chance to pacify nearby [Mobs](/wiki/Mobs "Mobs"). |
...
**“**I hope that doesn't end up hurtin' any lil critters.**”**
...
**“**I know how you feel about cats Woby, but it still seems pretty mean.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This should keep most creatures at bay.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Tail o' Three Cats** is a craftable [Weapon](/wiki/Weapon "Weapon") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It can be crafted with 3 [Cat Tails](/wiki/Cat_Tail "Cat Tail") and 1 [Tentacle Spot](/wiki/Tentacle_Spots "Tentacle Spots"), and requires an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

The primary use of the Tail o' Three Cats is to pacify [Mobs](/wiki/Mobs "Mobs") by whipping them into submission. When whipping a mob, there is a chance for a loud snap, causing all nearby mobs to lose aggro. The loud snap occurs 25% of the time for animals, 20% of the time for monsters, and 5% of the time for bosses. Pacified mobs can still reaggro.

In addition to this, the Tail o' Three Cats also has an increased melee range, double that of most other melee weapons, but the attack speed is slower than other weapons.

## Trivia[]

* The Tail o' Three Cats is considered to be part of *[A New Reign](/wiki/A_New_Reign "A New Reign")*, even though it was introduced before the official start of the beta branch.
* The Tail o' Three Cats is loosely based on the [cat o' nine tails](https://en.wikipedia.org/wiki/Cat_o%27_nine_tails "wikipedia:Cat o' nine tails"), a multi-tailed whip used long ago on misbehaving subjects, or as punishment.

## Gallery[]

Holding tail.png (153 KB)

[WX-78](/wiki/WX-78 "WX-78") holding a Tail o' Three Cats.

Tail on ground.png (356 KB)

A Tail o' Three Cats on the ground.
