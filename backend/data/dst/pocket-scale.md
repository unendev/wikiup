...
source_url: https://dontstarve.fandom.com/wiki/Pocket_Scale
---
...
|  |
| --- |
| [Weighs](/wiki/Weight "Weight") [Fishes](/wiki/Fishes "Fishes"). |
...
**“**Allow me to quickly weigh in, hyuyu!**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is funny measure thing.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Do you think there's a badge for catching the biggest fish?**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**In my opinion, everything should have a pocket-sized version.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Pocket Scale** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It is crafted with one [Log](/wiki/Log "Log"), one [Cut Stone](/wiki/Cut_Stone "Cut Stone"), and one [Gold Nugget](/wiki/Gold_Nugget "Gold Nugget"). It requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype.

The Pocket Scale is used to measure the [Weight](/wiki/Weight "Weight") of [Fishes](/wiki/Fishes "Fishes"). It can be used to anticipate the results of the [Fish Scale-O-Matic](/wiki/Fish_Scale-O-Matic "Fish Scale-O-Matic") or if [Crabby Hermit](/wiki/Crabby_Hermit "Crabby Hermit") will accept it.

This item is completely useless for [Wes](/wiki/Wes "Wes") as instead of announcing the weight of the fish, he stands there mute and motionless. It probably will not work if Wes is transformed into [Wonkey](/wiki/Wonkey "Wonkey") either, since Wonky is mute when playing as Wes. Wes can still use a [Fish Scale-O-Matic](/wiki/Fish_Scale-O-Matic "Fish Scale-O-Matic"), [Lures](/wiki/Lures#Heavy_Weighted "Lures"), or simply hand every fish to the [Crabby Hermit](/wiki/Crabby_Hermit "Crabby Hermit") (probably storing them in a [Tin Fishin' Bin](/wiki/Tin_Fishin%27_Bin "Tin Fishin' Bin") for freshness).

## Trivia[]

* The Pocket Scale was introduced in the *[Hook, Line, and Inker](/wiki/Return_of_Them#Hook,_Line,_and_Inker "Return of Them")* update.
