...
source_url: https://dontstarve.fandom.com/wiki/Lunar_Funcap
---
...
| --- |
| Moon Shroom**×4** Red Funcap**×1** |

| [Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Celestial Filter | Celestial OrbCelestial Altar |
...
|  |
| --- |
| * Reduces hunger loss rate by 25% * Periodically spawns [Lunar Mushroom Spores](/wiki/Mushroom_Spore#Lunar_Spore "Mushroom Spore") * Items held in the player's inventory or equip slots receive +50% spoilage rate. * Grants the player immunity to damage from [Lunar Spores](/wiki/Lunar_Spore "Lunar Spore"). |
...
The **Lunar Funcap** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in the *[From Beyond](/wiki/From_Beyond "From Beyond")* updates. It can be crafted at the [Celestial Orb](/wiki/Celestial_Orb "Celestial Orb") or [Celestial Altar](/wiki/Celestial_Altar "Celestial Altar") with 4 [Moon Shrooms](/wiki/Moon_Shroom "Moon Shroom") and 1 [Red Funcap](/wiki/Red_Funcap "Red Funcap").

The Lunar Funcap can be equipped in the head slot. When worn, it reduces the rate of [Hunger](/wiki/Hunger "Hunger") loss by 25%, provide 20% [Wetness resistance](/wiki/Wetness "Wetness") and 60 points of protection from [Overheating](/wiki/Overheating "Overheating"). They also periodically spawn [Lunar Spores](/wiki/Lunar_Spore "Lunar Spore"), which will damage nearby mobs. Wearing the Lunar Funcap grants immunity to the damage of the Spores. Like Garlands, they perish over time whether they are worn or not. They take 6 Days to completely spoil and can be worn for a total of 4 days.

Perishable items stored within the player's inventory while the Lunar Funcap is equipped will spoil 50% faster, this also applies to equipped items, including the Funcap itself. Items stored within [Backpacks](/wiki/Backpack "Backpack") remain unaffected.

## Trivia[]

* The Lunar Funcap was introduced in the *[Scrappy Scavengers](/wiki/Scrappy_Scavengers "Scrappy Scavengers")* update.

## Gallery[]

Lunar Funcap All Sides.png (214 KB)

Lunar Funcap from all sides.
