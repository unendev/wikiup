...
source_url: https://dontstarve.fandom.com/wiki/Stalagmite_Terrain
---
...
**Stalagmite Terrain** is an environment that can only be found inside [Caves](/wiki/Caves "Caves"). It has been named after the abundance of [Stalagmites](/wiki/Stalagmites "Stalagmites") that can be found in these areas. [Turfs](/wiki/Turfs "Turfs") like [Cave Rock Turf](/wiki/Cave_Rock_Turf "Cave Rock Turf") and [Guano Turf](/wiki/Guano_Turf "Guano Turf") are also abundant and cover most of the area. There are no known [Plants](/wiki/Plants "Plants") that can be found in these biomes.

There are two variants of Stalagmite Terrain, each having different features, both rarely spawning [Nightmare Fissures](/wiki/Nightmare_Fissure "Nightmare Fissure").
...
The first variant is abundant with normal Stalagmites. However, being their natural habitat, these areas are also heavily infested with [Cave Spiders](/wiki/Cave_Spider "Cave Spider") and [Spitters](/wiki/Spitter "Spitter") which live in [Spilagmites](/wiki/Spilagmite "Spilagmite"). There may be branches of this biome which are not infested, depending on [World Generation](/wiki/World_Generation "World Generation").

## Tall[]

## Tall Stalagmite Terrain
...
The second variant is abundant with tall Stalagmites and considered less dangerous. [Batilisks](/wiki/Batilisk "Batilisk") and their [Guano](/wiki/Guano "Guano") can commonly be found here. [Thulecite Sinkholes](/wiki/Sinkhole "Sinkhole") are usually found in here.

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, [Bat Caves](/wiki/Bat_Cave "Bat Cave") can rarely spawn in the Tall Stalagmite Terrain, making [Batilisks](/wiki/Batilisk "Batilisk") renewable even in the caves.

## Blueprint Gallery[]

Stalagmite Biome infested with Cave Spiders and Spitters.png (346 KB)

Stalagmite Terrain full of Spilagmites, Spitters, and Cave Spiders.

Guano area.png (266 KB)

Tall Stalagmite Terrain with a bunch of Guano, indicating there are Batilisks nearby.
