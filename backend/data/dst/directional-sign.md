...
source_url: https://dontstarve.fandom.com/wiki/Directional_Sign
---
...
"Point fingers at the world. Or signs."
...
| --- | --- |
| Decorations Filter Structures Filter | Science Machine |
...
**“**A navigational aid. "Thataway".**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Let the wood guide the way.**”**
...
**“**Nothing to be seen here, I fear.**”**
...
The **Directional Sign** is a craftable [Structure](/wiki/Structures "Structures") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It can be written on, and it shows up on the [map](/wiki/Map "Map") like a regular [Sign](/wiki/Sign "Sign"). Unlike the normal sign, and indeed almost every other entity, the sign's orientation is not fixed relative to the camera. When built, the sign points to the right, and will remain pointing that direction.

The Directional Sign requires [Boards](/wiki/Boards "Boards") to craft and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. If it is destroyed, the Boards are returned, allowing the player to build a new Directional Sign elsewhere.

When first built, the sign is blank, and examining it will yield a [character](/wiki/Character "Character") quote. Clicking the sign will bring up a dialog to write on the sign, after which examining the sign will yield whatever has been written on it. Directional Signs cannot be rewritten, but deconstructing a sign with a hammer will return a board, so they can be replaced virtually at will.

When writing on a sign, the dialogue will give the option to cancel, generate random text, or write to the sign. The text box can also be selected and typed into. The random function generates text for the sign which features a random noun based on the type of [Turf](/wiki/Turf "Turf") the sign is placed on, as well a random adjective describing the place. Sometimes there will be an quantifier modifying the adjective, and sometimes there will be an additional phrase after the name, or possibly both. Once written on, the sign will have small lines on it, indicating text.

| Part | Possible text |
| --- | --- |
| **Quantifiers** | Really, Very, Quite, Very Very, Extremely, Moderately, Minimally, Sort of, Totally |
| **Adjectives** | Sunny, Danker, Dark, Morose, Morbid, Awful, Horrible, Perfectly Normal, Ordinary, Perilous, Dangerous, Hazardous, Creepy, Empty, Lonely, Wet, Dry, Huge, Small, Little, Picturesque, Hideous, Dreary, Repulsive, Boring, Good, Striking, Uninteresting, Fascinating, Magnificent, Souless*[sic]*, Echoing, Sleepy, Smelly, Mediocre, Awesome, Brilliant, Excellent |
| **Nouns** | | Turf type | Possible names | | --- | --- | | [Cobblestones](/wiki/Cobblestones "Cobblestones") | Road, Path | | [Rocky](/wiki/Rocky_Turf "Rocky Turf") | Crag, Area, Region, Rocky Place | | Turfless | Patch, Turf, Area, Tract | | [Savanna](/wiki/Savanna_Turf "Savanna Turf") | Savannah, Grassland, Prairie | | [Grass](/wiki/Grass_Turf "Grass Turf") | Field, Pasture, Meadow, Garden | | [Forest](/wiki/Forest_Turf "Forest Turf")/[Deciduous](/wiki/Deciduous_Turf "Deciduous Turf") | Forest, Woods, Thicket, Grove | | [Marsh](/wiki/Marsh_Turf "Marsh Turf") | Marsh, Swamp, Bog, Fen | | [Web](/wiki/Spider_Den#Sticky_Webbing "Spider Den") | Web, Cobweb | | [Wooden Flooring](/wiki/Wooden_Flooring "Wooden Flooring") | Place, Corner, Spot, Base, Hidey-Hole | | [Carpeted Flooring](/wiki/Carpeted_Flooring "Carpeted Flooring") | Place, Corner, Spot, Base, Hidey-Hole, Carpet, Rug | | [Checkerboard Flooring](/wiki/Checkerboard_Flooring "Checkerboard Flooring") | Place, Corner, Spot, Base, Checkerboard, Zone | | [Cave](/wiki/Cave "Cave") Turfs | Cave | | [Sandy](/wiki/Sandy_Turf "Sandy Turf") | Desert, Badlands, Flats | | [Scaled Flooring](/wiki/Scaled_Flooring "Scaled Flooring") | Place, Corner, Spot, Base, Hidey-Hole, Zone, Scale | | Other Turf (such as from a mod) | Spot, Area, Region, Point, Locality, Site | |
| **Additions** | of Perilousness, of Horribleness, of Loneliness, of Sorrow, of Danger, of Hunger, of Shadows, infested with Monsters, crawling with Horrors, of Happiness, of Dreariness, of Death, full of Bees |

## https://static.wikia.nocookie.net/dont-starve-game/images/4/47/Placeholder.png/revision/latest?cb=20130218233329 Trivia[]

* In spite of the fact that the [Savanna](/wiki/Savanna "Savanna") biome is coded by that name, the Directional Sign uses the alternative spelling: "Savannah".
* There appears to be a running joke with Directional Signs, as most of the character quotes for blank and burnt sighs reference "Thataway" in some form
...
RelativeSign.png (197 KB)

A blank Directional Sign.

HoverSign.png (313 KB)

[Wilson](/wiki/Wilson "Wilson") preparing to write on a Directional Sign.

WrittenSign.png (158 KB)

A Directional Sign that has been written on.

Directional Sign Burnt.png (15 KB)

A burnt Directional Sign.
