...
source_url: https://dontstarve.fandom.com/wiki/Wilds
---
...
|  |
| --- |
| Cave LichenFernNightmare Fissure  (Mysterious PlantDon't Starve Together icon) |

Occasional

|  |
| --- |
| Monkey TotemCave Banana TreeLight FlowerMushroomsCave PondSlurperDepths Worm |
...
**“**A touch of color in the world of darkness.**”**

–[Wendy](/wiki/Wendy "Wendy")

The **Wilds** is one of the [biomes](/wiki/Biome "Biome") found in the [Ruins](/wiki/Ruins "Ruins"). These are the areas on which the [Ancients](/wiki/Ancient_Civilization "Ancient Civilization") did not set up any structures, the only hint of their activity being paths of [Runic Turf](/wiki/Runic_Turf "Runic Turf") leading to other biomes and the entrance to the Ruins, with the rest of the turf being exclusively [Mud Turf](/wiki/Mud_Turf "Mud Turf").

[Cave Lichen](/wiki/Cave_Lichen "Cave Lichen"), [Ponds](/wiki/Pond "Pond"), [Light Flowers](/wiki/Light_Flower "Light Flower"), [Slurpers](/wiki/Slurper "Slurper"), Blue [Mushrooms](/wiki/Mushroom "Mushroom"), and [Nightmare Fissures](/wiki/Nightmare_Light#Nightmare_Fissure "Nightmare Light") tend to be found in the Wilds. This biome is also infested with [Depths Worms](/wiki/Depths_Worm "Depths Worm") scattered randomly across this biome, waiting to ambush the player.

### Strategy[]

It's very easy to get overwhelmed and killed here. Slurpers will try to remove the survivor's hat, which splumonkeys then pick up and wear. Splumonkeys also like to loot [Hutch](/wiki/Hutch "Hutch") as he passes by. The survivor wants their belongings back, so they attack a Splumonkey which enrages the rest of them. The monkeys throw [Manure](/wiki/Manure "Manure"), destroying the survivor's sanity, which spawns [Shadow Creatures](/wiki/Shadow_Creatures "Shadow Creatures"). If the player is not immediately killed, they may step on a [Dangling Depth Dweller](/wiki/Dangling_Depth_Dweller "Dangling Depth Dweller") web. Or they may stay too long and let the [Nightmare phase](/wiki/Nightmare_Cycle "Nightmare Cycle") begin. At that point, the monkeys turn into shadow monkeys and switch to melee attacks. They and the Shadow Creatures that spawn from the Fissures will chase the player without pause and will not de-aggro until the nightmare phase ends, or the player leaves the caves, or dies, or perhaps kills them all.

Most explorers either race through here on a fast Beefalo, or as a weregoose or similarly use speed or teleportation to bypass most of the dangers. An alternate strategy is to time short, careful explorations between Nightmare phases, or do some combination of the two strategies. The rooms of the ruins proper have their own dangers, but that's much more of a burglary mission. It's much easier/safer to go slowly there and take on a smaller number of foes at one time.

## Don't Starve Together icon Don't Starve Together[]

This biome begins with the [Lichen Meadow](/wiki/Lichen_Meadow "Lichen Meadow") sub-biome in Don't Starve Together. The Meadow is a transition zone from the [Mud Biome](/wiki/Mud_Biome "Mud Biome") to the **Wilds**.
...
| **[Ruins](/wiki/Ruins "Ruins")** | Labyrinth (174 KB)  [Labyrinth](/wiki/Labyrinth "Labyrinth")  Military (155 KB)  [Military](/wiki/Military "Military")  Sacred (185 KB)  [Sacred](/wiki/Sacred "Sacred")  Village (184 KB)  [Village](/wiki/Village "Village")  Wilds (168 KB)  **Wilds**  Atrium (143 KB)  [Atrium](/wiki/Atrium "Atrium") Don't Starve Together |
