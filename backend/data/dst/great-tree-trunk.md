...
source_url: https://dontstarve.fandom.com/wiki/Great_Tree_Trunk
---
...
Grass Gator, Knobbly Tree Nut, Cut Grass, Twigs, Fireflies
...
|  |
| --- |
| Spreads its canopy over an area |
...
The **Great Tree Trunk** is an indestructible [Plant](/wiki/Plants "Plants") object exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* and introduced in the *[Waterlogged](/wiki/Don%27t_Starve_Together/Version_History#Waterlogged_Beta_.28since_July_26.2C_2021.29 "Don't Starve Together/Version History")* beta. They can be rammed into with a boat no more than once per day to drop [Cut Grass](/wiki/Cut_Grass "Cut Grass"), [Twigs](/wiki/Twigs "Twigs"), and a [Knobbly Tree Nut](/wiki/Knobbly_Tree#Knobbly_Tree_Nut "Knobbly Tree") (which can be fertilized to grow a similar type of giant tree). Ramming into the trunk also causes [Sea Striders](/wiki/Sea_Strider "Sea Strider"), to drop from their [Nests](/wiki/Sea_Strider_Nest "Sea Strider Nest") to investigate.

Each Great Tree Trunk will extend a circular canopy over a large area around them. The shade from the canopy protects objects under it from wildfires in the [Summer](/wiki/Seasons/Summer "Seasons/Summer"), reduces 35% [Wetness](/wiki/Wetness "Wetness") from [Rain](/wiki/Rain "Rain"), and mitigates [Overheating](/wiki/Overheating "Overheating") (180). When [Lightning](/wiki/Lightning "Lightning") strikes an area under the canopy the tree will block it and drop 0-3 [Cut Grass](/wiki/Cut_Grass "Cut Grass") and 1-3 [Twigs](/wiki/Twigs "Twigs").

[Grass Gators](/wiki/Grass_Gator "Grass Gator") will fall from the canopy on occasion, with up to one Gator spawning per trunk.

If less than 10 [Fireflies](/wiki/Fireflies "Fireflies") are under the canopy, there is a 70% chance one firefly will spawn per day.

## Contents

* [1 Great Tree Root](#Great_Tree_Root)
* [2 Trivia](#Trivia)
* [3 Gallery](#Gallery)
...
**“**I should steer clear of those if I don't want to meet a watery end.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Great Tree Roots** spawn around Great Tree Trunks and can be chopped or rammed with a boat to produce [Driftwood Pieces](/wiki/Driftwood_Piece "Driftwood Piece"). Tree roots do not respawn.

## Placeholder Trivia[]

* According to *Rhymes With Play* #282, the Great Tree Trunk's assets were inspired by the [Great Leafy Stalks](/wiki/Great_Leafy_Stalk "Great Leafy Stalk") and foliage from the [Deep Rainforest](/wiki/Deep_Rainforest "Deep Rainforest") biome of the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. They used those assets as stand-ins when prototyping the [Waterlogged](/wiki/Waterlogged "Waterlogged") biome.

## BlueprintGallery[]

RWP 282 Waterlogged concept art2.png (369 KB)

Great Tree Trunk concept art from *Rhymes With Play* #282.[[1]](#cite_note-1)

RWP 282 Waterlogged concept art3.png (1,011 KB)

Great Tree Trunk concept art from *Rhymes With Play* #282.
...
RWP 282 Great Tree Trunk concept art.png (847 KB)

Great Tree Trunk concept art from *Rhymes With Play* #282.

RWP 282 Great Tree Root concept art.png (672 KB)

Great Tree Root concept art from *Rhymes With Play* #282.
