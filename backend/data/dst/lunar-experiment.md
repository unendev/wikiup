...
source_url: https://dontstarve.fandom.com/wiki/Lunar_Experiment
---
...
| --- |
| Moon Moth Wings**×1** Lune Tree Blossom**×1** Sanity Decrease**×10** |
...
|  |
| --- |
| Can be used to change some items and mobs into Lunar counterparts. |
...
**“**Hot leaf water make things change!**”**
...
**“**MOON-POWERED ORGANIC REFURBISHER**”**

–[WX-78](/wiki/WX-78 "WX-78")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It seems to catalyze a mutation.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Not sure I need any more tranformin' in my life.**”**

–[Woodie](/wiki/Woodie "Woodie")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A fine pot of tea, with a side of mutation.**”**
...
**“**Should we drink it? Nah, probably not.**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I wouldn't drink that, mon ami.**”**
...
**“**What should we mutate first?**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It smells like shifting possibilities.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Lunar Experiment** is a feature exclusive to the [Hallowed Nights](/wiki/Hallowed_Nights "Hallowed Nights") [event](/wiki/Category:Events "Category:Events") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It can be conducted at the [Mad Scientist Lab](/wiki/Hallowed_Nights#Mad_Scientist_Lab "Hallowed Nights"), using a [Moon Moth Wing](/wiki/Moon_Moth_Wings "Moon Moth Wings") and a [Lune Tree Blossom](/wiki/Lune_Tree_Blossom "Lune Tree Blossom"), and depleting 10 Sanity for the player. The experiment has a 50% chance to result in only one potion, a 30% to result in two potions and a 20% to result in three potions.

The experiment will result in a **Steeped Lunar Essence** that can be used to change items and mobs into their Lunar counterparts eg. [Butterfly](/wiki/Butterfly "Butterfly") into [Moon Moth](/wiki/Moon_Moth "Moon Moth").

## Lunar Experiment Transformations[]

Butterfly Interface arrow right Moon Moth

Light Bulb Interface arrow right Bulbous Lightbug

Light Flower Interface arrow right Light Flower (note: this changes Light Flower that gives Light Bulb upon harvesting into the Light Flower that spawns Bulbous Light Bug)

Sapling Item Interface arrow right Sapling

Flower Interface arrow right Tree/Lune

Carrot Interface arrow right Carrat

Dragon Fruit Interface arrow right Saladmander

Spider Spider Warrior Cave Spider Spitter Dangling Depth Dweller Nurse Spider Interface arrow right Shattered Spider

Hound Interface arrow right Horror Hound

Pengull Interface arrow right Moonrock Pengull

Redbird Interface arrow right Moonblind Crow
