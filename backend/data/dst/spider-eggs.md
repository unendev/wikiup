...
source_url: https://dontstarve.fandom.com/wiki/Spider_Eggs
---
...
| --- |
| Silk**×12** Spider Gland**×6** Papyrus**×6 (Webber only)** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| **Structures Tab** | Always available |
...
|  |
| --- |
| Can grow into a [Spider Den](/wiki/Spider_Den "Spider Den"). |

## Sources

### Dropped by

Spider Queen, Spider Den(tier 3)
...
**“**A spider den in its juvenile form.**”**
...
**“**Expectin' ol'Woodlegs play wetnurse ta creepy crawlies?**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA CAN'ST SQUISHETH TINY SACKS!**”**

–[Wilba](/wiki/Wilba "Wilba")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Leggy Bug Babies inside**”**

–[Wormwood](/wiki/Wormwood "Wormwood")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Swell. I can make more horrible things.**”**
...
**“**They wiggle, wriggle, 'round inside.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Blegh, this where baby Spiderfolk come from?**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Aww, it's full of baby spiders!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I should squish them now, it'll save me the hassle later on...**”**

–[Wanda](/wiki/Wanda "Wanda")

**Spider Eggs** are acquired by destroying a Tier 3 [Spider Den](/wiki/Spider_Den "Spider Den") or killing a [Spider Queen](/wiki/Spider_Queen "Spider Queen"). They can be planted on the ground by picking them up from the inventory and clicking the ground with the right mouse button. This will create a tier 1 Spider Den, which then grows normally.

Spider Eggs can be used to create Spider Dens at any specific place, often an area where one can safely contain the [Spiders](/wiki/Spiders "Spiders") for [Silk](/wiki/Silk "Silk") farming. Spider Eggs are also a great fuel for [Campfires](/wiki/Campfire "Campfire"), adding a lot of burn time.
...
In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, [Webber](/wiki/Webber "Webber") begins the game with Spider Eggs, and he can craft more with 12 [Silk](/wiki/Silk "Silk"), 6 [Spider Glands](/wiki/Spider_Gland "Spider Gland"), and 6 [Papyrus](/wiki/Papyrus "Papyrus").
...
| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Silk**×12** Spider Gland**×4** Papyrus**×3 (Webber only)** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Structures Filter Survivor Items Filter | Always available |
...
|  |
| --- |
| Can grow into a [Spider Den](/wiki/Spider_Den "Spider Den"). Can be [Decorated](/wiki/Den_Decorating_Set "Den Decorating Set"). A place to sleep (Webber only). |
...
In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Spider Eggs were moved to Webber's exclusive [Survivor Items Filter](/wiki/Survivor_Items_Filter "Survivor Items Filter"). Also, the Papyrus costs were cut in half and the Spider Gland were lowered by 2.
...
* Despite what [Wilson](/wiki/Wilson "Wilson") says after inspecting Spider Eggs, they will never hatch unless the player manually plants them.
* The description for this recipe may be a reference to the Beatles' song "[With a Little Help from My Friends](https://en.wikipedia.org/wiki/With_a_Little_Help_from_My_Friends "wikipedia:With a Little Help from My Friends")".
...
* If paired with a few [Rabbit Hutches](/wiki/Rabbit_Hutch "Rabbit Hutch"), Spider Eggs can be turned into a reliable spider farm.

## Blueprint Gallery[]

Spider Eggs on ground.png (19 KB)

Spider Eggs dropped on the ground.

Spider Eggs prompt.png (45 KB)

The prompt that appears when holding Spider Eggs over the field.
