...
source_url: https://dontstarve.fandom.com/wiki/Anti_Venom
---
...
"Cures that not-so-fresh poison."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Venom Gland**×1** Seaweed**×3** Coral**×2** |
...
**“**This'll help if I'm poisoned.**”**

–[Willow](/wiki/Willow "Willow")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Wolfgang will flex poison out of veins!**”**
...
**“**The contents should make a most useful antidote.**”**
...
**“**This'll make the sickness go away.**”**
...
**“**'Tis th'sea thet'll claim me, not some sickly biter.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**GOOD FOR WILBA BOO BOOS**”**
...
**“**A cure for too much adventure.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Anti Venom** is a [Survival Tab](/wiki/Survival_Tab "Survival Tab") [item](/wiki/Item "Item") exclusive to the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype, and can be crafted using 1 [Venom Gland](/wiki/Venom_Gland "Venom Gland"), 3 [Seaweed](/wiki/Seaweed "Seaweed"), and 2 [Coral](/wiki/Coral "Coral"). It is used to remove the effects of [Poison](/wiki/Poison "Poison").

Each Anti Venom is single use only. Anti Venom provides no benefits when quaffed if the player is not already poisoned. One can protect themselves from poison by wearing a [Seashell Suit](/wiki/Seashell_Suit "Seashell Suit"), a [Particulate Purifier](/wiki/Particulate_Purifier "Particulate Purifier") or a [Horned Helmet](/wiki/Horned_Helmet "Horned Helmet"), depending on the source of the Poison. [WX-78](/wiki/WX-78 "WX-78") is immune to poison, therefore Anti Venom has no benefits to them.

Anti Venom can be also found in [X Marks the Spot](/wiki/X_Marks_the_Spot "X Marks the Spot") treasure chests.
...
Anti Venom is also present in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, however, it cannot be crafted as some of its materials are unavailable. Instead, it can be bought for 5 [Oincs](/wiki/Oinc "Oinc") at the [Curly Tails Mud Spa](/wiki/Curly_Tails_Mud_Spa "Curly Tails Mud Spa") in the [Pig City](/wiki/Pig_City "Pig City").

## Placeholder Trivia[]

* Anti Venom shares its animation with [Snake Oil](/wiki/Snake_Oil "Snake Oil") and [Poison Balm](/wiki/Poison_Balm "Poison Balm").
  + The animation is also similar to the /joy emote in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*.
...
Quaff Animation.png (409 KB)

[Wilson](/wiki/Wilson "Wilson") clicking his heels after consuming Anti Venom.
