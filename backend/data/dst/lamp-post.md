...
source_url: https://dontstarve.fandom.com/wiki/Lamp_Post
---
...
| --- |
| Alloy**×1** Electrical Doodad**×1** Lantern**×1** |
...
|  |
| --- |
| Provides light at [Night](/wiki/Night "Night"). |
...
**“**How wonderful! Does it run on direct current or alternating current?**”**
...
**“**A free light source. I'll take it.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Lamp Post** is a craftable and naturally occuring [Structure](/wiki/Structure "Structure") in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It can be found decorating the [Streets](/wiki/Stone_Road_Turf "Stone Road Turf") in [Pig Cities](/wiki/Pig_City "Pig City"). At [Night](/wiki/Night "Night"), the Lamp Post provides light without consuming any [Fuel](/wiki/Fuel "Fuel"). Like other Pig City structures, Lamp Posts will be rebuilt by [Worker Pigs](/wiki/Pig_Traders "Pig Traders").

In order to craft Lamp Posts themselves, the player must first obtain the [Key to the City](/wiki/Key_to_the_City "Key to the City") to access the [City Planning Tab](/wiki/City_Planning_Tab "City Planning Tab"). There, Lamp Posts can be crafted using one [Alloy](/wiki/Alloy "Alloy"), a [Electrical Doodad](/wiki/Electrical_Doodad "Electrical Doodad"), and a [Lantern](/wiki/Lantern "Lantern").

The Lamp Post prevents attacks from [Charlie](/wiki/Charlie "Charlie"), providing light in about a two [Pitchfork](/wiki/Pitchfork "Pitchfork") tile radius. The light turns on in the evening and lasts through the night.

## Prototype Tips[]

* Building a Lamp Post and destroying it using the [Executive Hammer](/wiki/Executive_Hammer "Executive Hammer") can refuel [Lanterns](/wiki/Lantern "Lantern") infinitely.

## PlaceholderTrivia[]

* They will only be lit during dusk and nighttime even if placed in complete darkness, therefore building them inside the [caves](/wiki/Caves "Caves") in RoG is not advisable.
