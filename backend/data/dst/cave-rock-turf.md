...
source_url: https://dontstarve.fandom.com/wiki/Cave_Rock_Turf
---
...
| --- | --- |
| Rocks**×3 Don't Starve Together** | 4 |
...
**Cave Rock Turf** is one of the [Turf](/wiki/Turf "Turf") [Items](/wiki/Items "Items"), acquired by digging Cave Rock Turf tiles with a [Pitchfork](/wiki/Pitchfork "Pitchfork"). Like other Turfs, it can be placed on any bare ground tile or used as [fuel](/wiki/Fire#Fuel "Fire").

Similar in appearance to the [Rocky Turf](/wiki/Rocky_Turf "Rocky Turf"), the Cave Rock Turf is often found on [Stalagmite Terrain](/wiki/Stalagmite_Terrain "Stalagmite Terrain") and in [Rocky Plains](/wiki/Rocky_Plains "Rocky Plains"). The difference between Rocky Turf and Cave Rock Turf is that Cave Rock Turf has more cracks along its surface, and more importantly, Cave Rock Turf is unable to be crafted into [Cobblestones](/wiki/Cobblestones "Cobblestones").

[Berry Bushes](/wiki/Berry_Bushes "Berry Bushes"), [Grass Tufts](/wiki/Grass_Tufts "Grass Tufts"), [Saplings](/wiki/Saplings "Saplings"), [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), [Pine Cones](/wiki/Pine_Cone "Pine Cone"), [Birchnuts](/wiki/Birchnut "Birchnut"), and [Lureplants](/wiki/Lureplants "Lureplants") cannot be placed on Cave Rock turf, and Eyeplants will not grow on it. Crows are the only [Birds](/wiki/Birds "Birds") that will land on Cave Rock turf.

Cave Rock Turf has the second highest overlap priority of any turf in the game, meaning it will almost always appear "on top" when overlapping adjacent turfs. The only turf with a higher overlap priority is [Mud Turf](/wiki/Mud_Turf "Mud Turf").

If brought to SW, [Floods](/wiki/Flooding "Flooding") can spawn on this turf.

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Cave Rock Turf can be crafted and prototyped with 3 [Rocks](/wiki/Rocks "Rocks") at [Terra Firma Tamper](/wiki/Terra_Firma_Tamper "Terra Firma Tamper") in the [Decorations Filter](/wiki/Decorations_Filter "Decorations Filter").

## Blueprint Gallery[]

Rock Turf Texture.png (293 KB)

Rock Turf texture.

Cave Rock Stand.jpg (43 KB)

[Wolfgang](/wiki/Wolfgang "Wolfgang") standing on some placed Cave Rock Turf.

Cave Rock Map.jpg (21 KB)

Cave Rock Turf as seen in the [Map](/wiki/Map "Map").
...
| **Cave Turf** | [Mud Turf](/wiki/Mud_Turf "Mud Turf") • [Guano Turf](/wiki/Guano_Turf "Guano Turf") • [Slimy Turf](/wiki/Slimy_Turf "Slimy Turf") • [Fungal Turf](/wiki/Fungal_Turf "Fungal Turf") • **Cave Rock Turf** |
