...
source_url: https://dontstarve.fandom.com/wiki/Sea_Fishing_Rod
---
...
| --- | --- |
| Tools Filter Fishing Filter | Science Machine |

Combat attributes

| [Damage](/wiki/Damage "Damage") |
| --- |
| 4.25  3.2 WendyWes  ---  5.3 Wigfrid  ---  3.2Wolfgang/4.25Wolfgang/8.5 Wolfgang  ---  2.1 Wanda (elderly) |
...
|  |
| --- |
| Allows the player to catch [Ocean Fishes](/wiki/Ocean_Fishes "Ocean Fishes"). |
...
The **Sea Fishing Rod** is an [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*.

The Sea Fishing Rod can be used to fish [Ocean Fishes](/wiki/Ocean_Fishes "Ocean Fishes"), [Wobster](/wiki/Wobster "Wobster"), [Lunar Wobster](/wiki/Lunar_Wobster "Lunar Wobster") and [Ocean Debris](/wiki/Ocean_Debris "Ocean Debris"). It has two inventory slots: one is for [Floats](/wiki/Floats "Floats") to improve the casting range and accuracy, and the other slot is for [Lures](/wiki/Lures "Lures") to improve the attractiveness towards Ocean Fishes. The Sea Fishing Rod cannot be used to catch [Freshwater Fish](/wiki/Freshwater_Fish "Freshwater Fish") or [Live Eel](/wiki/Live_Eel "Live Eel") at a [Pond](/wiki/Pond "Pond").

## Usage[]

1. First, the player baits the Lure on the Sea Fishing Rod with a [Berry](/wiki/Berries "Berries") or a [Seed](/wiki/Seeds "Seeds") (The lure is technically optional, but without it the player will have a harder time).
2. It is optional to also put a Float on the Sea Fishing Rod, such as a [Twig](/wiki/Twigs "Twigs"), to help with casting range and accuracy.
...
4. The player can then cast the line into the water near where the shadows of the fish are.
5. The player waits for the fish to bite; when it happens, set hook.
6. Now it's time for the reeling mini-game: fight the fish and bring it in.
   * The player must pay attention to the Sea Fishing Rod. If it is angled low in the water or angled in the middle between low and high, the player must keep reeling the rod in and the fish will come towards the player. If the fishing rod is angled high and the player's character appears to be struggling to keep the fish from swimming away, the player must stop reeling and wait until the rod lowers, then keep reeling in the fish. If the player keeps reeling when the Sea Fishing Rod is angled high, the line will snap, causing the Lure and Float to disappear. If the player stops reeling when the Sea Fishing Rod is angled low, then the fish will get away.
...
7. Once successful, the fish will pop up and land near the player's character.

To catch bigger Ocean Fish in the deep ocean, the player can follow these steps again but on a [boat](/wiki/Boat_Kit "Boat Kit") and with the usage of more advanced Lures and Floats made from a [Tackle Receptacle](/wiki/Tackle_Receptacle "Tackle Receptacle").

## Skins[]

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Sea\_Fishing\_Rod](/wiki/Belongings#Sea_Fishing_Rod "Belongings")*
...
* The Sea Fishing Rod was introduced in the *[Hook, Line, and Inker](/wiki/Return_of_Them#Hook,_Line,_and_Inker "Return of Them")* update.
* The Sea Fishing Rod is similar to an [Unimplemented Feature](/wiki/Unimplemented_Features "Unimplemented Features"), the Big Fishing Rod, which was intended to let players catch better fish.

## Gallery[]

DST Hook Line and Inker Trailer Wilson.png (673 KB)

The Sea Fishing Rod as seen in the *Hook, Line, and Inker* trailer.
