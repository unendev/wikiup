...
source_url: https://dontstarve.fandom.com/wiki/Cloth
---
...
Crate (Hammer), Slotmachine Shipwrecked  

Hot Air Balloon (Hammer) Hamlet

### Sold by

Pigg and Pigglet's General Store (Oinc ×5) Hamlet
...
**“**Amazing what you can do with bamboo.**”**
...
**“**'TIS THE FABRIC OF MINE FOLLY'**”**

–[Wilba](/wiki/Wilba "Wilba")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Soft. Made from friends**”**

–[Wormwood](/wiki/Wormwood "Wormwood")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**The same stuff my balloon is made out of.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Cloth** is a [Refined](/wiki/Refined "Refined") [Item](/wiki/Items "Items") introduced in the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC. It requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype and 3 [Bamboo](/wiki/Bamboo "Bamboo") to craft. Cloth can also be occasionally found when [Hammering](/wiki/Hammer "Hammer") [Crates](/wiki/Crate "Crate") or floating on the water in [Ship Graveyards](/wiki/Ocean#Shipwrecked "Ocean"). It is used in many crafting recipes and can be used as [Fuel](/wiki/Fuel "Fuel").

## Hamlet icon Hamlet[]

Cloth is also included in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, required to craft [Pith Hats](/wiki/Pith_Hat "Pith Hat") and [Gas Masks](/wiki/Gas_Mask "Gas Mask"). However, it cannot be refined from [Bamboo](/wiki/Bamboo "Bamboo") until the blueprint has been obtained from hammering the ['A Smashing Pot'](/wiki/A_Smashing_Pot "A Smashing Pot") , so players must acquire Cloth through different means. A piece of Cloth can be acquired by hammering the [hot air balloon](/wiki/Hot_Air_Balloon "Hot Air Balloon") debris scattered around the player's spawn point. Cloth can also be bought in the [Pigg and Pigglet's General Store](/wiki/Pigg_and_Pigglet%27s_General_Store "Pigg and Pigglet's General Store") for 5 [Oincs](/wiki/Oinc "Oinc").

There is a small chance(around 7%) for Bamboo to be obtained from hammering the ['A Smashing Pot'](/wiki/A_Smashing_Pot "A Smashing Pot") and the corresponding [blueprint](/wiki/Blueprint "Blueprint") for making cloth from it (has 4% chance). Another way for obtaining cloth, is through [trawling](/wiki/Trawl_Net "Trawl Net") in the hamlet ponds (1.96% chance). Also, Bamboo can be bought for 3 [Oincs](/wiki/Oinc "Oinc") at ['The Sty' Oddities Emporium](/wiki/%27The_Sty%27_Oddities_Emporium "'The Sty' Oddities Emporium") in the [Pig City](/wiki/Pig_City "Pig City").
