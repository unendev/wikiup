...
source_url: https://dontstarve.fandom.com/wiki/Moggles
---
...
The Sow's Ear Hat Shop (Oinc ×20) Hamlet icon
...
**“**Converts scents to visual light waves.**”**
...
**Moggles** are [Headwear](/wiki/Category:Hats "Category:Hats") from the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC. They are found in the [Light Tab](/wiki/Light_Tab "Light Tab"), require 2 [Moleworms](/wiki/Moleworm "Moleworm"), 2 [Electrical Doodads](/wiki/Electrical_Doodad "Electrical Doodad"), and 1 [Glow Berry](/wiki/Glow_Berry "Glow Berry") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

When worn, the player is able to see in the dark with a sort of negative filter. If the player wears the Moggles when there is light outside, their surroundings appear extremely bright. Unlike other [light](/wiki/Light "Light") items, Moggles allow the player to see everything on the screen.

Moggles will last for one and a half days in total but can be recharged using [Glow Berries](/wiki/Glow_Berries "Glow Berries"), which will restore their durability by 33.25% (almost 4 minutes), or [Lesser Glow Berries](/wiki/Lesser_Glow_Berry "Lesser Glow Berry"), which will restore their durability by 6.25% (45 seconds).

Despite not being a light source in the conventional sense, wearing Moggles will protect players from [Charlie](/wiki/Charlie "Charlie").

## Gift Icon Downloadable Content[]

In the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, Moggles cannot be crafted but can be brought over from a connected *Reign of Giants* world. In *Shipwrecked*, they can be refueled with [Dragoon Hearts](/wiki/Dragoon_Heart "Dragoon Heart"), restoring 33.25% of their durability similar to Glow Berries.

In the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, Moggles cannot be crafted. Instead, they can be bought for 20 [Oincs](/wiki/Oinc "Oinc") at [The Sow's Ear Hat Shop](/wiki/The_Sow%27s_Ear_Hat_Shop "The Sow's Ear Hat Shop") at the [Pig City](/wiki/Pig_City "Pig City").

## Prototype Tips[]

* Moggles are the only portable means of acquiring 100% visibility at night or underground.
  + The [Hamlet](/wiki/Hamlet "Hamlet") DLC introduces the [Cowl](/wiki/Cowl "Cowl"), which also provides 100% visibility, using sonar-type vision.
* Moggles can be particularly useful when dealing with [Cave Spiders](/wiki/Cave_Spider "Cave Spider") and [Spitters](/wiki/Spitter "Spitter").
* They are especially handy when exploring the [Ruins](/wiki/Ruins "Ruins") since the player is able to spot danger and prepare for the lying monsters in wait.
* Moggles will be destroyed if they reach 0% so the player should make sure to un-equip or refuel them before this happens.
* Briefly equipping Moggles will instantly kill any nearby [Night Hands](/wiki/Night_Hand "Night Hand").
* As with any other fuel, only 75% of the item's normal fuel value is added if the Glow Berries/Dragoon Hearts are [wet](/wiki/Wetness "Wetness"). If these items are scarce, player should take care to let them dry before refueling the Moggles.

## Placeholder Trivia[]

* Upon release, the recipe for Moggles was 2 [Moleworms](/wiki/Moleworm "Moleworm"), 2 [Electrical Doodads](/wiki/Electrical_Doodad "Electrical Doodad"), and 4 [Silk](/wiki/Silk "Silk"). It could be repaired with a [Sewing Kit](/wiki/Sewing_Kit "Sewing Kit") instead of needing to be refueled.
* Hovering over objects that can be examined or standing under a shaft of light in [Caves](/wiki/Caves "Caves") while using the Moggles will make the objects appear in black and white.
* The word "Moggles" is a portmanteau of the words "Mole" and "Goggles".
* [Wickerbottom's](/wiki/Wickerbottom "Wickerbottom") quote is clearly about the original design of the moggles, as the original design appeared to have moleworm noses over the wearer's eyes.
...
* While equipping Moggles, the entire screen is considered illuminated by a light source. As a result, [Spiders](/wiki/Spider "Spider") will panic while on screen.

## Blueprint Gallery[]

* Expand slideshow

  [Wilson](/wiki/Wilson "Wilson") wearing Moggles.
* Expand slideshow

  [Willow](/wiki/Willow "Willow") wearing Moggles.
* Expand slideshow

  [Wolfgang](/wiki/Wolfgang "Wolfgang") wearing Moggles.
* Expand slideshow

  [Wendy](/wiki/Wendy "Wendy") wearing Moggles.
* Expand slideshow

  [WX-78](/wiki/WX-78 "WX-78") wearing Moggles.
* Expand slideshow

  [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing Moggles.
* Expand slideshow

  [Woodie](/wiki/Woodie "Woodie") wearing Moggles.
* Expand slideshow

  [Wes](/wiki/Wes "Wes") wearing Moggles.
* Expand slideshow

  [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing Moggles.
* Moggles Wagstaff.png

  [Wagstaff](/wiki/Wagstaff "Wagstaff") wearing Moggles.
* Expand slideshow

  [Wigfrid](/wiki/Wigfrid "Wigfrid") wearing Moggles.
* Expand slideshow

  [Webber](/wiki/Webber "Webber") wearing Moggles.
* Expand slideshow

  [Walani](/wiki/Walani "Walani") wearing Moggles.
* Expand slideshow

  [Warly](/wiki/Warly "Warly") wearing Moggles.
* Expand slideshow

  [Wilbur](/wiki/Wilbur "Wilbur") wearing Moggles.
* Expand slideshow

  [Woodlegs](/wiki/Woodlegs "Woodlegs") wearing Moggles.
* Expand slideshow

  [Wilba](/wiki/Wilba "Wilba") wearing Moggles.
* Expand slideshow

  [Wormwood](/wiki/Wormwood "Wormwood") wearing Moggles.
* Expand slideshow

  [Wheeler](/wiki/Wheeler "Wheeler") wearing Moggles.
* Expand slideshow

  [Winona](/wiki/Winona "Winona") wearing Moggles.
* Expand slideshow

  [Wortox](/wiki/Wortox "Wortox") wearing Moggles.
* Expand slideshow

  [Wurt](/wiki/Wurt "Wurt") wearing Moggles.

1/22

Wilson Moggles.png (35 KB)

Wilson wearing the original Moggles design.

Mole Hat.png (17 KB)

The original Moggles design from all angles.

Moggles Night Vision.jpg (382 KB)

The Moggles' view in darkness.

Moogles during Day.png (40 KB)

Moggles' night vision during Day.

Moogles during Dusk.png (84 KB)

Moggles' night vision during Dusk.

Moogles during Night.png (67 KB)

Moggles' night vision during Night.

Moggles vision under light.png (495 KB)

Wolfgang being seen in black and white while wearing the Moggles under a shaft of light in a Cave.

Moggles See Charlie.png (325 KB)

Wilson sees Willow being attacked by Charlie while wearing Moggles in *Don't Starve Together*.
