...
source_url: https://dontstarve.fandom.com/wiki/Magma_Pile
---
...
Rocks75%, Flint25%, Red Gem0.25%, Blue Gem0.5%,  
Nitre25% (regular)  
Gold Nugget25% (gold)
...
No   
 Yes ([Volcano Biome](/wiki/Volcano_Biome "Volcano Biome"))

[Code](/wiki/Console "Console")

|  |
| --- |
| `"magmarock" "magmarock_gold"` |
...
**Magma Piles** are naturally-spawning [Structures](/wiki/Structure "Structure") in the [Magma Field](/wiki/Magma_Field "Magma Field") and [Volcano](/wiki/Volcano_(biome) "Volcano (biome)") [Biomes](/wiki/Biomes "Biomes") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. They are piles of igneous rocks which may be dug using a [Shovel](/wiki/Shovel "Shovel"), using 4% of the Shovel's durability per dig. They must be dug 6 times to be removed, and 2-3 items will drop every 2 shovel digs. The gold-flecked Magma Pile has a chance to drop [Gold Nuggets](/wiki/Gold_Nuggets "Gold Nuggets"), while the regular one can drop [Nitre](/wiki/Nitre "Nitre"). Both types also drop [Rocks](/wiki/Rocks "Rocks"), [Flint](/wiki/Flint "Flint"), and very rarely, red or blue [Gems](/wiki/Gems "Gems"). Sometimes a [Krissure](/wiki/Krissure "Krissure"), a sort of flaming geyser, will erupt after digging up a pile. This chance is higher while in the Volcano than in the Magma Field. Upon a Krissure's eruption, the final dropped items will be scattered about half a screen away. Magma Piles in Volcano Biome are renewable, after they are dug, they would regrow to full in a year at the same location, if a Krissure did not erupt after being dug.

## Blueprint Gallery[]

Magma piles.png (458 KB)

[Woodlegs](/wiki/Woodlegs "Woodlegs") next to a few Magma Piles.

Digging magmapiles.png (206 KB)

Woodlegs digging a Gold Magma Pile.

Magma Map.png (425 KB)

Magma Piles as seen on the [Map](/wiki/Map "Map").
