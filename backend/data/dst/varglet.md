...
source_url: https://dontstarve.fandom.com/wiki/Varglet
---
...
Can summon Hound Red Hound Blue Hound

### [Loot](/wiki/Mobs#Mob_Characteristics "Mobs")

Monster Meatx3-4 Hound's Toothx1-2
...
The **Varglet** is an aggressive mob exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. Varglets could appear in [Hound Waves](/wiki/Hound#Periodic_Hound_Attacks "Hound") after 20 days. They are capable of spawning 1 to 3 of their own Hounds. Similar to Hounds and unlike [Vargs](/wiki/Varg "Varg"), they can swim in the ocean and jump in and out of land and on [Boats](/wiki/Boat_Kit "Boat Kit").

## https://static.wikia.nocookie.net/dont-starve-game/images/4/4f/Spear.png/revision/latest?cb=20121216143213 Fighting Strategy[]

Below is the number of hits it takes with each weapon to kill a Varglet when playing with characters with a default damage modifier. The [Weather Pain](/wiki/Weather_Pain "Weather Pain") is not included due to the random nature of its projectile.

| Weapon | prutFishing RodBug Net | Lucy the Axe | Shovel Pitchfork Hammer Torch Umbrella  Walking Cane The Lazy ExplorerWillow's LighterSaddlehorn | Axe Pickaxe | SpearFencing Sword | Bramble TrapBattle SpearBat BatPickSlashAxe | Slurtle SlimeTentacle Spike | Ham Bat | Thulecite Club | Tooth Trap | Strident Trident | Morning Star | Dark SwordGlass Cutter | Blow Dart | Alarming Clock | Gunpowder |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **No. of hits for**Varglet | **142** | **45** | **36** | **23** | **18** | **15** | **12** | **11-21** | **11** | **10** | **9 or 23** | **9 or 14** | **9** | **6** | **5 (old)** **7 (aged)**  **8 (young) 23 (0%)** | **3** |

## Placeholder Trivia[]

* The Varglet was introduced in the [March 2022 QoL update](/wiki/Don%27t_Starve_Together/Version_History#March_24,_2022_-_March_2022_QoL_Update "Don't Starve Together/Version History").
* The Varglet is described as the "smaller cousin" to the Varg in the patch notes for its debut update.[[1]](#cite_note-1)

## References[]

1. [↑](#cite_ref-1) [Game Update - 499972](https://forums.kleientertainment.com/game-updates/dst/499972-r1765/): "Late hound waves replace 5 hounds onto a Varglet, the smaller cousin to the Varg." Posted on March 24, 2022.
