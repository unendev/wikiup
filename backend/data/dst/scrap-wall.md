...
–[Walter](/wiki/Walter "Walter"), examining build Scrap Wall

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Hope it keeps us safe.**”**

–[Wanda](/wiki/Wanda "Wanda"), examining build Scrap Wall

The **Scrap Wall** is a type of [Wall](/wiki/Wall "Wall") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in the *[From Beyond](/wiki/From_Beyond "From Beyond")* updates. It can be crafted with 4 [Scraps](/wiki/Scrap "Scrap"), yielding 8 Scrap Walls items, and requires an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. With 600 maximum, the Scrap Wall's health is between those of the [Stone Wall](/wiki/Stone_Wall "Stone Wall") and [Thulecite Wall](/wiki/Thulecite_Wall "Thulecite Wall"). Scrap Walls also have a 20% damage protection.

When built and placed, it will be at its third tier (phase 1). It can be upgraded into two more tiers with Scrap or [Gears](/wiki/Gears "Gears"), needing 4 to fully upgrade, or with another Scrap Wall items, needing only 1 to fully upgrade. The full stage has 3 different designs, from which one will be chosen randomly. When [hammered](/wiki/Hammer "Hammer"), the Scrap Wall will yield 1 Scrap, needing 10 strokes instead of the usual 3 strokes for the other walls.

Scrap Walls prevents the player's and [Mobs](/wiki/Mobs "Mobs")' movement and can be used for decorative purposes.

## Trivia[]

* Scrap Walls were added in the *[Scrappy Scavengers](/wiki/Scrappy_Scavengers "Scrappy Scavengers")* update.

## Gallery[]

Scrap Wall All Phases From Side.png (352 KB)

Scrap Wall from the side (all phases).
