...
source_url: https://dontstarve.fandom.com/wiki/Tar_Slick
---
...
**“**A highly combustible source of fuel lays just beneath the waves.**”**
...
**“**Aww, the tar's seeping right into the ocean water.**”**
...
**“**There be sludgy treasure down ther'.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**HAST BLACK GOO WITHIN**”**
...
**“**Black gold. Or black goop. Take your pick.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Tar Slick** is a naturally-spawning object exclusive to the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It can be found anywhere in the [Medium Ocean](/wiki/Ocean "Ocean") or Deep Ocean. It is a source of [Tar](/wiki/Tar "Tar"), which must be extracted by building a [Tar Extractor](/wiki/Tar_Extractor "Tar Extractor"). A Tar Slick does not run out, and cannot be destroyed, making Tar a renewable resource. A Tar Slick can also be created at the player's will using a [Quacken Drill](/wiki/Quacken_Drill "Quacken Drill"), thus making Tar Slick renewable.

## Placeholder Trivia[]

* The Tar Slick was added to the *Shipwrecked* DLC more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21st,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.

## Blueprint Gallery[]

Tar Extractor at work.png (666 KB)

A Tar Extractor producing Tar from a Tar Slick.

Map Icon Tar Slick.png (4 KB)

A Tar Slick on the [Map](/wiki/Map "Map").

DS Shipwrecked Home Sea Home Update.png (2.36 MB)

Tar Slick as seen in the poster for the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update.
