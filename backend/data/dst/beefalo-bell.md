...
source_url: https://dontstarve.fandom.com/wiki/Beefalo_Bell
---
...
| --- | --- |
| Tools FilterBeefalo Riding Filter | Science Machine |
...
|  |
| --- |
| Bonds player to a [beefalo](/wiki/Beefalo "Beefalo") |
...
**“**This bell cömmands löyalty fröm the wöölen beasts.**”**
...
The **Beefalo Bell** is a craftable [item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, It is found in the [Tools Filter](/wiki/Tools_Filter "Tools Filter"), requiring three [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget") and one [Flint](/wiki/Flint "Flint"), and requires the [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. It is used to bond with a [Beefalo](/wiki/Beefalo "Beefalo") by hovering the bell over it, then clicking the left mouse button. Players can name the Beefalo by either typing it in or choosing one of various names by clicking the Random button: the default name given is "[Player]'s Beefalo".
...
When a player goes offline with a Beefalo Bell, the bonded Beefalo disappears with the player. It also allows players to take Beefalo into the [Caves](/wiki/Caves "Caves") and through [Worm Holes](/wiki/Worm_Hole "Worm Hole").
...
* The Bell can be kept at base or a secure location, so the bonded Beefalo can go back by themselves once dismounted.
* The Beefalo Bell is a handy tool to have around when taming a Beefalo, as having to feed it to make it a follower can be expensive.
* You can use this to hunt Beefalo by using it on a beefalo and luring it away from the herd.

## Placeholder Trivia[]

* The Beefalo Bell was introduced in the *[Year of the Beefalo](/wiki/Year_of_the_Beefalo "Year of the Beefalo")* update, as part of the event.
* The Beefalo Bell resembles a real life instrument called a Cowbell.
* The name "Wellington" is likely a play on words of the dish, [Beef Wellington](https://en.wikipedia.org/wiki/Beef_Wellington "wikipedia:Beef Wellington").
