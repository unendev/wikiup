...
source_url: https://dontstarve.fandom.com/wiki/Fish_Food
---
...
| --- | --- |
| Rot**×2** Barnacles**×3** Silk**×1** (or for 1 Empty Bottle (DST) from Crabby Hermit) | 1 ‒ 3 |

| [Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Fishing Filter/Bottle Exchange Filter | Rare Blueprint (Crabby Hermit lvl. 8) |
...
|  |
| --- |
| Attract [Ocean Fishes](/wiki/Ocean_Fishes "Ocean Fishes"). |
...
**“**You use it to lure the fish in.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's only fair to feed the fish before they feed me.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Fish Food** is an [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in the *[Return of Them](/wiki/Return_of_Them "Return of Them")* updates. 3 Fish Foods can be obtained from the level 8 [Crabby Hermit](/wiki/Crabby_Hermit "Crabby Hermit") in exchange for 1 [Empty Bottle](/wiki/Empty_Bottle#Don't_Starve_Together "Empty Bottle").

The [Rare Blueprint](/wiki/Rare_Blueprint "Rare Blueprint") for Fish Food can be bought for five Empty Bottles from the Crabby Hermit at lv. 8. After learning the blueprint, the Fish Food can be crafted with 2 [Rot](/wiki/Rot "Rot"), 3 [Barnacles](/wiki/Barnacles "Barnacles"), and 1 [Silk](/wiki/Silk "Silk").

## Usage[]

Fish food can be thrown into the [Ocean](/wiki/Ocean "Ocean") to attract nearby [Ocean Fishes](/wiki/Ocean_Fishes "Ocean Fishes") and create new temporary schools of fish if there are not too many fish nearby. This effect lasts 20 seconds.

When thrown, similiar to the [Napsack](/wiki/Napsack "Napsack"), it creates a cloud.

## Trivia[]

* Fish Food was introduced in the *[She Sells Sea Shells](/wiki/Return_of_Them#She_Sells_Sea_Shells "Return of Them")* update.
* Fish Food originally cost 3 empty bottles, this was reduced to 1 in the *[The Curse of Moon Quay](/wiki/The_Curse_of_Moon_Quay "The Curse of Moon Quay")* update.
