...
source_url: https://dontstarve.fandom.com/wiki/Mangrove_Tree
---
...
[Mangrove](/wiki/Mangrove "Mangrove")
...
**“**An impressive root system. In theory it would help avoid water saturation.**”**
...
**“**I'm guessing it's safe from fire in this water.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Mangrove Trees** are a type of [Tree](/wiki/Tree "Tree") in the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC. They are found growing in the waters of the [Mangrove](/wiki/Mangrove "Mangrove") biome and can only be accessed by [Boat](/wiki/Boats "Boats") or [Raft](/wiki/Raft "Raft"). They have a distinctive appearance with a bulbous trunk and roots that begin above the waterline.

When chopped down, the player receives 1 [Log](/wiki/Logs "Logs") and 1 [Twig](/wiki/Twigs "Twigs"), 1 Log and 2 Twigs or 2 Logs and 3 Twigs, depending on the tree's size.
