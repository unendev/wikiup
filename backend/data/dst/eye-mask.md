...
source_url: https://dontstarve.fandom.com/wiki/Eye_Mask
---
...
315 hp  
393 [true hp](/wiki/Armor/DST#True_durability "Armor/DST")

### [Drops](/wiki/Items "Items")

Milky Whites x3 Monster Meatx2 (Deconstruction Staff)
...
|  |
| --- |
| Absorbs 80% of physical damage. Feed food to repair. |
...
**“**You could say I have an eye for style.**”**
...
**“**Wolfgang not fan of squishy hat.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I am the beholder of the eye.**”**

–[Wendy](/wiki/Wendy "Wendy")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**COMMENCING OCULAR AUGMENTATION**”**

–[WX-78](/wiki/WX-78 "WX-78")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I doubt that they make my prescription in this size.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Protective eye gear that protects everything but the eyes.**”**
...
**“**Follower of Heimdall, watch over my path!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**We have even MORE eyes and teeth!**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I must remember to avoid cutting onions while wearing this.**”**
...
**“**Guess I'll really be seein' the world through different eyes.**”**

–[Winona](/wiki/Winona "Winona")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Well, isn't this a sight for sore eyes. Hyuyuyu!**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Feels like hug from a slug.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Don't worry Woby. It's just a hat, see?**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**How bizarre... I simply must try it on!**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Eye Mask** is a wearable head slot [Armor](/wiki/Armor "Armor") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* and introduced in the *[An Eye for An Eye](/wiki/An_Eye_for_An_Eye "An Eye for An Eye")* update. It's dropped from the [Eye of Terror](/wiki/Eye_of_Terror "Eye of Terror") upon death.

It has a durability of 315 and absorbs 80% of all physical damage. Its durability can be repaired by feeding it any food item. Although it can be repaired, it will just break as per normal when its durability reaches zero.

Durability repair calculations have a number of rules.

* Absolute value is calculated. [Monster Meat](/wiki/Monster_Meat "Monster Meat") or [Red Caps](/wiki/Red_Cap "Red Cap"), which provide -20 Health Meter, are calculated as if were positive 20.
* Health has a multiplier of 4.
* Hunger has a multiplier of 1.75.
* Sanity values are ignored.

A [Monster Meat](/wiki/Monster_Meat "Monster Meat") can repair the Eye Mask by 112.8125 durability.

```
math.abs(-20)*4+math.abs(18.75)*1.75

```

## Prototype Tips[]

* If a player gives the Eye Mask any glow-related food it will glow without the need to wear a light-related item, perfect for exploration during night or in caves.
* In caves during [Nightmare Phase](/wiki/Nightmare_Cycle "Nightmare Cycle") Eye Mask start glowing red similar to [Thulecite Medallion](/wiki/Thulecite_Medallion "Thulecite Medallion")

## Placeholder Trivia[]

* The Eye Mask is introduced in the *An Eye for an Eye* update, as a crossover collaboration with Re-Logic's *Terraria*.
* The Eye Mask is a reference to the Eye of Cthulhu Mask item from *Terraria.*
  + In *Terraria*, the Eye of Cthulhu Mask is an exclusive drop from the Eye of Cthulhu, which only serves as a vanity item.
* When fed while the item is placed on the ground, it plays a little animation.

## Blueprint Gallery[]

RWP aEFaE Eye Mask concept art.png (838 KB)

Eye Mask concept art from *Rhymes With Play* #An Eye for An Eye
