...
source_url: https://dontstarve.fandom.com/wiki/Viper
---
...
| --- |
| -25/min  (0/min Webber) (-18.75/min Wendy) (-22.5/min Walani) (-27.5/min Wolfgang) |
...
Rainforest TreeStone SlabFish Farm
...
**“**What a wonderfully vicious reptile! I would like its skin.**”**
...
**“**'Tis a land and sea serpent.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A BOLTING-HUTCH OF BEASTLINESS**”**
...
**“**Don't want to bother you. I'll just be on my way.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Vipers** are hostile [Mobs](/wiki/Mobs "Mobs") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. They can be found in the [Ancient Pig Ruins](/wiki/Ancient_Pig_Ruins "Ancient Pig Ruins"), under [Stone Slabs](/wiki/Stone_Slab "Stone Slab"), and when cutting down a [Rainforest Tree](/wiki/Tree/Rainforest_Tree "Tree/Rainforest Tree").

## Brain Behavior[]

Similar to [Snakes](/wiki/Snake "Snake") from the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, Vipers are nocturnal creatures, and unless they are provoked by chopping down a Rainforest Tree or flipping the stone slabs, they will not be active until [Dusk](/wiki/Dusk "Dusk") and through [Night](/wiki/Night "Night"). If any Vipers are attacked, all other Vipers in the vicinity will join in the battle to attack their aggressor. If the player runs far enough away, the Vipers will give up, and fall asleep until another creature or the player walks near. Vipers will actively pick fights with all other creatures (except their own kind), hostile or not. Vipers will try to eat [Meat](/wiki/Meats "Meats") and [Eggs](/wiki/Eggs "Eggs") that are left on the ground.

## Spear Fighting Strategy[]

* Vipers take 1 blasts to be frozen with an [Ice Staff](/wiki/Ice_Staff "Ice Staff") and takes 1 [Sleep Dart](/wiki/Sleep_Dart "Sleep Dart") to be put to sleep.
* Vipers may be kited by dodging their attack and then attacking them 3 times which kills them before they can hit the player, as long as a weapon at least as strong as a [Spear](/wiki/Spear "Spear") is used.
...
* According to [Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), vipers resemble a breed of *Agkistrodon*, which is a genus of the *Viperidae* family. Despite all members of this family are venomous, vipers seem to be non-poisonous in the game. Vipers have the ability to swim and have a forked tail. However, no snakes with a forked tail exist in real life.

## Blueprint Gallery[]

Viper Freeze.PNG (15 KB)
