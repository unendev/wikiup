...
source_url: https://dontstarve.fandom.com/wiki/Quackering_Ram
---
...
"Everybody better get out of your way!"

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Quacken Beak**×1** Bamboo**×4** Rope**×4** |
...
| --- |
| 150  112.5 WendyWes  ---  187.5 Wigfrid  ---  75WolfgangDon't Starve/112.5WolfgangDon't Starve Together/150Wolfgang/300 Wolfgang  ---  75 Wanda (elderly) |
...
**“**An exceptionally enormous blunt object to hit things with.**”**
...
**“**I prefer to be a pacifist on the pacific.**”**
...
**“**Tis time fer a quackerin'!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA ARMED AGAINST SEA OF TROUBLES**”**
...
The **Quackering Ram** is a craftable [Item](/wiki/Item "Item") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is found in the [Nautical Tab](/wiki/Nautical_Tab "Nautical Tab"), requires a [Quacken Beak](/wiki/Quacken_Beak "Quacken Beak"), 4 [Bamboo](/wiki/Bamboo "Bamboo") and 4 [Ropes](/wiki/Rope "Rope") to craft, and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. The Quackering Ram can be attached to [Boats](/wiki/Boats "Boats"), allowing the player to ram [Mobs](/wiki/Mobs "Mobs") and [Structures](/wiki/Structures "Structures"), dealing damage. When the player is on the way towards a Structure or Mob, they will 'charge' when close to it and deal 150 damage.

## Placeholder Trivia[]

* The Quackering Ram was added to the *Shipwrecked* DLC more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21st,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.

## Mosquito Bugs[]

* Equipping the Quackering Ram on a boat will temporarily give it the charge boost. A large free [speed boost](/wiki/Player_Speed "Player Speed") can be obtained by continuously equipping and unequipping.

## Blueprint Gallery[]

DS Shipwrecked Home Sea Home Update.png (2.36 MB)

Quackering Ram as seen in the poster for the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update.
