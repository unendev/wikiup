...
source_url: https://dontstarve.fandom.com/wiki/Weather_Pain
---
...
**“**Swirl and twirl, let cruel winds unfurl!**”**
...
**“**Oh botheration, I thought it was a compass.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Weather Pain** is a ranged [Weapon](/wiki/Weapon "Weapon") from the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC. It requires 10 [Down Feathers](/wiki/Down_Feather "Down Feather"), 1 [Volt Goat Horn](/wiki/Volt_Goat_Horn "Volt Goat Horn"), and 1 [Gears](/wiki/Gears "Gears") to craft, and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.
...
In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, the Weather Pain can be used to destroy [Obsidian Boulders](/wiki/Obsidian_Boulder "Obsidian Boulder").

In the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, the Weather Pain crafting recipe is unavailable, however, a [Blueprint](/wiki/Blueprint "Blueprint") for it can be bought with 100 [Oincs](/wiki/Oinc "Oinc") from [The Tinkerer's Tower](/wiki/The_Tinkerer%27s_Tower "The Tinkerer's Tower"). All of its ingredients are available at ['The Sty' Oddities Emporium](/wiki/%27The_Sty%27_Oddities_Emporium "'The Sty' Oddities Emporium"). The Weather Pain can be used to destroy [Suspicious Cracks](/wiki/Ancient_Pig_Ruins "Ancient Pig Ruins") in the [Ancient Pig Ruins](/wiki/Ancient_Pig_Ruins "Ancient Pig Ruins").

## Tips[]

* Due to the somewhat unpredictable behavior of its projectile, the Weather Pain is best used against slow or immobile targets that spawn weaker mobs to defend them, e.g., [Big Tentacles](/wiki/Big_Tentacle "Big Tentacle"), Poison [Birchnut Trees](/wiki/Birchnut_Tree "Birchnut Tree"), or [Spider Queens](/wiki/Spider_Queen "Spider Queen"). This is especially effective against Poisonous Birchnut Trees, which will die in one hit, making the Weather Pain an ideal tool for acquiring [Living Logs](/wiki/Living_Log "Living Log").
* Against particularly slow [Mobs](/wiki/Mobs "Mobs") or even immobile ones, the Weather Pain can do more than 100 damage with a single use, surpassing even [Blow Darts](/wiki/Blow_Dart "Blow Dart"), making it potentially the best ranged weapon—depending on the target.
* The Weather Pain's projectile destroys trees, which can make it useful for gathering [Logs](/wiki/Logs "Logs"), especially if the trees are planted close together. This will often happen inadvertently in a Poison Birch farm.
* By using a [Construction Amulet](/wiki/Construction_Amulet "Construction Amulet") to make one using 5 feathers, and then using a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff") to get ten feathers back, the Weather Pain can be renewed easily in late game as long as the player doesn't use all its charges before deconstructing it.
* The Weather Pain is handy against certain [Boss Mobs](/wiki/Category:Boss_Monsters "Category:Boss Monsters") such as the Toadstool's Sporecaps and Ancient Fuelweaver's Woven Shadows.

## Trivia[]

* The name "Weather Pain" is a portmanteau of the words "Weather Vane" and "Pain".
* [Weather pains](https://en.wikipedia.org/wiki/Weather_pains) in real life are joint pains induced by atmospheric pressure changes.
...
* Due to the fact that the [Moose/Goose](/wiki/Moose/Goose "Moose/Goose") only drops up to 5 down feathers, it's impossible to craft this without fighting the former twice or fighting [Moslings](/wiki/Mosling "Mosling").
  + However, using a Construction Amulet will make it possible to craft.
* The Weather Pain is [featured](https://terraria.fandom.com/wiki/Weather_Pain) as a Magic weapon in Terraria as a part of the Terraria x Don't Starve event.

## Bugs[]

* If the Shadow Puppets summoned with Maxwell's [Codex Umbra](/wiki/Codex_Umbra "Codex Umbra") are hit by this weapon's projectile, they will become hostile.
* If a [Shadow Creature](/wiki/Shadow_Creature "Shadow Creature") is hit by this weapon's projectile, it will become hostile to the player, regardless of Sanity level.
* If a static [Character](/wiki/Character "Character") (a player character summoned by commands) is hit by this projectile, it will be briefly hostile.
* If [Abigail](/wiki/Abigail "Abigail") is hit by this weapon's projectile, she will try to attack and no longer follow Wendy.

## Gallery[]

Weather Pain vs. Birchnut Tree.png (386 KB)

The Weather Pain's whirlwind after destroying a Poisonous Birchnut Tree.

Weather Pain vs. Tentacles.png (233 KB)

The Weather Pain being used against a Big Tentacle. The whirlwind will make quick work of the Baby Tentacles.

Weather Pain in Terraria.png (589 bytes)

Weather Pain in Terraria
