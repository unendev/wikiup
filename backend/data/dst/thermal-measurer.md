...
source_url: https://dontstarve.fandom.com/wiki/Thermal_Measurer
---
...
The **Thermal Measurer** is a craftable [Structure](/wiki/Structure "Structure"). It requires 2 [Boards](/wiki/Boards "Boards") and 2 [Gold Nugget](/wiki/Gold_Nugget "Gold Nugget") to craft and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype.

The Thermal Measurer is used to approximate the current ambient temperature. It can measure temperatures in a range from 0 to 35 degrees (actual temperature can go outside of this range). The gauge goes up as temperature increases (signifying [Summer](/wiki/Summer "Summer")'s approach) and goes down as the temperature falls (signifying [Winter](/wiki/Winter "Winter")'s approach). During the winter, it turns blue.

## Downloadable Content[]

In the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, the Thermal Measurer can be [flooded](/wiki/Flooding "Flooding"). When flooded, it will visually emit sparks and cease to function.

## Trivia[]

* The reading from the Thermal Measurer goes down in the [Night](/wiki/Night "Night") due to the lack of heat from the sun. It goes back up in the [Daytime](/wiki/Day "Day").
* It was added in *[A Winter's Tale](/wiki/Version_History#A_Winter's_Tale "Version History")* update.
* Before the release of the *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* DLC, the Thermal Measurer was called the Winterometer.

## Gallery[]

Winterometer summer.png (57 KB)

Summer.

Winterometer almost to winter.PNG (31 KB)

Close to winter.

Winterometer winter.png (33 KB)

During mid-winter.

Burnt Thermal Measurer.png (60 KB)

A burnt Thermal Measurer from the *Reign of Giants* DLC.

A Winter's Tale.jpg (725 KB)

Thermal Measurer as seen in the poster for *[A Winter's Tale](/wiki/Don%27t_Starve/Version_History#February_26,_2013_-_A_Winter's_Tale "Don't Starve/Version History")* update.
