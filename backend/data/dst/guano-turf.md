...
source_url: https://dontstarve.fandom.com/wiki/Guano_Turf
---
...
| --- | --- |
| Guano**×2 Don't Starve Together** | 4 |
...
**Guano Turf** is a [Turf](/wiki/Turf "Turf") item. It can be found on [Stalagmite Terrain](/wiki/Stalagmite_Terrain "Stalagmite Terrain") and in the [Rocky Plains](/wiki/Rocky_Plains "Rocky Plains") [Biome](/wiki/Biomes "Biomes"), inside [Caves](/wiki/Caves "Caves") where [Batilisks](/wiki/Batilisk "Batilisk") roam. Guano Turf can be acquired by digging it up with a [Pitchfork](/wiki/Pitchfork "Pitchfork"). It can then be placed on any bare ground tile or used as [fuel](/wiki/Fire#Fuel "Fire").

Plants like [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Saplings](/wiki/Saplings "Saplings"), [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), [Lureplants](/wiki/Lureplant "Lureplant"), [Pine Cones](/wiki/Pine_Cone "Pine Cone"), and [Birchnuts](/wiki/Birchnut "Birchnut") can be planted on these Turfs. It will not stop the Lureplants' [Eyeplants](/wiki/Lureplant#Eyeplant "Lureplant") from spawning.
...
In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Guano Turf can be crafted and prototyped with 2 [Guano](/wiki/Guano "Guano") at [Terra Firma Tamper](/wiki/Terra_Firma_Tamper "Terra Firma Tamper") in the [Decorations Filter](/wiki/Decorations_Filter "Decorations Filter").

## Blueprint Gallery[]

Guano Turf Texture.png (262 KB)

Guano Turf texture.

Guano Stand.jpg (37 KB)

[Wolfgang](/wiki/Wolfgang "Wolfgang") standing on some placed Guano Turf.

Guano Map.jpg (22 KB)

Guano Turf as seen on the [Map](/wiki/Map "Map").
...
| **Cave Turf** | [Mud Turf](/wiki/Mud_Turf "Mud Turf") • **Guano Turf** • [Slimy Turf](/wiki/Slimy_Turf "Slimy Turf") • [Fungal Turf](/wiki/Fungal_Turf "Fungal Turf") • [Cave Rock Turf](/wiki/Cave_Rock_Turf "Cave Rock Turf") |
