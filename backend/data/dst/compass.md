...
source_url: https://dontstarve.fandom.com/wiki/Compass
---
...
| --- |
| Gold Nugget**×1** Papyrus**×1 Gold Nugget×1 Flint×1 Don't Starve Together** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| **Survival Tab** | Tools Filter | Science Machine  Always available Don't Starve Together |

## Properties

### [Durability](/wiki/Durability "Durability")

2.5 days Don't Starve Together
...
|  |
| --- |
| Shows the direction the map is rotated. Shows the location of other players carrying a compass.Don't Starve Together |
...
**“**Is all directions, but no directions.**”**
...
**“**If only it could tell me which way is past and which way is future.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Compass** is an [item](/wiki/Item "Item") found in the [Survival](/wiki/Survival "Survival") [crafting tab](/wiki/Crafting "Crafting"), and requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype, and 1 [Gold Nugget](/wiki/Gold_Nugget "Gold Nugget") and 1 [Papyrus](/wiki/Papyrus "Papyrus") to craft.

Its function is to tell the orientation of the player when the player is not using minimap. When examined, the player will state what direction they're facing (the camera is rotated with the E and Q buttons). The player will start out oriented Northeast.

This item is useless to [Wes](/wiki/Wes "Wes") and [Wilbur](/wiki/Wilbur "Wilbur"), since they cannot talk and thus cannot interact with the item.

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the Compass is equipped in the hand slot and has a durability of 2.5 days. It is crafted using [Flint](/wiki/Flint "Flint") instead of [Papyrus](/wiki/Papyrus "Papyrus"), and does not require a Science Machine to prototype. Additionally, a small compass icon opens up above the hand slot showing the player the direction they are facing. However, during [Full Moons](/wiki/Moon_Cycle "Moon Cycle"), the handle will spin instead of showing a consistent direction. When the player's sanity is below 33%, the compass will begin to turn in a direction by an exponential amount of degrees that relates to the player's [sanity](/wiki/Sanity "Sanity"). Between 33% and 20%, the compass will spin a set 90 degrees (the compass will turn from west to east, and then from east to west if the player is facing north).

Equipping a Compass will also reveal the location of other players that have a Compass equipped, even in unexplored areas. This can be very helpful, especially when playing in [Wilderness Mode](/wiki/Don%27t_Starve_Together "Don't Starve Together"). The compass is also used to craft the [Ocuvigil](/wiki/Ocuvigil "Ocuvigil") and the [Cartographer's Desk](/wiki/Cartographer%27s_Desk "Cartographer's Desk").
...
* The Compass was introduced in the *[It's not a rock!](/wiki/Version_History#It's_not_a_rock! "Version History")* update.
* The Golden Compass may be a reference to the American edition of the first book of the famous *[His Dark Materials](https://en.wikipedia.org/wiki/His_Dark_Materials "wikipedia:His Dark Materials")* trilogy, by Philip Pullman, later made into a movie.
* Even though Winona says she's "Good with directions.", all her directional quotes are actually backwards (i.e. North is South, East is West, and vice-versa), so one should take that into account when using a compass while playing as Winona.

## Blueprint Gallery[]

Wilson with Compass DST.png (122 KB)

Wilson with a compass equipped in *Don't Starve Together*.

Compass Icon.png (78 KB)

The compass icon that appears when equipped in *Don't Starve Together*.

Starting orientation.png (1.27 MB)

Wilson in starting position, showing screen orientation as northeast.

A New Reign Updateposter1.png (2.44 MB)

Compass as seen in the poster for the *[East or West, Base is Best](/wiki/A_New_Reign#August_11,_2016_-_East_or_West,_Base_is_Best "A New Reign")* update.
