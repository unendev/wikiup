...
source_url: https://dontstarve.fandom.com/wiki/Telelocator_Focus
---
...
| --- |
| Nightmare Fuel**×4** Living Log**×4** Gold Nugget**×8** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| Magic Tab | Shadow Magic Filter Structures Filter | Shadow Manipulator |

Perk

|  |
| --- |
| Used to control the randomness of the [Telelocator Staff](/wiki/Telelocator_Staff "Telelocator Staff"). |
...
–[Wilson](/wiki/Wilson "Wilson"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I wonder how they hover?**”**

–[Willow](/wiki/Willow "Willow"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Pretty rock now hovers.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**The gem has focused it.**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**POWER == ON**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**What a strange effect.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Looks ready.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This one's ready.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Contains a precisely placed gem of a particular pigment.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Shöwtime!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Looks good.**”**

–[Webber](/wiki/Webber "Webber"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I think it wants me to jam rocks in it.**”**

–[Walani](/wiki/Walani "Walani"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Gem it!**”**

–[Warly](/wiki/Warly "Warly"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'Tis full o'treasure.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**IT WORKETH!**”**

–[Wilba](/wiki/Wilba "Wilba"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Ready**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Helps with keeping focus.**”**

–[Wheeler](/wiki/Wheeler "Wheeler"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Ready for a test run!**”**

–[Winona](/wiki/Winona "Winona"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Magic always does provide!**”**

–[Wortox](/wiki/Wortox "Wortox"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Rock got all floaty.**”**

–[Wurt](/wiki/Wurt "Wurt"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Ready to go.**”**

–[Walter](/wiki/Walter "Walter"), when examining a Gem Stand.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This thing sure takes up a lot of space.**”**

–[Wanda](/wiki/Wanda "Wanda"), when examining a Gem Stand.

The **Telelocator Focus** is a craftable [Structure](/wiki/Structure "Structure") found in the [Magic Tab](/wiki/Magic_Tab "Magic Tab") and used to control the randomness of the [Telelocator Staff](/wiki/Telelocator_Staff "Telelocator Staff"). It requires a [Shadow Manipulator](/wiki/Shadow_Manipulator "Shadow Manipulator") to prototype, and costs 4 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"), 4 [Living Logs](/wiki/Living_Log "Living Log"), and 8 [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget") to craft.

The Telelocator Focus has three Gem Stands for the placement of three [Purple Gems](/wiki/Purple_Gem "Purple Gem") in order to activate it. When the Telelocator Staff is used on the player or mob, they will immediately be transported to the center of the nearest activated Telelocator Focus. The three Purple Gems will be consumed and must be replaced before the Telelocator Focus can be used again. The Gems can also be removed from the stands to deactivate the Telelocator Focus.

## Prototype Tips[]

* Enemies that are transported can be set on fire from the lightning strike and will quickly spread the fire anywhere they go. Creating walls around the Telelocator Focus will prevent this from happening, but placing a [Lightning Rod](/wiki/Lightning_Rod "Lightning Rod") near the Telelocator Focus will make this a non-issue altogether.
* A good location to place the Telelocator Focus is in the middle of a [Tooth Trap](/wiki/Tooth_Trap "Tooth Trap") field.
...
* In the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC, a Telelocator Staff and Telelocator Focus are useful for gathering the [Iron Hulk's](/wiki/Iron_Hulk "Iron Hulk") parts in one place, at the cost of gems and living logs. Putting them on the [fourth island](/wiki/Pinacle "Pinacle") ensures that the parts will always respawn close together when the Hulk is killed.

## Placeholder Trivia[]

* The Telelocator Focus was officially introduced in the *[Hungry for your Hunger](/wiki/Version_History#July_23.2C_2013_-_Hungry_For_Your_Hunger "Version History")* update. It was previously implemented into the game without the sockets and with unlimited uses.
* The Telelocator Focus used to be a [Gemology Tab](/wiki/Removed_Features#Gemology_Tab "Removed Features") item.

## Blueprint Gallery[]

Telelocator Focus ready.png (264 KB)

An activated Telelocator Focus.

Give Prompt.png (642 KB)

The "Give" prompt that appears when placing a Purple Gem in one of the stands.

Teleangle.png (53 KB)

A Telelocator Focus spawned before it was officially introduced, with no Gem Stands and unlimited use.

Telebase.png (25 KB)

The Telelocator Focal Point on the ground.
