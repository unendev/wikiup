...
source_url: https://dontstarve.fandom.com/wiki/Night_Light
---
...
| --- |
| Gold Nugget**×8** Nightmare Fuel**×2** Red Gem**×1** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| Magic Tab | Light Sources Filter Shadow Magic Filter Structures Filter | Prestihatitator |
...
**“**Amazing. It emits a psychic attack along with light energy!**”**
...
**“**Don't provide much comfort, do it?**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA LIKETH SHINY THING**”**
...
**“**It's like a garden light fueled by evil.**”**
...
The **Night Light** is a [Magic](/wiki/Magic "Magic") [Structure](/wiki/Structure "Structure") in *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")*. It requires a [Prestihatitator](/wiki/Prestihatitator "Prestihatitator") to prototype and costs 8 [Gold Nuggets](/wiki/Gold_Nuggets "Gold Nuggets"), 2 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"), and 1 [Red Gem](/wiki/Red_Gem "Red Gem") to craft.

The Night Light provides light, similar to a [Campfire](/wiki/Campfire "Campfire"), and can only be fueled using Nightmare Fuel. One Nightmare Fuel provides light for 175 seconds, and reaches maximum output with 3 Nightmare Fuel. It does not provide warmth, so it will not prevent [Freezing](/wiki/Freezing "Freezing"). Once placed, the Night Light cannot be moved (only destroyed/deconstructed).

Standing next to an active Night Light lowers the player's [Sanity](/wiki/Sanity "Sanity") by 3 per minute (except for [Willow](/wiki/Willow "Willow"), who gains up to +7/min). Being near the Night Light at dusk or night increases the total Sanity drain to 8 points per minute. The Sanity drain can be avoided by standing some distance away.

Night Lights can be a useful light source in [Caves](/wiki/Caves "Caves") and [Ruins](/wiki/Ruins "Ruins"), where there is an abundance of Nightmare Fuel, but has no use on the surface where nightmare fuel is not as plentiful and materials to fuel other fires are.

## Downloadable Content[]

In all [DLC](/wiki/DLC "DLC")s as well as *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, when a Night Light begins to smolder, it will not burst into flames, but instead, lights up as if it were fueled. Also, Night Lights can be extinguished by an [Ice Flingomatic](/wiki/Ice_Flingomatic "Ice Flingomatic"), [Luxury Fan](/wiki/Luxury_Fan "Luxury Fan"), or [Ice](/wiki/Ice "Ice"). Also it does not provide warmth to cause [Overheating](/wiki/Overheating "Overheating") during [Summer](/wiki/Summer "Summer") or [Dry Season](/wiki/Dry_Season "Dry Season").

### Don't Starve Together Don't Starve Together[]

In *Don't Starve Together*, Winona with the [Shadow Seeker II](/wiki/Shadow_Seeker_II "Shadow Seeker II") skill will be revived at a Night Light when she has a [Fragile Rose](/wiki/Fragile_Rose "Fragile Rose") in her iventory.

## Placeholder Trivia[]

* The Night Light was added in the *[Insanity!](/wiki/Version_History#Insanity! "Version History")* update.
* The Night Light's ghastly flames can still be affected by [Night Hands](/wiki/Night_Hand "Night Hand").
* The gem on the Night Light has five corners. However, the red gem only has four.
* The Night Light used to share its model with [Maxwell's Light](/wiki/Maxwell%27s_Light "Maxwell's Light") in the older versions of *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")*.
* In older versions, the [Fire Staff](/wiki/Fire_Staff "Fire Staff") could be used as a way to fuel Night Lights. One fire staff's shot fueled it for 175 seconds, the same as 1 Nightmare Fuel.

## Blueprint Gallery[]

NightLight Night2.png (588 KB)

Two Night Lights illuminating a base entrance.

Night light.png (1.23 MB)

The Night Light's progress without fuel.

Insanity!.jpg (153 KB)

Night Light as seen in the poster for the *[Insanity!](/wiki/Don%27t_Starve/Version_History#February_12,_2013_–_Insanity! "Don't Starve/Version History")* update.

## Gramophone Sounds[]

<https://dontstarve.fandom.com/wiki/File:Night_Light_crackle.ogg>
The steady crackle of the Night Light.
