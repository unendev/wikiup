...
source_url: https://dontstarve.fandom.com/wiki/Beeswax
---
...
| --- | --- | --- |
| **Refine Tab** | Refined Materials Filter | Science Machine Don't Starve  Alchemy Engine Don't Starve Together |
...
**Beeswax** is a [Refined](/wiki/Refine "Refine") [item](/wiki/Item "Item"). It requires 1 [Honeycomb](/wiki/Honeycomb "Honeycomb") to craft, and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype (an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*).

If left on the ground near [fire](/wiki/Fire "Fire") or a fire-spreading heat source like a [Camp Fire](/wiki/Camp_Fire "Camp Fire") or a [Dwarf Star](/wiki/Dwarf_Star "Dwarf Star"), instead of smoldering the Beeswax will melt and vanish, and cannot be retrieved.

## Contents

* [1 Usage](#Usage)
  + [1.1 Don't Starve](#Don't_Starve)
  + [1.2 Don't Starve Together](#Don't_Starve_Together)
...
Beeswax can be used to craft [Wax Paper](/wiki/Wax_Paper "Wax Paper"), which can then be used in other recipes.

### Don't Starve Don't Starve[]

In *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")*, only a limited number of Beeswax can be crafted as Honeycomb is not renewable.

### Don't Starve Together Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Beeswax is a renewable item as Honeycombs are renewable from the [Gigantic Beehive](/wiki/Gigantic_Beehive "Gigantic Beehive"). It can be used to preserve [Giant Vegetables](/wiki/Giant_Vegetables "Giant Vegetables") as decorative items or to craft the [Embalming Spritz](/wiki/Embalming_Spritz "Embalming Spritz") and [Battle Call Canister](/wiki/Battle_Call_Canister "Battle Call Canister").
...
* Beeswax was first introduced to *Don't Starve Together* in the *[Herd Mentality](/wiki/A_New_Reign#November_24th,_2016_-_Herd_Mentality "A New Reign")* update during *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It was later added to *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")* in the *[Quality of Life](/wiki/Don%27t_Starve/Version_History "Don't Starve/Version History")* update.
  + The prototyping was moved to the Alchemy Engine in the [March 2022 QoL update](/wiki/Don%27t_Starve_Together/Version_History#March_24,_2022_-_March_2022_QoL_Update "Don't Starve Together/Version History").
...
Beeswax Melting.gif (349 KB)

The melting animation for Beeswax.
