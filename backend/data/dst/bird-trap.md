...
source_url: https://dontstarve.fandom.com/wiki/Bird_Trap
---
...
| --- | --- | --- |
| **Survival Tab** | Tools Filter Food & Gardening Filter | Science Machine |
...
|  |
| --- |
| Captures [Birds](/wiki/Birds "Birds"). Can be baited. |
...
The Boar's Tusk Weapon Shop (Oinc ×20) Hamlet icon
...
**“**An state-of-the-art snare for those elusive birds.**”**
...
**“**I can catch myself a birdy buddy with this.**”**
...
**“**Once ye fly in, ye don't fly oot.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA CAN'ST ENTRAPETH BIRDIES**”**
...
**“**It keeps the little birdies grounded.**”**
...
**“**The birds will find this so funny!**”**
...
**“**A bird trap! Classic survival stuff!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Thankfully, birds are stupid.**”**

–[Wanda](/wiki/Wanda "Wanda")

A **Bird Trap** is a [Survival](/wiki/Survival "Survival") [Item](/wiki/Item "Item") used to catch [Birds](/wiki/Birds "Birds"). It is crafted using 3 [Twigs](/wiki/Twig "Twig") and 4 [Silk](/wiki/Silk "Silk") and requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. Bird Traps can be baited with [Seeds](/wiki/Seeds "Seeds") to significantly increase the chance of catching a Bird, though it is not a requirement. Using a [Feather Hat](/wiki/Feather_Hat "Feather Hat") will increase the number of birds landing to speed up the process. A Bird Trap is required in order to put a bird into the player's inventory so that it can be imprisoned in a [Bird Cage](/wiki/Bird_Cage "Bird Cage").
...
* Following the *[Naughty and Nice](/wiki/Version_History#Naughty_and_Nice "Version History")* update, [Feathers](/wiki/Feather "Feather") and [Morsels](/wiki/Morsel "Morsel") can no longer be acquired directly using the Trap. Instead, murdering the Bird while it's in the [Inventory](/wiki/Inventory "Inventory") is now necessary.
* In the old science system, the Bird Trap used to cost 30 [Research Points](/wiki/Research_points_list "Research points list") to craft.
...
* In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, putting a Seed retrieved from the Ocean inside the Bird Trap may make it look like it's still in the Ocean. Picking up the Bird Trap may cause the Seed to disappear.

## Blueprint Gallery[]

WilsonBirdTrap.jpg (6 KB)

A placed Bird Trap.

Bird Cage on Map.png (50 KB)

Bird Trap icon on the [Map](/wiki/Map "Map").

Bird Trap Phrases.Png (61 KB)
