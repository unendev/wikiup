...
source_url: https://dontstarve.fandom.com/wiki/Driftwood
---
...
Driftwood Piece×2 Twigs×1 (small)  
Driftwood Piece×4 Twigs×2 (tall)
...
**“**An old, dead tree, beached and bleached.**”**
...
**“**Looks kind of eerie, doesn't it?**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**That tree is long dead.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Driftwood** are naturally spawning objects exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. They are found in the [Rocky Beach](/wiki/Rocky_Beach "Rocky Beach") [Biome](/wiki/Biomes "Biomes") on the [Lunar Island](/wiki/Lunar_Island "Lunar Island") admidst the [Ocean](/wiki/Ocean "Ocean").

Driftwood can be chopped down with an [Axe](/wiki/Axe "Axe"), and is a source of [Driftwood Pieces](/wiki/Driftwood_Piece "Driftwood Piece") and [Twigs](/wiki/Twigs "Twigs"). If the taller version is felled, it leaves behind a stump, which can be dug up with a [Shovel](/wiki/Shovel "Shovel") for an extra Driftwood Piece.

## Trivia[]

* Driftwood was introduced in the *[Turn of Tides](/wiki/Return_of_Them#Turn_of_Tides "Return of Them")* update.
* There is an unused normal version of driftwood in the Don't Starve New Home files

## Gallery[]

Driftwood 1 burnt.png (15 KB)

Burnt Driftwood.

Driftwood 2 burnt.png (21 KB)

Burnt Driftwood.

Driftwood 3 burnt.png (39 KB)

Burnt Driftwood.

Driftwood 3 Stump.png (49 KB)

The stump of the Driftwood tree.
