...
source_url: https://dontstarve.fandom.com/wiki/Vitreoasis
---
...
The **Vitreoasis** is a naturally spawning object exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It is common (and exclusively found) in [Lunar Grotto](/wiki/Lunar_Grotto "Lunar Grotto") biome.

The pool contains 3 [Moon Glass](/wiki/Moon_Glass "Moon Glass") structures, and each one can be mined for 2 [Moon Shards](/wiki/Moon_Shard "Moon Shard"), with a 50% chance of getting an extra one.

At each [Full Moon](/wiki/Full_Moon "Full Moon"), each mined Moon Glass have a 10% chance to reappear.
...
The **Small Vitreoasis** is a naturally spawning object exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It is common (and exclusively found) in [Lunar Grotto](/wiki/Lunar_Grotto "Lunar Grotto") biome.

It is a smaller version of the Vitreoasis, only containing 1 Moon Glass structure.

## PlaceholderTrivia[]

* The Vitreoasis and Small Vitreoasis were introduced in the *[Forgotten Knowledge](/wiki/Return_of_Them#Forgotten_Knowledge "Return of Them")* update.
* Appears to be portmanteau of words "vitreous" and "oasis".
...
A view of them zoomed out in-game.
