...
source_url: https://dontstarve.fandom.com/wiki/Spiky_Tree
---
...
**“**What a gnarled old tree.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Spiky Trees** are found only in the [Marsh](/wiki/Marsh "Marsh"). Instead of dropping [Logs](/wiki/Logs "Logs") when chopped like other trees, Spiky Trees drop [Twigs](/wiki/Twigs "Twigs") with only a 20% chance to drop a Log. Also, these trees do not have a life-cycle (changing size over time). There is also no way to replant them. Like other trees, the stumps of the Spiky variety can be dug up with a Shovel or Regal Shovel to get an additional log.

## Reign of Giants icon Reign of Giants[]

In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, Spiky Trees can also be found in the [Desert](/wiki/Desert "Desert") [biome](/wiki/Biome "Biome").

## Mosquito Bugs[]

* When chopping down a burning tree (not one that has already burnt) with an Axe of any kind or as a [Werebeaver](/wiki/Woodie "Woodie"), the game will sometimes crash, but when it doesn't, the tree will drop as many Logs and Pine Cones as listed above using only 1% of the Axe, as if it was a burnt tree. This bug was fixed in the RoG DLC.
...
Spiky Tree Stump.png (60 KB)

A Spiky Tree stump.

Burnt Spiky Tree.png (27 KB)

A burnt Spiky Tree.

Spiky trees.jpg (84 KB)

Two differently colored Spiky Trees.
