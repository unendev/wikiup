...
source_url: https://dontstarve.fandom.com/wiki/Arboretum_Experiment
---
...
| --- |
| Batilisk Wing**×1** Living Log**×1** Sanity Decrease**×20** |
...
|  |
| --- |
| Can be planted to grow into a [Totally Normal Tree](/wiki/Tree/Totally_Normal "Tree/Totally Normal"). |
...
**“**I hath birthed the röot öf terrör!**”**
...
**“**There's a tree inside just waiting to come out!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**The root inside is particularly lively.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Arboretum Experiment** is a feature exclusive to the [Hallowed Nights](/wiki/Hallowed_Nights "Hallowed Nights") [event](/wiki/Category:Events "Category:Events") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It can be conducted at the [Mad Scientist Lab](/wiki/Hallowed_Nights#Mad_Scientist_Lab "Hallowed Nights"), using a [Batilisk Wing](/wiki/Batilisk_Wing "Batilisk Wing") and a [Living Log](/wiki/Living_Log "Living Log"), and depleting 20 Sanity for the player.

The experiment will result in a **Totally Normal Root** that can be planted to create a Totally Normal Sapling. This will grow into a [Totally Normal Tree](/wiki/Tree/Totally_Normal "Tree/Totally Normal") over time that can be decorated using [Halloween Decorations](https://dontstarve.fandom.com/wiki/Hallowed_Nights#Halloween_Decorations). The Totally Normal Root can also be used as [Fire](/wiki/Fire "Fire") [Fuel](/wiki/Fuel "Fuel").
...
All Hallowed Nights potions on the ground.

Totally Normal Root planted.png (26 KB)

A planted Totally Normal Root.

Totally Normal Sapling.png (34 KB)

A Totally Normal Sapling.
