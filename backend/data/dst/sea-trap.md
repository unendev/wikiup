...
source_url: https://dontstarve.fandom.com/wiki/Sea_Trap
---
...
"It's a trap for sea creatures."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Palm Leaf**×4** Empty Bottle**×2** Jellyfish**×1** |
...
|  |
| --- |
| Catches [Wobsters](/wiki/Wobsters "Wobsters"). Can be baited. |
...
Yaarctopus (exchanged for Jelly-O Pop)
...
**“**Little pincher does not stand a chance.**”**
...
**“**I do hope this yields a lobster dinner.**”**
...
**“**Wobster goes in. Dinner comes out.**”**
...
**“**Tis' a pirate's lunch fer me!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**FOR TRAPPING YON PINCHY MEATS**”**
...
**“**It looks that way so the crustaceans won't recognize that I'm desperate.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Sea Trap** is a [Nautical Tab](/wiki/Nautical_Tab "Nautical Tab") [Item](/wiki/Item "Item") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It can only be used to catch [Wobsters](/wiki/Wobster "Wobster"), requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype, and 4 [Palm Leaves](/wiki/Palm_Leaf "Palm Leaf"), 2 [Empty Bottles](/wiki/Empty_Bottle "Empty Bottle"), and 1 Jellyfish to craft. It is also a reward from the [Yaarctopus](/wiki/Yaarctopus "Yaarctopus") in exchange for [Jelly-O Pop](/wiki/Jelly-O_Pop "Jelly-O Pop"). Sea Traps act similar to regular [Traps](/wiki/Trap "Trap").

## Icon Tools Usage[]

Sea Traps are set by placing them in the [Ocean](/wiki/Ocean#Shipwrecked "Ocean"), and can be picked up again at any time. They will move a bit of distance before settling completely when deployed.

Once set, Sea Traps can be baited with [Food](/wiki/Food "Food"), which is attractive to Wobsters. Bait will be consumed upon a successful catch, but will be given back if the player picks up the Sea Trap with the bait still in it. Once a Sea Trap has caught a Wobster, it will drop its hook with a cage, with the Wobster in the cage.

Sea Traps do not need bait in order to catch Wobsters; if a Wobster touches the Sea Trap for any reason, it will possibly catch it. This means if a Sea Trap is placed directly on top of a [Wobster Den](/wiki/Wobster_Den "Wobster Den"), it will catch the Wobster when it leaves home or comes back.

When a Sea Trap is picked up from the ocean and is still yet to catch a Wobster, no durability is lost, allowing it to be moved around freely. When a Sea Trap is picked up after catching a Wobster (or failing), it will lose durability.
...
* Besides Limpets, the Sea Trap can be baited with [Eggs](/wiki/Eggs "Eggs"), any meats including [Monster Meat](/wiki/Monster_Meat "Monster Meat"), [Roe](/wiki/Roe "Roe"), [Mussels](/wiki/Mussel "Mussel"), and any fish but [Jellyfish](/wiki/Jellyfish "Jellyfish").

## Blueprint Gallery[]

Sea Trap at sea.png (341 KB)
