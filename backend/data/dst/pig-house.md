...
source_url: https://dontstarve.fandom.com/wiki/Pig_House
---
...
**“**TOWN DOTH DIFFERENT FROM WILBA HOMESTEAD**”**
...
**Pig Houses** are natural and craftable [Structures](/wiki/Structure "Structure") where [Pigs](/wiki/Pig "Pig") spawn and live. A Pig is spawned once a Pig House is constructed and respawns after 4 [Days](/wiki/Day "Day") if killed. Pig Houses are naturally occurring in [Pig Villages](/wiki/Pig_Village "Pig Village"), with the possibility of the village containing the [Pig King](/wiki/Pig_King "Pig King"). Occasionally, an individual Pig House can be found in the wilderness.

A Pig House requires 4 [Boards](/wiki/Boards "Boards"), 3 [Cut Stones](/wiki/Cut_Stone "Cut Stone"), and 4 [Pig Skins](/wiki/Pig_Skin "Pig Skin") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

One pig will come out of each house at dawn, and return at [Dusk](/wiki/Dusk "Dusk"). A dead pig takes 4 days to re-spawn from its house. A pig will not return to its house while fighting or befriended by a player, or when the area is unloaded (when the player is too far away). On a [Full Moon](/wiki/Moon_Cycle "Moon Cycle"), any outdoor pigs turn into Werepigs. The next morning, they can be found sleeping late outside their houses, or wherever they ended up at dawn.

At [Dusk](/wiki/Dusk "Dusk") and [Night](/wiki/Night "Night") (surface or caves), a Pig House with a Pig in in will turn its [Light](/wiki/Light "Light") on. The light would be bright enough to ward off [Charlie](/wiki/Charlie "Charlie"), but players cannot use it. If the player approaches the house, the pig turns the light off, as though it doesn't want visitors and is pretending that no-one is home. The Pig will relight the light only when the player moves away.

A pig house can be set on [Fire](/wiki/Fire "Fire") to force the pig outside at night.

If a pig house is built in the [Caves](/wiki/Caves "Caves") the pig still leaves in the morning and returns in the evening. If the House is under a [Cave Light](/wiki/Cave_Light "Cave Light"), the Pig will behave normally while out. If located in complete [Darkness](/wiki/Darkness "Darkness"), the Pig will panic and run to the closest [Cave Light](/wiki/Cave_Light "Cave Light"), [Campfire](/wiki/Campfire "Campfire"), or other [Light](/wiki/Light "Light") source. There's never a full moon in the [Caves](/wiki/Caves "Caves") to turn them into Werepigs, but they will still transform if fed 4 [Monster Meat](/wiki/Monster_Meat "Monster Meat").

Pig Houses are the only source of Pigs, which in turn are the only renewable source of [Pig Skin](/wiki/Pig_Skin "Pig Skin"), a necessary ingredient for critical early-game items like [Football Helmets](/wiki/Football_Helmet "Football Helmet"), [Ham Bats](/wiki/Ham_Bat "Ham Bat"), and [Saddles](/wiki/Saddle "Saddle"). If every pig house is destroyed and all the pig skin used up, there is no way to get more pigs or more skin. If a single pig skin is left, it can be doubled by using a [Construction Amulet](/wiki/Construction_Amulet "Construction Amulet") to make a [One-man Band](/wiki/One-man_Band "One-man Band"), then a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff") to return 2 pig skin. This can be done 3 times, to yield 4 skin to make a Pig House. The new pig can be fed 4 monster meat and killed to yield a skin. The pig will re-spawn every 4 days and can be killed again for another skin. Additional pig houses can eventually be built and the pig (skin) supply restored.

## Uses[]

Clumps of pig houses make it easy to find many pigs in one place so that they can be befriended (by giving each pig a [Meat Item](/wiki/Meats "Meats")) to chop wood for the player or to fight or distract a mob or boss for the player. If [Monster Meat](/wiki/Monster_Meat "Monster Meat") is used, after a day of work (or even right away), each pig can be fed 3 more monster meat to turn it into a Werepig, which will drop 2 [Meat](/wiki/Meat "Meat") and 1 [Pig Skin](/wiki/Pig_Skin "Pig Skin") when killed.

Solo speed-runners commonly hammer Pig Houses for resources in the early game. Once the player has a [Science Machine](/wiki/Science_Machine "Science Machine") and 4 [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget"), hammering 2 houses is a quick way to get 4 boards and 4 stone for an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine"), plus a pig skin for a [Football Helmet](/wiki/Football_Helmet "Football Helmet"). A now-homeless pig be fed 4 monster meat and killed to make a [Ham Bat](/wiki/Ham_Bat "Ham Bat"). Hammering more houses can speed making a [Crock Pot](/wiki/Crock_Pot "Crock Pot"), [Prestihatitator](/wiki/Prestihatitator "Prestihatitator"), [Think Tank](/wiki/Think_Tank "Think Tank"), or to build half as many pig houses somewhere else on the map.
...
* Pigs eat [Food](/wiki/Food "Food") and other items on the ground, including [Glommer's Goop](/wiki/Glommer%27s_Goop "Glommer's Goop"), [Pig Skin](/wiki/Pig_Skin "Pig Skin"), [Seeds](/wiki/Seeds "Seeds"), seasonal goodies, and [Rot](/wiki/Rot "Rot").
* Pigs outside their Houses during a [Full Moon](/wiki/Moon_Cycle "Moon Cycle") turn into a Werepigs
* Eating [Monster Foods](/wiki/Monster_Foods "Monster Foods") accidentally left on the ground could turn a pig into a [Werepig](/wiki/Werepig "Werepig").

An "incredible inedible" is a good way to keep pigs out at night for farming pig skin on a full moon. Build a small enclosure with walls and maybe a gate and place bait on the ground inside it. Good bait for pigs includes [Rot](/wiki/Rot "Rot"), [Powdercake](/wiki/Powdercake "Powdercake") or [Pig Skin](/wiki/Pig_Skin "Pig Skin"). Place pig houses around this enclosure. Once a pig detects the "food", it will walk towards it forever. If a wall is in the way, the pig continues walking in place and does not return to its house again until killed. When a pig re-spawns, it leaves its house in a random direction and may have trouble finding the bait until it wanders around for a little while, possibly getting into trouble unless an outer wall or land-edge constrains it. Pigs will hop onto boats.

Pig House - [Spider Den](/wiki/Spider_Den "Spider Den") farms are discussed on the Spider Den page.

## Trivia[]

* According to [WX-78](/wiki/WX-78 "WX-78"), Pigs decorate the insides of their homes with pig-shaped furniture.
* Characters have different [examination quotes](/wiki/Character_quotes "Character quotes") for an occupied Pig House at dusk and night.
...
* Warly's quote on the Pig House is a clear reference to *[The Three Little Pigs](https://en.wikipedia.org/wiki/The_Three_Little_Pigs)*.
* In the animated short ["Swine and Dine"](https://youtu.be/_AV3o_03ANo?si=t4zVn1aoKReDYsP7) it is confirmed that the houses are bigger on the inside, containing multiple rooms.

## Bugs[]

 https://static.wikia.nocookie.net/dont-starve-game/images/5/58/Pig Ocean Bug.png/revision/latest?cb=20121220132609 https://static.wikia.nocookie.net/dont-starve-game/images/5/58/Pig Ocean Bug.png/revision/latest?cb=20121220132609 
...
* If a Pig House is placed along a shore, there is a chance the Pig will spawn in the [Ocean](/wiki/Ocean "Ocean") rather than on land, preventing it from getting back on the island. Theoretically, if trapped Pigs become Werepigs, they will also be trapped in the ocean.
* After leaving a [Cave](/wiki/Cave "Cave"), it's possible for the light to be left on during the day.
...
Pig House light.png (57 KB)

Pig House with lights on.

Pig house.gif (29 KB)

Pig House during [winter](/wiki/Winter "Winter").

Bonfire.png (50 KB)

Pigs would spawn from Bonfires in the game's alpha test.

Burned pig house.png (115 KB)

A burnt-down Pig House in the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC.

Pig House Bug.png (1,020 KB)

A Pig inside his house during the day. Notice Wilson's quote.

Pig House Unbuilt.png (668 KB)

An Unused texture for an Unbuilt Pig House.

House Rubble.png (21 KB)

A texture for the Rubble of a Pig House, used in *[The Gorge](/wiki/The_Gorge "The Gorge")* event.

Worn Pig House.png (54 KB)

A Worn Pig House used in *The Gorge* event.

Unused side model Pig House.png (61 KB)

Unused side model of pig house from Don't Starve Beta files

Official game screenshots from early builds of the game Pig house.jpg (455 KB)
