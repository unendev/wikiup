...
source_url: https://dontstarve.fandom.com/wiki/Mini_Glacier
---
...
**“**Unusual how these ice formations appear in vast numbers.**”**
...
**“**At least someone around here knows how to chill!**”**
...
**“**Better here than 'neath me boat tearin' at her hull.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS MOUND OF FRIGID ICE.**”**
...
**“**Reminds me of my days exploring the Arctic.**”**
...
**“**Brrr, that cold on scales!**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This will really give you the chills.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A frozen chunk of future water.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Mini Glaciers** are naturally occurring objects found in the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC. When mined, they will drop [Ice](/wiki/Ice "Ice") and [Rocks](/wiki/Rocks "Rocks"). Mini Glaciers are only at their fullest during the [Winter](/wiki/Winter "Winter") and will begin to melt in the [Spring](/wiki/Spring "Spring"). By [Summer](/wiki/Summer "Summer"), all that will be left is a puddle of water, and the player will have to wait until [Autumn](/wiki/Autumn "Autumn") for them to slowly begin to freeze again. If exposed to a heat source (such as a [Campfire](/wiki/Campfire "Campfire")) Mini glaciers will melt, reducing down to the puddle state. Once the heat source is gone, and if the ambient temperature is low enough, the Mini Glacier will freeze again. It will return to the maximum state allowed by the current temperature. When mined, Mini Glaciers make a different sound from boulders.

Additionally, Mini Glaciers will appear next to [Pengull](/wiki/Pengull "Pengull") breeding grounds during [Winter](/wiki/Winter "Winter"), making them a renewable resource.
...
Mini Glacier can be found in rocky biomes. These Mini Glaciers replenish at the same spot after summer. Mini Glacier can also be spawned by [Pengulls](/wiki/Pengull "Pengull"). These Mini Glaciers disappear permanently in summer.
...
Examine mini glacier.jpg (82 KB)

A Mini Glacier half way through its growing stage.

Mini Glaciers.png (79 KB)

Two large Mini Glaciers just starting to melt.

Melted Mini Glacier.png (73 KB)

A Melted Mini Glacier.

Glacier-icons.png (90 KB)

Mini Glaciers in a Rockyland biome.

Mini glaciers map.jpg (92 KB)

Mini Glaciers spawn around Pengull grounds in winter.

Fireflies inside a Mini Glacier.png (31 KB)

[Fireflies](/wiki/Fireflies "Fireflies") inside a Mini Glacier.

Ice glitch.png (2.31 MB)

A glitch that occurs when pengulls base too close to the ocean.
