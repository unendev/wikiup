...
source_url: https://dontstarve.fandom.com/wiki/Deer_Antler
---

*Exclusive to:* Don't Starve Together

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 See also: [Stag Antler](/wiki/Stag_Antler "Stag Antler")*
...
|  |
| --- |
| Summon Klaus when used on Loot Stash. |
...
**“**This looks like a key piece to a puzzle...**”**

–[Wanda](/wiki/Wanda "Wanda")

A **Deer Antler** is an [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It is dropped by the antler-type [No-Eyed Deer](/wiki/No-Eyed_Deer "No-Eyed Deer") after charging at objects such as [Trees](/wiki/Tree "Tree"). Trying to use a Deer Antler to unlock the [Loot Stash](/wiki/Loot_Stash "Loot Stash") will destroy the antler, drop a [Bone Shard](/wiki/Bone_Shards "Bone Shards") and cause [Klaus](/wiki/Klaus "Klaus") to spawn. There are three visual variants of the Deer Antler, that all function in the same way. The antler serves no other purpose than being used on the stash.

## Prototype Tips[]

* With a way to ward off Klaus that spawns after the shard is used on the Stash ([Telelocator Staff](/wiki/Telelocator_Staff "Telelocator Staff"), Using [Mobs](/wiki/Mobs "Mobs") as bait, etc.) the player can insert all of their easy-to-find antlers to turn into [Bone Shards](/wiki/Bone_Shards "Bone Shards"), as another Klaus will not spawn if the Antler has already been used on the sack.

## Placeholder Trivia[]

* Deer Antlers were introduced in the *[Winter's Feast](/wiki/A_New_Reign#December_8th,_2016_-_Winter's_Feast_Sneak_Preview "A New Reign")* update, alongside the [Event](/wiki/Winter%27s_Feast "Winter's Feast") of the same name.

## Blueprint Gallery[]

Deer Antler B.png (3 KB)

A visual variant of the Deer Antler.

Deer Antler C.png (4 KB)

A visual variant of the Deer Antler.

Deer Antler A.png (4 KB)
