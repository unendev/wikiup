...
source_url: https://dontstarve.fandom.com/wiki/Ham_Bat
---
...
| --- |
| Pig Skin**×1** Twigs**×2** Meat**×2** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| **Fight Tab** | Weapons Filter | Alchemy Engine |

Combat attributes

| [Damage](/wiki/Damage "Damage") |
| --- |
| Don't Starve:  59.5  44.6 WendyWes  ---  74.4 Wigfrid  ---  29.8Wolfgang/59.5Wolfgang/119 Wolfgang   ---   https://static.wikia.nocookie.net/dont-starve-game/images/f/f8/Reign of Giants icon.png/revision/latest?cb=20140408110712ShipwreckedHamletDon't Starve Together:  29.75  22.3 WendyWes  ---  37.2 Wigfrid  ---  14.9WolfgangDon't Starve/22.3WolfgangDon't Starve Together/29.75Wolfgang/59.5 Wolfgang  ---  14.9 Wanda (elderly) - 59.5  44.6 WendyWes  ---  74.4 Wigfrid  ---  29.8WolfgangDon't Starve/44.6WolfgangDon't Starve Together/59.5Wolfgang/119 Wolfgang  ---  29.8 Wanda (elderly) |
...
**“**Remarkably destructive yet still susceptible to food spoilage.**”**
...
**“**Made wit' metal from th'finest meat mines.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS WEAPON 'O PIG BUTT**”**
...
The **Ham Bat** is a [Melee Weapon](/wiki/Weapon "Weapon") that inflicts 59.5 points of damage. It has unlimited uses within a 10-day period, after which it [spoils](/wiki/Rot "Rot"). Despite being made from meat, it cannot be consumed by the player or other creatures in the game, and it won't provoke a hostile reaction from [Bunnymen](/wiki/Bunnyman "Bunnyman") when carried by the player.

The Ham Bat requires 1 [Pig Skin](/wiki/Pig_Skin "Pig Skin"), 2 [Twigs](/wiki/Twigs "Twigs"), and 2 [Meat](/wiki/Meat "Meat") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

## Gift Icon Downloadable Content[]

In DLCs and DST, the Ham Bat's damage will now decrease as the weapon spoils. The highest damage is 59.5 when fresh, and the damage decreases by about 0.37 per minute or 2.975 per day until it reaches its lowest damage of 29.75, just before turning into [Rot](/wiki/Rot "Rot"). It becomes weaker than a [Tentacle Spike](/wiki/Tentacle_Spike "Tentacle Spike") after 2.86 days, weaker than a [Battle Spear](/wiki/Battle_Spear "Battle Spear") after 5.71 days, and after 8.67 days it is about as powerful as a [Spear](/wiki/Spear "Spear").

The Ham Bat will last longer when put into an [Ice Box](/wiki/Ice_Box "Ice Box"), [Insulated Pack](/wiki/Insulated_Pack "Insulated Pack"), [Sea Sack](/wiki/Sea_Sack "Sea Sack"), [Chef Pouch](/wiki/Chef_Pouch "Chef Pouch") and [Snow Chester](/wiki/Snow_Chester "Snow Chester").

## Don't Starve Together Skins[]

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Ham\_Bat](/wiki/Belongings#Ham_Bat "Belongings")*
...
* Having four spare [Monster Meat](/wiki/Monster_Meat "Monster Meat"), feeding them to a [Pig](/wiki/Pig "Pig") (resulting in it turning into a [Werepig](/wiki/Werepig "Werepig")) and then slaying the Werepig can result in the player receiving all of the necessary ingredients needed for crafting, excluding the Twigs. One alternative is to feed meat to a single Pig and select a neutral Pig as an attack target; this will cause surrounding neutral Pigs to become aggressive towards the player's Pig follower and kill it, causing it to drop resources.
* The unlimited uses make it ideal for dealing damage to mobs and entities that don't fight back, like [Spider Dens](/wiki/Spider_Den "Spider Den") and [Snurtles](/wiki/Snurtle "Snurtle").
  + It is also an efficient weapon against [Bosses](/wiki/Category:Boss_Monsters "Category:Boss Monsters") due to their large Health pools.
* It's more effective to craft the Ham Bat in [Winter](/wiki/Winter "Winter") because during that season spoilage rate is reduced by 25%.
...
* Player can use a [Bundling Wrap](/wiki/Bundling_Wrap "Bundling Wrap") to contain and preserve large amounts of [Meat](/wiki/Meat "Meat") for indefinite time, allowing them to always have the possibility of crafting Ham Bats without the need of hunting for Meat beforehand

## Placeholder Trivia[]

* The Ham Bat was added in the *[A Little Rain Must Fall](/wiki/Version_History#A_Little_Rain_Must_Fall "Version History")* update.
* The Ham Bat makes an appearance as the [Ham Shank](http://wiki.teamfortress.com/wiki/Ham_Shank) in the popular online first-person shooter *Team Fortress 2* to promote *Don't Starve* shortly before its release (along with the Wilson weave). It was awarded in Genuine quality to those who pre-purchased *Don't Starve* before April 23, 2013.
* The Ham Bat was the second renewable melee-weapon in the game, after the [Dark Sword](/wiki/Dark_Sword "Dark Sword").
* Before the first ["Bugfix/Performance"](/wiki/New_Features#November_14.2C_2013_-_Bugfix_.2F_Performance_update "New Features") update, the Ham Bat used to be an edible [Monster Food](/wiki/Monster_Food "Monster Food") item and had 100 uses, in addition to spoiling over time.
* A Ham Bat can be used as a [Steam](https://en.wikipedia.org/wiki/Steam_(software) "wikipedia:Steam (software)") chat emoticon.
* On the *Reign Of Giants* promotion picture for Winter, Wilson is seen cooking a piece of meat that resembles the Ham Bat.

## Blueprint Gallery[]

Ham Bat Held.jpg (12 KB)

Wolfgang wielding the Ham Bat.

Toy Spider.png (1.14 MB)

A [Spider](/wiki/Spider "Spider") figurine by a Ham Bat.

Don't Starve Banner.png (213 KB)

Wilson's Weave along with the Ham Shank on the promotional banner for *Don't Starve*.

Snowgangmanyhambats.png (108 KB)

Wolfgang caroling with the default Ham Bat and the two Ham Bat skins.

Ham Bat in Terraria.png (910 bytes)

Ham Bat in Terraria

Klei Office Photo3.jpg (58 KB)

Big Ham Bat in Klei Office
