...
source_url: https://dontstarve.fandom.com/wiki/Lightning_Conductor
---
...
"An electrifying addition to your mast."
...
|  |
| --- |
| [Lightning](/wiki/Lightning "Lightning") protection when atop a [Mast](/wiki/Mast "Mast"). |
...
**“**I've harnessed the power of electricity over land and sea!**”**

–[Wilson](/wiki/Wilson "Wilson")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**That's where the lightning goes.**”**
...
**“**Alas, being struck down by lightning is one less thing I can look forward too.**”**
...
**“**A very sensible safety measure.**”**
...
**“**Yöu may dö yöur wörst, öh mighty Thör!**”**
...
**“**It will be sizzling with electricity in no time.**”**
...
**“**The static makes Woby's fur all poofy.**”**
...
The **Lightning Conductor** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It is found in the [Seafaring Filter](/wiki/Seafaring_Filter "Seafaring Filter") and requires 5 [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget") to craft, and a [Think Tank](/wiki/Think_Tank "Think Tank") to prototype.

The Lightning Conductor can be deployed on a [Mast](/wiki/Mast "Mast") or [Winged Sail](/wiki/Winged_Sail "Winged Sail"). The equipped mast acts as a [Lightning Rod](/wiki/Lightning_Rod "Lightning Rod"), diverting lightning with the same protection radius and emitting light when charged. It is mutually exclusive with (i.e. cannot be used at the same time as) a [Deck Illuminator](/wiki/Deck_Illuminator "Deck Illuminator").

## Don't Starve Together Skins[]

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Lightning\_Conductor](/wiki/Belongings#Lightning_Conductor "Belongings")*
...
* The Lightning Conductor was introduced in the *[Troubled Waters](/wiki/Return_of_Them#Troubled_Waters "Return of Them")* update.

## Blueprint Gallery[]

Lightning Conductor Build.png (67 KB)

Base and top of a built Lightning Conductor.
