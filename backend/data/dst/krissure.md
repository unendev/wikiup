...
source_url: https://dontstarve.fandom.com/wiki/Krissure
---
...
|  |
| --- |
| Produces [Light](/wiki/Light "Light") and [Heat](/wiki/Heat "Heat"). |
...
**“**Woodlegs must be standin' on a sea o'fire.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**YON GROUND IS'T FWOOSHY**”**
...
**Krissures** are objects found in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")*  DLC. After a player has dug up a [Magma Pile](/wiki/Magma_Pile "Magma Pile"), a Krissure may appear and erupt. Krissures will alternate between dormant and erupting states. It can be used as a [Light](/wiki/Light "Light") source, but it may burn if a player stands too close. Note that it's the initial burst of krissure that sets things on fire, not the lasting flame itself. The player can cook [Food](/wiki/Food "Food") over an erupting Krissure. [Flooded](/wiki/Flooding "Flooding") Krissures do not erupt. Krissures can be removed using [coconades](/wiki/Coconade "Coconade") explosion .

[Sprinkler](/wiki/Sprinkler "Sprinkler")s in the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC can be used to stop a Krissure from erupting, but caution should be taken when removing said sprinkler.

## Mosquito Bugs[]

* If the player dies near Krissures and uses a [Touchstone](/wiki/Touchstone "Touchstone"), [Life Giving Amulet](/wiki/Life_Giving_Amulet "Life Giving Amulet"), [Meat Effigy](/wiki/Meat_Effigy "Meat Effigy"), or another method of resurrection, the Krissure will sometimes get stuck in the erupting state, but no longer allow the player to cook [Food](/wiki/Food "Food"). This may also occur at the end of the Werebeaver transformation while playing as [Woodie](/wiki/Woodie "Woodie").
* While probably not meant to be in the game, [Willow](/wiki/Willow "Willow") does not get a [Sanity](/wiki/Sanity "Sanity") bonus while standing next to an erupting Krissure. She still retains fire immunity.

## Blueprint Gallery[]

KrissurePre.png (13 KB)

A Krissure before erupting.

KrissureBlow.png (55 KB)

A Krissure erupting.

Wilson next to krissure.PNG (182 KB)

[Wilson](/wiki/Wilson "Wilson") next to a Krissure.

Webber Fissure.png (947 KB)

[Webber](/wiki/Webber "Webber") between two Krissures. It is also obvious that they can be used as a light source in the picture.
