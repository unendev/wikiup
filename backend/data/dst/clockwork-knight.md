...
source_url: https://dontstarve.fandom.com/wiki/Clockwork_Knight
---

:   *For the [Ruins](/wiki/Ruins "Ruins") version, see [Damaged Knight](/wiki/Damaged_Knight "Damaged Knight").*
...
Marble Sculptures (Don't Starve Together)
...
–[Wilson](/wiki/Wilson "Wilson"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's a pony!**”**

–[Willow](/wiki/Willow "Willow"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Horsey horse!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A cold, soulless horse.**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**HORSE AUTOMATON**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**An automatic equine.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Maxwell's own mounted police.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Such quality workmanship!**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A triumphant piece of combat ready cogwork.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I sense battle!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Wow! That's complicated clockwork.**”**

–[Webber](/wiki/Webber "Webber"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**He looks like he could use a nap.**”**

–[Walani](/wiki/Walani "Walani"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A tricky cheval!**”**

–[Warly](/wiki/Warly "Warly"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Cavalry's'ere!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**THOU'RT A KNAVE!**”**

–[Wilba](/wiki/Wilba "Wilba"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Neigh machine**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**An accordion stomach. Bold choice. Not one I would've made.**”**

–[Wheeler](/wiki/Wheeler "Wheeler"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Incredible! Let me look at those gears!**”**

–[Winona](/wiki/Winona "Winona"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A knight in rusted armor!**”**

–[Wortox](/wiki/Wortox "Wortox"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Springy Ironfolk.**”**

–[Wurt](/wiki/Wurt "Wurt"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Just horsing around...**”**

–[Walter](/wiki/Walter "Walter"), when examining a Clockwork Knight.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Clockwork and I usually get along just fine...**”**

–[Wanda](/wiki/Wanda "Wanda"), when examining a Clockwork Knight.

The **Clockwork Knight** is a hostile [Mob](/wiki/Mob "Mob") that protects the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") in [Sandbox Mode](/wiki/Sandbox_Mode "Sandbox Mode") or certain places in [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode"). It also spawns from a mined [Maxwell Statue](/wiki/Maxwell_Statue "Maxwell Statue") in the Adventure Mode chapter, *Epilogue*. It is one of the [Chess Monsters](/wiki/Chess_Monsters "Chess Monsters") guarding the [Chess](/wiki/Chess "Chess") [Biome](/wiki/Biome "Biome").

## Brain Behavior[]

A Knight's main purpose is to guard the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing"). They are seen sleeping near it along with some [Clockwork Bishops](/wiki/Clockwork_Bishops "Clockwork Bishops") and a [Clockwork Rook](/wiki/Clockwork_Rook "Clockwork Rook"). When a mob or the player gets close, the Knight will stand up and stare at the creature, and if the creature gets close enough, the Knight will do a war cry and charge at it, using its springy neck to headbutt when it gets close. The Knight will then attempt to kite. If the knight is followed, it will usually try to headbutt once more, then it will do its war cry again. The Knight cannot be stun-locked and does not respawn.
...
Befriending at least 5 [Pigs](/wiki/Pig "Pig") can easily kill all the Knights and other Clockwork Monsters around the Wooden Thing. Alternatively, the attacks of the [Clockwork Rook](/wiki/Clockwork_Rook "Clockwork Rook") will damage them. With a bit of timing and luck, a Rook can be used to destroy the other Clockwork Monsters. When trying to kill a Knight for its [Gears](/wiki/Gears "Gears"), a death by fire will cause it to drop [Ashes](/wiki/Ashes "Ashes").

Below is the number of hits it takes with each weapon to kill Clockwork Knights when playing with characters with a default damage modifier. The [Weather Pain](/wiki/Weather_Pain "Weather Pain") is not included due to the random nature of its projectile.

| Weapon | Fishing RodBug Net | Lucy the Axe | Shovel Pitchfork Hammer Torch Umbrella  Walking Cane Willow's Lighter | Axe Pickaxe Luxury Axe Opulent Pickaxe  Boomerang | PickSlashAxe | Spear | Bat Bat | Ham Bat | Morning Star | Tentacle Spike Battle Spear Thulecite Club Fire Dart  Fire Staff Slurtle Slime | Tooth TrapDark Sword | Blow Dart | Gunpowder | Old Bell |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| No. of hits for Clockwork Knight | **71** | **23** | **18** | **12** | **10** | **9** | **8** | **6-11** | **5 or 7** | **6** | **5** | **3** | **2** | **1** |

## Placeholder Trivia[]

* The Clockwork Knight was introduced in *[A Little Rain Must Fall](/wiki/Don%27t_Starve/Version_History#A_Little_Rain_Must_Fall "Don't Starve/Version History")* update.
* The Clockwork Knight has a random chance to do a battle cry before attacking.

## Blueprint Gallery[]

Clockwork Front.png (39 KB)

Head-on view of a Clockwork Knight.

Clockwork Back.png (55 KB)

Back view of a Clockwork Knight.

Clockwork Sleeping.png (14 KB)

A Clockwork Knight resting.

Chess Biome ingame.png (1.8 MB)

Willow is surrounded by eight Clockwork Knights in Adventure Mode.

Knight Charge.jpg (7 KB)

A Knight charging before attacking.

Dead Knight.jpg (7 KB)
...
Four Knights protecting the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") in an old version of the game.

A Little Rain Must Fall.jpg (755 KB)

Clockwork Knight as seen in the poster for *[A Little Rain Must Fall](/wiki/Don%27t_Starve/Version_History#March_12,_2013_-_A_Little_Rain_Must_Fall "Don't Starve/Version History")* update.

Art Stream 33 Clockwork Monsters.png (734 KB)

A Clockwork Knight as seen in a drawing from Art Stream # 33.

Broken Clockworks before revision.jpg (58 KB)

Older versions of Broken Clockworks.

Mob concept art.jpg (99 KB)

Clockwork knight concept art
