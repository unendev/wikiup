...
source_url: https://dontstarve.fandom.com/wiki/Log_Raft
---
...
**“**This looks... sort of boat-like...**”**

–[Wilson](/wiki/Wilson "Wilson")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Campfire wood has other uses, apparently!**”**
...
**“**The dispersal of weight should keep me briefly afloat.**”**
...
**“**She don't look too sturdy.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**ALAS! 'TIS BARELY WORTHY O' THE SEA**”**
...
**“**About as stable as a wooden balloon.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

A **Log Raft** is a craftable [Boat](/wiki/Boats "Boats") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It can be found in the [Nautical Tab](/wiki/Nautical_Tab "Nautical Tab"), requires 6 [Logs](/wiki/Log "Log") and 4 [Cut Grass](/wiki/Cut_Grass "Cut Grass") to craft and is available from the beginning of the game. It begins with 150 durability, which will deplete gradually with use and when damage is taken. It can be repaired with a [Boat Repair Kit](/wiki/Boat_Repair_Kit "Boat Repair Kit") or the [Sea Yard](/wiki/Sea_Yard "Sea Yard"). The Log Raft cannot have attachments.

## Prototype Tips[]

* The Log Raft and the [Raft](/wiki/Raft "Raft") share the same amount of durability, the only difference is that the Raft is faster.
