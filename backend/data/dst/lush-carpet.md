...
source_url: https://dontstarve.fandom.com/wiki/Lush_Carpet
---
...
**“**There's something unnatural about this ground.**”**
...
**“**A fancy place to leave muddy footprints.**”**
...
**“**A gööd cölör tö hide the blöödstains öf battle.**”**
...
**“**That's a real dramatic chunk of ground.**”**
...
**“**Oh, what a lovely carpet!**”**

–[Wanda](/wiki/Wanda "Wanda")

**Lush Carpet** is a naturally generated type of [flooring](/wiki/Turfs "Turfs") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It was added in *[A Little Drama](/wiki/A_Little_Drama_and_QOL "A Little Drama and QOL")* update and can be found on the [Stage](/wiki/Stage "Stage") [Set Piece](/wiki/Set_Piece "Set Piece") or on a one tile large [Briar Wolf Set Piece](/wiki/Briar_Wolf "Briar Wolf").

It is an alternative for the regular [Carpeted Flooring](/wiki/Carpeted_Flooring "Carpeted Flooring") and has a dark purple texture. It can be crafted with one [board](/wiki/Boards "Boards") and one [beefalo wool](/wiki/Beefalo_Wool "Beefalo Wool") and requires an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

## Placeholder Trivia[]

* The Last update where a new [turf](/wiki/Turfs "Turfs") type was added, which is the Ancient Stonework, was *Turn of the Tides*, released in June 2019. Since then, *Don't Starve Together* hadn't received a new turf type. After almost 3 years, however, 10 new turf types were introduced, including the lush carpet.
* Shade of Lush Carpet is the opposite of the regular one. (The latter is bright purple, while its lush variant is dark.)
* Lush carpet shares the same crafting recipe with regular carpeted flooring.

## Blueprint Gallery[]

RWP ALD Lush Carpet concept art1.png (1.64 MB)

Lush Carpet concept art from Rhymes With Play stream.
