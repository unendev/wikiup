...
source_url: https://dontstarve.fandom.com/wiki/Fish_Farm
---
...
"Grow your own fishfood with roe!"

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Silk**×2** Rope**×2** Coconut**×4** |
...
**“**Entirely devoid of fish at the moment.**”**
...
**“**I guess I gotta find fish eggs now. Oof.**”**
...
**“**Nary a fish in sight!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WHEREFORE LITTLE FISHY?**”**
...
**“**Swell. A fish farm without any fish.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Fish Farm** is a craftable [Structure](/wiki/Structure "Structure") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is found in the [Food Tab](/wiki/Food_Tab "Food Tab"), requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype, and 2 [Silk](/wiki/Silk "Silk"), 2 [Ropes](/wiki/Rope "Rope") and 4 [Coconuts](/wiki/Coconut "Coconut") to craft. It needs to be stocked using [Roe](/wiki/Roe "Roe") to produce either [Tropical Fish](/wiki/Tropical_Fish "Tropical Fish"), [Purple Groupers](/wiki/Purple_Grouper "Purple Grouper"), [Pierrot Fish](/wiki/Pierrot_Fish "Pierrot Fish"), or [Neon Quattros](/wiki/Neon_Quattro "Neon Quattro").

Once stocked with Roe, the Fish Farm enters a state in which it has no fish, and can only be examined. It will then begin to progress through 4 growth stages, each of which taking 1/2 to 3/4 of a day (8-12 clock segments), and adding 1 additional fish to its stock upon completion. Upon reaching its 5th and final state, the farm will be stocked with 4 fish.

A Fish Farm is harvested the same way as e.g. [Farms](/wiki/Farms "Farms") and [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), no [Fishing Rod](/wiki/Fishing_Rod "Fishing Rod") is required to harvest it. Each harvest will yield exactly one fish, and reduce the growth stage by one. If the Fish Farm is harvested in the first stage, it will be empty again and require restocking with Roe. If the player does not completely empty the farm, it will always keep producing the same kind of fish.

There is a chance when harvesting a fish farm for a [Crocodog](/wiki/Crocodog "Crocodog") to spawn.
...
* Fish Farms can be pre-crafted in a *Shipwrecked* world and brought over to a *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* world, where they can be placed in a [Lily Pond](/wiki/Lily_Pond "Lily Pond") and produce the same types of fish if stocked with Roe.

## Placeholder Trivia[]

* Fish Farms were added to the *Shipwrecked* DLC more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21st,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.
* The three fish that can only be obtained from Fish Farms are required to cook the [Tropical Bouillabaisse](/wiki/Tropical_Bouillabaisse "Tropical Bouillabaisse").
* According to the game files, it seems there was originally going to be 5th type of fish that could be grown in the farm, the "Spotted Wanda".
* In the code, the four growth stages are called "one fish", "two fish", "red fish", and "blue fish". This is a reference to the book *[One Fish, Two Fish, Red Fish, Blue Fish](https://en.wikipedia.org/wiki/One_Fish,_Two_Fish,_Red_Fish,_Blue_Fish "wikipedia:One Fish, Two Fish, Red Fish, Blue Fish")* by [Dr. Seuss](https://en.wikipedia.org/wiki/Dr._Seuss "wikipedia:Dr. Seuss"). In addition, [Wilba's](/wiki/Wilba "Wilba") quotes reference this, in the specific order. (Ex. Red = First stage Blue = second, etc.)

## Blueprint Gallery[]

Fish Farm Types.png (1.18 MB)

All Fish Farm types. From left to right top to bottom, Tropical Fish, Newly stocked (Unset type), Unstocked, Purple Grouper, Neon Quattro, Pierrot Fish.

DS Shipwrecked Home Sea Home Update.png (2.36 MB)

Fish Farm as seen in the poster for the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update.
