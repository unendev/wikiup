...
source_url: https://dontstarve.fandom.com/wiki/Cargo_Boat
---
...
**“**A SAILING VESSEL WITH ENHANCED STORAGE CAPABILITIES**”**
...
**“**A top-notch transporter of goods across bodies of water.**”**
...
**“**This surfboard sure has a lot of pockets.**”**
...
**“**Fer th'hoarder at sea.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**HOLDETH LOTS O' STUFFS**”**

–[Wilba](/wiki/Wilba "Wilba")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Big Floater of friends**”**

–[Wormwood](/wiki/Wormwood "Wormwood")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Now all my things can go adventuring with me.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Cargo Boat** is a craftable [Boat](/wiki/Boats "Boats") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is found in the [Nautical Tab](/wiki/Nautical_Tab "Nautical Tab"), requires 6 [Boards](/wiki/Boards "Boards") and 3 [Ropes](/wiki/Rope "Rope") to craft, and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") or [Sea Lab](/wiki/Sea_Lab "Sea Lab") to prototype. Along with being customizable with boat attachments such as [Sails](/wiki/Sail "Sail"), it allows the player an extra 6 slots of storage.

The Cargo Boat begins with 300 durability, which will deplete as it takes damage from going against [Waves](/wiki/Waves "Waves"). While moving, it will also lose durability over time at a rate of 1 per 4.8 seconds, lasting a total of 3 [Days](/wiki/Day "Day"). Cargo Boats can be repaired with a [Boat Repair Kit](/wiki/Boat_Repair_Kit "Boat Repair Kit") or the [Sea Yard](/wiki/Sea_Yard "Sea Yard").

## Prototype Tips[]

* A [Set Piece](/wiki/Set_Piece "Set Piece") can be found with a lone Cargo Boat that contains a [Spear Gun](/wiki/Spear_Gun "Spear Gun"), a [Spear](/wiki/Spear "Spear") and 3 [Morsels](/wiki/Morsel "Morsel"), but if the player gets on the boat, 3 [Sea Hounds](/wiki/Sea_Hounds "Sea Hounds") will spawn and attack the player. Depending on when the player has found the boat, the Morsels may spoil and become [Rot](/wiki/Rot "Rot").

## Blueprint Gallery[]

Cargo Boat-0.png (582 KB)

A Cargo Boat with a [Trawl Net](/wiki/Trawl_Net "Trawl Net") attached.

Cargo Boat night.png (317 KB)

A Cargo Boat at night with a [Boat Torch](/wiki/Boat_Torch "Boat Torch") attached.

Boat logic.png (451 KB)

A glitched Cargo Boat sailing on land. This bug can no longer occur.
