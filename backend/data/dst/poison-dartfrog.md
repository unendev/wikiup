...
source_url: https://dontstarve.fandom.com/wiki/Poison_Dartfrog
---
...
Knocks out items from inventory.  
...
**“**It's reasonable to conclude that this amphibian means me harm.**”**
...
**“**A scallywag of o' tha land!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**IT SCREW TONGUE TO STICKING PLACE**”**
...
The **Poison Dartfrog** is a hostile [Mob](/wiki/Mob "Mob") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It spawns from the [Lily Pond](/wiki/Lily_Pond "Lily Pond") biome and has the same attack pattern as regular [Frogs](/wiki/Frog "Frog"). It also has the same ability to knock items out of the player's inventory. However, contrary to what its name might suggest, its attack does not poison the player.

It can be attacked directly, or caught using a [Trap](/wiki/Trap "Trap"). Upon death, it drops [Poison Dartfrog Legs](/wiki/Poison_Dartfrog_Legs "Poison Dartfrog Legs"), which can be eaten - though it's poisonous - or used to craft a [Venom Gland](/wiki/Venom_Gland "Venom Gland").

Poison Dartfrogs will eat raw [Bean Bugs](/wiki/Bean_Bugs "Bean Bugs") left on the ground. They won‘t attack [Hippopotamooses](/wiki/Hippopotamoose "Hippopotamoose") or [Spiders](/wiki/Spiders "Spiders") on sight.

## Placeholder Trivia[]

* Although referred to as a [Poison Dartfrog](https://en.wikipedia.org/wiki/Poison_dart_frog "wikipedia:Poison dart frog"), its appearance is based on the [red-eyed treefrog](https://en.wikipedia.org/wiki/Agalychnis_callidryas "wikipedia:Agalychnis callidryas").

## Blueprint Gallery[]

Poison Dartfrog Sleeping.png (4 KB)

A poison dartfrog asleep

Poison Dartfrog Dead.png (6 KB)

A dead poison dartfrog.
