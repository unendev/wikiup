...
source_url: https://dontstarve.fandom.com/wiki/Marsh_Turf
---
...
| --- | --- |
| Decorations Filter Survivor Items Filter | Always available(Wurt) Terra Firma Tamper |
...
Tentapillar 25%,   
[Marsh](/wiki/Marsh "Marsh") tiles (Pitchfork)
...
**Marsh Turf** is one of the [Turf](/wiki/Turf "Turf") [items](/wiki/Items "Items"), acquired by digging [Marsh](/wiki/Marsh "Marsh") tiles with a [Pitchfork](/wiki/Pitchfork "Pitchfork"). These turfs can commonly be found at the [Marsh](/wiki/Marsh "Marsh") biome and rarely at the [Mosaic](/wiki/Mosaic "Mosaic") biome. Like other Turfs, it can be placed on any bare ground tile, or it can be used as a good burning fuel for a [Campfire](/wiki/Campfire "Campfire") or [Fire Pit](/wiki/Fire_Pit "Fire Pit").

Plants like [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Saplings](/wiki/Saplings "Saplings"), [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), [Lureplants](/wiki/Lureplant "Lureplant"), [Pine Cones](/wiki/Pine_Cone "Pine Cone"), and [Birchnuts](/wiki/Birchnut "Birchnut") can be planted on these Turfs. It will not stop Lureplants' [Eyeplants](/wiki/Eyeplant "Eyeplant") from spawning.

When placed on the [Surface World](/wiki/Surface_World "Surface World") covering a large enough area, Crows are the only [Birds](/wiki/Birds "Birds") that will spawn and land on these turfs.
...
In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Marsh Turf can be crafted by [Wurt](/wiki/Wurt "Wurt") with one [Cut Reeds](/wiki/Cut_Reeds "Cut Reeds") and two [Rot](/wiki/Rot "Rot") in the [Decorations Filter](/wiki/Decorations_Filter "Decorations Filter") and [Survivor Items Filter](/wiki/Survivor_Items_Filter "Survivor Items Filter").

Wurt is also able to walk [30% faster](/wiki/Player_Speed "Player Speed") on this terrain, the same speed as when walking on [Cobblestones](/wiki/Cobblestones "Cobblestones").

All of Wurt's character-specific craftable [Structures](/wiki/Structures "Structures"), such as [Craftsmerm Houses](/wiki/Craftsmerm_House "Craftsmerm House") and [Merm Flort-ifications](/wiki/Merm_Flort-ifications "Merm Flort-ifications"), can only be placed on Marsh Turf.

Other Characters can craft it via the [Terra Firma Tamper](/wiki/Terra_Firma_Tamper "Terra Firma Tamper").
