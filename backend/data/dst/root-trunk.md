...
source_url: https://dontstarve.fandom.com/wiki/Root_Trunk
---
...
| --- |
| Bramble Bulb**×1** Flytrap Stalk**×2** Boards**×3** |
...
|  |
| --- |
| Can hold up to 12 item stacks. Shares its inventory with all other Root Trunks. |
...
**“**A complex intelligent root system is moving my belongings for me. Fascinating!**”**
...
**“**Now I don't gotta go far to get all my stuff.**”**
...
**“**Yarr! All o'Woodleg's treasures!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**KEEPETH WILBA'S STUFF**”**

–[Wilba](/wiki/Wilba "Wilba")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Friends help carry stuff**”**
...
The **Root Trunk** is a craftable [Structure](/wiki/Structure "Structure") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is found in the [Magic Tab](/wiki/Magic_Tab "Magic Tab"), requires a [Hogus Porkusator](/wiki/Hogus_Porkusator "Hogus Porkusator") to prototype, and a [Bramble Bulb](/wiki/Bramble_Bulb "Bramble Bulb"), two [Flytrap Stalks](/wiki/Flytrap_Stalk "Flytrap Stalk"), and three [Boards](/wiki/Boards "Boards") to craft.

A single Root Trunk functions similar to a [Chest](/wiki/Chest "Chest"), but with 12 storage slots. Items can be stored in a Root Trunk by dragging them onto it or by opening the Root Chest to place them in specific slots.

What makes the Root Trunk special, however, is that it shares its inventory with all other Root Trunks built by the player. Therefore, it is possible to store items in them and transfer them from Root Trunk to Root Trunk instead of carrying them in the player's [Inventory](/wiki/Inventory "Inventory").

Unlike regular Chests, Root Trunks do not drop their contents if they are destroyed by [Fire](/wiki/Fire "Fire"), with a [Hammer](/wiki/Hammer "Hammer") or a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff"). If the last one of them has been destroyed, the items inside them are stored in limbo and can only be accessed again by building another Root Trunk.

Root Trunk can be opened by [Pogs](/wiki/Pog "Pog").

## Placeholder Trivia[]

* Root Trunk was added in the March 18, 2019 update.
* Root Trunk used to require only one [Flytrap Stalk](/wiki/Flytrap_Stalk "Flytrap Stalk") to craft, but it was changed in the March 28, 2019 update.

## Blueprint Gallery[]

Root Trunk Burnt.png (25 KB)
