...
source_url: https://dontstarve.fandom.com/wiki/Fryfocals
---
...
"Static boom focusing apparatus."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Spectoggles**×1** Red Gem**×1 (Wagstaff Portrait)** |
...
| --- |
| 50  37.5 WendyWes  ---  62.5 Wigfrid  ---  25WolfgangDon't Starve/37.5WolfgangDon't Starve Together/50Wolfgang/100 Wolfgang  ---  25 Wanda (elderly) |
...
|  |
| --- |
| Removes blurriness. Wagstaff Portrait  Damages and ignites [Mobs](/wiki/Mobs "Mobs"). Wagstaff Portrait Prevents slowdown from [Heavy Fog](/wiki/Heavy_Fog "Heavy Fog") when body slot items equipped. Hamlet icon |
...
–[Wilson](/wiki/Wilson "Wilson"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**These would be better if they worked.**”**

–[Willow](/wiki/Willow "Willow"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Wolfgang doesn't know what this is.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**The world looks like the photographs of Abigail I have.**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**NON-FUNCTIONING. THIS MUST BE WHAT THE FLESHSACKS CALL "REGRET"**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I do like this particular shade of sepia.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Don't think it's working.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**If they worked, I might consider wearing these.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Tiny spheres of static energy make a marvelous flaming projectile.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It is öf nö use tö me.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**We can pretend they work. Pew! Pew!**”**

–[Webber](/wiki/Webber "Webber"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I don't get it.**”**

–[Walani](/wiki/Walani "Walani"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Are those potatoes?**”**

–[Warly](/wiki/Warly "Warly"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Nary a use in sight.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**GIVE WILBA A SEA OF SEE TROUBLES**”**

–[Wilba](/wiki/Wilba "Wilba"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Can't use**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining the Fryfocals

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Oh I get what this is for! Oh wait, no I don't.**”**

–[Wheeler](/wiki/Wheeler "Wheeler"), when examining the Fryfocals

The **Fryfocals** are a [Character](/wiki/Characters "Characters")-specific [Hat](/wiki/Category:Hats "Category:Hats") [Item](/wiki/Item "Item") craftable by [Wagstaff](/wiki/Wagstaff "Wagstaff") through the [Tinkering Tab](/wiki/Tinkering_Tab "Tinkering Tab"). They are crafted with [Spectoggles](/wiki/Spectoggles "Spectoggles") and a [Red Gem](/wiki/Red_Gem "Red Gem").

Fryfocals can be used to damage [Mobs](/wiki/Mobs "Mobs") whilst igniting them. Be wary as the fire can spread to other flammable objects if the mob is near. Similar to the other goggles, they remove nearsightedness from Wagstaff, but also give the world a sepia tint. For any other character besides Wagstaff, the Fryfocals will still make the world sepia-toned but they cannot be used to set fire to mobs and will only give characters blurry vision.

## PrototypeTips[]

* Since the Fryfocals only degrade when a fireball is shot, in contrast to the [Visor](/wiki/Visor "Visor"), the only effect applied to the screen is a slight tint, instead of a FOV restriction.
* Using the Fryfocals while [wet](/wiki/Wetness "Wetness") will shock Wagstaff twice, dealing a total of 16 damage (affected by armor); all lightning insulating clothes such as [Rain Coat](/wiki/Rain_Coat "Rain Coat") and [Snakeskin Jacket](/wiki/Snakeskin_Jacket "Snakeskin Jacket") cannot prevent the shock damage.
