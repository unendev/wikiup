...
source_url: https://dontstarve.fandom.com/wiki/Honey_Chest
---
...
|  |
| --- |
| Turns [Nectar](/wiki/Nectar "Nectar") into [Honey](/wiki/Honey "Honey"). |
...
**“**Theoretically, it automatically performs the enzymatic activity required to make honey.**”**
...
**“**'t be makin' tha sweet golden treasure!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**MAKETH THE SWEET YUMS**”**

–[Wilba](/wiki/Wilba "Wilba")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Buzz juice! Where's Buzz?**”**

–[Wormwood](/wiki/Wormwood "Wormwood")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I need the storage space, but I want the honey.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Honey Chests** are a type of [Chest](/wiki/Chest "Chest") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. They have 9 slots and can be found within [Mant Hills](/wiki/Mant_Hill "Mant Hill").

These chests have the unique ability to turn [Nectar](/wiki/Nectar "Nectar") into [Honey](/wiki/Honey "Honey") after 1/10 of day (48 seconds) of being in the chest. The player does not have to leave the Mant Hill for this transformation to occur.
...
Honey Ches Early model1.png (466 KB)

Unimplemented model of Honey Chest

Honey Ches Early model2.png (443 KB)

Unimplemented model of Honey Chest

Ui honeychest old.png (10 KB)

Unimplemented unique UI of Honey Chest
