...
source_url: https://dontstarve.fandom.com/wiki/Compromising_Statue
---
...
**“**Döömed never tö die in battle! Ö, wöe!**”**
...
The **Compromising Statue** is an object exclusive to the [Pocket Edition](/wiki/Don%27t_Starve:_Pocket_Edition "Don't Starve: Pocket Edition") of *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve").* When the player creates a world with the [No-Sweat](/wiki/No-Sweat_Mode "No-Sweat Mode") preset applied, it will spawn. Upon death, the statue will revive the player and will drop 1-2 [Rocks](/wiki/Rocks "Rocks"), along with 2 [Flint](/wiki/Flint "Flint").
...
* Penalties that normally afflict the player upon death and in other revival circumstances, such as empty [inventory](/wiki/Inventory "Inventory") (items can be recovered at the place of death, as long as they haven't been destroyed by any means) and reset of most [character](/wiki/Characters "Characters") abilities ([Wilson](/wiki/Wilson "Wilson") and [Webber](/wiki/Webber "Webber") will be beardless; [WX-78](/wiki/WX-78 "WX-78") loses all [Gears](/wiki/Gears "Gears").)

## Prototype Tips[]

* Fighting a group of [Mobs](/wiki/Mobs "Mobs") or [Boss Monsters](/wiki/Boss_Monsters "Boss Monsters") near the Compromising Statue may result in the player being killed repeatedly, as the statue resurrects them without any [items](/wiki/Items "Items").
* Due to the Compromising Statue being able to be used infinitely without penalty, it may be plausible to intentionally die in order to regain stats if the player has either under 75 Health, 100 Hunger, or 150 Sanity, and they're also near the Compromising Statue to retrieve their items back.

## Blueprint Gallery[]

Compromising Statue on map.jpg (394 KB)

The Compromising Statue and [Wilson](/wiki/Wilson "Wilson") on the map.

Compromising Statue map icon.jpg (5 KB)

The Compromising Statue's map icon.

Wilson reviving from Compromising Statue.jpg (508 KB)
