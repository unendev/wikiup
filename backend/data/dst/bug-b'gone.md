...
source_url: https://dontstarve.fandom.com/wiki/Bug_B'Gone
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Bug_B%27Gone?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
-5/sec (to player)  
-60 and then -30 per 10 sec (to mobs)
...
**“**An excellent merger of tubers and predatory plant stalk.**”**
...
**“**A land cannon fer the wee buggies.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**IT KILLETH THE TEENY BUGS.**”**
...
**“**This'll keep those tiny flyers grounded.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Bug B'Gone** is a craftable item exclusive to the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC. It is found in the [Survival Tab](/wiki/Survival_Tab "Survival Tab"), requires 6 [Tubers](/wiki/Tuber "Tuber") and a [Flytrap Stalk](/wiki/Flytrap_Stalk "Flytrap Stalk") to craft, and an [Science Machine](/wiki/Science_Machine "Science Machine") to prototype.

Its main use is to kill [Gnat swarms](/wiki/Gnat_Swarm "Gnat Swarm") and [Rabid Beetles](/wiki/Glowfly "Glowfly"). Gnats cannot be killed with a regular weapon (unless they are frozen beforehand), while any Rabid Beetle that runs through the cloud will die instantly. It can also be used to ease a fight by reducing the health of enemies a little bit.

Another Use of the Bug B'Gone is to kill most bug-type creatures. Currently, the cloud this creates will apply "strong" poison to [Weevoles](/wiki/Weevole "Weevole"), [Scorpions](/wiki/Scorpion "Scorpion"), [Mants](/wiki/Mant "Mant"), [Butterflys](/wiki/Butterfly "Butterfly"), [Bees](/wiki/Bee "Bee") and [Mosquitos](/wiki/Mosquito "Mosquito"), which cause them to take 60 damage directly, and then take 30 damage per 10 second.

The cloud is harmful to the player too, as it will cause them to take 5 damage per second from poisoning for as long as they stay inside the cloud, similar to staying in the [Gas Rainforest](/wiki/Gas_Rainforest "Gas Rainforest") biome without a [Gas Mask](/wiki/Gas_Mask "Gas Mask"). Note that the player can stay in the Noxious Cloud without taking damage if they wear a Gas Mask.
