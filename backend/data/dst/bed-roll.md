...
source_url: https://dontstarve.fandom.com/wiki/Bed_Roll
---

**Bed Rolls** are craftable [items](/wiki/Item "Item") that can be used to sleep through the [night](/wiki/Night "Night"). There are two types of bed rolls: Straw Rolls and Fur Rolls.

At [dusk](/wiki/Dusk "Dusk") or [night](/wiki/Night "Night"), the item can be used by dragging and dropping on a [character](/wiki/Character "Character") (which causes the '[Sleep](/wiki/Sleep "Sleep")' option to appear) or by right-clicking them from the inventory. The character will place it on the ground and lie down, and time will advance to the beginning of the next [day](/wiki/Day "Day"). When going to sleep in a bed roll, the character takes an immediate [hunger](/wiki/Hunger "Hunger") penalty. If the hunger penalty causes hunger to reduce to 0, the character will lose [health](/wiki/Health "Health") in their sleep. Considering that this item allows a player to skip the dusk/night sanity loss, this makes the bed roll's sanity benefits even more pronounced.

Bed rolls cannot be used in "dangerous" situations, such as near a [Spider Nest](/wiki/Spider_Nest "Spider Nest"), in a [Marsh](/wiki/Marsh "Marsh") (if [Tentacles](/wiki/Tentacles "Tentacles") are nearby, as any Tentacles count as dangerous mobs even if they're under the surface), during combat, when [monsters](/wiki/Monster "Monster") are nearby, and when [Hounds](/wiki/Hound "Hound") or [Depths Worms](/wiki/Depths_Worm "Depths Worm") are approaching. This also includes [Shadow Creatures](/wiki/Shadow_Creature "Shadow Creature").

Bed Rolls are unusable by [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") due to her insomnia.
...
| --- | --- | --- |
| **Survival Tab** | Healing Filter | Science Machine |

Effects

| Health | Hunger | Sanity |
| --- | --- | --- |
| 0.0 (on use) Don't Starve +0.5/second Don't Starve Together | -75 (on use) Don't Starve -1/second Don't Starve Together | 33 (on use) Don't Starve +0.67/second Don't Starve Together |
...
|  |
| --- |
| Lets the character skip through the night Don't Starve.  Lets the character [Sleep](/wiki/Sleep "Sleep") Don't Starve Together. |

## Sources

### Dropped by

Slotmachine Steamer Trunk Shipwrecked icon
...
**“**Looks comfy, but it smells like mildew.**”**
...
**“**I slept on worse back at the lumber camp.**”**
...
**“**The aroma of sweet hay is having a lethargic effect.**”**
...
**“**A little better than bare ground. Scratchy.**”**

–[Warly](/wiki/Warly "Warly")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Don't look fit fer a dry nights sleep.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS STUFFS DREAMS ARE MADE ON**”**
...
**“**I'm thinking its good for one, maybe two, dreams.**”**
...
**“**To lay my sweet little head down.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Scale-less rather sleep on itchy grass than mud?**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**You make due with what you have out in the wilderness.**”**
...
The **Straw Roll** is a one time use [survival](/wiki/Survival "Survival") item that can be used to skip dusk and night. Using it restores 33 [sanity](/wiki/Sanity "Sanity") but consumes 75 [hunger](/wiki/Hunger "Hunger"). Additionally, it will set the user's temperature to 15. It requires 6 [Cut Grass](/wiki/Cut_Grass "Cut Grass") and 1 [Rope](/wiki/Rope "Rope") to craft and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. A Straw Roll can be used to craft a Fur Roll, which has multiple uses. The player is also immune to any damage during the sleep animation. A Straw Roll [burns](/wiki/Fire#Fuel_Values "Fire") longer than the sum of its components (360 seconds versus 270 seconds, respectively, when used in a [Fire Pit](/wiki/Fire_Pit "Fire Pit")).
...
| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Straw Roll**×1** Bunny Puff**×2** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| **Survival Tab** | Healing Filter | Alchemy Engine |

Effects

| Health | Hunger | Sanity |
| --- | --- | --- |
| 30 (on use) Don't Starve +1/second Don't Starve Together | -75 (on use) Don't Starve  -1/second Don't Starve Together | 50 (on use) Don't Starve  +1/second Don't Starve Together |
...
|  |
| --- |
| Lets the character skip through the night.  Raise body temperature (up to 30) Don't Starve Together |
...
**“**Preposterously effective at inducing lethargy.**”**
...
**“**For a more comfortable nap time!**”**
...
**“**It feels nice, like cuddling up with Woby.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**If I have to spend time sleeping, at least I can do it comfortably.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Fur Roll** is a survival item that can be used to sleep through Dusk and Night, restoring Sanity and [Health](/wiki/Health "Health"). It requires 1 [Straw Roll](/wiki/Straw_Roll "Straw Roll"), 2 [Bunny Puffs](/wiki/Bunny_Puffs "Bunny Puffs") to make, and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. It is similar to the Straw Roll; however, the Straw Roll is single use, while the Fur Roll can be used until it runs out of durability. The player is, like with the Straw Roll, immune to any damage during the sleep animation.

The Fur Roll can be used three times. Using it restores 50 Sanity and 30 Health but consumes 75 hunger. Additionally, it will set the user's temperature to maximum, which is useful during [winter](/wiki/Winter "Winter").

### Don't Starve Together Skins[]

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Fur\_Roll](/wiki/Belongings#Fur_Roll "Belongings")*
...
In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, the behavior changes so that upon the Fur Roll's use, if the sleeper's temperature is below 35, it will be set to 35, but if it is above 52.5, it will increase by 17.5, making it dangerous to use in the heat of [Summer](/wiki/Summer "Summer") when [overheating](/wiki/Overheating "Overheating") is a possibility.

The Straw Roll will not affect the sleeper's temperature.

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, sleeping in a Bed Roll affects stats over time rather than instantly, and sleeping won't skip time. If [Hunger](/wiki/Hunger "Hunger") reaches 0, the character will automatically wake up to avoid starvation.

Players can not use Bed Roll in several circumstances: when it's daytime, they are below 25 Hunger, a [hound](/wiki/Hound "Hound") attack is coming or near a monster.

Using the Straw Roll restores 0.67 Sanity/second, 0.5 Health/second, and costs 1 Hunger/second.

The sleeping animation will not prevent damage from falling minerals during [earthquakes.](/wiki/Earthquake "Earthquake")

Using the Fur Roll restores 1 Sanity/second, 1 Health/second, and costs 1 Hunger/second. Additionally, it will increase the user's temperature by 1/second if it is less than 30, and decrease the user's temperature by 1/second if it is greater than 45.

The Fur Roll will not prevent the user's temperature from being affected by other sources, so its temperature effect may be counteracted, and will also stack with other sources.
...
* The Straw Roll was added in the *[October 2, 2012](/wiki/Version_History#October_2.2C_2012.5B18.5D "Version History")* update, and the Fur Roll was added in the *[Underground](/wiki/Version_History#Underground "Version History")* update.
* In *Don't Starve Together*, [Charlie](/wiki/Charlie "Charlie") will not attack you when you are sleeping, making bed rolls an effective backup plan if you have no light source.
...
Straw Roll in use.png (27 KB)

Wilson about to use a Straw Roll.

Webber sleeping on Straw Roll.jpg (66 KB)

Webber sleeping next to a spider den

Wes sleeping on Fur Roll.jpg (31 KB)

[Wes](/wiki/Wes "Wes") about to sleep on a Fur Roll.
