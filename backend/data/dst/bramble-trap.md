...
source_url: https://dontstarve.fandom.com/wiki/Bramble_Trap
---
...
|  |
| --- |
| Deals 40 damage in a radius of 1 tile when triggered. |
...
**“**If any intruders come by, they'll be in for a thorny surprise.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Bramble Trap** is a [character](/wiki/Character "Character")-specific [Weapon](/wiki/Weapon "Weapon") similar to the [Tooth Trap](/wiki/Tooth_Trap "Tooth Trap"), only available in the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC and *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It is craftable by [Wormwood](/wiki/Wormwood "Wormwood") from the [Green Thumb Tab](/wiki/Green_Thumb_Tab "Green Thumb Tab") using a [Living Log](/wiki/Living_Log "Living Log") and a [Stinger](/wiki/Stinger "Stinger"). It can be placed on the ground and deals 40 damage in a radius of one [Pitchfork](/wiki/Pitchfork "Pitchfork") tile when it is stepped on by a [Mob](/wiki/Mob "Mob"), also damaging [Walls](/wiki/Walls "Walls"). This can damage the player, but the player will not activate it by stepping over it (In *Don't Starve Together*, Bramble Trap thorns do not damage Walls, and in non-PvP servers they also do not damage players and their followers). The splash damage can be avoided by wearing a [Bramble Husk](/wiki/Bramble_Husk "Bramble Husk"), which will negate its damage without losing any durability. Like a Tooth Trap, it has 10 uses and must be reset after each use.

Bramble Trap damage will not aggro nearby mobs, nor will it increase a player's [Naughtiness](/wiki/Krampus#Naughtiness "Krampus"). Bramble Traps are also fireproof. A Bramble Trap can be picked up and placed elsewhere at any time, regardless of having been triggered or not.

The following [Mobs](/wiki/Mob "Mob") will not activate Bramble Traps:
...
* [Celestial Champion](/wiki/Celestial_Champion "Celestial Champion") (in its third phase)
* [Dragonfly](/wiki/Dragonfly "Dragonfly")
* [Glommer](/wiki/Glommer "Glommer")
* [Gnat Swarm](/wiki/Gnat_Swarm "Gnat Swarm")s
...
* [Poison Mosquitoes](/wiki/Poison_Mosquito "Poison Mosquito")
* [Shadow Creatures](/wiki/Shadow_Creature "Shadow Creature")
* [Vampire Bats](/wiki/Vampire_Bat "Vampire Bat")

## Prototype Tips[]

* Although clustering these traps together can be dangerous, the player can avoid damage altogether from these by wearing a Bramble Husk. This makes farming large groups of enemies like [Spiders](/wiki/Spider "Spider") simple and easy.

## Blueprint Gallery[]

RWP 241 Green Thumb Tab Concept Art.png (1.26 MB)

Concept art of the Bramble Trap (right) from *Rhymes With Play* #241.
