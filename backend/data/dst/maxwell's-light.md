...
source_url: https://dontstarve.fandom.com/wiki/Maxwell's_Light
---
...
|  |
| --- |
| `"maxwelllight", "maxwelllight_area"` |
...
**“**A light source that sensitive to motion! Revolutionary!**”**
...
**“**Whoever put this here is my new best friend.**”**
...
**“**Ooohoohoo, it warms in my presence!**”**
...
**Maxwell's Light** is a special [Structure](/wiki/Structure "Structure") that appears in Chapters 5 and 6 of [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode"). It will light up when approached, and will turn off when the player walks away from it.

Maxwell's Light cannot be destroyed and does not drain sanity when standing next to it. It's possible to light a Maxwell's Light with a [Torch](/wiki/Torch "Torch") or [Fire Staff](/wiki/Fire_Staff "Fire Staff"). Standing among the eyes in the shadows around Maxwell's Lights will not cause them to disappear.

## Placeholder Trivia[]

* Before *[The End of the Beginning](/wiki/Don%27t_Starve/Version_History#The_End_of_the_Beginning "Don't Starve/Version History")* update, Maxwell's Light used the same model as [Night Lights](/wiki/Night_Light "Night Light").
* Some of the Maxwell's Lights in Chapter 6 have a much smaller light radius than those in Chapter 5.
* Maxwell's Lights make an appearance in Klei Entertainment's *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* promo, *A New Reign*.

## Mosquito Bugs[]

* If the player sleeps near a Maxwell's Light, it will not light up upon waking up until they move out of the Light's radius. This also applies when [Woodie](/wiki/Woodie/Normal "Woodie/Normal") awakens from [Werebeaver](/wiki/Woodie/Cursed "Woodie/Cursed") form or when resurrecting via [Touch Stone](/wiki/Touch_Stone "Touch Stone").

## Blueprint Gallery[]

Maxwell's Light ingame.png (463 KB)

Maxwell's Light in the game before *The End of the Beginning*.

World 6.jpg (29 KB)

Maxwell's Lights ingame with Wilson for scale.

Maxwell's Light icon forest.png (15 KB)

Maxwell's Light's icon on the [Map](/wiki/Map "Map").

A New Reign Maxwell Lights.png (207 KB)

Maxwell's Lights as seen in the "*A New Reign*" cinematic.

DST Nightmare Wallpaper.jpg (353 KB)

Maxwell's Lights as seen on the Steam "Nightmare" wallpaper.
