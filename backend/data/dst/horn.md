...
source_url: https://dontstarve.fandom.com/wiki/Horn
---
...
**“**Ah! An ivory incisor. Theoretically, I can find a use for it.**”**
...
**“**I'm glad it's not attached to anything.**”**
...
A **Horn** is an [Item](/wiki/Item "Item") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It has a 33% chance to be dropped when a [Water Beefalo](/wiki/Water_Beefalo "Water Beefalo") is killed. It can be used to craft [Horned Helmet](/wiki/Horned_Helmet "Horned Helmet") and [Dripple Pipes](/wiki/Dripple_Pipes "Dripple Pipes").
...
* Horns are very similar in usage to [Beefalo Horns](/wiki/Beefalo_Horn "Beefalo Horn") which are obtained by killing [Beefalo](/wiki/Beefalo "Beefalo"). Both items are used to craft head slot items and are used as parts of playable musical instruments.
