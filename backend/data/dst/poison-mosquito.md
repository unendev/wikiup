...
source_url: https://dontstarve.fandom.com/wiki/Poison_Mosquito
---
...
Attacks poison the target.  
Explodes after sucking enough blood, the explosion also poisons Mobs around it.

### [Loot](/wiki/Mobs#Mob_Characteristics "Mobs")

**Yellow Mosquito Sack 50%, Venom Gland 25%,  
Poison Mosquito** (Bug Net)

### Spawns from

During Monsoon Season, Slot Machine
...
|  |
| --- |
| Can be "murdered" for Yellow Mosquito Sack **(50%)**. |
...
**“**I presume they carry diseases here too.**”**
...
**“**You not only take, but you also give? Well, no thanks!**”**
...
**“**'TIS POISON'DOUS BITE-BUG!**”**

–[Wilba](/wiki/Wilba "Wilba")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Bzzt that makes sick**”**
...
The **Poison Mosquito** is a hostile [Mob](/wiki/Mobs "Mobs") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is a yellow and purple coloured version of the normal [Mosquito](/wiki/Mosquito "Mosquito"), and its attacks [Poison](/wiki/Poison "Poison") the target. It has a 50% chance to drop a [Yellow Mosquito Sack](/wiki/Yellow_Mosquito_Sack "Yellow Mosquito Sack") and a 25% chance to drop a [Venom Gland](/wiki/Venom_Gland "Venom Gland").

Poison Mosquitoes spawn either in [Monsoon Season](/wiki/Monsoon_Season "Monsoon Season") from [Flooded](/wiki/Flooding "Flooding") tiles or via a bad outcome of the [Slot Machine](/wiki/Slot_Machine "Slot Machine"). Like Mosquitoes, they are fast-moving and can be caught with a [Bug Net](/wiki/Bug_Net "Bug Net"). They have a small yellow blood sac which grows with each successful attack. On the fourth successful attack, the Poison Mosquito will explode and cause additional damage to its surroundings and poison Mobs around it.

Wearing any kind of head and body [Armor](/wiki/Armor "Armor") at the same time will prevent the player from taking damage, being stunlocked and poisoned by Poison Mosquitoes. The player still takes damage and gets poisoned from the explosion.

## Prototype Tips[]

* A [Seashell Suit](/wiki/Seashell_Suit "Seashell Suit") or a [Horned Helmet](/wiki/Horned_Helmet "Horned Helmet") will prevent the player from being poisoned by the Mosquitoes.

## Placeholder Trivia[]

* Unlike normal Mosquitoes which spawn from [Ponds](/wiki/Pond "Pond") in the [Marsh](/wiki/Marsh "Marsh"), the Poison Mosquitoes do not spawn from [Tidal Pools](/wiki/Tidal_Pool "Tidal Pool") in the [Tidal Marsh](/wiki/Marsh#Shipwrecked "Marsh").

## Blueprint Gallery[]

Poison monsquito sighting.jpg (221 KB)

Poison Mosquitoes spawned after using the Slot Machine.
