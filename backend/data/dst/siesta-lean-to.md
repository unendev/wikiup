...
source_url: https://dontstarve.fandom.com/wiki/Siesta_Lean-to
---
...
-25 (-0.33/second Don't Starve Together)
...
|  |
| --- |
| Lowers [temperature](/wiki/Overheating "Overheating") and raises [Sanity](/wiki/Sanity "Sanity") and [Health](/wiki/Health "Health") at the expense of [Hunger](/wiki/Hunger "Hunger") |
...
**“**For indulging in the therapeutic properties of a nap.**”**
...
**“**For little day trips to dreamland.**”**
...
**“**Wanna take a nap! Nap right here...**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A shady spot for a quick nap.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I could stand to spend a moment or two out of the heat.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Siesta Lean-to** is a craftable [Structure](/wiki/Structure "Structure") from the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC. It requires 2 [Silk](/wiki/Silk "Silk"), 4 [Boards](/wiki/Boards "Boards"), and 3 [Rope](/wiki/Rope "Rope") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

The player is able to [sleep](/wiki/Sleep "Sleep") inside the Siesta Lean-to only during the [day](/wiki/Day "Day"). Doing so will advance the time to [Dusk](/wiki/Dusk "Dusk") and set the player's current temperature to 15 °C, but only if the player's temperature is above 35 °C. This makes it very handy for [Summer](/wiki/Summer "Summer"), where [Heat](/wiki/Heat "Heat") is the most prominent threat, and dusk and night are a lot shorter than the other times of the day. Functioning similarly to the [Tent](/wiki/Tent "Tent"), sleeping in the Siesta Lean-to will restore 60 health and 50 sanity at the cost of 25 hunger and has 6 uses (15 uses in Don't Starve Together).

[Wickerbottom](/wiki/Wickerbottom "Wickerbottom") can not use the Siesta Lean-to due to her insomnia.

## Shipwrecked icon Shipwrecked[]

The Siesta Lean-to is also included in the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, where it can be used to deal with Overheating during the [Dry Season](/wiki/Dry_Season "Dry Season"). It works exactly as it does in the *Reign of Giants* DLC.

## Don't Starve Together icon Don't Starve Together[]

In [Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together"), the Siesta Lean-to has been altered to a similar fashion as the [Tent](/wiki/Tent "Tent"), healing over time, instead of instantly. While sleeping in the lean-to, players regenerate 1Sanity/sec & 2Health/sec at the cost of a mere 0.33Hunger/sec. It also reduces [Wetness](/wiki/Wetness "Wetness") by 1/second, and lowers [Body Temperature](/wiki/Overheating "Overheating") by 1/second as long as the player's temperature is greater than 40. All outside temperature sources are ignored, so the player's temperature will not decrease if it is below 40. If the player has enough food, they can hibernate through tough seasons, such as winter or summer.

## Prototype Tips[]

* One could have the Siesta Lean-to prebuilt in case of emergency overheating. It may then be placed to cool down, while also giving some sanity and health. This way of using the Lean-to should only be used if one does not have an [Endothermic Fire Pit](/wiki/Endothermic_Fire_Pit "Endothermic Fire Pit") ready, as the structure has a limited amount of uses and costs time.
...
* A [siesta](https://en.wikipedia.org/wiki/Siesta "wikipedia:Siesta") is a short nap taken during midday in some countries with hotter climates.
* A [Lean-to](https://en.wikipedia.org/wiki/Lean-to "wikipedia:Lean-to") is a type of shelter that consists of rafters leaning against a wall or structure forming a roof. Lean-tos are associated with camping and wilderness survival.

## Blueprint Gallery[]

Siesta no sleep.jpg (93 KB)

[Wilson](/wiki/Wilson "Wilson") attempting to sleep during dusk.

Burnt Siesta Lean-to.png (61 KB)

A burnt Siesta Lean-to.

Schermafbeelding 2016-02-08 om 16.53.01.png (2.06 MB)

[Warly](/wiki/Warly "Warly") standing next to a Siesta Lean-to in the *Shipwrecked* DLC.
