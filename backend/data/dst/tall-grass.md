...
source_url: https://dontstarve.fandom.com/wiki/Tall_Grass
---
...
Machete Luxury Machete Shears Shovel Regal Shovel

### Resources

Cut Grass×1 (MacheteLuxury Machete)  
...
**“**The obstinacy of this grass requires something sharper than my hands.**”**
...
**Tall Grass** is a [Plant](/wiki/Plant "Plant") exclusive to [*Don't Starve: Hamlet*](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet") DLC, which can be found in the [Plains](/wiki/Plains "Plains") and [Rainforest](/wiki/Rainforest "Rainforest") [Biomes](/wiki/Biomes "Biomes"). Just like the [grass](/wiki/Grass "Grass") in the base game, it yields [Cut Grass](/wiki/Cut_Grass "Cut Grass"), but only with the help of a tool. Unlike Grass Tuft, Tall Grass take 4 days to regrow ([Rain](/wiki/Rain "Rain") will reduce this time) and never withered because of high temperature. However, like Grass Tuft, Tall Grass do not grow during [Winter](/wiki/Winter "Winter").

Several tools can be used :

* With a [Machete](/wiki/Machete "Machete") or [Luxury Machete](/wiki/Luxury_Machete "Luxury Machete"), it will yield **one** Cut Grass after **three** hits.
* With a [Obsidian Machete](/wiki/Obsidian_Machete "Obsidian Machete")Shipwrecked icon, it will yield **one** Cut Grass after **one** hits.
* With [Shears](/wiki/Shears "Shears"), it will yield **two** Cut Grass in **one** cutting.
* With a [Shovel](/wiki/Shovel "Shovel") or [Regal Shovel](/wiki/Regal_Shovel "Regal Shovel"), it will yield **one** Cut Grass and give a [Grass Tuft](/wiki/Grass_Tuft "Grass Tuft") to be replanted instead.

Depending on the biome/turf Tall Grass is planted in, it will grow as a different plant. If the Grass Tuft is planted on [Wild Plains Turf](/wiki/Wild_Plains_Turf "Wild Plains Turf"), [Rainforest Turf](/wiki/Rainforest_Turf "Rainforest Turf"), [Deep Rainforest Turf](/wiki/Deep_Rainforest "Deep Rainforest") or [Dense Turf](/wiki/Dense_Turf "Dense Turf"), it will grow as a Tall grass, and there will be no need to fertilize it. But if it is replanted in any other biome/turf, it will grow as an ordinary one, and the player will have to use [Manure](/wiki/Manure "Manure"), [Guano](/wiki/Guano "Guano") or [Rot](/wiki/Rot "Rot") beforehand in order to fertilize it.

Tall Grass tufts may be infested with [Weevoles](/wiki/Weevole "Weevole"), spawning up to three during the evening, night, and when the tuft is hacked or sheered. Harvesting, digging up or burning an infested Tall Grass tuft will remove the infestation. Game attempts to create new infested grass each time the grass regrows as long as there is no other infested grass nearby (within 3 pitchfork tiles).

Tall Grass tufts replanted by the player may become infested when other infested Tall Grass is destroyed in the world.

## Placeholder Trivia[]

* Tall Grass used to be yellow, but the color was changed in the *[Quality of Life](/wiki/Don%27t_Starve:_Hamlet#Version_History "Don't Starve: Hamlet")* update.
