...
source_url: https://dontstarve.fandom.com/wiki/Sanguine_Experiment
---
...
| --- |
| Mosquito**×1** Red Cap**×1** Sanity Decrease**×10** |
...
|  |
| --- |
| Restores the players' health on consumption and over time. |

[Code](/wiki/Console "Console")

|  |
| --- |
| `"halloweenpotion_health_small"`  `"halloweenpotion_health_large"` |

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I was hoping for something bigger.**”**

–[Wilson](/wiki/Wilson "Wilson"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I wish it was a little stronger.**”**

–[Willow](/wiki/Willow "Willow"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is okay, but big Wolfgang need big drink!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Like life, it's a bit disappointing.**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**SMALL UPGRADE**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Not as potent as I would have liked.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Not bad.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Could be a little stronger.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A meager reward för my tröubles.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's only a little powerful.**”**

–[Webber](/wiki/Webber "Webber"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I don't think it'll do much.**”**

–[Warly](/wiki/Warly "Warly"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Little thing for belly**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Aw, I was hoping for a little more.**”**

–[Winona](/wiki/Winona "Winona"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**How tame and timid!**”**

–[Wortox](/wiki/Wortox "Wortox"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Didn't turn out so good...**”**

–[Wurt](/wiki/Wurt "Wurt"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It didn't turn out quite as well as I thought it would.**”**

–[Walter](/wiki/Walter "Walter"), when examining a Flask of Sanguine Mixture.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I'm a clocksmith, not a chemist.**”**

–[Wanda](/wiki/Wanda "Wanda"), when examining a Flask of Sanguine Mixture.

The **Sanguine Experiment** is a feature exclusive to the [Hallowed Nights](/wiki/Hallowed_Nights "Hallowed Nights") [event](/wiki/Category:Events "Category:Events") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It can be conducted at the [Mad Scientist Lab](/wiki/Hallowed_Nights#Mad_Scientist_Lab "Hallowed Nights"), using a [Mosquito](/wiki/Mosquito "Mosquito") and a [Red Cap](/wiki/Red_Cap "Red Cap"), and depleting 10 Sanity for the player. The experiment has a 66% chance to result in a **Flask of Sanguine Mixture** and a 33% to result in a **Canteen of Sanguine Mixture**.

Both potions restore the players' [Health](/wiki/Health "Health") upon consumption and slowly over time. The Flask initially restores 8 Health upon consumption, while the Canteen restores 20 Health upon consumption. During the next minute, both potions restore 1 Health every two seconds, adding up to a additional restoration of 30 Health. Both potions can also be used as [Fire](/wiki/Fire "Fire") [Fuel](/wiki/Fuel "Fuel").

## Placeholder Trivia[]

* The Mad Scientist Lab and all related craftable Items were introduced to the Hallowed Nights event in 2018.
* When [Wormwood](/wiki/Wormwood "Wormwood") consumes either of these potions, he does NOT receive the initial 8 / 20 Health, but will still restore 1 Health every two seconds, resulting in a total restoration of 30 Health.

## Blueprint Gallery[]

Hallowed Nights Experiments.png (170 KB)

All Hallowed Nights potions except for the Steeped Lunar Essence on the ground.
