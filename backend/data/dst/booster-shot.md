...
source_url: https://dontstarve.fandom.com/wiki/Booster_Shot
---
...
"Boosts your declining max health."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Rot**×8** Nitre**×2** Stinger**×1** |
...
|  |
| --- |
| Restores 25% of lost maximum health |
...
**“**On further reflection, I don't want an injection.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Don't like needles, florp!**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This is supposed to make me healthier?**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I have no use for it, what I need is more time!**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Booster Shot** is a craftable [Healing](/wiki/Healing_Filter "Healing Filter") [item](/wiki/Item "Item") only available in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It requires 8 [Rot](/wiki/Rot "Rot"), 2 [Nitre](/wiki/Nitre "Nitre"), and 1 [Stinger](/wiki/Stinger "Stinger") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

It can restore maximum [Health](/wiki/Health "Health") lost through the usage of [Telltale Hearts](/wiki/Telltale_Heart "Telltale Heart") and [Florid Posterns](/wiki/Florid_Postern "Florid Postern"). It will not increase one's maximum Health past the default.
...
* The item restores missing maximum health, without modifying actual health.
* Always adds 25% of the base character's health value to the current maximum health value, except if this latter is already at its base value, resulting no change.

## Placeholder Trivia[]

* Prior to [March 8th, 2016](/wiki/Don%27t_Starve_Together/Version_History "Don't Starve Together/Version History") update, the crafting recipe for the Booster Shot required 3 [Papyrus](/wiki/Papyrus "Papyrus"), 2 [Healing Salves](/wiki/Healing_Salve "Healing Salve"), and one Stinger.
...
* Having Rot as an ingredient refers to [Penicillin](https://en.wikipedia.org/wiki/Penicillin "wikipedia:Penicillin"), an anti-biotic derived from mold.

## Mosquito Bugs[]

* The Booster Shot can be used on a [Shadow Creature](/wiki/Shadow_Creature "Shadow Creature"). The item will be consumed and results in no effects whatsoever.

## Blueprint Gallery[]

Booster Shot.gif (28 KB)

Five Booster Shots restoring lost maximum Health.
