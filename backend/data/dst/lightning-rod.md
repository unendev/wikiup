...
source_url: https://dontstarve.fandom.com/wiki/Lightning_Rod
---
...
| --- |
| Gold Nugget**×3** Cut Stone**×1 Gold Nugget×4 Cut Stone×1 Don't Starve Together** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| Science Tab | Structures FilterRain Gear Filter | Science Machine |
...
The **Lightning Rod** is a craftable [Structure](/wiki/Structures_Tab "Structures Tab") that attracts [Lightning](/wiki/Lightning "Lightning") strikes. It requires 4 [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget") and 1 [Cut Stone](/wiki/Cut_Stone "Cut Stone") to craft and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype.

A Lightning Rod protects from [Lightning Strikes](/wiki/Lightning "Lightning") that originate 10 tiles from the Lightning Rod's placement spot. Lightning ignites flammable [Items](/wiki/Items "Items") such as [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft") and [Chest](/wiki/Chest "Chest") within 1 tile of its target. In Don't Starve, Lightning can possibly target players 7.5 tiles from its origin so that a strike just outside the Lightning Rod's 10 tile protection radius may hit a player just under 4 tiles away from the Lightning Rod. A single Lightning Rod thus only provides 2.5 tiles radius (10 wall-units) of lightning-proof coverage for the player. The area between 2.5 and 10 tiles has some lightning protection, but it is not 100%.

Placing a Lightning Rod every 14 Tiles would optimize the number of Lightning Rods for 100% lightning coverage. An [Ice Flingomatic](/wiki/Ice_Flingomatic "Ice Flingomatic") doesn't prevent the strike, but will put out most fires. 2-4 Lightning Rods, instead of 1, is still recommended for a base of 1-6 Ice Flingomatics.

The Lightning Rod also provides a small radius of light (but not heat) after absorbing a lightning bolt, which is just bright enough to prevent [Charlie](/wiki/Charlie_(Night_Monster) "Charlie (Night Monster)") from attacking. The light lasts for up to a 1440 seconds, but the light will darken at daybreak after 960 seconds.

## Prototype Tips[]

* On a boat, using a [Lightning Conductor](/wiki/Lightning_Conductor "Lightning Conductor") can save room that would have been taken up by the Lightning Rod.

## Downloadable Content[]

In all [DLCs](/wiki/DLC "DLC") and *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the cost to craft a Lightning Rod is increased to 4 Gold Nuggets.

If a Lightning Rod and a [Volt Goat](/wiki/Volt_Goat "Volt Goat") are in close vicinity in the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, they both have an equal chance of being struck by Lightning.

In Don't Starve Together, [WX-78](/wiki/WX-78 "WX-78") can use a recently-struck Lightning Rod to recharge.

## Trivia[]

* The Lightning Rod was added in the *[Doorway To Adventure](/wiki/Version_History "Version History")* update.

## Gallery[]

Lightning rod charged.jpg (3 KB)

A charged Lightning Rod.

Lightning Rod light.jpg (66 KB)

A Lightning Rod can be used as a light source.

Lightning Rod on.png (95 KB)

Charged Lightning Rod radiating light and buzzing with electricity.

Doorway to Adventure.jpg (608 KB)

Lightning Rod as seen in the poster for the *[Doorway to Adventure](/wiki/Don%27t_Starve/Version_History#March_26,_2013_-_Doorway_to_Adventure "Don't Starve/Version History")* update.

Smite'ning Rod Icon.png (6 KB)

Reskinned Lightning Rod

Wx 78 near of two lighting rods.png (246 KB)

WX-78 near two Lightning Rods
