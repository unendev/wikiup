...
source_url: https://dontstarve.fandom.com/wiki/Mighty_Gym
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because it needs updating for the changes from the [March 2022 QoL update](/wiki/Don%27t_Starve_Together/Version_History#March_24,_2022_-_March_2022_QoL_Update "Don't Starve Together/Version History")*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Mighty_Gym?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
| --- |
| Boards**×4** Cut Stone**×2** Rope**×3** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Wolfgang Filter Structures Filter | Science Machine |

Perk

|  |
| --- |
| Increases Might Meter while succesfully playing the "minigame" |
...
**“**I think I pulled a muscle just looking at it...**”**

–[Wilson](/wiki/Wilson "Wilson")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**You know what this strongman show needs? Pyrotechnics!**”**

–[Willow](/wiki/Willow "Willow")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Watch, puny friends! Wolfgang will perform feats of strength!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It seems strength can only be found through suffering.**”**

–[Wendy](/wiki/Wendy "Wendy")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**THE LARGE ONE SEEMS TO LIKE THIS FLESHLING TORTURE DEVICE**”**

–[WX-78](/wiki/WX-78 "WX-78")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Do be careful not to overexert yourself, dear.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**So that's where all my good boards went!!**”**

–[Woodie](/wiki/Woodie "Woodie")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Hmph. I suppose some people are impressed by shows of brute strength.**”**

–[Maxwell](/wiki/Maxwell "Maxwell")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**My friend döth pössess strength that cöuld rival mighty Thör's!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Can we try, Mr. Wolfgang? We've got extra arms to lift with!**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I think perhaps I'll stick to cooking.**”**
...
**“**I might've helped him a little bit on the mechanical side of things.**”**

–[Winona](/wiki/Winona "Winona")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Mortals have such curious ways.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Can do it too! Mermfolk super strong, flurt!**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Wow! I wonder if I could be as strong as Mr. Wolfgang one day...**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I don't know where he finds the time for such things.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Mighty Gym** is a [structure](/wiki/Structures "Structures") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* exclusive to [Wolfgang](/wiki/Wolfgang "Wolfgang"). It can be crafted from his Survivor Items tab and requires 4 [Boards](/wiki/Boards "Boards"), 2 [Cut Stone](/wiki/Cut_Stone "Cut Stone"), and 3 [Rope](/wiki/Rope "Rope") to craft, and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. Its function is to increase Wolfgang's might.

When the player uses the structure, a minigame will start. A "bell" on the meter on the base of the structure will start moving, and the player must click in time with the bell's movements in the center of the meter to increase their might. When hitting the borders (black), the weights will fall and Wolfgang won't gain anything. The player's rate of [hunger](/wiki/Hunger "Hunger") loss increases dramatically while playing, especially when using heavier weights.

## Contents

* [1 Gym Weights](#Gym_Weights)
* [2 Loaded Gym](#Loaded_Gym)
* [3 Gallery](#Gallery)
* [4 Trivia](#Trivia)
* [5 Bugs](#Bugs)
...
When built, the Mighty Gym's weights appear with [Potato Sacks](/wiki/Potato_Sack "Potato Sack") that can be unloaded and replaced for heavy items. Check the values below:

| **Item** | **Value** |
| --- | --- |
| Potato Sack | 1 |
| Sunken ChestShell ClusterBoulderGlass SpikeGlass CastleKnobbly Tree Nut Lunar AltarsLunar AltarsLunar AltarsLunar AltarsLunar AltarsLunar Altars Suspicious MarbleSuspicious MarbleSuspicious Marble | 2 |
| Giant Crops Carved HornucopiaBubble Pipe CarvingAnchor FigurePawn Figure Rook FigureKnight FigureBishop FigureQueenly Figure Kingly FigureVarg FigureHound FigureCarrat Figure Beefalo FigureKitcoon FigureCatcoon FigureBunnyman Figure | 3 |
| Giant Crops Deerclops FigureBearger FigureMoose/Goose FigureDragonfly Figure Ancient Guardian FigureToadstool FigureBee Queen FigureKlaus Figure Antlion FigureAncient Fuelweaver FigureMalbatross FigureCrab King Figure Moon Moth Figure Figure"Moon" FigureCelestial Champion FigureEye of Terror Figure Twins of Terror Figure | 4 |
...
| **Total Weight** | **Better Section** | **Might Gain per Lift** | **Hunger Drain** | Relative Hunger Efficiency |
| --- | --- | --- | --- | --- |
| 2 to 3 | Orange | 4 | 4× | 1 |
| 4 to 6 | Yellow | 6.67 | 11× | 0.61 |
| 7 to 8 | White | 10 | 22× | 0.45 |

The hunger drain will be applied even if the player is idle.

The hunger drain increases more than the might-gain-per-lift does. As a result, the more weight is applied,
the *less* might is gained per unit of hunger lost. However, with the time saved, the player can probably
do more useful work to offset the loss.

## https://static.wikia.nocookie.net/dont-starve-game/images/9/98/Blueprint.png/revision/latest?cb=20130315060140 Gallery[]

MightyGymPlaced.png (323 KB)

Wolfgang standing next to a placed Mighty Gym.

MightyGymInUse.png (311 KB)

Wolfgang using the Mighty Gym.

MightyGymSuccess.png (311 KB)

Wolfgang performing a successful lift. Note that the biceps atop the gym flex.

MightyGymFailure.png (289 KB)

Wolfgang failing a lift and dropping the weights.

Mighty gym statues.png (197 KB)

A Mighty Gym loaded with statues shows the slider bar with white center, surrounded by yellow, and then black outer edges.

## https://static.wikia.nocookie.net/dont-starve-game/images/4/47/Placeholder.png/revision/latest?cb=20130218233329Trivia[]

* The Mighty Gym was added as part of [Wolgang's Character Refresh Update](/wiki/Don%27t_Starve/Version_History "Don't Starve/Version History").
* Its efficiency was improved in the [March 2022 QoL update](/wiki/Don%27t_Starve_Together/Version_History#March_24,_2022_-_March_2022_QoL_Update "Don't Starve Together/Version History").

## MosquitoBugs[]

* Some Chess pieces not made from [Marble](/wiki/Marble "Marble") appear invisible when placed on the Mighty Gym.
...
* When placing the Mighty Gym near a body of water, dismounting will sometimes cause Wolfgang to jump in and suffer the drowning penalty of losing 25% of their max health (similar to when being ressurected by [Telltale Heart](/wiki/Telltale_Heart "Telltale Heart")), -25 [Hunger](/wiki/Hunger "Hunger"), -25 [Sanity](/wiki/Sanity "Sanity"), gain 100% [Wetness](/wiki/Wetness "Wetness") and drop half of their inventory slots into the water.
