...
source_url: https://dontstarve.fandom.com/wiki/Oscillating_Fan
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Oscillating_Fan?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
| --- |
| Alloy**×2** Electrical Doodad**×2** Gears**×1** |
...
|  |
| --- |
| Prevents the effects of [Hay Fever](/wiki/Hay_Fever "Hay Fever"). Dries the player off. |
...
**“**A plane propeller would be better.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Oscillating Fan** is a craftable [Structure](/wiki/Structure "Structure") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is found in the [Science Tab](/wiki/Science_Tab "Science Tab"), requires 2 [Alloy](/wiki/Alloy "Alloy"), 2 [Electrical Doodads](/wiki/Electrical_Doodad "Electrical Doodad") and 1 [Gear](/wiki/Gears "Gears") to craft, and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

While active, the fan prevents the effects of [Hay Fever](/wiki/Hay_Fever "Hay Fever") and will dry the player off very rapidly (5 times as fast) even in [Fog](/wiki/Fog "Fog") or [Rain](/wiki/Rain "Rain") as long as the player is within a certain range of the fan.

When crafted, the fan will display a radius for effect, similar to the [Ice Flingomatic](/wiki/Ice_Flingomatic "Ice Flingomatic"). The fan can be turned on or off, but will automatically turn off when it runs out of fuel. The player is able to refuel it with regular [Fuel](/wiki/Fire#Fuel "Fire") items along with [Nitre](/wiki/Nitre "Nitre").

In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, the Oscillating Fan can be [flooded](/wiki/Flooding "Flooding").
