...
source_url: https://dontstarve.fandom.com/wiki/Bat_Bat
---
...
"All this science is so... draining."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Batilisk Wing**×3** Living Log**×2** Purple Gem**×1** |
...
| --- |
| 42.5  31.9 WendyWes  ---  53.1 Wigfrid  ---  21.3WolfgangDon't Starve/31.9WolfgangDon't Starve Together/42.5Wolfgang/85 Wolfgang  ---  21.3 Wanda (elderly) |
...
|  |
| --- |
| Leeches 6.8 of target's Health on hit. |
...
**“**I can take a bit of my enemy's lifespan and add it to my own.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Bat Bat** is a craftable [magical](/wiki/Magic "Magic") [Melee Weapon](/wiki/Weapon#Melee_Weapons "Weapon"). It requires a [Shadow Manipulator](/wiki/Shadow_Manipulator "Shadow Manipulator") to prototype and 5 [Batilisk Wings](/wiki/Batilisk_Wing "Batilisk Wing"), 2 [Living Logs](/wiki/Living_Log "Living Log") and 1 [Purple Gem](/wiki/Purple_Gem "Purple Gem") to craft.

The Bat Bat deals 42.5 damage per hit and has 75 uses. Each hit leeches 6.8 Health from non-[wall](/wiki/Walls "Walls") targets, but drains 3.4 Sanity from the player if they are not at full health.

Bat Bats may also be found in [Ornate Chests](/wiki/Ornate_Chest "Ornate Chest"), which appear in the [Ruins](/wiki/Ruins "Ruins").

## Don't Starve Together Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the Bat Bat also requires 3 [Batilisk Wings](/wiki/Batilisk_Wing "Batilisk Wing"), 2 [Living Logs](/wiki/Living_Log "Living Log") and 1 [Purple Gem](/wiki/Purple_Gem "Purple Gem") to craft.

### Skins[]

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Bat\_Bat](/wiki/Belongings#Bat_Bat "Belongings")*
...
* The Bat Bat's leeching ability makes it ideal for fighting dangerous enemies that cannot be easily outrun, like numerous [Hounds](/wiki/Hound "Hound") or giants (especially [Dragonfly](/wiki/Dragonfly "Dragonfly")), while wearing armor; there may be no opportunity to stop and use a healing item, but striking provides the much-needed quick healing.
* The Bat Bat is immensely useful for [Wormwood](/wiki/Wormwood "Wormwood"), since it allows him to easily regain the health he cannot receive from healing foods. He is also able to easily obtain the living logs needed.
* Batilisk Wings needed for Bat Bats can be farmed by setting up [Rabbit Hutches](/wiki/Rabbit_Hutch "Rabbit Hutch") near an open [Sinkhole](/wiki/Sinkhole "Sinkhole"). The Bunnymen will come out at night and quickly kill any spawning [Batilisks](/wiki/Batilisk "Batilisk"). This will also generate [Guano](/wiki/Guano "Guano") and [Monster meat](/wiki/Monster_Meat "Monster Meat") as a byproduct.
* A quick way to regain health is to attack [Chester](/wiki/Chester "Chester"), [Packim Baggims](/wiki/Packim_Baggims "Packim Baggims"), [Ro Bin](/wiki/Ro_Bin "Ro Bin"), or [Hutch](/wiki/Hutch "Hutch") with a Bat Bat, since their health regenerates quickly.
* [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)")'s Sanity boost will make up for the Sanity lost from each hit when using this weapon. The health bonus is also welcome, since he has low max health.
* This weapon will heal a total of 510 HP while draining 255 Sanity in its lifetime. This is equal to 17 [Honey Poultices](/wiki/Honey_Poultice "Honey Poultice"), 25.5 [Healing salves](/wiki/Healing_Salve "Healing Salve"), or 12.75 [Pierogi](/wiki/Pierogi "Pierogi") or [Fishsticks](/wiki/Fishsticks "Fishsticks"). In the absence of [Jellybeans](/wiki/Jellybeans "Jellybeans"), the Bat Bat offers potent healing unaffected by spoilage.
...
* Despite Wanda's quote for the Bat Bat, fighting with it does *not* restore Age.
* Wigfrid's lifesteal can be used to obtain even more health per hit.This also stacks with her battle songs, making her one of the best tanks in the game.

## Trivia[]

* The Bat Bat was introduced in the *[It's Not a Rock!](/wiki/Version_History#June_11th,_2013_-_It's_not_a_rock! "Version History")* update.
* The Bat Bat was the second weaponized food item added to game, after the [Ham Bat](/wiki/Ham_Bat "Ham Bat").
* Bat Bats were one of many items added to [Terraria](https://en.wikipedia.org/wiki/Terraria) in the Eye for an Eye update.

## Gallery[]

Bat Bats Wilson.png (135 KB)

Bat Bat on the ground and wielded by [Wilson](/wiki/Wilson "Wilson").
