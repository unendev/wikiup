...
source_url: https://dontstarve.fandom.com/wiki/Hollow_Stump
---
...
**“**Fascinating! A stump that regenerates cat-like creatures!**”**
...
**“**With all that yarn, there must be knitter inside.**”**
...
**“**Something skritching inside.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I think something lives in there!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It looks like something's been living in there for a while.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Hollow Stump** is a naturally-spawning object from the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, found only in a [Deciduous Forest](/wiki/Deciduous_Forest "Deciduous Forest") [Biome](/wiki/Biome "Biome"). It is a large stump with a hole, with yarn hanging from its branches and a ball of yarn on the side. It is the home of a [Catcoon](/wiki/Catcoon "Catcoon").

The Hollow Stump can be destroyed with a [Hammer](/wiki/Hammer "Hammer") to yield 2 [Twigs](/wiki/Twigs "Twigs"), 2 [Logs](/wiki/Logs "Logs"), and a chance of another random item, detailed below in the chart.
...
Spawned Catcoons wander within 30 metres of their Hollow Stump.
...
In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the Hollow Stump has 20 inventory slots. Catcoons will store any item they pick up from the ground into the stump. Players can search the Hollow Stump to retrieve those items, but doing so will aggro the Catcoon.

The Hollow Stump will only drop 2 [Twigs](/wiki/Twigs "Twigs") and 2 [Log](/wiki/Log "Log") when destroyed.
...
* [Catcoons](/wiki/Catcoons "Catcoons") spawning a total of 9 times, as well as the cat having 9 unique "gifts", is a reference to the myth that cats have 9 lives.
...
Catcoon icon deciduous forest.png (40 KB)

Hollow Stump icon on a [Map](/wiki/Map "Map").

Art Stream 19 Catcoon.png (601 KB)

A Hollow Stump as seen in a drawing from Art Stream #19.
