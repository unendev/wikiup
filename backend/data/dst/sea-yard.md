...
source_url: https://dontstarve.fandom.com/wiki/Sea_Yard
---
...
"Keep your boats ship-shape!"

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Log**×4** Tar**×6** Limestone**×6** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Nautical Tab | Alchemy Engine |

Perk

|  |
| --- |
| Automatically repairs [Boats](/wiki/Boats "Boats") in proximity. |
...
**“**Magnificent. I could use this kind of automation in my factory!**”**
...
**“**Thet'll give Sea Legs a leg up! Harr!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**IT FIXETH WILBA SHIP**”**
...
**“**If I had this for my balloon, I wouldn't be stranded here.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Sea Yard** is a craftable [Structure](/wiki/Structure "Structure") exclusive to the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is found in the [Nautical Tab](/wiki/Nautical_Tab "Nautical Tab") and requires 4 [Logs](/wiki/Log "Log"), 6 [Limestones](/wiki/Limestone "Limestone") and 6 [Tar](/wiki/Tar "Tar") to craft. The Sea Yard can only be placed in the [Ocean](/wiki/Ocean "Ocean") and can be used to repair damaged [Boats](/wiki/Boats "Boats") at a rate of 0.5% per second.

To start the automatic repairing, the boat needs to be bought close to the structure, and also the player must refuel the Sea Yard occasionally using Tar. The repairing will stop once the boat is back to full durability, if the boat moves too far away from the structure, or if it runs out of fuel. The player doesn't necessarily need to be in the boat for the Sea Yard to keep repairing the boat. When fully repaired, the [Seagull](/wiki/Birds "Birds") sitting on top of the Sea Yard will repeatedly make loud noises.

If several Sea Yards are placed close to each other, only one will be activated to repair the player's boat.

## Prototype Tips[]

* Since the Sea Yard restores a percentage of boat HP per second instead of a set amount of HP, it is best used to repair [Encrusted Boats](/wiki/Encrusted_Boat "Encrusted Boat") (repairs 4 HP/sec) and to a lesser degree, [Armored Boats](/wiki/Armored_Boat "Armored Boat") (repairs 2.5 HP/sec).
* Building a [Ballphin Palace](/wiki/Ballphin_Palace "Ballphin Palace") or [Buoy](/wiki/Buoy "Buoy") right next to the Sea Yard provides a permanent light source at night, as well as a means to recover sanity by befriending the [Bottlenose Ballphin](/wiki/Bottlenose_Ballphin "Bottlenose Ballphin").
* Building a Sea Yard very close to a [Brainy Sprout](/wiki/Brainy_Sprout "Brainy Sprout") is an excellent choice of location. Not only does the sprout have a +25/min sanity aura, it also provides light during dusk and night. Placing a [Bouyant Chiminea](/wiki/Buoyant_Chiminea "Buoyant Chiminea") nearby will also allow the player to dry off if needed while waiting for repairs to complete.
* Crafting a [Sea Chest](/wiki/Sea_Chest "Sea Chest") or other container near the Sea Yard to store sanity boosting equipment (such as a [Shark Tooth Crown](/wiki/Shark_Tooth_Crown "Shark Tooth Crown"), [Thulecite Suit](/wiki/Thulecite_Suit "Thulecite Suit"), [Limestone Suit](/wiki/Limestone_Suit "Limestone Suit"), etc.) is recommended for convenient sanity regeneration while the player waits for repairs. Storing Tar for refueling is also a good idea.

## Placeholder Trivia[]

* The Sea Yard was added to the *Shipwrecked* DLC more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21st,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.
* If healed using the Sea Yard, the [The 'Sea Legs'](/wiki/The_%27Sea_Legs%27 "The 'Sea Legs'") and [Armored Boat](/wiki/Armored_Boat "Armored Boat") are the most efficient boats for travelling, since they gain 57.6 wall units of travel distance per second spent healing.

## Blueprint Gallery[]

Seayard.gif (5.05 MB)

The Sea Yard automatically repairing a [Row Boat](/wiki/Row_Boat "Row Boat").

DS Shipwrecked Home Sea Home Update.png (2.36 MB)

Sea Yard as seen in the poster for the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update.
