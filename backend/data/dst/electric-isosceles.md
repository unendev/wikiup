...
source_url: https://dontstarve.fandom.com/wiki/Electric_Isosceles
---
...
**“**A stimulating device. Does it work on electrostatic energy?**”**
...
**“**Whar they lead is anybody's guess.**”**
...
**“**An equalateral adventure.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

An **Electric Isosceles** is an object found in the deep [Ocean](/wiki/Ocean "Ocean") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. Electric Isosceles appear as electrified white triangles in the ocean and expand when approached by a player. They act as the *Shipwrecked* version of [Worm Holes](/wiki/Worm_Hole "Worm Hole"). Sailing through them transports the player and their [Boat](/wiki/Boats "Boats") to another Electric Isosceles elsewhere on the map. Like Worm Holes, they can also be given [items](/wiki/Item "Item") to transport to the other end. There are 6 Electric Isosceles pairs (in total 12 individual Electric Isosceles) in most worlds and each Electric Isosceles only connects to the other Electric Isosceles of the same pair. Often they can end on two different sides of the ocean.

Traveling through an Electric Isosceles costs 15 Sanity. [Sanity](/wiki/Sanity "Sanity") can be quickly drained by repeatedly traveling between them.

## Placeholder Trivia[]

* Electric Isosceles are a reference to the [Bermuda Triangle](https://en.wikipedia.org/wiki/Bermuda_Triangle "wikipedia:Bermuda Triangle"). This is confirmed by their spawn code.

## Blueprint Gallery[]

CVWCwNyVEAApTf2.png (343 KB)

[Willow](/wiki/Willow "Willow") near an Electric Isosceles.

Bermuda triangle travel.gif (4.23 MB)

[Woodlegs](/wiki/Woodlegs "Woodlegs") travelling through an Electric Isosceles.
