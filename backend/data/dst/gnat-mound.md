...
source_url: https://dontstarve.fandom.com/wiki/Gnat_Mound
---
...
[Painted Biome](/wiki/Painted "Painted")
...
**“**The nest of those exceptionally annoying bugs.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'Tis the Valhalla of bugs.**”**
...
**“**Like an apartment building for bugs.**”**
...
**“**Barnacle's o'tha land.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**ALL THAT BUZZES IS GNAT HOME**”**
...
**“**Not bad, for a mound full of bugs.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Gnat Mound** is a naturally spawning object introduced in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is found in the [Painted](/wiki/Painted "Painted") [biome](/wiki/Biome "Biome"), and spawns a Gnat Swarm.

It takes 6 hits with a [Pickaxe](/wiki/Pickaxe "Pickaxe") or [Opulent Pickaxe](/wiki/Opulent_Pickaxe "Opulent Pickaxe") to be completely destroyed. Each 2 hits, some [Rocks](/wiki/Rocks "Rocks"), [Iron Ore](/wiki/Iron_Ore "Iron Ore"), or more rarely, [Flint](/wiki/Flint "Flint") will be yielded, and the Gnat Mound will visibly go down a tier, similar to [Mini Glaciers](/wiki/Mini_Glacier "Mini Glacier").

**Gnat Mounds** are able to spawn [Gnat Swarms](/wiki/Gnat_Swarm "Gnat Swarm") every 120 seconds, and are also created by them. When a Gnat Mound is completely destroyed, the Gnat Swarm that was originated from will rebuild another Mound, if and only if this Gnat Swarm hasn't been recently killed. A new Mound will be made at the lowest tier, and then "repaired" by the Gnats Swarm over time. Gnat Swarms will also repair their mound if damaged, but not completely destroyed. Gnat Mounds try not to spawn Gnat Swarms when [raining](/wiki/Rain "Rain").

Despite being made of Rock, the Gnat Mound is flammable, and will drop [Ash](/wiki/Ashes "Ashes") when burned down or mined while burning.

The Gnat Mound is considered a structure and will be targeted by the [BFB](/wiki/BFB "BFB") if it lands near one.

## PrototypeTips[]

* As [Gnat Swarms](/wiki/Gnat_Swarm "Gnat Swarm") are able to rebuild a destroyed Gnat Mound, a good strategy is to carry a Gnat Swarm in Swinesbury City after destroying their Mound, and wait for them to rebuild another. This way, Rocks and Iron Ore will be easy to get, and renewable.
* It's possible to carry [Gnat Swarm](/wiki/Gnat_Swarm "Gnat Swarm") to connected worlds in order to create new Gnat Mounds, making [Iron Ore](/wiki/Iron_Ore "Iron Ore") renewable outside of Hamlet worlds.
