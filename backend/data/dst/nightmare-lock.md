...
source_url: https://dontstarve.fandom.com/wiki/Nightmare_Lock
---
...
The **Nightmare Lock** is a unique [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode") [structure](/wiki/Structure "Structure") used to trap the person sitting on the [Nightmare Throne](/wiki/Nightmare_Throne "Nightmare Throne"). It looks like a tiny version of the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") with spikes surrounding it, and can only be found at the epilogue of the Adventure Mode beside [Maxwell](/wiki/Maxwell_(NPC) "Maxwell (NPC)"). Also, a [Divining Rod](/wiki/Divining_Rod "Divining Rod") is required to unlock the lock. After unlocking, Maxwell (or whatever character was put there last) will be released, and the player's character will take his place on the Nightmare Throne. Back in [Sandbox Mode](/wiki/Sandbox_Mode "Sandbox Mode"), the player will become [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") (or whatever character was last on the throne) but will keep the items they had when they activated [Maxwell's Door](/wiki/Maxwell%27s_Door "Maxwell's Door").

## Placeholder Trivia[]

* In older versions of the game, the Shadow Key (which shared the same model as a [Purple Gem](/wiki/Purple_Gem "Purple Gem")) was used to free Maxwell.
* If the player spawns a Nightmare Lock in a world and tries to unlock it with a Divining Rod, the game will crash.

## Blueprint Gallery[]

Nightmare Lock Ingame.png (112 KB)

Nightmare Lock ingame with [Wolfgang](/wiki/Wolfgang "Wolfgang") for scale.

Nightmare Lock Unlocked.png (120 KB)

The Nightmare Lock unlocked by a Divining Rod.
