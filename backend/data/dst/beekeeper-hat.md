...
source_url: https://dontstarve.fandom.com/wiki/Beekeeper_Hat
---
...
| --- | --- | --- |
| **Dress Tab** | Armour Filter Clothing Filter Rain Gear Filter | Alchemy Engine |

Combat attributes

| [Protection](/wiki/Armor "Armor") |
| --- |
| 80% of damage taken from all types of Bees. |
...
750 HP  
1050 HP Don't Starve Together  
1312.5 [true hp](/wiki/Armor/DST#True_durability "Armor/DST")Don't Starve Together
...
**“**I like having a layer of netting between the bees and my face.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Beekeeper Hat** is a wearable [Armor](/wiki/Armor "Armor") item, crafted in the [Dress Tab](/wiki/Dress "Dress"). It requires 8 [Silk](/wiki/Silk "Silk") and 1 [Rope](/wiki/Rope "Rope") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

The Beekeeper Hat has 750 durability and absorbs 80% of damage taken from [Bees](/wiki/Bee "Bee") and [Killer Bees](/wiki/Killer_Bee "Killer Bee"). It is useful when a player is harvesting [Honey](/wiki/Honey "Honey") from a [Bee Box](/wiki/Bee_Box "Bee Box") or destroying [Beehives](/wiki/Beehive "Beehive").

## Gift Icon Downloadable Content[]

In all [DLCs](/wiki/DLC "DLC"), the Beekeeper Hat provides 20% [Wetness](/wiki/Wetness "Wetness") resistance during [Rain](/wiki/Rain "Rain"). In the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, it can be obtained from the [Slot Machine](/wiki/Slot_Machine "Slot Machine").

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the Beekeeper Hat additionally reduces damage taken from [Grumble Bees](/wiki/Grumble_Bees "Grumble Bees") and the [Bee Queen](/wiki/Bee_Queen "Bee Queen") by the same amount, making it very useful when farming [Royal Jelly](/wiki/Royal_Jelly "Royal Jelly"). It also has 40% more durability (1050).

The Beekeeper Hat also additionally reduces the stagger from getting hit by bee enemies, which can be useful in avoiding getting stun-locked by a large horde of Grumble Bees during the Bee Queen fight. With any other armor piece, the player may take many hits if they happen to get overwhelmed, which will not happen with the Beekeeper Hat equipped.

## Don't Starve Together Skins[]

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Beekeeper\_Hat](/wiki/Belongings#Beekeeper_Hat "Belongings")*
...
* The Beekeeper Hat was added in the *[October 2, 2012](/wiki/Version_History#October_2.2C_2012.5B18.5D "Version History")* update.

## Blueprint Gallery[]

* Expand slideshow

  [Wilson](/wiki/Wilson "Wilson") wearing a Beekeeper Hat.
* Expand slideshow

  [Willow](/wiki/Willow "Willow") wearing a Beekeeper Hat.
* Expand slideshow

  [Wolfgang](/wiki/Wolfgang "Wolfgang") wearing a Beekeeper Hat.
* Expand slideshow

  [Wendy](/wiki/Wendy "Wendy") wearing a Beekeeper Hat.
* Expand slideshow

  [WX-78](/wiki/WX-78 "WX-78") wearing a Beekeeper Hat.
* Expand slideshow

  [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing a Beekeeper Hat.
* Expand slideshow

  [Woodie](/wiki/Woodie "Woodie") wearing a Beekeeper Hat.
* Expand slideshow

  [Wes](/wiki/Wes "Wes") wearing a Beekeeper Hat.
* Expand slideshow

  [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing a Beekeeper Hat.
* Beekeeper Hat Wagstaff.png

  [Wagstaff](/wiki/Wagstaff "Wagstaff") wearing a Beekeeper Hat.
* Expand slideshow

  [Wigfrid](/wiki/Wigfrid "Wigfrid") wearing a Beekeeper Hat.
* Expand slideshow

  [Webber](/wiki/Webber "Webber") wearing a Beekeeper Hat.
* Expand slideshow

  [Walani](/wiki/Walani "Walani") wearing a Beekeeper Hat.
* Expand slideshow

  [Warly](/wiki/Warly "Warly") wearing a Beekeeper Hat.
* Expand slideshow

  [Wilbur](/wiki/Wilbur "Wilbur") wearing a Beekeeper Hat.
* Expand slideshow

  [Woodlegs](/wiki/Woodlegs "Woodlegs") wearing a Beekeeper Hat.
* Expand slideshow

  [Wilba](/wiki/Wilba "Wilba") wearing a Beekeeper Hat.
* Expand slideshow

  [Wormwood](/wiki/Wormwood "Wormwood") wearing a Beekeeper Hat.
* Expand slideshow

  [Wheeler](/wiki/Wheeler "Wheeler") wearing a Beekeeper Hat.
* Expand slideshow

  [Winona](/wiki/Winona "Winona") wearing a Beekeeper Hat.
* Expand slideshow

  [Wortox](/wiki/Wortox "Wortox") wearing a Beekeeper Hat.
* Expand slideshow

  [Wurt](/wiki/Wurt "Wurt") wearing a Beekeeper Hat.
* Beekeeper Hat Walter.png

  [Walter](/wiki/Walter "Walter") wearing a Beekeeper Hat.
