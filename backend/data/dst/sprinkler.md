...
source_url: https://dontstarve.fandom.com/wiki/Sprinkler
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Sprinkler?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
|  |
| --- |
| Put out nearby fires Grows Nettle Vine Makes Farm grow faster |
...
**“**A dynamic mechanical atomizer of H2O!**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Rain comes from within it's workings.**”**
...
**“**Relief fer tha'plants.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**TIS DRINKIES FOR WILBA FOODS.**”**
...
**“**I'll be honest, I'm probably going to run through it.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Sprinkler** is a craftable [Structure](/wiki/Structure "Structure") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is found in the [Food Tab](/wiki/Food_Tab "Food Tab"), requires 2 [Alloy](/wiki/Alloy "Alloy"), 1 [Blue Gem](/wiki/Blue_Gem "Blue Gem") and 6 pieces of [Ice](/wiki/Ice "Ice") to craft, and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. Sprinklers have a radius that requires them to be close to nearby [Water](/wiki/Lily_Pond "Lily Pond"). When built, a pipe appears which connects them to the water.

[Nettle Vines](/wiki/Nettle_Vine "Nettle Vine") that are planted near the Sprinkler will grow outside of [Humid Season](/wiki/Seasons/Humid "Seasons/Humid"). Additionally, farms planted within the Sprinkler radius will grow crops faster.

Sprinklers must be fueled, and the amount of fuel is indicated by a red gauge on the front similar to the [Ice Flingomatic](/wiki/Ice_Flingomatic "Ice Flingomatic"). It can accept any type of [Fuel](/wiki/Fuel_Values "Fuel Values"). A full tank allows the Sprinkler to run for approximately 7.5 min or 15 day segments.

If a player stands within the radius, they will quickly become wet from the Sprinkler at a rate of ~3 [Wetness](/wiki/Wetness "Wetness") per second. This can be prevented by wearing water-resistant or water-proofing items (eg., [Rain Coat](/wiki/Rain_Coat "Rain Coat"), [Eyebrella](/wiki/Eyebrella "Eyebrella"), [Umbrella](/wiki/Umbrella "Umbrella")).
