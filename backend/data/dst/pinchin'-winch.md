...
source_url: https://dontstarve.fandom.com/wiki/Pinchin'_Winch
---
...
| --- |
| Boards**×2** Cut Stone**×1** Rope**×2** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Seafaring Filter | Blueprint |

Perk

|  |
| --- |
| Allows recovering of [Underwater Salvageables](/wiki/Underwater_Salvageable "Underwater Salvageable"). |
...
**“**Thankfully, it saves me from having to dive down myself.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Pinchin' Winch** is a craftable [Structure](/wiki/Structure "Structure") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. The Pinchin' Winch [Blueprint](/wiki/Blueprint "Blueprint") can be bought in the [Bottle Exchange Filter](/wiki/Bottle_Exchange_Filter "Bottle Exchange Filter") for an [Empty Bottle](/wiki/Empty_Bottle#Don't_Starve_Together "Empty Bottle"). It requires 2 [Boards](/wiki/Boards "Boards"), 1 [Cut Stone](/wiki/Cut_Stone "Cut Stone") and 2 [Ropes](/wiki/Rope "Rope") to craft.

It can be placed on a [Boat](/wiki/Boat_Kit "Boat Kit") and is used to recover [Ocean Debris](/wiki/Ocean_Debris "Ocean Debris"), [Knobbly Tree Nuts](/wiki/Knobbly_Tree#Knobbly_Tree_Nut "Knobbly Tree") or [Underwater Salvageables](/wiki/Underwater_Salvageable "Underwater Salvageable").

## Trivia[]

* The Pinchin' Winch was introduced in the *[She Sells Sea Shells](/wiki/Return_of_Them#She_Sells_Sea_Shells "Return of Them")* update.
* The Pinchin' Winch can be built on land. If it is activated on land, it clinks against the ground. This is also its behaviour on docks.

## Gallery[]

Pinchin' Winch Placed Animation.gif (766 KB)

Animation of the Pinchin' Winch placed.

Pinchin' Winch Drop Animation.gif (1,011 KB)

Animation of the Pinchin' Winch dropped into the water.

Pinchin' Winch Pull Animation.gif (1.29 MB)

Animation of the Pinchin' Winch pulled out of the water.

Pinchin' Winch Pull Heavy Animation.gif (1.49 MB)

Animation of the Pinchin' Winch pulling a heavy object.

Pinchin' Winch Drop Ground Animation.gif (996 KB)

Animation of the Pinchin' Winch dropped, when build on the ground.
