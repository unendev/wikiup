...
source_url: https://dontstarve.fandom.com/wiki/Maxameleon
---
...
**“**I've only just arrived and already I've made a discovery.**”**
...
**“**Woodlegs liked tha other guy better.**”**
...
**Maxameleon** is a chameleon that can be seen at the beginning of the game, exclusive to the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC. It takes the role of introducing the player to the world just like Maxwell, to whom this name might be referencing. After the intro scene it can be examined before it disappears.
...
* Maxameleon's design is based on the [veiled chameleon](https://en.wikipedia.org/wiki/Veiled_chameleon "wikipedia:Veiled chameleon").
* Wickerbottom refers to Maxameleon as a "Chamaeleoninae Evaporatus", [Chamaeleoninae](https://en.wikipedia.org/wiki/Chamaeleoninae "wikipedia:Chamaeleoninae") being the biological classification for chameleons. "Evaporatus" may refer to it disappearing after the intro.
* Maxameleon's name is a portmanteau of the words "[Maxwell](/wiki/Maxwell "Maxwell")" and "Chameleon," as well as the name Maximilian.
