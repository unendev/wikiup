...
source_url: https://dontstarve.fandom.com/wiki/Boards
---
...
| --- |
| Log**×4 Lucy the Axe×1 Log×3 (Woodie only in Don't Starve Together)** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | Don't Starve Together[Skill Required](/wiki/Skill "Skill") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- | --- |
| **Refine Tab** | Refined Materials FilterWoodie Filter | Woodworker | Science Machine |
...
|  |
| --- |
| Used to make the majority of structures. |

## Sources

### Dropped by

Sunken Boat, Crate (Hammer)
...
**“**Board fabrication without planing tools! Extraordinary!**”**
...
**“**I'd be board too, if I just lay around all day.**”**
...
**“**It's a board. How untoward!**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Tree pieces for building, florp.**”**
...
**“**I'm already bored of looking at them.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Boards** are [Refined](/wiki/Refined "Refined") [Items](/wiki/Items "Items") crafted with 4 [Logs](/wiki/Log "Log") used in the construction of various items and structures. A [Science Machine](/wiki/Science_Machine "Science Machine") is required to prototype them. Boards are also highly flammable and can be used as [Fuel](/wiki/Fuel "Fuel"). Boards can be directly used to repair [Boats](/wiki/Boat_Kit "Boat Kit").

Due to the fact that 4 Logs refine into 1 Board, and Boards stack up to 10 (40 logs), it is more efficient to carry a single stack of Boards than two stacks of 20 Logs. One can also store more wood in a container if they convert them to Boards. It must be noted, however, that Boards cannot be used in recipes that require logs, such as [Campfires](/wiki/Campfires "Campfires").
...
**[Seafaring](/wiki/Seafaring_Tab "Seafaring Tab"):**
...
**[Engineering](/wiki/Engineering_Tab "Engineering Tab"):**
...
**[Celestial](/wiki/Celestial_Tab "Celestial Tab"):**
...
**[Spider Care](/wiki/Spider_Care_Tab "Spider Care Tab"):**
...
* In the old research system, a Board's [research cost](/wiki/Research_points_list "Research points list") was 30.
