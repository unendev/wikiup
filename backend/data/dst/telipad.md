...
source_url: https://dontstarve.fandom.com/wiki/Telipad
---
...
| --- |
| Gears**×1** Electrical Doodad**×1** Cut Stone**×2 (Wagstaff)** |
...
|  |
| --- |
| Used as receiver pad for teleportation with the [Telebrella](/wiki/Telebrella "Telebrella"). |
...
**“**A landing pad for jumping through space.**”**

–[Willow](/wiki/Willow "Willow")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is for making disappear-y things into reappear-y things.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It can retreive me from the aether.**”**

–[Wendy](/wiki/Wendy "Wendy")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**CARRIAGE RETURN FOR A TELEPORTATION UNIT**”**

–[WX-78](/wiki/WX-78 "WX-78")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A teleportation receptical.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It works with the umbrella thing somehow.**”**
...
**“**Returns me fröm anöther realm.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's a teleportation pad. But it needs an umbrella thing to work.**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A nice cozy metal thing to teleport to.**”**

–[Walani](/wiki/Walani "Walani")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A lot better than the Paris Metro.**”**
...
**“**A landing pad for a teleporter.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Telipad** is a [Character](/wiki/Characters "Characters")-exclusive [Structure](/wiki/Structure "Structure") craftable only by [Wagstaff](/wiki/Wagstaff "Wagstaff"). It is found in the [Tinkering Tab](/wiki/Tinkering_Tab "Tinkering Tab"), and requires [Gears](/wiki/Gears "Gears"), an [Electrical Doodad](/wiki/Electrical_Doodad "Electrical Doodad") and two [Cut Stones](/wiki/Cut_Stone "Cut Stone") to craft.

The Telipad is used in conjunction with the [Telebrella](/wiki/Telebrella "Telebrella") to be able to teleport. It is placed at a set location and can be teleported to as long as the player is within a certain range, indicated by the blinking light on top of the Telebrella. In the base game, only a limited number of Telipad can be built per world, as Gears are a non-renewable resource. In DLCs gears are renewable through multiple ways.

## Blueprint Gallery[]

Along Came A Spider Telipad.png (20 KB)

Telipad in a short film *Along Came A Spider*
