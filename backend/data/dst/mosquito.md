...
source_url: https://dontstarve.fandom.com/wiki/Mosquito
---
...
Mosquito Sack 50%, Mosquito (Bug Net)

### Spawns from

Pond ([Marsh](/wiki/Marsh "Marsh"))  
Tumbleweed (0.1%) https://static.wikia.nocookie.net/dont-starve-game/images/f/f8/Reign of Giants icon.png/revision/latest?cb=20140408110712Don't Starve Together  
Lily Pad Hamlet  
Skeeter Bomb Don't Starve Together
...
**“**It's trying to drain the life right out of me!**”**

–[Wanda](/wiki/Wanda "Wanda")

A **Mosquito** is a hostile [Mob](/wiki/Mobs "Mobs") that spawns from [Ponds](/wiki/Ponds "Ponds"), at [Dusk](/wiki/Dusk "Dusk") and Night, in [Marsh](/wiki/Marsh "Marsh") [Biomes](/wiki/Biome "Biome"). Mosquitoes are fast-moving and aggressive.

Because they deal a relatively small amount of damage, farming them can be profitable for health from their [Mosquito Sacks](/wiki/Mosquito_Sack "Mosquito Sack"). They have a small red blood sac which grows with each successful attack. On the fourth successful attack, the Mosquito will explode and cause additional damage to its surroundings.

Mosquitoes will not spawn during [Winter](/wiki/Winter "Winter"), as their Ponds will be frozen throughout the season.
...
The most effective way to deal with Mosquitoes is to capture them with a [Bug Net](/wiki/Bug_Net "Bug Net"). When caught, the Mosquito will turn into an [Item](/wiki/Item "Item") in the player's [Inventory](/wiki/Inventory "Inventory"), which can be Murdered for a 50% chance of getting a Mosquito Sack. Due to their fast flying speed, Mosquitoes are difficult to hit with melee [weapons](/wiki/Weapons "Weapons"). When hit, the Mosquito will be "stunlocked" and spin around for a moment before recovering. This makes them very easy to kill in a 1v1 fight.

In *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")*, wearing any kind of head and body [Armor](/wiki/Armor "Armor") at the same time will prevent the player from taking damage and being stunlocked by Mosquitoes. The player still takes damage from the explosion.

Mosquitoes take one blast from the [Ice Staff](/wiki/Ice_Staff "Ice Staff") to be frozen and one [Sleep Dart](/wiki/Sleep_Dart "Sleep Dart") to be put to sleep.

## Downloadable Content[]

In all [DLCs](/wiki/DLC "DLC"), Mosquitoes inside the player's inventory will starve in 2 days unless fed. They can be fed with anything edible to the player, even [Mandrakes](/wiki/Mandrake "Mandrake"), [Deerclops Eyeballs](/wiki/Deerclops_Eyeball "Deerclops Eyeball"), [Rot](/wiki/Rot "Rot"), and such.

In the *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* DLC, Mosquitoes can be collected by harvesting [Tumbleweeds](/wiki/Tumbleweed "Tumbleweed").

In the [Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked") DLC, Mosquitoes are replaced by their [Poisonous](/wiki/Poison_Mosquito "Poison Mosquito") variant, spawning from puddles and [Mangroves](/wiki/Mangrove "Mangrove") in [Monsoon](/wiki/Seasons/Monsoon "Seasons/Monsoon") season.

In the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, Mosquitoes spawn from [Lily Pads](/wiki/Lily_Pad "Lily Pad") in the [Lily Ponds](/wiki/Lily_Pond "Lily Pond") [Biome](/wiki/Biome "Biome") during Dusk and Night.
...
* Mosquitoes were added in *[A Little Rain Must Fall](/wiki/Version_History#A_Little_Rain_Must_Fall "Version History")* update.
* Mosquitoes originally spawned from the same Ponds as [Frogs](/wiki/Frogs "Frogs"), but that has been changed so each spawns from separate, different colored Ponds (Mosquito Ponds are darker).
* Before the *[All's Well That Maxwell](/wiki/New_Features#October_22.2C_2013_-_All.27s_Well_that_Maxwell "New Features")* update, Mosquitoes did not drop anything.
* Real-life mosquitoes lay their eggs in stagnant water, which explains why Mosquitoes spawn from Ponds in game.

## Gallery[]

Mosquito All Stages.png (87 KB)

All stages of a Mosquito.

Mosquito Flying Animation.gif (176 KB)

Animation of a Mosquito flying..

Mosquito Attacked Animation.gif (135 KB)

Animation of a Mosquito getting attacked.

Mosquito Sleeping Animation.gif (293 KB)

Animation of a Mosquito sleeping.

Mosquito Exploding Animation.gif (194 KB)

Animation of a Mosquito exploding.

Mosquito Pond Ingame.jpg (159 KB)

A mosquito spawning pond.

Frozen Mosquito.PNG (7 KB)

A frozen mosquito.

Mosquitotrap.png (13 KB)

Maxwell's Mosquito trap; an unimplemented item.

Mosquito Pond and Frog Pond.png (1.11 MB)

Wilson next to a Frog [Pond](/wiki/Pond "Pond") and a Mosquito Pond.
