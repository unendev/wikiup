...
source_url: https://dontstarve.fandom.com/wiki/Blunderbuss
---
...
"Loud and messy, but gets the job done."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Boards**×2** Tenpiece Oinc**×1** Gears**×1** |
...
| --- |
| 200 (10 Weapon)  150 (7.5 Weapon) WendyWes250 (12.5 Weapon) Wigfrid100-400 (5-20 Weapon) Wolfgang |
...
|  |
| --- |
| Requires [Gunpowder](/wiki/Gunpowder "Gunpowder") to load. |
...
**“**A magnificent killing instrument. Such a sleek design.**”**
...
The **Blunderbuss** is a craftable [Weapon](/wiki/Weapon "Weapon") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is found in the [Fight Tab](/wiki/Fight_Tab "Fight Tab"), requires 2 [Boards](/wiki/Boards "Boards"), a [Tenpiece Oinc](/wiki/Tenpiece_Oinc "Tenpiece Oinc"), and [Gears](/wiki/Gears "Gears") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

The Blunderbuss needs to be loaded with [Gunpowder](/wiki/Gunpowder "Gunpowder") to be able to fire. However, it can be used as a very weak melee weapon while unloaded. When loaded, a small red light can be seen on it, suggesting it is a matchlock gun.

Because the Blunderbuss deals the exact same damage as the Gunpowder used to load it does, this makes it much easier, predictable and practical to use from range when compared to having to light Gunpowder on its own on the ground.

Unlike the explosion of the Gunpowder on the ground, the Blunderbuss will not cook [meat](/wiki/Meats "Meats") or set any flammable items on fire, this can make the Blunderbuss all the more useful for boss mobs.

## Placeholder Trivia[]

* Blunderbuss is one of four [Weapons](/wiki/Weapon "Weapon") that can be loaded by items, others being [Spear Gun](/wiki/Spear_Gun "Spear Gun"), [Pew-matic Horn](/wiki/Pew-matic_Horn "Pew-matic Horn") and the [Trusty Slingshot](/wiki/Trusty_Slingshot "Trusty Slingshot")
* Blunderbuss can also be crafted using 10 [Oincs](/wiki/Oinc "Oinc") or 1 [Centapiece Oinc](/wiki/Centapiece_Oinc "Centapiece Oinc"). If using Centapiece Oinc, 1 Tenpiece Oinc will be used and 9 Tenpiece Oincs will be returned.
