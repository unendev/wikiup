...
source_url: https://dontstarve.fandom.com/wiki/Shell_Beach_Turf
---
...
"A soft patch of sand scattered with shells."

Crafting

| [Recipe](/wiki/Crafting "Crafting") | Amount produced |
| --- | --- |
| Broken Shell (DST)**×1** Rocks**×1** | 4 |
...
[Hermit Island](/wiki/Hermit_Island "Hermit Island") turf (Pitchfork)
...
**“**That's a chunk of sandy ground.**”**
...
**Shell Beach Turf** is one of the [Turf](/wiki/Turfs "Turfs") items exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*.

It can be acquired by digging Shell Beach tiles on [Hermit Island](/wiki/Hermit_Island "Hermit Island") with a [Pitchfork](/wiki/Pitchfork "Pitchfork"). The Shell Beach Turf [Blueprint](/wiki/Blueprint "Blueprint") can be bought in the [Bottle Exchange Filter](/wiki/Bottle_Exchange_Filter "Bottle Exchange Filter") for 3 [Empty Bottles](/wiki/Empty_Bottle#Don't_Starve_Together "Empty Bottle"). It requires 1 [Broken Shell](/wiki/Broken_Shell "Broken Shell") and 1 [Rocks](/wiki/Rocks "Rocks") to craft.

## Placeholder Trivia[]

* The Shell Beach Turf was introduced in the *[She Sells Sea Shells](/wiki/Return_of_Them#She_Sells_Sea_Shells "Return of Them")* update.

## Blueprint Gallery[]

Shell beach texture.png (312 KB)

Shell Beach Turf texture.
