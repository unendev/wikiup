...
source_url: https://dontstarve.fandom.com/wiki/Sapling
---
...
Twigs  
Sapling Item (ShovelRegal ShovelBrightshade Shoevel)
...
Sapling (ShovelRegal ShovelBrightshade Shoevel)
...
[Beach](/wiki/Beach "Beach") Shipwrecked  
[Magma Field](/wiki/Magma_Field "Magma Field") Shipwrecked  
[Rainforest](/wiki/Rainforest "Rainforest") Hamlet  
[Wild Plains](/wiki/Wild_Plains "Wild Plains") Hamlet
...
**“**I want to see it grow so I can chop it down.**”**
...
**“**I predict it will be a tree soon enough.**”**
...
**“**Kind of twiggy. I can work with twigs.**”**
...
**“**It has delusions of being a tree.**”**
...
**“**For some reason, these ones don't seem to grow any bigger.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Saplings** are small [Plants](/wiki/Plants "Plants") found commonly in [Grasslands](/wiki/Grasslands "Grasslands") and [Forests](/wiki/Forest "Forest"). They can be picked to provide 1 [Twig](/wiki/Twig "Twig"), after which they will need 4 days to regrow. Saplings can be dug up with a [Shovel](/wiki/Shovel "Shovel") and replanted in a new location (typically closer to a base camp). Saplings can't be planted on [Checkerboard Floorings](/wiki/Checkerboard_Flooring "Checkerboard Flooring"), [Wooden Floorings](/wiki/Wooden_Flooring "Wooden Flooring"), [Cobblestones](/wiki/Cobblestone "Cobblestone"), [Carpeted Floorings](/wiki/Carpeted_Flooring "Carpeted Flooring"), [Rocky Turfs](/wiki/Rocky_Turf "Rocky Turf"), [Sandy Turfs](/wiki/Sandy_Turf "Sandy Turf"), and [Cave Rock Turfs](/wiki/Cave_Rock_Turf "Cave Rock Turf"), unless it has been planted before these [turfs](/wiki/Turf "Turf") were placed. Unlike [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft") and [Berry Bushes](/wiki/Berry_Bushes "Berry Bushes"), Saplings don't require fertilization to regrow after being replanted. This is similar to [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), which can be harvested without fertilization.

They are also highly flammable, and may be used as fuel in [Campfires](/wiki/Campfires "Campfires") or [Fire Pits](/wiki/Fire_Pits "Fire Pits"). When burned on the ground, a Sapling will leave behind 1 [Ash](/wiki/Ashes "Ashes"). Because they burn easily, Saplings planted close together are very susceptible to [Lightning](/wiki/Lightning "Lightning") strikes. This can be prevented by building [Lightning Rods](/wiki/Lightning_Rod "Lightning Rod"). Saplings will not regrow during [Winter](/wiki/Winter "Winter"). They are renewable in the Caves by using the [Seed of Ruin](/wiki/Seed_of_Ruin "Seed of Ruin").

Despite their name and [comments](/wiki/Character_quotes "Character quotes") from some characters, Saplings will never grow into [Trees](/wiki/Tree "Tree").

Saplings, along with other items, like [Log Suits](/wiki/Log_Suit "Log Suit"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), and [Boards](/wiki/Boards "Boards"), have the longest burn time.

## Downloadable Content[]

In the *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* DLC, Saplings will turn into Withered Saplings during [Summer](/wiki/Summer "Summer"). During this condition, Saplings are unharvestable for their Twigs and digging these will yield 1 Twig. A way of curing or preventing these from withering is to simply apply [fertilizers](/wiki/Category:Fertilizer "Category:Fertilizer") or build an [Ice Flingomatic](/wiki/Ice_Flingomatic "Ice Flingomatic") nearby.

In the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, Saplings will turn into Withered Saplings during [Dry Season](/wiki/Dry_Season "Dry Season"). They can be found in [Beach](/wiki/Beach "Beach") and [Magma Field](/wiki/Magma_Field "Magma Field") [Biome](/wiki/Biome "Biome").

In the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, Saplings can be found in [Rainforest](/wiki/Rainforest "Rainforest") and [Wild Plains](/wiki/Wild_Plains "Wild Plains") Biome.

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Saplings can get replaced by [Twiggy Trees](/wiki/Twiggy_Tree "Twiggy Tree") on world generation as an alternative source for Twigs. Also, Saplings are renewable in *Endless* and *Wilderness* [Game Modes](/wiki/Don%27t_Starve_Together#Game_Modes "Don't Starve Together") through [Resource Renewal](/wiki/Regrowth#Resource_Renewal "Regrowth"), or in the other game modes when enabling Basic Resources Regrowth in the [World Customization](/wiki/World_Customization/Don%27t_Starve_Together "World Customization/Don't Starve Together").
...
Twigs  
Lunar Sapling Item (ShovelRegal ShovelBrightshade Shoevel)
...
| --- |
| Twigs**×5** Health Decrease**×5 (Wormwood only)** |

| [Filter](/wiki/Filters "Filters") | [Skill Required](/wiki/Skill "Skill") |
| --- | --- |
| Wormwood Filter | Sapling Crafting |

## Item Properties

### Dropped by

Lunar Sapling (ShovelRegal ShovelBrightshade Shoevel)

### [Fuel Value](/wiki/Fire#Fuel_Values "Fire")

Fire Pit360 secCampfire180 sec
...
[Lunar Forest](/wiki/Lunar_Forest "Lunar Forest") Don't Starve Together  
[Lunar Baths](/wiki/Lunar_Baths "Lunar Baths") Don't Starve Together
