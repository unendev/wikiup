...
source_url: https://dontstarve.fandom.com/wiki/Coral_Reef
---
...
**Coral ×2-4 (Pickaxe)  
Limestone ×1-3 Coral Larva (Hammer)**
...
[Coral Reefs](/wiki/Coral_Reefs "Coral Reefs")
...
**“**Ye better steer clear, Woodlegs.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**PRETTY ROCKS 'NEATH THE WATER**”**
...
When mined with a [Pickaxe](/wiki/Pickaxe "Pickaxe"), Coral Reefs drop 2-4 pieces of Coral total. After being mined, they can be [Hammered](/wiki/Hammer "Hammer") to drop 1-3 [Limestones](/wiki/Limestone "Limestone") and a [Coral Larva](/wiki/Coral_Larva "Coral Larva"). If the rock is not hammered, the Coral will fully grow back after 12 [Days](/wiki/Day "Day"). It has a heavily increased grow rate during rain, similar to [Mushrooms](/wiki/Mushrooms "Mushrooms"). It is also possible to replant Coral Reefs using [Coral Nubbins](/wiki/Coral_Nubbin "Coral Nubbin").

## Placeholder Trivia[]

* The option to replant Coral Reefs was added to the *Shipwrecked* DLC more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21st,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.
* Before the *Home Sea Home* update, the Coral Reef's Limestone used to sink, and the only way to retrieve it was by using a [Trawl Net](/wiki/Trawl_Net "Trawl Net").

## Mosquito Bugs[]

* Sometimes, Coral Reefs will not regenerate offscreen after 12 days when the player is too far away from them.
* Some Coral Reefs may spawn on top of (or very close to) other objects (like a [Seaweed Plant](/wiki/Seaweed_Plant "Seaweed Plant") or other Coral Reefs), making them impossible to harvest.

## Blueprint Gallery[]

Coral Reef Ingame.png (1.1 MB)

A coral reef biome with its inhabitants.

Ballphin Palace Coral Reef.png (1.37 MB)

A Coral Reef containing a Ballphin Palace.

Ballphin Palace at Dusk.png (238 KB)

A inhabited Ballphin Palace at Dusk.

Wickerbottom's coral reef.png (1,009 KB)

[Wickerbottom](/wiki/Wickerbottom "Wickerbottom") mining some Coral Reefs.

Coral Reef Terrain Texture.png (315 KB)

Terrain texture used for Coral Reefs.
