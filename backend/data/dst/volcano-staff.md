...
source_url: https://dontstarve.fandom.com/wiki/Volcano_Staff
---
...
| --- |
| Fire Staff**×1** Obsidian**×4** Dragoon Heart**×1** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") |
| --- |
| **Volcanic Tab** |
...
|  |
| --- |
| Creates a [Fire Rain](/wiki/Volcano "Volcano"). |

## Sources

### Dropped by

Chest of the Depths X Marks The Spot
...
**“**Such power focused into a portable staff! Magnificent!**”**
...
**“**Ye'll do me biddin' now, 'cano!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA SPIT FWOOSHING, SPOUT RAIN!**”**
...
The **Volcano Staff** is a [Volcanic](/wiki/Volcanic "Volcanic") [Item](/wiki/Item "Item") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It requires 1 [Fire Staff](/wiki/Fire_Staff "Fire Staff"), 4 [Obsidian](/wiki/Obsidian "Obsidian") and 1 [Dragoon Heart](/wiki/Dragoon_Heart "Dragoon Heart") to craft. It can also occasionally be found in [X Marks the Spot](/wiki/X_Marks_the_Spot "X Marks the Spot") Treasure Chests, has a 50% chance of being found in the [Chest of the Depths](/wiki/Chest_of_the_Depths "Chest of the Depths") dropped by the [Quacken](/wiki/Quacken "Quacken") and by the bodies failed survivors. with 3-5 uses. Additionally, the staff can be found as [Set Piece](/wiki/Set_Piece#Volcano_Staff_Trap "Set Piece") with the staff in the middle and 6 [Obsidian](/wiki/Obsidian "Obsidian") forming a circle around it. When the staff is picked up from the Set Piece, even by a [Prime Ape](/wiki/Prime_Ape "Prime Ape"), the Volcano immediately erupts and Dragoon Eggs rain from the sky. Like all items in the [Volcanic Tab](/wiki/Volcanic_Tab "Volcanic Tab"), it cannot be prototyped and the player must be wearing a [Brain of Thought](/wiki/Brain_of_Thought "Brain of Thought") or be near an [Obsidian Workbench](/wiki/Obsidian_Workbench "Obsidian Workbench") to craft it again.

When used, it rains down [Dragoon Eggs](/wiki/Dragoon_Egg "Dragoon Egg") where the spell was cast. There is a small chance for some of the Dragoon Eggs to stay intact, and [Lava Pools](/wiki/Lava_Pool "Lava Pool") will also form. When the player is on land, the Volcano Staff can only be targeted on land terrain. If cast close to the ocean, dragoon eggs may fall in the ocean and create [Big Waves](/wiki/Waves "Waves"). When the player's on boat, it can only be targeted on sea terrain.
...
The Set Piece - picking up the Volcano Staff will start a Volcano eruption.

 

When the Volcano Staff is brought to a base game, *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* or *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* world via the [Seaworthy](/wiki/Seaworthy "Seaworthy") or [Skyworthy](/wiki/Skyworthy "Skyworthy") and used there, it will fail to activate and nothing will happen, accompanied by the player's character saying that it will not work there.

## Prototype Tips[]

* When cast on a dead [Whale](/wiki/Whale "Whale"), each Dragoon Egg that hits the carcass will advance the bloating stage by 1.
* The Volcano Staff can be used on a herd of [Water Beefalo](/wiki/Water_Beefalo "Water Beefalo") when they are grouped together at dusk and night. Surrounding [Mangrove Trees](/wiki/Mangrove_Tree "Mangrove Tree") will be harvested if hit but will otherwise regrow. This method is better than using [Boat Cannon](/wiki/Boat_Cannon "Boat Cannon"), [Coconade](/wiki/Coconade "Coconade"), or [Obsidian Coconade](/wiki/Obsidian_Coconade "Obsidian Coconade") since there is less chance of spreading fire and burning down the biome. Be aware that Crocodogs and Sea Hounds are likely to spawn due to the massive amount of meat dropped.
* Similar to using explosives, casting the Volcano Staff on a cluster of [Magma Piles](/wiki/Magma_Pile "Magma Pile") results in higher quality drops and [Krissures](/wiki/Krissure "Krissure"). It can also be used on Obsidian Boulders in lieu of gunpowder. Having [Ice](/wiki/Ice "Ice") ready to use on any Lava Pools spawned is recommended for even more Obsidian gained.
* The Volcano Staff is useful for mining and relocating large amounts of [Coral](/wiki/Coral "Coral") quickly as an alternative to Boat Cannons and Coconades.

## Mosquito Bugs[]

* On console editions, having a Boat Lantern equipped prevents the use of the Volcano Staff while at sea. Removing the lantern will allow normal use of the staff. This bug also prevents use of other equipment such as the Spyglass while on a boat.

## Placeholder Trivia[]

* The crafting description is a reference to the folk tale *[Henny Penny](https://en.wikipedia.org/wiki/Henny_Penny "wikipedia:Henny Penny")*, more commonly known as "Chicken Little", in which the same phrase is repeatedly used to indicate the end of the world.
* If the player is killed by their own summoned Dragoon Eggs, the cause of death in the [Morgue](/wiki/Morgue "Morgue") will be listed as "Shenanigans".

## Blueprint Gallery[]

Wilsonusingstaff.jpg (508 KB)

[Wilson](/wiki/Wilson "Wilson") using the Volcano Staff.

Wilsonusingstaff2.jpg (507 KB)

Sample results of using the Volcano Staff.
