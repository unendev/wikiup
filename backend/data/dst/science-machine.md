...
source_url: https://dontstarve.fandom.com/wiki/Science_Machine
---
...
| --- |
| Gold Nugget**×1** Log**×4** Rocks**×4** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| Science Tab | Prototypers & Stations Filter Structures Filter | Always available. |

Perk

|  |
| --- |
| Unlocks additional [Crafting](/wiki/Crafting "Crafting") recipes. |
...
**“**How interesting! Proximity affects its usability.**”**
...
**“**Time to make some discoveries of the scientific variety!**”**
...
**“**Mortals play such silly games.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Funny-hair man say "Science" come out of it?**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I never knew science was such an important part of survival.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I really want to know what makes it tick...**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Science Machine** is the tier 1 [Science](/wiki/Science "Science") station. It costs 1 [Gold Nugget](/wiki/Gold_Nugget "Gold Nugget"), 4 [Logs](/wiki/Log "Log"), and 4 [Rocks](/wiki/Rocks "Rocks") to craft, and it is available from the start of the game. Like other Prototyper, standing near the Science Machine allows prototyping new recipes. Prototyping [Items](/wiki/Items "Items") for the first time will grant the player 15 [Sanity](/wiki/Sanity "Sanity"). Once prototyped, items can be crafted without being near a Science Machine.

GlommerSee also: [Crafting](/wiki/Crafting "Crafting")

## Downloadable Content[]

In the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, Science Machine can be [flooded](/wiki/Flooding "Flooding") causing it to malfunction and become unusable.

## Tips[]

* When [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") is near a Science Machine, it acts as an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine"), as she is already able to craft tier 1 science items, thus making the Science Machine serve as a tier 2 Science station.
...
* In the [early Beta](/wiki/Don%27t_Starve/Version_History "Don't Starve/Version History") version of *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")*, the game used a "[Research Points](/wiki/Research_points_list "Research points list")" system, instead of prototyping. When [Wilson](/wiki/Wilson "Wilson") examines the Science Machine, he states that "It breaks down items into their scientific components", which is a leftover dialogue script from when the game used Research Points.
* Its old crafting description was "*Probe the depths of the universe!*".
* The main section of this machine bears a resemblance to the weighted storage cubes in [Valve](https://en.wikipedia.org/wiki/Valve_Corporation "wikipedia:Valve Corporation")'s *[Portal](https://en.wikipedia.org/wiki/Portal_(series) "wikipedia:Portal (series)")* series.
...
Science Machine.gif (329 KB)

The animation played when the player is near a Science Machine.

Burnt Science Machine.png (43 KB)

A burnt Science Machine from the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC.

ScienceMachine.png (38 KB)

An idle Science Machine.

Valentines 2018 1.png (6.86 MB)

Science Machine as seen on the 2018 Valentine Cards.

Dont Starve research machines gif by Kelly.gif (988 KB)

Dont Starve research machines gif by Kelly [[1]](#cite_note-1)

Bachelor of Science.jpg (174 KB)

In "Bachelor of Science" achivment
