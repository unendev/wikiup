...
source_url: https://dontstarve.fandom.com/wiki/Napsack
---
...
| --- | --- |
| Shroom Skin**×1** Canary (Volatile)**×1** | 4 |
...
**“**It's more humane than a stink bomb.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Who would want to spend precious time napping?**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Napsack** is a [Weapons Filter](/wiki/Weapons_Filter "Weapons Filter") [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. To prototype it, players need its [Rare Blueprint](/wiki/Blueprint "Blueprint"), which is dropped by the [Misery Toadstool](/wiki/Toadstool "Toadstool"). Four Napsacks can be crafted using a [Shroom Skin](/wiki/Shroom_Skin "Shroom Skin") and a Poisoned [Canary](/wiki/Canary "Canary").

Napsacks can be thrown, similar to [Water Balloons](/wiki/Water_Balloon "Water Balloon"), to create a sleep cloud, causing all nearby [Mobs](/wiki/Mobs "Mobs") to go to sleep for a maximum of 20 seconds.

## Prototype Tips[]

* Napsacks can be used to duplicate Shroom Skin by using a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff"), since four Napsacks are made each batch. Since [Green Gems](/wiki/Green_Gem "Green Gem") are renewable through [Tumbleweeds](/wiki/Tumbleweed "Tumbleweed"), [Dragonfly](/wiki/Dragonfly "Dragonfly") and [Ruins regeneration](/wiki/Ruins#Don't_Starve_Together "Ruins"), this can be used to mass-produce Shroom Skins from at least one skin.

## Placeholder Trivia[]

* "Napsack" is a portmanteau of the words "nap" and "knapsack".
* The Napsack was added in an unnamed [Bonus Update](/wiki/Don%27t_Starve_Together/Version_History#May_18,_2017_-_Bonus_Update "Don't Starve Together/Version History") after the completion of *A New Reign*.
* A "Knapsack" (or "Napsack") is a sack-like strapped carry-on, similar to a backpack.

## Blueprint Gallery[]

Wilson napsack.png (130 KB)

[Wilson](/wiki/Wilson "Wilson") holding a Napsack.

Napsack throwing new.gif (9.75 MB)

Wilson tossing a Napsack, causing the targets to fall asleep.
