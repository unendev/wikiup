...
source_url: https://dontstarve.fandom.com/wiki/Horror_Hound
---
...
|  |
| --- |
| `"mutatedhound"` `"houndcorpse" (transformation)` |
...
**“**What if I'm actually inside out, and it's rightside in?**”**
...
The **Horror Hound** is a [Monster](/wiki/Monster "Monster") [Mob](/wiki/Mobs "Mobs") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, and introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*.

They have a 50% chance to spawn when a normal [Hound](/wiki/Hound "Hound") dies on the [Lunar Island](/wiki/Lunar_Island "Lunar Island"). The Hound's corpse will stay on the screen after dying, and begin shaking before erupting into a Horror Hound after 4 to 5 seconds.
...
* Horror Hounds were introduced in the *[Turn of Tides](/wiki/Return_of_Them#Turn_of_Tides "Return of Them")* update.
* It's color scheme was changed within the *Turn of Tides* beta from a reddish hue to a more pale complexion.

## Blueprint Gallery[]

Horror Hound All Sides.png (417 KB)

Horror Hound from the front, side and back.

Horror Hound Old.png (1.48 MB)

The old color scheme of the Horror Hound.

RWP 276 Doodle Jam 3.png (844 KB)

Maxwell, Wormwood, and Wortox running away from a **Horror Hound** in a drawing from *Rhymes With Play* #276.

Art Stream 80 Horror Hound.png (1.16 MB)

A Horror Hound as seen in a drawing from Art Stream # 80.
...
Horror Hound Dead.png (145 KB)

Dead Horror Hound.

Horror Hound Sleeping.png (168 KB)

Sleeping Horror Hound.
