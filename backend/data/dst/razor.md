...
source_url: https://dontstarve.fandom.com/wiki/Razor
---
...
Pigg and Pigglet's General Store (Oinc ×3) Hamlet icon
...
**“**Shavin's fer princes and lawyers.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**FOR HAIR ON'ST CHINNY CHIN CHIN.**”**
...
**“**I've never seen a serrated razor before.**”**
...
The **Razor** is a craftable [Tool](/wiki/Tool "Tool") [Item](/wiki/Item "Item") found in the [Tools](/wiki/Tools "Tools") Tab. It requires 2 [Twigs](/wiki/Twigs "Twigs") and 2 [Flints](/wiki/Flint "Flint") to craft, and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. Unlike other Tools, on pc it cannot be equipped, and to be used it has to be lifted and used on a target instead. Players using a [Controller](https://en.wikipedia.org/wiki/controller "wikipedia:controller") have to simply be near an entity that can be shaved for the "Shave" prompt to appear. Since it has no [durability](/wiki/Durability "Durability"), the Razor has infinite uses.

The Razor can be used to shave [Wilson](/wiki/Wilson "Wilson")'s Beard, which provides leftover [Beard Hair](/wiki/Beard_Hair "Beard Hair"). To shave the Beard, simply right-click the Razor while it's in the inventory, or hover over the target. The amount of Beard Hair received depends on the beard's length. The Razor can also be used to shave [Beefalos](/wiki/Beefalo "Beefalo") while they are sleeping (whether at night or when put to sleep using [Sleep Darts](/wiki/Sleep_Dart "Sleep Dart"), a [Life Giving Amulet](/wiki/Life_Giving_Amulet "Life Giving Amulet"), or a [Pan Flute](/wiki/Pan_Flute "Pan Flute")), resulting in 3 [Beefalo Wool](/wiki/Beefalo_Wool "Beefalo Wool"). This requires taking it out of the inventory and hovering over the beefalo. The Beefalo will not wake up after being shaved, but Beefalo in [heat](/wiki/Beefalo#Mating_Season "Beefalo") will sometimes wake up and attack. In [Dont starve together](/wiki/Don%27t_Starve_Together "Don't Starve Together"), you can use a razor to shave [sea weeds](/wiki/Sea_Weed "Sea Weed") for up to 3 [barnacles](/wiki/Barnacles "Barnacles"). This depends on how many barnacles the sea weed has, and will aggravate any nearby sea weeds.
...
In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC (and by extension, *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*), [Webber](/wiki/Webber "Webber") can also use the Razor to shave his Beard. The amount of [Silk](/wiki/Silk "Silk") received depends on the Beard's length.

At this point, in the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, the Razor cannot be used to shave [Water Beefalo](/wiki/Water_Beefalo "Water Beefalo").

In the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC, Razors can be used to shave [Hedges](/wiki/Hedge "Hedge") for 1 [Clippings](/wiki/Clippings "Clippings") each.

## Don't Starve Together Skins[]

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Razor](/wiki/Belongings#Razor "Belongings")*
...
* Wearing a [Beefalo Hat](/wiki/Beefalo_Hat "Beefalo Hat") prevents Beefalo in heat from attacking the [Character when](/wiki/Character "Character") they're shaving them.
* A good tip is to not shave a Beard until the first Winter is over, as the Beard (unlike [Clothes](/wiki/Clothes "Clothes")) will not wear out, providing insulation as long as the player doesn't shave.
  + In DLCs, it is advised to shave at the beginning of [Summer](/wiki/Summer#Reign_of_Giants "Summer")/[Dry Season](/wiki/Dry_Season "Dry Season") due to the Beard accelerating the rate at which Wilson and Webber overheat and providing no benefits when fully grown during those [Seasons](/wiki/Seasons "Seasons").

## Placeholder Trivia[]

* Even though other Characters have facial hair, they are unable to shave. When examining the Razor, they will bring up an excuse for not doing it. For instance, [Woodie](/wiki/Woodie "Woodie") says that "A true lumberjack never shaves."
...
Wilson Razor2.png (336 KB)

Wilson shaving a Beefalo put to sleep using the Pan Flute.

Shave Beefalo.png (499 KB)

Beefalo after being shaved.

Shave2.png (39 KB)

Wilson surrounded by Beard Hair after getting a shave.

Shaved-beefalo.jpg (35 KB)

shaved beefalo

Dead Shaved Beefalo.png (46 KB)
