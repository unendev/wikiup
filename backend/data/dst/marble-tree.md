...
source_url: https://dontstarve.fandom.com/wiki/Marble_Tree
---
...
PickaxeOpulent PickaxePick/Axe
...
*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 See also: [Marble Shrub](/wiki/Marble_Shrub "Marble Shrub")*
...
**“**A deposit of metamorphic rock in the form of a tree.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Even the winds cannöt knöck this tree döwn.**”**
...
**“**And here we see... a marble tree!**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Mr. choppy man, try chop down this tree! Hee-hee...**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I don't think it'll make for good firewood.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**What a delightfully odd tree.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Marble Tree** is a naturally-spawning [Structure](/wiki/Structure "Structure") that often appears in [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode"), in a [Chess](/wiki/Chess "Chess") [Biome](/wiki/Biome "Biome"), or around the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing"). It usually spawns on [Checkerboard Flooring](/wiki/Checkerboard_Flooring "Checkerboard Flooring"), surrounded by [Evil Flowers](/wiki/Evil_Flowers "Evil Flowers").

It can be mined with a [Pickaxe](/wiki/Pickaxe "Pickaxe"), [Opulent Pickaxe](/wiki/Opulent_Pickaxe "Opulent Pickaxe") or [Pick/Axe](/wiki/Pick/Axe "Pick/Axe") for 1-3 pieces of [Marble](/wiki/Marble "Marble"). Marble Trees are not flammable.

## Placeholder Trivia[]

* The trees with a round ball on top resemble the [truffula](http://i.imgur.com/7Skp6n3.jpg) trees from *[The Lorax](https://en.wikipedia.org/wiki/The_Lorax "wikipedia:The Lorax")* by [Dr. Seuss](https://en.wikipedia.org/wiki/Dr._Seuss "wikipedia:Dr. Seuss").

## Blueprint Gallery[]

Examinemarbletree.png (614 KB)

Wilson examining the Marble Tree.

World 3 Marble Trees.png (1.42 MB)

Three randomly spawning Marble Trees in Adventure Mode.

Different types of marble trees.png (73 KB)

Three types of Marble Trees.
