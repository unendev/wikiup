...
source_url: https://dontstarve.fandom.com/wiki/Poison_Spear
---
...
"Jab'em with a sick stick."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Spear**×1** Venom Gland**×1** |
...
| --- |
| 34  25.5 WendyWes  ---  42.5 Wigfrid  ---  17Wolfgang/34Wolfgang/68 Wolfgang  +12 poison damage over 2 minutes (1 damage every 10 seconds). |
...
**“**Luckily the venom gland doesn't weigh down the tip of the spear.**”**
...
**“**Who needs quick deaths when they can be slow and painful?**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Poison Spear** is a craftable [Weapon](/wiki/Weapon "Weapon") exclusive to the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. Like the [Spear](/wiki/Spear "Spear"), it deals 34 damage, but also [poisons](/wiki/Poison "Poison") the target on hit. The poisoned target will receive 1 damage every 10 seconds for 2 minutes, so 12 total poison damage are added. When a target is poisened, it cannot be poisoned again, so the poison damage cannot be accumulated or extended.

Poisoned enemies move slower, attack less often, and deal less damage. However, the [Food](/wiki/Food "Food") [Items](/wiki/Items "Items") that drop from poisoned enemies will have their freshness reduced to 50%.

## Tips[]

* The Poison Spear is a useful melee weapon in killing [Prime Apes](/wiki/Prime_Ape "Prime Ape") as it slows their movement speed on each hit.
* Because of its ability to slow down and weaken enemies, this weapon is excellent against Bosses like the [Tiger Shark](/wiki/Tiger_Shark "Tiger Shark"); or in *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* linked worlds, against the [Dragonfly](/wiki/Dragonfly "Dragonfly") due to her fast attack period, making it safer to land a hit and kite while she's poisoned.
* Loaded into a [Spear Gun](/wiki/Spear_Gun "Spear Gun"), the Poison Spear makes a great first strike against a [Blue Whale](/wiki/Blue_Whale "Blue Whale")/[White Whale](/wiki/White_Whale "White Whale"). The spoilage penalty on loot will not apply and the whale will move and attack much slower.
* The [Sealnado](/wiki/Sealnado "Sealnado") is not affected by Poison.

## Trivia[]

 https://static.wikia.nocookie.net/dont-starve-game/images/6/6e/Poison Spear old.png/revision/latest?cb=20151228124125 https://static.wikia.nocookie.net/dont-starve-game/images/6/6e/Poison Spear old.png/revision/latest?cb=20151228124125 

Old icon.

 

* Prior to the *[Hang Ten](/wiki/Don%27t_Starve:_Shipwrecked#December_17,_2015_-_Hang_Ten_Update "Don't Starve: Shipwrecked")* update, the Poison Spear's icon looked just like a regular Spear with its tip being green.
