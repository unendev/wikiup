...
source_url: https://dontstarve.fandom.com/wiki/Tropical_Parasol
---
...
**“**It provides a modicum of protection from the elements.**”**
...
**“**I's a pirate wit' an umbrella.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA STAY'TH DRY 'NEATH**”**
...
**“**A portable tree to stand under.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Tropical Parasol** is the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* version of the [Pretty Parasol](/wiki/Pretty_Parasol "Pretty Parasol"). It is also found in the [Survival Tab](/wiki/Survival_Tab "Survival Tab"), is always available to craft, but instead of using [Cut Grass](/wiki/Cut_Grass "Cut Grass"), it requires 3 [Palm Leaves](/wiki/Palm_Leaf "Palm Leaf") to craft. Similar to the Pretty Parasol, it is an easier to craft replacement for the [Umbrella](/wiki/Umbrella "Umbrella").

While equipped, it provides protection against [Wetness](/wiki/Wetness "Wetness") and [Overheating](/wiki/Overheating "Overheating"), and slowly restores [Sanity](/wiki/Sanity "Sanity"). After it is crafted, it will slowly perish over time whether or not it is equipped. Unlike the [Pretty Parasol](/wiki/Pretty_Parasol "Pretty Parasol"), it cannot be used as [Fuel](/wiki/Fuel "Fuel").

There is a chance to acquire this item while spending [Dubloons](/wiki/Dubloons "Dubloons") at the [Slot Machine](/wiki/Slot_Machine "Slot Machine").

## Blueprint Gallery[]

Tropical Parasol wielded by Wilson screenshot.jpg (11 KB)

[Wilson](/wiki/Wilson "Wilson") holding a Tropical Parasol.

DroppedTropicalParasol.png (327 KB)

A Tropical Parasol dropped on the ground.
