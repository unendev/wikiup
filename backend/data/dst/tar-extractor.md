...
source_url: https://dontstarve.fandom.com/wiki/Tar_Extractor
---
...
"This offshore rig knows the drill."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Coconut**×2** Bamboo**×4** Limestone**×4** |
...
**“**Splendid. We very much need something like this at home.**”**
...
**“**It's doing everything for me. Great!**”**
...
**“**Tis workin'up a mighty sweat!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**MAKETH THE BLACK GOO**”**
...
**“**At least I don't have to do it by hand.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Tar Extractor** is a craftable [Structure](/wiki/Structure "Structure") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is found in the [Nautical Tab](/wiki/Nautical_Tab "Nautical Tab") and requires 2 [Coconuts](/wiki/Coconut "Coconut"), 4 [Bamboo](/wiki/Bamboo "Bamboo") and 4 [Limestones](/wiki/Limestone "Limestone") to craft. Tar Extractors can only be placed on top of [Tar Slicks](/wiki/Tar_Slick "Tar Slick"). They will extract [Tar](/wiki/Tar "Tar") and drop it at the output end every 2 min (4 per [Day](/wiki/Day "Day")). When fully fueled, a Tar Extractor will last for two days, producing a total of 8 Tar. They can be refueled self-sufficiently by using some of the extracted Tar.

## Prototype Tips[]

* As Tar Slicks can only be found in [Medium](/wiki/Ocean#Shipwrecked "Ocean") and [Deep Ocean](/wiki/Ocean#Shipwrecked "Ocean"), the player will be exposed to [Waves](/wiki/Wave "Wave") when interacting with a Tar Extractor. [Sea Walls](/wiki/Sea_Wall "Sea Wall") can be built for protection.
* Alternatively, the player can create Tar Slicks with the [Quacken Drill](/wiki/Quacken_Drill "Quacken Drill"), providing easier access to Tar.

## Placeholder Trivia[]

* The Tar Extractor was added to the *Shipwrecked* DLC more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21st,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.

## Blueprint Gallery[]

Tar Extractor at work.png (666 KB)

A Tar Extractor producing Tar.

DS Shipwrecked Home Sea Home Update.png (2.36 MB)

Tar Extractor as seen in the poster for the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update.

Tar extractor animation.gif (8.74 MB)

Tar Extractor animation.
