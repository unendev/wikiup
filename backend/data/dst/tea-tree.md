...
source_url: https://dontstarve.fandom.com/wiki/Tea_Tree
---
...
|  |
| --- |
| `"teatree_short" "teatree_normal" "teatree_tall" "teatree_piko_nest"` |
...
**“**I could do so many things with tea tree leaves.**”**

–[Warly](/wiki/Warly "Warly")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'Tis a growing ship mast.**”**
...
The **Tea Tree** is a tree type exclusive to *[Don't Starve: Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, found in the Cultivated Biome outside of the Hamlets. A fully grown Tea Tree yields 1 [Twigs](/wiki/Twigs "Twigs"), 2 [Seed Pods](/wiki/Seed_Pod "Seed Pod"), and 2 [Logs when](/wiki/Log "Log") chopped.

A Tea Tree may be infested, and will spawn a [Piko](/wiki/Piko "Piko") or [Orange Piko](/wiki/Orange_Piko "Orange Piko") during the day or when chopped, as well as housing the Piko during evenings and nights. Pikos will continue to spawn from and return to the stump of a chopped Tea Tree. Once the stump is dug up, the spawner is destroyed. Piko-infested Tea Trees are created during world generation. Trees planted by the player will not spawn Pikos but can be infested with homeless Pikos.
...
Like other trees, Tea Trees have a chance to be [Peculiar](/wiki/Peculiar_Objects "Peculiar Objects"), making them investigable with a [Magnifying Glass](/wiki/Magnifying_Glass "Magnifying Glass") or [Wagstaff](/wiki/Wagstaff "Wagstaff")'s [Spectoggles](/wiki/Spectoggles "Spectoggles"). Chopping down Tea Trees near [Birchnut Trees](/wiki/Tree/Birchnut "Tree/Birchnut") can cause the Birchnut Trees to turn into Poison Birchnut Trees.
...
* According to Wickerbottom, the Tea Tree's species is *[Camellia Sinensis](https://en.wikipedia.org/wiki/Camellia_sinensis "wikipedia:Camellia sinensis").*

## Tips[]

* Tea Tree can be infested with [Piko](/wiki/Piko "Piko") without destroying its previous spawner: If a Piko is captured and wrapped into a [Bundling Wrap](/wiki/Bundling_Wrap "Bundling Wrap") and opened, the Piko will become homeless thus will find and infest a nearby Tea Tree. However, the Piko might steal the [Wax Paper](/wiki/Wax_Paper "Wax Paper") immediately upon opening the Bundling Wrap before running and infesting a Tea Tree.
* Tea Trees, although easier to obtain their seeds from than [Rainforest Trees](/wiki/Rainforest_Tree "Rainforest Tree"), drop less logs than other trees, therefore, it is best to instead buy and plant [Pine Cones](/wiki/Pine_Cone "Pine Cone") from [Ms. Sow’s Floral Arrangements](/wiki/Miss_Sow%27s_Floral_Arrangements "Miss Sow's Floral Arrangements") and instead chop down Tea Trees for their seed pods, only chopping down Tea Trees in the early game whilst preparations are being made..
...
Tea Tree Burnt.png (987 bytes)

A burnt Tea tree.

Tea Tree Stump.png (2 KB)

A tea tree stump.

Tea Tree Sapling.png (6 KB)
