...
source_url: https://dontstarve.fandom.com/wiki/Jungle_Tree
---
...
Log Jungle Tree Seed Egg Banana
...
**“**I wonder if this one is possessed?**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**There are nö trees like this where I sail fröm.**”**
...
**“**Thet tree be hidin' all kinds o'treasures.**”**
...
**Jungle Trees** are a type of Tree found only in the [Jungle](/wiki/Jungle "Jungle") biome in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. They are by far the largest trees. When chopped down they yield [Logs](/wiki/Log "Log") and [Jungle Tree Seeds](/wiki/Jungle_Tree_Seed "Jungle Tree Seed"). Chopping any size Jungle Tree has a 50% chance of trying to spawn [Snakes](/wiki/Snake "Snake"). While there is a chance to get no snakes, a maximum of 1 to 3 [Snakes](/wiki/Snake "Snake") can be spawned depending on the size of the Tree. After [Day](/wiki/Day "Day") 3 [Poison](/wiki/Poison "Poison") Snakes can be encountered this way. If the medium-sized and fully grown Jungle Trees didn't try to spawn Snakes (even if no Snakes were actually spawned), they will spawn a [Food](/wiki/Food "Food") item. This food item for medium-sized Jungle Trees is always an [Egg](/wiki/Egg "Egg"), while fully grown Jungle Trees drop either Eggs or [Bananas](/wiki/Banana "Banana") with equal likelihood. Like most trees, the player may use a [Shovel](/wiki/Shovel "Shovel") to dig up the stump to obtain an extra Log.

## }} Gallery[]

Jungle Tree Stump.png (131 KB)

A Jungle Tree stump.

Jungle Tree Burnt.png (118 KB)

A burnt Jungle Tree.

Jungle Tree Sapling.png (6 KB)
