...
source_url: https://dontstarve.fandom.com/wiki/Ocuvigil
---
...
| --- |
| Purple Moonlens**×1** Compass**×1** Boards**×2** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Tools Filter Shadow Magic Filter | Prestihatitator |

Perk

|  |
| --- |
| Marks a spot on the [Map](/wiki/Map "Map"). Reveals the [Fog of War](https://en.wikipedia.org/wiki/Fog_of_war#In_video_games "wikipedia:Fog of war") in the area around it. |
...
An **Ocuvigil** is a *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* exclusive [Structure](/wiki/Structure "Structure"), introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It is found in the [Tools Filter](/wiki/Tools_Filter "Tools Filter") and [Shadow Magic Filter](/wiki/Shadow_Magic_Filter "Shadow Magic Filter"), requires a [Purple Moonlens](/wiki/Moonlens "Moonlens"), a [Compass](/wiki/Compass "Compass") and 2 [Boards](/wiki/Boards "Boards") to craft, and a [Prestihatitator](/wiki/Prestihatitator "Prestihatitator") to prototype. It serves as a [Map](/wiki/Map "Map") marker and is also used for revealing the [Fog of War](https://en.wikipedia.org/wiki/Fog_of_war#In_video_games "wikipedia:Fog of war") in a certain location to all players. Contrary to popular belief, it does not keep the area around it loaded.

## Prototype Tips[]

* Placing Ocuvigil next to [Bee Queen's](/wiki/Bee_Queen "Bee Queen") hive will keep the players informed whenever she respawns. There are multiple similar uses of this structure such as keeping an eye on the [spider dens](/wiki/Spider_Den "Spider Den"), the [Ruins](/wiki/Ruins "Ruins") awaiting to respawn.
* Placing Ocuvigil on a [Boat](/wiki/Boats "Boats") moving with an open [Mast](/wiki/Mast "Mast") results in a slow but automatic exploration of ocean lines (the same is no longer possible by simply pushing it with an [Oar](/wiki/Oar "Oar") since the [Waterlogged Update](/wiki/Don%27t_Starve_Together/Version_History#Waterlogged_Beta_.28since_July_26.2C_2021.29 "Don't Starve Together/Version History"), in which boats ceased maintaining their momentum nearly indefinitely after being rowed once).

## Placeholder Trivia[]

* The Ocuvigil was added in the *[East or West, Base is Best](/wiki/A_New_Reign#August_11,_2016_-_East_or_West,_Base_is_Best "A New Reign")* update.
...
* It used to be crafted with a [Yellow Moonlens](/wiki/Moonlens "Moonlens"), that was replaced by a Purple Moonlens in a later update, as [Yellow Gems](/wiki/Yellow_Gem "Yellow Gem") are not easily available in worlds without [Caves](/wiki/Caves "Caves").

## Blueprint Gallery[]

Ocuvigil screenshot.png (89 KB)

The Ocuvigil glowing.

Burnt Ocuvigil.png (2 KB)

The Ocuvigil when burnt.

Ocuvigil new map.PNG (260 KB)

The Ocuvigil as seen on the [Map](/wiki/Map "Map").

Ocuvigil old.png (3 KB)

The old Ocuvigil crafting icon.

Ocuvigil Build old.png (6 KB)

The old Ocuvigil.

Ocuvigil on map.jpg (135 KB)

The old Ocuvigil as seen on the Map.

A New Reign Updateposter1.png (2.44 MB)

Ocuvigil as seen in the poster for the *[East or West, Base is Best](/wiki/A_New_Reign#August_11,_2016_-_East_or_West,_Base_is_Best "A New Reign")* update.
