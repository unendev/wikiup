...
source_url: https://dontstarve.fandom.com/wiki/Tent
---
...
Restores sanity, costs time and hunger.Don't Starve Together"

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Silk**×6** Twigs**×4** Rope**×3** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| Survival Tab | Healing Filter Structures Filter Winter Items Filter | Alchemy Engine |

## Properties

### Health

60 (+2/second Don't Starve Together)

### Hunger

-75 (-1/second Don't Starve Together)

### Sanity

50 (+1/second Don't Starve Together)

### Durability

6 uses

15 uses (Don't Starve Together)
...
The **Tent** is a [Survival](/wiki/Survival "Survival") [structure](/wiki/Structure "Structure") that can be used to sleep through [dusk and night](/wiki/Day-Night_Cycle "Day-Night Cycle"), like an immobile [Straw Roll](/wiki/Straw_Roll "Straw Roll") or [Fur Roll](/wiki/Fur_Roll "Fur Roll"). It will restore 50 [Sanity](/wiki/Sanity "Sanity") and 60 [Health](/wiki/Health "Health") at the cost of 75 [Hunger](/wiki/Hunger "Hunger"), and set the player's body temperature to maximum when used. It requires 6 [Silk](/wiki/Silk "Silk"), 4 [Twigs](/wiki/Twigs "Twigs"), 3 [Rope](/wiki/Rope "Rope") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. The player is also immune to any damage except fire while using the tent.

Tents can be used six times before disappearing, or 15 times in Don't Starve Together. If the player destroys one with a [Hammer](/wiki/Hammer "Hammer"), the number of resources returned is inversely proportional to number of times the player's used the Tent (the more times the Tent is used, the fewer resources it will drop when demolished).

## Gift Icon Downloadable Content[]

In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* and *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLCs, the behavior changes so that if the sleeper's temperature is below 35, then it will be set to 35. It may be more useful in [Winter](/wiki/Winter "Winter"), where freezing is the prominent threat and dusk and night are much longer. Sleeping also reduces [Wetness](/wiki/Wetness "Wetness") by 30.

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, sleeping in a Tent affects stats over time rather than instantly. Using a Tent restores 1 Sanity/second, 2 Health/second and costs 1 Hunger/second. It also reduces [Wetness](/wiki/Wetness "Wetness") by 1/second, and raises [Body Temperature](/wiki/Freezing "Freezing") by 1/second as long as the player's temperature is less than 40. All outside temperature sources are ignored, so the player's temperature will not increase if it is above 40. At least 26 [Hunger](/wiki/Hunger "Hunger") is required before sleeping in a Tent. The Tent can protect against the environment (e.g. Wetness, [Freezing](/wiki/Freezing "Freezing")) while sleeping.

## Prototype Tips[]

* The Tent is unusable by [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") due to her insomnia.
* Unequipping any items that lose [durability](/wiki/Durability "Durability") while worn (e.g. [Winter Hat](/wiki/Winter_Hat "Winter Hat"), [Miner Hat](/wiki/Miner_Hat "Miner Hat")) before sleeping will save their durability.
...
* When used in tandem with a [Siesta Lean-to](/wiki/Siesta_Lean-to "Siesta Lean-to") ([RoG](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants") must be enabled), the Tent can allow a player to quickly skip days or even seasons at the expense of food. This does not work in DST. Alternatively, [Cursed Woodie](/wiki/Cursed_Woodie "Cursed Woodie") can accomplish a similar feat by repeatedly transforming into werebeaver and letting the log meter deplete fast.
* Even though [Wormwood](/wiki/Wormwood "Wormwood") cannot heal from eating food, the Tent allows him to deal with this restriction by converting Hunger points to Health (and Sanity). Assuming there is an abundant supply of food, Wormwood can repeatedly replenish his health this way in order to farm valuable [Living Logs](/wiki/Living_Log "Living Log").
* Wearing a [Slurper](/wiki/Slurper "Slurper"), [Belt of Hunger](/wiki/Belt_of_Hunger "Belt of Hunger"), [Hibearnation Vest](/wiki/Hibearnation_Vest "Hibearnation Vest") or [Funcap](/wiki/Funcap "Funcap") or playing as [Wolfgang](/wiki/Wolfgang "Wolfgang"), [Wes](/wiki/Wes "Wes"), or [Warly](/wiki/Warly "Warly") doesn't change the [Hunger](/wiki/Hunger "Hunger") cost of sleeping in a Tent.

## Placeholder Trivia[]

* The Tent's original use was to allow the player to change their character. Crafting the tent cost more resources (15 Silk, 6 Twigs, and 3 Ropes), its crafting description was "*Change your skin*", and the Tent would be destroyed after one use. This functionality was changed in the 2013 [*Progress!* update](/wiki/Don%27t_Starve/Version_History#January_29,_2013_–_Progress! "Don't Starve/Version History").
...
* Sleeping while taking damage from [Freezing](/wiki/Freezing "Freezing") may cause the edges of the screen to be stuck red. This will persist until the game is reloaded or if the character starts taking freezing damage again and warms back up.
* Sometimes a tent may be used 7 times before disappearing.

## Blueprint Gallery[]

Tent Burnt.png (33 KB)

A burnt Tent.

Tent Placing Animation.gif (562 KB)

Animation of placing a Tent.

Tent Sleeping Animation.gif (1.75 MB)

Animation of a Tent, when someone is sleeping in it.

Tent Destroying Animation.gif (1.13 MB)

Animation of a Tent, when it got destroyed.

Beast Don't Starve.jpg (840 KB)

Three Tents made whilst playing as Wickerbottom.

Screecher Tent.png (19 KB)

A Tent as it appears in *[The Screecher](/wiki/The_Screecher "The Screecher")*.

Burnt Tent.png (120 KB)

A burnt Tent from the *Reign of Giants* DLC.
