...
source_url: https://dontstarve.fandom.com/wiki/Codex_Umbra
---

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 See also: [Shadow Puppet](/wiki/Shadow_Puppet "Shadow Puppet")*
...
| --- |
| Papyrus**×2** Nightmare Fuel**×2** Health Decrease**×-50** (only craftable by Maxwell Don't Starve Together) |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Shadow Magic Filter Maxwell Filter | Always available |
...
The **Codex Umbra** is a character-exclusive item that [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") starts the game with.
...
–[Maxwell](/wiki/Maxwell "Maxwell"), examining a Codex Umbra

When used in *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")*, it sacrifices 15 [health](/wiki/Health "Health") and 55 of maximum [Sanity](/wiki/Sanity "Sanity") to spawn a [Shadow Puppet](/wiki/Shadow_Puppet "Shadow Puppet") clone of Maxwell. It has infinite durability and requires 2 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel") to be used. For each puppet active, Maxwell's maximum sanity is reduced, similar to how [Meat Effigies](/wiki/Meat_Effigy "Meat Effigy") reduce maximum health. A maximum of 3 puppets can be active at one time and each one will disappear 2.5 days after it was summoned. If a Shadow Puppet is killed or despawns, Maxwell will get the used max sanity back.
...
**“**Do you want me to read you a story, Abigail?**”**
...
**“**I'm not letting THAT in MY library!**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Trees made into... paper? How unholy!**”**
...
**“**My attempts to understand this are being thwarted somehow.**”**
...
**“**I'm getting a serious case of bad vibes just by looking at it.**”**
...
**“**Ain't be keeping such witchcraft aboard me ship.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS A BOOK OF BAD DREAMS.**”**
...
**“**...Don't like stories in that book.**”**
...
In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the Codex Umbra can be crafted from the [Shadow Magic Filter](/wiki/Shadow_Magic_Filter "Shadow Magic Filter") and [Survivor Items Filter](/wiki/Survivor_Items_Filter "Survivor Items Filter"), using two [Papyrus](/wiki/Papyrus "Papyrus"), two [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel") and costing 50 [Health](/wiki/Health "Health"). It has a durability of 20 uses and does not break if it reaches 0%. Nightmare Fuel repairs 25% durability. It has a UI for choosing to summon between Shadow Servants, Duelists, Sneaks and Prisons. Creating puppets costs 30 max sanity and does not cost health, meaning that Maxwell can hold up to 6 Puppets at a time.

**[Shadow Duelists](/wiki/Shadow_Puppet#Shadow_Duelist "Shadow Puppet")** behave differently from their Don't Starve counterparts, having the ability to dash to the enemy and enter a defensive stance, blocking some of the incoming damage.

**[Shadow Prison](/wiki/Shadow_Traps#Shadow_Prison "Shadow Traps")** traps enemies in range in place, making them unable to move for 24 seconds (Bosses get trapped for half the duration). Most enemies that are below the ground level, as well as some units (Like [Crab Guards](/wiki/Crab_King "Crab King")) are immune to this ability.

**[Shadow Sneak](/wiki/Shadow_Traps#Shadow_Sneak "Shadow Traps")** sets up a shadow trap that activates once a non-boss unit enters the activation zone, influencing all units in range of about 1.5 tile. Influenced units will flee for 12 seconds, even if they get attacked. This ability can be used to transform [Rabbits](/wiki/Rabbit "Rabbit"), [Bunnymen](/wiki/Bunnymen "Bunnymen"), and [Splumonkeys](/wiki/Splumonkey "Splumonkey") into their nightmare variants, regardless of how much sanity the Players have. Shadow Prison and shadow Sneak can be activated at 0 sanity.
...
When the Codex Umbra reaches 0% durability, Maxwell has another quote for it:

**“**It hungers for the fuel.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), examining a Codex Umbra at 0% durability
...
–[William Carter](/wiki/William_Carter "William Carter")

The Codex Umbra's writer, origin, and age is currently unknown. What is known though, is that the book ends up on earth and is discovered by [William Carter](/wiki/William_Carter_Puzzles "William Carter Puzzles") during his early years as a stage magician. The Codex's earliest appearance is in August of 1904. At the time, William was aboard a train heading to San Francisco, California from New York City.[[1]](#cite_note-1) After the train crashes into a broken-down circus wagon, William disappears, and is assumed dead.[[2]](#cite_note-2) In reality, William managed to escape after he uses the book's powers to assist Wolfgang in freeing him from the wreckage.

Months later, William established himself in San Francisco and began going by the name of Maxwell. Maxwell updated his act to incorporate dark manifestations that he taught himself to summon from the Codex Umbra.[[3]](#cite_note-3) He found great success in this new act and eventually hired an assistant, [Charlie](/wiki/Charlie "Charlie").[[4]](#cite_note-4) In spite of this success, Maxwell is far more fixated with with the secrets and power the Codex, and gradually loses his sanity as he delves deeper and deeper into the book. During his last performance, Maxwell pushes his act to an extreme and attempts to pull "shadows incarnate" from the Codex. The book instead creates hands that pull both him and Charlie away into a [parallel dimension](/wiki/The_Constant "The Constant").[[5]](#cite_note-5)

The Codex Umbra reappeared, still in Maxwell's possession, after he was [dethroned](/wiki/Adventure_Mode "Adventure Mode") and became a survivor. After reuniting with [Wilson](/wiki/Wilson "Wilson"), Maxwell found the scientist's blueprints for an invention and offered to help construct it with assistance from the Codex Umbra. This made it possible for Maxwell and Wilson to build a [portal](/wiki/Removed_Features#Jury-Rigged_Portal "Removed Features") that allowed other survivors to join forces with them.[[6]](#cite_note-6)

## Trivia[]

* Codex Umbra is Latin for "Shadow Manuscript" or "The Shadow Code".
* It's possible for the Codex Umbra to be set alight and burn into ashes. In *Don't Starve*, the book will re-appear in Maxwell's inventory upon re-loading the world.
* If using the Codex Umbra reduces Maxwell's health to zero, the [Morgue](/wiki/Morgue "Morgue") will list the cause of death as "Shenanigans".
* Like [Abigail's Flower](/wiki/Abigail%27s_Flower "Abigail's Flower"), the Codex Umbra floats when placed on the ground, but only if the corresponding Maxwell is nearby. If he moves out of range, the book will close and fall to the ground.
* In the beta test of Maxwell's rework, when using the Codex Umbra, in addition to 4 items that were included in the final version of the update, it was possible to select a spell that allows you to turn the Top Hat in your inventory into a [Magician's Top Hat](/wiki/Magician%27s_Top_Hat "Magician's Top Hat").

 https://static.wikia.nocookie.net/dont-starve-game/images/2/2d/Magician%27s Top Hat Crafting image.png/revision/latest?cb=20221203145333 https://static.wikia.nocookie.net/dont-starve-game/images/2/2d/Magician%27s Top Hat Crafting image.png/revision/latest?cb=20221203145333 
...
* Despite being a starting character specific item, the Codex Umbra can be stolen by mobs like [Krampus](/wiki/Krampus "Krampus") or [Eyeplants](/wiki/Lureplant "Lureplant").
* Using a [Sinkhole](/wiki/Sinkhole "Sinkhole") to enter the [Caves](/wiki/Caves "Caves") or [Ruins](/wiki/Ruins "Ruins") without the Codex Umbra can sometimes cause it to duplicate in the player's inventory.
...
1. [↑](#cite_ref-1) [William Carter Puzzle #4](/wiki/William_Carter_Puzzles#Fourth_puzzle "William Carter Puzzles"): The Coach Ticket is dated August 15, 1904 and permits travel from New York's Grand Central Station to San Francisco.
2. [↑](#cite_ref-2) [William Carter Puzzle #4](/wiki/William_Carter_Puzzles#Fourth_puzzle "William Carter Puzzles"), The Newspaper: "A passenger​ train struck a circus wagon that had broken down along the tracks at the Old Mill crossing. Dozens of passengers were injured, and at least one man is missing. The missing man has yet to be identified, but fellow passengers described him as a tall, nervous fellow with an English accent. A search party was convened but quickly abandoned when it became apparent that a cage full of potentially dangerous trained monkeys had been vacated in the collision. Given the remoteness of the crash site, the scorching desert sun, and the escaped animals, the missing man has been presumed dead."
3. [↑](#cite_ref-3) [William Carter Puzzle #5](/wiki/William_Carter_Puzzles#Fifth_puzzle "William Carter Puzzles"): A new poster for "Maxwell the Great", a requisition for an ad in *The San Francisco Call* dated June 6, 1905, and a journal page recounting an encounter with a Shadow Creature after a ritual.
4. [↑](#cite_ref-4) [William Carter Puzzle #6](/wiki/William_Carter_Puzzles#Sixth_puzzle "William Carter Puzzles"): New poster for "The Amazing Maxwell" featuring Charlie holding the Codex, and a letter from Charlie about their latest successful performance.
5. [↑](#cite_ref-5) [William Carter Puzzle #8](/wiki/William_Carter_Puzzles#Eighth_puzzle "William Carter Puzzles"): *[The Final Act](http://www.dontstarvegame.com/science/mdocs/max/stage/1/grand-finale.html)* ([Youtube](https://www.youtube.com/watch?v=8BUcTVIV5y0))
6. [↑](#cite_ref-6) [Cyclum Puzzles](/wiki/Cyclum_Puzzles "Cyclum Puzzles"): [Last page of the comic](/wiki/File:Final.png "File:Final.png")
