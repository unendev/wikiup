...
source_url: https://dontstarve.fandom.com/wiki/Chest
---

:   *For the Event chests containing skins, see [Treasury](/wiki/Treasury "Treasury").*
...
| --- | --- | --- |
| Structures Tab | Structures FilterStorage Solutions Filter | Science Machine |
...
Boards, Anything contained within

Perk

|  |
| --- |
| Can hold up to 9 items |
...
**“**A place where to store loot.**”**

–[Maxwell](/wiki/Maxwell "Maxwell")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Has a lock, but it does not require a key. Curious.**”**
...
**“**Aye, th' meaning o' life inna box.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A BOX FOR'TH WILBA THINGS**”**
...
**“**A storage place for bits and bobs.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Oooooh, box for things!**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It isn't a toy chest, it's a very grownup SUPPLY chest.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Less cluttering up my pockets means less cluttering up my mind.**”**

–[Wanda](/wiki/Wanda "Wanda")

A **Chest** is a storage [Structure](/wiki/Structure "Structure"). It requires 3 [Boards](/wiki/Boards "Boards") to build and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. It has 9 storage slots. [Items](/wiki/Items "Items") can be stored in a Chest by dragging them onto it or by opening the Chest to place them in specific slots. Chests help keep items better organized than by dropping them on the ground. [Animals](/wiki/Animals "Animals") also cannot eat [Food](/wiki/Food "Food") kept in Chests except for [Splumonkeys](/wiki/Splumonkey "Splumonkey"), who can knock items out of them as well as Bearger. Also, [Krampus](/wiki/Krampus "Krampus") is able to break Chests in order to steal the items inside.

[Backpacks](/wiki/Backpack "Backpack"), [Piggybacks](/wiki/Piggyback "Piggyback"), and [Krampus Sacks](/wiki/Krampus_Sack "Krampus Sack") cannot be stored in Chests, even if the containers are empty. However, they can be used as an alternative storage space if for some reason the player is unable to craft a Chest.

In both [Sandbox Mode](/wiki/Sandbox_Mode "Sandbox Mode") and [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode"), Chests are occasionally found pre-built in the [world](/wiki/World "World"). These are natural [Set Pieces](/wiki/Set_Pieces "Set Pieces") and they may contain traps set by [Maxwell](/wiki/Maxwell_(NPC) "Maxwell (NPC)"), causing various effects such as:

* Spontaneous [combustion](/wiki/Fire "Fire") ([Character](/wiki/Character "Character") and surrounding objects burst into flames).
* [Summer](/wiki/Summer "Summer") or [Winter](/wiki/Winter "Winter") suddenly occurs.
* All food in the player's inventory immediately [Spoil](/wiki/Rot "Rot").

## Downloadable Content[]

In *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")*, during [Summer](/wiki/Summer "Summer"), Chests, as with many structures, can spontaneously combust. A smoking effect will appear, in which time the player must either extinguish the smouldering. Using one's hands causes damage. If this is not done in time, the object will combust and burn. The alternative way to solve this is by using a [Scaled Chest](/wiki/Scaled_Chest "Scaled Chest").

As with Backpacks, an [Insulated Pack](/wiki/Insulated_Pack "Insulated Pack") cannot be placed in a Chest.

In [*Shipwrecked*](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked"), [Thatch Packs](/wiki/Thatch_Pack "Thatch Pack"), [Sea Sacks](/wiki/Sea_Sack "Sea Sack"), [Booty Bags](/wiki/Booty_Bag "Booty Bag"), and [Warly's](/wiki/Warly "Warly") [Chef Pouch](/wiki/Chef_Pouch "Chef Pouch") cannot be placed inside a Chest.

In *[Hamlet](/wiki/Hamlet "Hamlet")*, [Pogs](/wiki/Pog "Pog") can open Chests and empty them by taking all of the items stored. If they find any [food](/wiki/Food "Food") in them, they will eat it. Like other [Backpacks](/wiki/Category:Backpacks "Category:Backpacks"), the [Vortex Cloak](/wiki/Vortex_Cloak "Vortex Cloak") cannot be placed inside a Chest.
...
|  |
| --- |
| Can hold up to 9 items. The chest no longer has a stacksize limit |
...
**“**A big trunk for all my junk.**”**

–[Willow](/wiki/Willow "Willow")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Wolfgang could store whole gym inside!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's still not big enough to hold all my regrets.**”**

–[Wendy](/wiki/Wendy "Wendy")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**ENHANCED EXTERNAL STORAGE UNIT**”**
...
**“**Lots of storage, made of quality wood, what more could you ask for?**”**

–[Woodie](/wiki/Woodie "Woodie")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A place to store lots of loot.**”**

–[Maxwell](/wiki/Maxwell "Maxwell")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Enöugh rööm tö störe an entire armöry!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Think of all the toys we could fit in there!**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**The real treasure is the extra storage space.**”**
...
**“**There's room to spare for things in there.**”**
...
**“**Just look at how many important survival supplies it can hold!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I can always use more space for trinkets.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Tall Chest** is an upgraded version of the Chest, exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, and introduced in the *[From Beyond](/wiki/From_Beyond "From Beyond")* updates. To receive the Tall Chest an [Elastispacer](/wiki/Elastispacer "Elastispacer") has to be used on a Chest. The Tall Chest has still 9 inventory slots, but these do not have a stacksize limit anymore, making it possible to store an unlimited amount of 9 different [Items](/wiki/Items "Items") (for safety reasons, this amount is capped at 4,294,967,296 items). The number above a stack will show 999+, if there are 1000 or more items in the stack. The Tall Chest has a slightly different, taller design with some more details.

Taking an item from a slot of a Tall Chest will give the maximum stack amount of the item, making it impossible to move the whole stack to another slot at once, if the amount of the item is above its stacksize limit.

If the Tall Chest is hammered or destroyed, up to a single stack of each item stored inside along with an [Enlightened Shard](/wiki/Enlightened_Shard "Enlightened Shard") and a single Boards will drop. The rest of the items will be stored in the Tall Chest Remains, which can be repaired using the shard and three boards. The items can be taken from the remains by rummaging through them, much like a [Junk Pile](/wiki/Junk_Pile "Junk Pile") can be rummaged. Through rummaging, player will obtain a single stack of a random item stored in the chest. When the chest remains are empty, they will be destroyed, leaving a single Boards behind.

Exploding Tall Chest will cause a shockwave that throws away nearby players.

## Trivia[]

* In the old research system, the cost of a Chest was 100 [Research Points](/wiki/Research_points_list "Research points list").
* The Tall Chest was introduced in the *[Scrappy Scavengers](/wiki/Scrappy_Scavengers "Scrappy Scavengers")* update.
* Before the *[600904](/wiki/Don%27t_Starve_Together/Version_History/2024#April_2,_2024 "Don't Starve Together/Version History/2024")* hotfix, there was no stacksize limit for Tall Chests. The amount was capped at 4,294,967,296, for safety reasons.
...
Chest open.jpg (106 KB)

An open Chest.

Chest store.png (27 KB)

"Store" appears when a storable item is dragged over a Chest.

Ice Box Trap 1.png (343 KB)

A Set Piece trap with a Chest that, when opened, has a chance to cause Winter to immediately arrive.

Bones Trap 1.png (643 KB)

A Set Piece with a Chest that has a chance to catch fire when opened.

Burnt Chest.png (21 KB)

A burnt Chest from the *Reign of Giants* DLC.

Tall Chest Burnt.png (17 KB)

Tall Chest burnt.

Tall Chest Animation.gif (437 KB)

Animation of Tall Chest opening and closing.

Chest emoji from official Klei Discord server.png (12 KB)

Unused Chest emoji from official Klei Discord server.

Engry Chest emoji from official Klei Discord server.png (14 KB)

Unused Engry Chest emoji from official Klei Discord server.
