...
source_url: https://dontstarve.fandom.com/wiki/Sandbag
---
...
**“**Fer keepin' th' flood waters at bay.**”**
...
**Sandbags** are a craftable [Structure](/wiki/Structure "Structure") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is crafted with 2 [Cloth](/wiki/Cloth "Cloth") and 3 [Sand](/wiki/Sand "Sand"), and yields 4 Sandbags when crafted. It is used to prevent [Flooding](/wiki/Flooding "Flooding") by barricading tides rising from the shore, or filling the puddles that appear during [Monsoon Season](/wiki/Monsoon_Season "Monsoon Season").

Although they count as [Walls](/wiki/Wall "Wall"), unlike other walls, they are allowed to be placed very close to existing structures. [Mobs](/wiki/Mobs "Mobs") may attack Sandbags if it is in the way to their target. As with any Wall, Sandbags can occasionally be targeted and destroyed by [Spiders](/wiki/Spider "Spider").

Both [Puddles](/wiki/Flooding#Puddles "Flooding") and [Tides](/wiki/Flooding#Tides "Flooding") can be stopped by placing Sandbags in front of them, but if a puddle is not completely surrounded it can continue to expand in any direction which isn't blocked by a Sandbag. This means that given enough time or a small enough wall, a puddle can seep around a wall of sandbags and overtake it. However, a complete encirclement of sandbags can keep a puddle from getting in or out, allowing you to either contain a puddle in one spot where it starts or keep a small area from being touched. Puddles can also be stopped from expanding by placing a single Sandbag in the exact center, even though this single Sandbag does not block any edges of the puddle. It is not known at this time whether this is a bug or intended functionality. This works for any size of the puddle, as long as the center "eye" is covered with a Sandbag.
...
[Hammering](/wiki/Hammer "Hammer") a placed Sandbag that is blocking a puddle will cause the puddle to immediately extend. Hammering a Sandbag will drop 2 [Sand](/wiki/Sand "Sand") if it was undamaged, otherwise it will drop 1 Sand.

## Blueprint Gallery[]

SandbagUsage1.png (435 KB)

A valid method to use Sandbags to stop a puddle from expanding.

SandbagUsage2.png (201 KB)

Alternative method using a single Sandbag, applied in the earliest stage.

SangbagUsage3.png (3.38 MB)

Alternative method applied at a later stage to the puddle on the left. Puddle on the right is not stopped in any way.

Saved crockpot.jpg (349 KB)

Puddle expansion towards the [Crock Pot](/wiki/Crock_Pot "Crock Pot") is stopped by proper use of Sandbags.
