...
source_url: https://dontstarve.fandom.com/wiki/Pig_Traders/Beautician
---
...
Gives 2× Oinc for Jet Feather Crimson Feather Azure Feather Thunder Feather Peagawk Plume Doydoy Feather once a day.
...
Town House Curly Tails Mud Spa
...
**“**PROVIDES NONFUNCTIONAL BEAUTIFICATION SERVICES**”**
...
**“**An example of the fine citizenry of this town.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Shieldmaidens have nö use för thee.**”**
...
**“**A lady who likes her feathers.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Beautician** is a [Pig Trader](/wiki/Pig_Traders "Pig Traders") [Mob](/wiki/Mob "Mob") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. She has pink hair and a purple outfit. She will pay two [Oincs](/wiki/Oinc "Oinc") when given certain feathers, but only once per day. She will accept [Jet Feathers](/wiki/Jet_Feather "Jet Feather"), [Crimson Feathers](/wiki/Crimson_Feather "Crimson Feather"), [Azure Feathers](/wiki/Azure_Feather "Azure Feather"), [Thunder Feathers](/wiki/Thunder_Feather "Thunder Feather"), [Peagawk Plumes](/wiki/Peagawk_Plume "Peagawk Plume") and [Doydoy Feathers](/wiki/Doydoy_Feather "Doydoy Feather").

## Brain Behavior[]

A Beautician may spawn from a [Town House](/wiki/Town_House "Town House"), and will wander randomly around their house and eat any edible items left on the ground, including [Pig Skin](/wiki/Pig_Skin "Pig Skin"). Every so often they will drop one Manure where they are standing, and if the player picks up that manure the Beautician will approach them and give them one Oinc, along with an accompanying Quote.

Whenever there is a hostile mob nearby, or a player targets them or another Pig Trader or [Royal Guard](/wiki/Royal_Guard "Royal Guard") near them, they will enter a panicked state. They will begin to move around semi-randomly in a direction away from the aggressor.
