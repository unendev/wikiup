...
source_url: https://dontstarve.fandom.com/wiki/Stagehand
---
...
End Table Blueprint for Stagehand

Perk

|  |
| --- |
| Searches for [Fire](/wiki/Fire "Fire"). |
...
**“**Woby, what's wrong? It's just a table.**”**
...
The **Stagehand** is a naturally spawning object in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It spawns in a circle of 5 [Roses](/wiki/Flower#Rose "Flower"). The Stagehand seems to have something moving under it resembling a [Night Hand](/wiki/Shadow_Creature#Night_Hand "Shadow Creature"). At night, the creature's legs creep out from under the table and search for a light source in its vicinity. The Stagehand will only be attracted to sources that produce fire, like [Campfires](/wiki/Campfire "Campfire") and [Torches](/wiki/Torch "Torch"). Once it finds a valid light source, it will sit back down. If it is currently sitting near a light source, and the player goes to sleep nearby, the Stagehand may stand back up for some reason, though it will not move. If the player gets too close to the table when it is visible at night, the creature will go back under the table. Characters have different quotes when the "creature" is standing. It cannot be destroyed, but hammering it 86 times (requiring 1.72 [Hammers](/wiki/Hammer "Hammer")) will make it drop an End Table [Blueprint](/wiki/Blueprint "Blueprint") (which can be dropped multiple times), used to craft the End Table. However, the count will reset if 15 seconds pass between two Hammer strikes in the same way HP of [Fences](/wiki/Wood_Fence "Wood Fence"), [Chests](/wiki/Chest "Chest") and other buildings resets 15 seconds after being struck.
...
| --- |
| Marble**×2** Boards**×2** Carpeted Flooring**×2** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Decorations Filter Structures Filter | Blueprint |
...
Unlike the Stagehand, the End Table is craftable, and can be either burnt down, turning into [Ashes](/wiki/Ashes "Ashes"), or hammered to drop half of its crafting items. The player can place any kind of [Flower](/wiki/Flower "Flower") in the vase on the table. This includes [Lune Tree Blossoms](/wiki/Lune_Tree_Blossom "Lune Tree Blossom"), [Light Bulbs](/wiki/Light_Bulb "Light Bulb"), [Glow Berries](/wiki/Glow_Berry "Glow Berry") and [Forget-Me-Lots](/wiki/Forget-Me-Lots "Forget-Me-Lots"). Doing so will grant the player 5 [Sanity](/wiki/Sanity "Sanity"), but only for the first flower or when replacing a withered flower. Placed Light Bulbs and Glow Berries provide light, but will wilt after 10 days. The other flowers won't wilt unless the End Table catches fire.

There are eight variaties of Flowers, three variaties of Light Bulbs, and two varieties of Forget-Me-Lots showing up in the vase when the player decorates the structure using the corresponding items.
...
–[Wilson](/wiki/Wilson "Wilson"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**What's a weird table doing out here? Let's burn it!**”**

–[Willow](/wiki/Willow "Willow"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Wolfgang has no use for tiny table.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**My heart aches with its beauty.**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**IT'S HORRIBLE, I HATE IT**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Something devious is lurking in the shadows.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Not my style.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This must be the work of an unseen hand.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Merely a table.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is there a spider friend rustling beneath?**”**

–[Webber](/wiki/Webber "Webber"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Oh, what a nice table setting.**”**

–[Warly](/wiki/Warly "Warly"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Too shy?**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Why's this table givin' me the creeps?**”**

–[Winona](/wiki/Winona "Winona"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I see you!**”**

–[Wortox](/wiki/Wortox "Wortox"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Something... weird...**”**

–[Wurt](/wiki/Wurt "Wurt"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Woby, what's wrong? It's just a table.**”**

–[Walter](/wiki/Walter "Walter"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I know you're hiding in there.**”**

–[Wanda](/wiki/Wanda "Wanda"), when examining a sitting Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Just keep your hand to yourself, alright?**”**

–[Wilson](/wiki/Wilson "Wilson"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Gross! I told you we shoulda burned it!**”**

–[Willow](/wiki/Willow "Willow"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**GAH! Table is creepy walking fist!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A creature of shadow that seeks the light... how sad...**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**FIVE DIGITS OF TERROR**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**That was an underhanded trick!**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I really wish I hadn't seen that.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Hmph. Impressive sleight of hand.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Keep thy hand fröm öut mine fires!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Definitely not a spider!**”**

–[Webber](/wiki/Webber "Webber"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I've got to hand it to you, I was startled!**”**

–[Warly](/wiki/Warly "Warly"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Ohh! Table friend!**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Shoo!**”**

–[Winona](/wiki/Winona "Winona"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Well hello there little friend.**”**

–[Wortox](/wiki/Wortox "Wortox"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Leeme alone, flort!!**”**

–[Wurt](/wiki/Wurt "Wurt"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Maybe it wants to roast marshmallows too?**”**

–[Walter](/wiki/Walter "Walter"), when examining a standing Prickly Stagehand

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**You'll never catch me! I've outsmarted you and your ilk at every turn!**”**

–[Wanda](/wiki/Wanda "Wanda"), when examining a standing Prickly Stagehand

The **Prickly Stagehand** is a natural structure generated in the world of *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, added in *[A Little Drama](/wiki/A_Little_Drama_and_QOL "A Little Drama and QOL")* update. It's a second Stagehand variant that appears near the [stage](/wiki/Stage "Stage").

If it was attacked by a player or the player was attacked by someone during the performance, then the Stagehand will start attacking them. It creates a spiked shadow arm that is cast on the surface like a shadow, starts reaching out to whoever this mob is targeting and attacking. Periodically, it will get up before the next attack. Sometimes when you deal damage to it, it can start to walk
...
* The End Table can be used as an efficient light source since it can give out light for 10 days with a single [Glow Berry](/wiki/Glow_Berry "Glow Berry") or a [Light Bulb](/wiki/Light_Bulb "Light Bulb").
* The End Table can't be destroyed by [Werepigs](/wiki/Pig "Pig"), [Hounds](/wiki/Hound "Hound") and most hostile creatures and even bosses, which makes it a perfect, albeit expensive way of protecting Moon Stone or any other valuable asset.
* To get a wilted flower the End Table can be set on fire, which can be then extinguished with a [Watering Can](/wiki/Watering_Can "Watering Can").

## Placeholder Trivia[]

* Stagehand and End Tables were introduced in the *[A Little Fixer Upper](/wiki/A_New_Reign#September_1,_2016_-_A_Little_Fixer_Upper "A New Reign")* update.
* When the Stagehand was first added to the game, it could be destroyed with a Hammer for 2 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"), 1 [Marble](/wiki/Marble "Marble"), and 1 [Petals](/wiki/Petals "Petals").
* In *[Reap What You Sow](/wiki/Reap_What_You_Sow "Reap What You Sow")*, the wilt time of its flower was increased from 2.5 days to 10 days.
  + This was changed in a hotfix shortly after the release of the *[Host of Horrors](/wiki/Host_of_Horrors "Host of Horrors")* update to only affect Light Bulbs and Glow Berries.
* The ability to change the skin of the Stagehand with the [Clean Sweeper](/wiki/Clean_Sweeper "Clean Sweeper") was added in the *[Waterlogged](/wiki/Don%27t_Starve_Together/Version_History#Waterlogged_Beta_.28since_July_26.2C_2021.29 "Don't Starve Together/Version History")* update.
...
End Table as seen in the poster for the *[A Little Fixer Upper](/wiki/A_New_Reign#September_1,_2016_-_A_Little_Fixer_Upper "A New Reign")* update.

Stage hand fire.gif (1.13 MB)

A Stagehand putting out its own fire

Stage hand legs out.png (48 KB)

A stagehand with its legs out at dusk.

Screen Shot 2016-09-02 at 5.37.12 PM.png (1.74 MB)

Stagehand at night (top left).

Screen Shot 2016-09-02 at 5.36.09 PM.png (4.39 MB)

Stagehand at dusk.

Stagehand Walking Animation.gif (1.21 MB)

The walking animation of a Stagehand.

Endtable var.png (495 KB)

Different flowers used to decorate End Tables.

End Table Burnt.png (3 KB)

A burnt End Table.

RWP ALD new Stagehand2 concept art1.png (492 KB)

Second Stagehand concept art from Rhymes With Play stream.

RWP ALD new Stagehand2 concept art2.png (593 KB)

Second Stagehand concept art from Rhymes With Play stream.

RWP ALD Stagehand2 animation1.gif (1.03 MB)

Second Stagehand animation concept art from Rhymes With Play stream.

RWP ALD Stagehand2 animation2.gif (592 KB)

Second Stagehand animation concept art from Rhymes With Play stream.

RWP ALD Stagehand2 animation3.gif (340 KB)
