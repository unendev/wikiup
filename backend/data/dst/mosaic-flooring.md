...
source_url: https://dontstarve.fandom.com/wiki/Mosaic_Flooring
---
...
"Elegantly broken rock. In blue."  
"Elegantly broken rock. In red."  
"Elegantly broken rock. In grey."
...
|  |
| --- |
| `"turf_mosaic_blue" "turf_mosaic_red" "turf_mosaic_grey"` |
...
**Mosaic Flooring** is a [turf](/wiki/Turfs "Turfs") type exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It was added in *[A Little Drama](/wiki/A_Little_Drama_and_QOL "A Little Drama and QOL")* Update alongside with lush carpet and [Ruins](/wiki/Ruins "Ruins") turfs. It can be found near the [Stage](/wiki/Stage "Stage") Set Piece or crafted using a single piece of [Marble](/wiki/Marble "Marble") for four turf. It comes in three different colours.
