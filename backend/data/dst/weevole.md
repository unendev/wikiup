...
source_url: https://dontstarve.fandom.com/wiki/Weevole
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Weevole?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
**“**What a wonderfully persistent species of insect!**”**
...
**“**Aggravating bugs! A complete waste of wings.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Weevoles** are [Mobs](/wiki/Mobs "Mobs") introduced in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, which spawn in [Tall Grass](/wiki/Tall_Grass "Tall Grass") fields at [Dusk](/wiki/Dusk "Dusk") and [Night](/wiki/Night "Night").
...
If they get low on health, they'll bury themselves in the ground and resurface few seconds later, though [Pog](/wiki/Pog "Pog") can attack them while they're underground.

When they die, they drop [Weevole Carapace](/wiki/Weevole_Carapace "Weevole Carapace"), which can be used in the Crock Pot to make [Hard Shell Tacos](/wiki/Hard_Shell_Tacos "Hard Shell Tacos") or to craft the [Weevole Mantle](/wiki/Weevole_Mantle "Weevole Mantle").

They will eat any plant related items left on the ground by the player. Those include: [Cork](/wiki/Cork "Cork"), [Grass](/wiki/Cut_Grass "Cut Grass"), [Grass Tuft](/wiki/Grass_Tuft "Grass Tuft"), [Berry Bush](/wiki/Berry_Bush "Berry Bush"), [Sapling](/wiki/Sapling "Sapling") (item), [Logs](/wiki/Log "Log"), Boards, [Evergreen](/wiki/Tree "Tree") Sapling and [Seeds](/wiki/Seeds "Seeds").

Weevoles can be caught in [Traps](/wiki/Traps "Traps"), killing them instantly and rewarding Weevole Carapace when harvested.

## Prototype Tips[]

* Player may want to create their own **Weevole** infested grass in a location more suitable for their needs. To do that they just need to plant the grass, keeping in mind that Tall Grass will grow (and not require fertilizer) on turfs [Plain](/wiki/Plains "Plains"), [Rainforest](/wiki/Rainforest "Rainforest"), [Deep Rainforest](/wiki/Deep_Rainforest "Deep Rainforest") or [Dense Turf](/wiki/Dense_Turf "Dense Turf"). Each time Tall Grass regrows, the game attempts to infest it. The chance is higher, the more tall grass is around within 3 turf tiles. Each grass increases chance to become infested by 1%. It means that 100 grasses within 3 tiles will grant 100% chance for any of the 100 grass to become infested as long as there is no other infested grass nearby. The easy way to do that would be planting 25 grass in one tile making sure there are no other grass within 3 tiles. When they regrow each of the 25 grasses will have 25% chance to be infested. The infested grass will stay infested as long as it is not harvested or destroyed in any way. https://static.wikia.nocookie.net/dont-starve-game/images/2/2a/Weevole %22farm%22.jpg/revision/latest?cb=20201212152828 https://static.wikia.nocookie.net/dont-starve-game/images/2/2a/Weevole %22farm%22.jpg/revision/latest?cb=20201212152828 

  Example of Weevole "farm" with a bait in the center

## Placeholder Trivia[]

* The name Weevole is a portmanteau: [Weevils](https://en.wikipedia.org/wiki/Weevil "wikipedia:Weevil") are a family of beetles, and a [vole](https://en.wikipedia.org/wiki/Vole "wikipedia:Vole") is a small rodent.
