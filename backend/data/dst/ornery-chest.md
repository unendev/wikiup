...
source_url: https://dontstarve.fandom.com/wiki/Ornery_Chest
---
...
Pure Horror×3-6, Hound's Tooth×0-2  
...
Infused [Shadow Atrium](/wiki/Shadow_Atrium "Shadow Atrium").

[Code](/wiki/Console "Console")

|  |
| --- |
| `"chest_mimic"   "chest_mimic_revealed"` |

Scrapbook [Scrapbook](/wiki/Scrapbook "Scrapbook")

|  |
| --- |
| A heartless monster. It craves the taste of loot, and flesh. |

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Horrible! Definitely horrible!**”**
...
**“**Wolfgang knew box too fancy to be true!**”**
...
**“**This creature mimics an artifact.**”**
...
**“**It cöntained nöt a mystery, but a curse!**”**
...
**“**And I was right! It's a box monster, Woby!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Totally not worth the peek!**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Ornery Chest** is a neutral [mob](/wiki/Mob "Mob") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in the *[From Beyond](/wiki/From_Beyond "From Beyond")* updates. It mimics an [Ornate Chest](/wiki/Ornate_Chest "Ornate Chest") and can be revealed by opening it.

Ornery Chests only appear when [Shadow Rifts](/wiki/Shadow_Rifts "Shadow Rifts") are active. Every time a rift opens, an Ornate Chest will turn into an Ornery Chest. It will keep the loot of the Ornate Chest.

## Behavior[]

Once revealed, the Ornery Chest will start to attack, knock out items of the players' inventory and eat them, adding the items to its inventory. When killed, it drops 3-6 [Pure Horror](/wiki/Pure_Horror "Pure Horror"), 0-2 [Hound's Tooth](/wiki/Hound%27s_Tooth "Hound's Tooth"), and its current inventory.

When a [Shadow Atrium](/wiki/Shadow_Atrium "Shadow Atrium") is placed in a sleeping Ornery Chest, it will drop a [Possessed Shadow Atrium](/wiki/Possessed_Shadow_Atrium "Possessed Shadow Atrium") upon death.

## Trivia[]

* The Ornery Chest was added in the *[Depths of Duplicity](/wiki/Depths_of_Duplicity "Depths of Duplicity")* update.
