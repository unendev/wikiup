...
source_url: https://dontstarve.fandom.com/wiki/Palm_Tree
---
...
**“**Its fronds are quite large and could be made useful.**”**
...
**“**A nice bit o'shade thar.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS TREE O' THE BIG LEAVES**”**
...
**“**These trees look different from the air.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Palm Trees** are a variety of [Tree](/wiki/Tree "Tree") found in [Beach](/wiki/Beach "Beach") [biomes](/wiki/Biomes "Biomes") in the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC. When chopped down with an [Axe](/wiki/Axe "Axe"), they yield [Logs](/wiki/Log "Log") and [Palm Leaves](/wiki/Palm_Leaf "Palm Leaf"). Fully-grown Palm Trees will grow [Coconuts](/wiki/Coconut "Coconut"), which will also drop when the tree is cut down. The Coconuts can be planted to create Palm Tree Saplings, which grow into new Palm Trees. They can also be split into 2 halves with a [Machete](/wiki/Machete "Machete"), allowing them to be used as [Food](/wiki/Food "Food"), however they can no longer be planted once split. As with almost all trees (with the exception of the [Mangrove Tree](/wiki/Tree/Mangrove_Tree "Tree/Mangrove Tree")), the stump may be dug up with a [Shovel](/wiki/Shovel "Shovel") to yield another Log.

Palm Trees may be destroyed by [Strong Winds](/wiki/Strong_Winds "Strong Winds").

Similar to its [Evergreen](/wiki/Evergreen "Evergreen") and [lumpy evergreen](/wiki/Lumpy_Evergreen "Lumpy Evergreen") counterparts, when a Palm Tree is chopped down, there is a chance that some nearby Palm Trees may become [Palm Treeguards](/wiki/Palm_Treeguards "Palm Treeguards"). Palm Treeguards will not spawn before [Day](/wiki/Day "Day") 4 starts. Chopping down a Palm Tree has a 1/75 chance to spawn Palm Treeguards. Provided that there are enough Palm Trees around, before day 31, 3 Palm Treeguards will spawn. Starting from day 31, there is a 50% chance a 4th will also spawn. After day 80, a minimum of 4 will spawn, with 50% chance to spawn a 5th.

While Chopping down fully grown Palm Trees, there is a 1% chance for a Coconut to fall on every strike. The Coconut deals 20 damage, which can be partially mitigated by wearing [Armor](/wiki/Armor "Armor"). The fallen Coconut stays intact and can be collected.

## Tips[]

* [The Lazy Forager](/wiki/The_Lazy_Forager "The Lazy Forager") can catch falling Coconuts before it can damage the character.
* Coconuts can only be planted on turfless tiles, aka Beaches, requiring a Pitchfork to create blank space if planted in Hamlet or the main Don't Starve world.
