...
source_url: https://dontstarve.fandom.com/wiki/Meat_Effigy
---
...
| --- |
| Boards**×4** Cooked Meat**×4** Beard Hair**×4 Don't Starve Boards×4 Health Decrease×40 Beard Hair×4 Don't Starve Together** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| Magic Tab | Healing Filter Shadow Magic Filter Structures Filter | Prestihatitator |
...
|  |
| --- |
| Resurrects the player on [Death](/wiki/Death "Death"). |
...
MODELLED AFTER THE MEATBRAINED SCIENCE FLESHLING (DST)**”**
...
**“**Who is that supposed to be? (DS)

It's a giant doll of our friend!! (DST)**”**
...
**“**I can never die! Hyuyu!**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is Funny-hair man... okay?**”**
...
Maximum health lowered to 120, then 90.

 

The **Meat Effigy** is an [effigy](https://en.wikipedia.org/wiki/Effigy "wikipedia:Effigy") of [Wilson](/wiki/Wilson "Wilson") which resurrects the player on [Death](/wiki/Death "Death"). It is one of the three ways to be resurrected in the base game (the other two are wearing a [Life Giving Amulet](/wiki/Life_Giving_Amulet "Life Giving Amulet"), or activating a [Touch Stone](/wiki/Touch_Stone "Touch Stone") before death). A Meat Effigy requires 4 [Boards](/wiki/Boards "Boards"), 4 [Beard Hairs](/wiki/Beard_Hair "Beard Hair"), 4 [Meat](/wiki/Meat "Meat"), and 30 maximum health to craft and a [Prestihatitator](/wiki/Prestihatitator "Prestihatitator") to prototype.

## Icon Tools Usage[]

Every Meat Effigy constructed lowers maximum [Health](/wiki/Health "Health") by 30 points, which can only be restored if the Meat Effigy is destroyed or used for revival. Building up to 5 Meat Effigies will lower most characters' (all except for a mighty [Wolfgang](/wiki/Wolfgang "Wolfgang"), an upgraded [WX-78](/wiki/WX-78 "WX-78"), [Webber](/wiki/Webber "Webber") and [Wigfrid](/wiki/Wigfrid "Wigfrid"), who are still killed by making more) [Health](/wiki/Health "Health") to 0 and kill them, after which they will be revived and restored to 30 health.

As long as there is a Meat Effigy standing somewhere in the world, the character will be revived at the *nearest* Meat Effigy. However, if a [Touch Stone](/wiki/Touch_Stone "Touch Stone") is closer than the Meat Effigy they will be resurrected at the Touch Stone instead. After death and resurrection, the Meat Effigy used will be destroyed. Alternatively, it can be destroyed using the [Hammer](/wiki/Hammer "Hammer") or [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff") which will return the lost 30 health.

An [Ancient Pseudoscience Station](/wiki/Ancient_Pseudoscience_Station "Ancient Pseudoscience Station") can spawn Effigies when hammered. The health penalty of Effigies produced this way do not take effect until the character has died and been resurrected.
...
In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, a Meat Effigy requires 4 [Boards](/wiki/Boards "Boards"), 4 [Beard Hairs](/wiki/Beard_Hair "Beard Hair"), and 40 [Health](/wiki/Health "Health") to craft and a [Prestihatitator](/wiki/Prestihatitator "Prestihatitator") to prototype. Crafting a Meat Effigy does not lower maximum health.
...
Meat Effigies will not resurrect [Ghost Characters](/wiki/Ghost_Characters "Ghost Characters") automatically. Ghost Characters can resurrect from a Meat Effigy by clicking the "Activate Meat Effigy" button in the top-right corner of the screen. Ghost Characters will not be resurrected from a [Touch Stone](/wiki/Touch_Stone "Touch Stone") while attuned to a Meat Effigy.

In worlds with [Caves](/wiki/Caves "Caves"), attunement is specific to each server. If a player has a Meat Effigy in the Forest, then dies in the Caves, the Meat Effigy will not be usable until that player travels up to the surface, which can be done in ghost form.

## Prototype Tips[]

* The ability to build Meat Effigies easily is [Wilson](/wiki/Wilson "Wilson")'s greatest advantage over the other characters because he is a walking renewable source of Beard Hair, which is the Meat Effigy's rarest ingredient. However, note that Wilson will have no beard after resurrection.
* Beard hair can also be obtained by catching rabbits and lowering sanity, turning them into [beardlings](/wiki/Rabbit "Rabbit").
* If the player is concerned about the Meat Effigy being destroyed (e.g. by the [Deerclops](/wiki/Deerclops "Deerclops")), it is recommended to place it somewhere seldom visited.
* When building a Meat Effigy, it is a good idea to leave some supplies near it to make the retrieval of items easier or to prevent freezing to death in winter. For example, having a [Walking Cane](/wiki/Walking_Cane "Walking Cane") and [Log Suit](/wiki/Log_Suit "Log Suit") nearby can help for covering long distances quickly, and can also help with retrieving items from dangerous places.
  + Additionally, a [Lazy Forager](/wiki/The_Lazy_Forager "The Lazy Forager") can be placed next to a Meat Effigy, as the Lazy Forager can be incredibly useful for retrieving items near enemies, such as hounds.
...
* Meat Effigies can be spawned in by the [Console](/wiki/Console "Console") with no effect to health, except once the player dies or reloads the game. The health penalty will then be applied, making a very vicious cycle of repeated death and resurrection if the player happened to spawn in lots of them.
...
* An [effigy](https://en.wikipedia.org/wiki/Effigy "wikipedia:Effigy") is a representation of someone in sculpture or another three-dimensional art medium. Effigies are usually constructed for funerary, religious, or caricatural purposes.
