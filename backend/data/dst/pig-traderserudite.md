...
source_url: https://dontstarve.fandom.com/wiki/Pig_Traders/Erudite
---
...
Oinc x5 for Nightmare Fuel once a day
...
The Flying Pig Arcane Shop, Town House
...
**“**SELLER OF NONLOGICAL MAGIC INSTRUMENTS**”**
...
**“**Frustratingly reluctant to answer my questions about her curious wares.**”**
...
**“**So yer a wizard then?**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**SPEAK LESS THAN SHE KNOWEST**”**
...
**“**A purveyor of fine esoteric interests.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Erudite** is a [Pig Trader](/wiki/Pig_Traders "Pig Traders") [Mob](/wiki/Mob "Mob") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. She will give the player five [Oincs](/wiki/Oinc "Oinc") for one [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel") once a day. She also runs [The Flying Pig Arcane Shop](/wiki/Pig_Shops#The_Flying_Pig_Arcane_Shop "Pig Shops") in the second city.

## Brain Behavior[]

One Erudite may spawn from a [Town House](/wiki/Town_House "Town House"), and will wander randomly around their house and eat any edible items left on the ground, including [Pig Skin](/wiki/Pig_Skin "Pig Skin"). Every so often they will drop one Manure where they are standing, and if the player picks up that manure the Erudite will approach them and give them one Oinc, along with an accompanying Quote.
