...
source_url: https://dontstarve.fandom.com/wiki/Bio_Scanalyzer
---
...
"It never hurts to have a backup scan."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Electrical Doodad**×1** Silk**×1** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") |
| --- |
| Tools Filter Survivor Items Filter |
...
|  |
| --- |
| Allows WX-78 to scan organism to unlock circuit blueprints. |
...
**“**I wonder if it dreams about scanning sheep?**”**

–[Wilson](/wiki/Wilson "Wilson")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Heh, how mad do you think WX would get if I painted a mustache on it?**”**
...
**“**It appears to be dormant, for the moment.**”**
...
**“**Something about it is temptingly kickable.**”**

–[Maxwell](/wiki/Maxwell "Maxwell")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Rest well, nöble scöut.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is your name really Jimmy?**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It seems vaguely potato shaped... or perhaps I'm just hungry.**”**

–[Warly](/wiki/Warly "Warly")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Little friend of robot**”**
...
**“**The tiny tin terror's tuckered out!**”**
...
The **Bio Scanalyzer** is an item that can only be crafted and used by [WX-78](/wiki/WX-78 "WX-78"), exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. The Bio Scanalyzer can be used to scan various organisms for various blueprints on circuits.

When deployed and near a scannable creature, the Bio Scanalyzer will seek and scan the creature, with a green circle highlighted near it. WX-78 must stay within the circle, 7[m](/wiki/Metre "Metre") of the Bio Scanalyzer, for the scanning to complete. The scanning will take 10 seconds for most mobs, 20 seconds for epic mobs. Once the scanning is completed, the Bio Scanalyzer will go to WX's last location from when it finished scanning and deposit 1-10 [Bio Data](/wiki/Bio_Data "Bio Data"), depending on the mob scanned, before going inactive to be retrieved. Scanning a creature multiple times within 480 seconds results in less [Bio Data](/wiki/Bio_Data "Bio Data"). If it scans a creature that teaches a new circuit, the circuit will be learned upon retrieval.

The Scan is interrupted when [Moleworms](/wiki/Moleworm "Moleworm") are underground.

## Placeholder Trivia[]

* The Bio Scanalyzer was added as part of [WX-78's Character Refresh Update](/wiki/Don%27t_Starve/Version_History "Don't Starve/Version History").
* The Bio Scanalyzer's designation is "J1-M1", and his name is Jimmy.[[1]](#cite_note-1)
* The Bio Scanalyzer’s design resembles the PotatOS from *Portal 2* and might be a reference to it.

## MosquitoBugs[]

* If Multiple Bio Scanalyzers are deployed at the same time, all of them can scan the same mob at the same time, resulting in more [Bio Data](/wiki/Bio_Data "Bio Data").

## Blueprint Gallery[]

Bio Scanalyzer Mob.png (99 KB)

Mob

RWP WX-78 Bio Scanalyzer concept arts1.png (278 KB)

Bio Scanalyzer concept arts from *Rhymes With Play WX-78's Refresh*

RWP WX-78 Bio Scanalyzer concept arts2.png (389 KB)

Bio Scanalyzer concept arts from *Rhymes With Play WX-78's Refresh*

RWP WX-78 Bio Scanalyzer concept arts3.png (264 KB)

Bio Scanalyzer concept arts from *Rhymes With Play WX-78's Refresh*

RWP WX-78 Bio Scanalyzer concept arts4.png (270 KB)

Bio Scanalyzer concept arts from *Rhymes With Play WX-78's Refresh*

## References[]

1. [↑](#cite_ref-1) [Rhymes With Play (April 28th, 2022)](https://www.youtube.com/watch?v=VU8-zoWwyKw&t=780)
