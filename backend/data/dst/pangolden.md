...
source_url: https://dontstarve.fandom.com/wiki/Pangolden
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Pangolden?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
Can poop [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget"). 75% damage resistance in ball form.
...
The **Pangolden** is a large passive [Mob](/wiki/Mob "Mob") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. They are found in the [Painted](/wiki/Painted "Painted") [Biome](/wiki/Biomes "Biomes") and roll up when they face any danger. While rolled up, Pangoldens take 75% reduced damage.

Pangoldens produce [Gold nuggets](/wiki/Gold_nugget "Gold nugget") and poop them out. In order to do that, they must eat either three [Gold Dust](/wiki/Gold_Dust "Gold Dust"), eat enough food on the ground, or slurp from a [Sparkling Pool](/wiki/Sparkling_Pool "Sparkling Pool") eight times.

Occasionally, a Pangolden will sit and lick its legs.

## Placeholder Trivia[]

* The Pangolden's name is a portmanteau of the words "[pangolin](https://en.wikipedia.org/wiki/Pangolin "wikipedia:Pangolin")", the animal the mob is based off of, and the act of gold panning, which refers to the Mob's ability to gather gold dust from water.
* The Pangolden is not incapable of attack. It's just that in most cases, by the time they leave the defensive state, the rage is over, so players rarely see Pangolden attacks. If the player attacks it with a weapon that consistently deals damage, (like [Weather Pain](/wiki/Weather_Pain "Weather Pain") or [Poison Spear](/wiki/Poison_Spear "Poison Spear")) the player will be attacked by the Pangolden.

## Winona's Spotlight Animations[]

Pangolden Attack Up.gif (2.85 MB)

attack animation

Pangolden Attack Side.gif (3.3 MB)

attack animation

Pangolden Attack Down.gif (3.11 MB)
