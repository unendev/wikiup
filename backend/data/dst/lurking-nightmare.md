...
source_url: https://dontstarve.fandom.com/wiki/Lurking_Nightmare
---
...
Nightmare Fuel×2-4   
Rift open: Pure Horror×2-3, Nightmare Fuel×1-2

### Spawns from

Nightmare Light Nightmare Fissure
...
The **Lurking Nightmare** is a [Shadow Creature](/wiki/Shadow_Creature "Shadow Creature") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in the *[From Beyond](/wiki/From_Beyond "From Beyond")* updates.

There is a 14% chance for a Lurking Nightmare to spawn from a [Nightmare Light](/wiki/Nightmare_Light "Nightmare Light") or [Nightmare Fissure](/wiki/Nightmare_Fissure "Nightmare Fissure") during the [Nightmare Phase](/wiki/Nightmare_Cycle "Nightmare Cycle") (31.5% chance when a [Shadow Rift](/wiki/Shadow_Rift "Shadow Rift") is open), regardless of the player's [Sanity](/wiki/Sanity "Sanity").

When killed, they drop 2-4 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel") (when Shadow Rift is open, 1-2 Nightmare Fuel and 2-3 [Pure Horror](/wiki/Pure_Horror "Pure Horror")).

## Behavior[]

The Lurking Nightmare can perform an attack dealing 50 damage.

If hit by a player, it will perform an attack in which it splits itself into 2 shadow pillars on either side of the player and shoot towards them dealing damage unless dodged.

When Shadow Rifts are open, the Lurking Nightmare receives [Planar Entity Protection](/wiki/Planar_Entity_Protection "Planar Entity Protection") and deals additional 20 [Planar Damage](/wiki/Planar_Damage "Planar Damage"). Its attack will also knock back the [character](/wiki/Character "Character"), even from a [Beefalo](/wiki/Beefalo "Beefalo").

## Trivia[]

* The Lurking Nightmare was added in the *[Depths of Duplicity](/wiki/Depths_of_Duplicity "Depths of Duplicity")* update.
