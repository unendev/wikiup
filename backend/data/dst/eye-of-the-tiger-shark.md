...
source_url: https://dontstarve.fandom.com/wiki/Eye_of_the_Tiger_Shark
---
...
**“**Theoretically, it's edible. But I believe there could be a better use for it.**”**
...
**“**I hope this is useful because my hands are all gooey now.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Eye of the Tiger Shark** is a [Food](/wiki/Food "Food") [Item](/wiki/Item "Item") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is dropped by the [Tiger Shark](/wiki/Tiger_Shark "Tiger Shark") and can be used to craft the [Super Spyglass](/wiki/Super_Spyglass "Super Spyglass"). When eaten, it will restore 60 [Health](/wiki/Health "Health"), and 75 [hunger](/wiki/Hunger "Hunger") at the cost of 15 [Sanity](/wiki/Sanity "Sanity"). It is considered [Meat](/wiki/Meats "Meats"), therefore if left on the ground, nearby [Wildbores](/wiki/Wildbore "Wildbore"), [Spiders](/wiki/Spider "Spider") and [Snakes](/wiki/Snake "Snake") will be attracted to it and will eat it.
...
* The name might be a reference to the song *[Eye of the Tiger](https://en.wikipedia.org/wiki/Eye_of_the_Tiger "wikipedia:Eye of the Tiger")*.
* Food-wise, this item can be considered the *Shipwrecked* counterpart to the [Deerclops Eyeball](/wiki/Deerclops_Eyeball "Deerclops Eyeball").
