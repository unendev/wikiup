...
source_url: https://dontstarve.fandom.com/wiki/Tuber_Tree
---
...
Machete Luxury Machete

### Resources

Tuber (normal)   

Blooming Tuber (blooming)
...
**Tuber Trees** are [Plants](/wiki/Plants "Plants") introduced in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. They can be found in the [Painted](/wiki/Painted "Painted") [Biome](/wiki/Biome "Biome").

They have a seasonal life cycle: In the [Temperate](/wiki/Seasons/Temperate "Seasons/Temperate") and [Humid](/wiki/Seasons/Humid "Seasons/Humid") Seasons, they will not be mature, then they will bloom in the [Lush Season](/wiki/Seasons/Lush "Seasons/Lush"), finally returning to their original state once Lush Season ends.

Unlike other trees, Tuber Trees cannot be chopped down with an [Axe](/wiki/Axe "Axe"), but must be hacked using a [Machete](/wiki/Machete "Machete") or [Luxury Machete](/wiki/Luxury_Machete "Luxury Machete") instead.

A fully grown Tuber Tree yields up to three [Tubers](/wiki/Tuber "Tuber"), taking three (one for [Obsidian Machete](/wiki/Obsidian_Machete "Obsidian Machete")Shipwrecked icon) hits with the Machete each. While regular, unripe Tubers will [Poison](/wiki/Poison "Poison") the player when eaten, [Blooming Tuber](/wiki/Tuber "Tuber") yielded during the Lush Season are safe to eat.

Tuber Trees leave a stump like most trees after hacking several times (12 hits for big tree, 9 hits for small tree). As the Trees are not completely destroyed during this process, they will slowly regrow the hacked Tuber every 4 days, into the smaller version of the normal or blooming tuber tree. The stump can be dug up by a [Shovel](/wiki/Shovel "Shovel"), producing a Tuber. The stumps will not regrow. Like other trees, they have a chance to be [Peculiar](/wiki/Peculiar_Objects "Peculiar Objects"), making them investigatable with a [Magnifying Glass](/wiki/Magnifying_Glass "Magnifying Glass") or [Wagstaff](/wiki/Wagstaff "Wagstaff")'s [Spectoggles](/wiki/Spectoggles "Spectoggles").

Tuber Trees can catch on fire. A burnt Tuber Tree can be destroyed with a Machete, producing [Charcoal](/wiki/Charcoal "Charcoal").

## Prototype Tips[]

* Due to Tuber Trees not being renewable, one should avoid triggering the lightning that [Thunderbirds](/wiki/Thunderbird "Thunderbird") produce since one cannot replace the burnt Tuber Tree.
