...
source_url: https://dontstarve.fandom.com/wiki/Pan_Flute
---
...
**“**Pan flute music: so boring everyone falls instantly asleep.**”**
...
**“**Plays sleepy music, florp.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It can't be too hard to play.**”**
...
The **Pan Flute** is a [Magic](/wiki/Magic "Magic") [item](/wiki/Item "Item"). It requires 5 [Cut Reeds](/wiki/Cut_Reeds "Cut Reeds"), 1 [Mandrake](/wiki/Mandrake "Mandrake"), and 1 [Rope](/wiki/Rope "Rope") to craft, and a [Prestihatitator](/wiki/Prestihatitator "Prestihatitator") to prototype.

When played, it puts all [Mobs](/wiki/Mobs "Mobs") within 15[m](/wiki/Distance "Distance") to [sleep](/wiki/Sleep "Sleep"), except for those that are incapable of sleeping.

It takes 1 second to begin playing the Pan Flute after clicking it. Mobs will be put into a deeper sleep than usual, allowing the player to move closer to them without waking them up; for example, the [Tallbird](/wiki/Tallbird "Tallbird").
...
The Pan Flute can be used to cool down enraged [Dragonfly](/wiki/Dragonfly "Dragonfly"), outrun [Bee Queen](/wiki/Bee_Queen "Bee Queen")'s [Grumble Bees](/wiki/Grumble_Bee "Grumble Bee"), buy time against [Toadstool](/wiki/Toadstool "Toadstool") when it is trying to summon Sporecaps, shave [Beefalo](/wiki/Beefalo "Beefalo"), or steal [Tallbird Eggs](/wiki/Tallbird_Egg "Tallbird Egg") and [Pengull](/wiki/Pengull "Pengull") [Eggs](/wiki/Eggs "Eggs"). The Pan Flute also complements the [Feather Hat](/wiki/Feather_Hat "Feather Hat") when looking for [Morsels](/wiki/Morsel "Morsel") and [Feathers](/wiki/Feather "Feather").

[Mandrakes](/wiki/Mandrake "Mandrake") are rare and if the player wishes to use Pan Flute more, they can deconstruct a Pan Flute using a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff") and craft it again to renew its durability. Mandrakes also have a chance to be obtained from [Klaus](/wiki/Klaus "Klaus")'s loot.

## Gift Icon Downloadable Content[]

In the *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* DLC, the Pan Flute has a 75% chance to be found around the [Glommer's Statue](/wiki/Glommer%27s_Statue "Glommer's Statue").

In the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, the Pan Flute can rarely be found when fishing with the [Trawl Net](/wiki/Trawl_Net "Trawl Net"), making it renewable.

In the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC, the Pan Flute is renewable since [Mandrakes](/wiki/Mandrake "Mandrake") can be bought in ['The Sty' Oddities Emporium](/wiki/%27The_Sty%27_Oddities_Emporium "'The Sty' Oddities Emporium") for 50 [Oincs](/wiki/Oinc "Oinc").

In [Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together"), the Pan Flute has a 100% chance to be found around [Glommer's Statue](/wiki/Glommer%27s_Statue "Glommer's Statue").

## Don't Starve Together Skins[]

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Pan\_Flute](/wiki/Belongings#Pan_Flute "Belongings")*
...
* The Pan Flute is named after [Pan](https://en.wikipedia.org/wiki/Pan_(god) "wikipedia:Pan (god)"), the Greek god of animals and music.
* The Pan Flute is one of the 7 ways to put mobs to sleep, with the others methods being the [Sleep Dart](/wiki/Sleep_Dart "Sleep Dart"), [Life Giving Amulet](/wiki/Life_Giving_Amulet "Life Giving Amulet"), [Napsack](/wiki/Napsack "Napsack"), [Wickerbottom's](/wiki/Wickerbottom "Wickerbottom") book [Sleepytime Stories](/wiki/Sleepytime_Stories "Sleepytime Stories"), and eating or cooking a Mandrake.
* Using a Pan Flute near a [Bird](/wiki/Birds "Birds") in flight will cause it to fall to the ground, ready to be picked up for a short time.
* It is also apparently [Wortox](/wiki/Wortox "Wortox")'s flute, according to his character quote. This would make sense as the Pan Flute is shown to be [shadow magic](/wiki/Shadow_Magic_Filter "Shadow Magic Filter"), and Wortox is an imp, which, according to folklore, dabble in the dark arts.
  + It is also shown in the portrait for his Verdant skin, which has similarities to Satyrs, which in folk tales would use Pan Flutes.
* Making a Pan Flute out of a Mandrake is a much more efficient use of a Mandrake, as cooking and eating Mandrakes only have two uses, destroy the Mandrake, and also put the user to sleep. Pan Flutes have ten uses, but if used only nine times can be renewed with Deconstuction Staves, and do not put the user to sleep.

## Blueprint Gallery[]

Pan Flute Ground.png (56 KB)

on the ground

Wilson Pan Flute.png (164 KB)

[Wilson](/wiki/Wilson "Wilson") playing the Pan Flute.

Maxwell1.jpg (14 KB)

[Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") putting [Hounds](/wiki/Hounds "Hounds") to sleep.
