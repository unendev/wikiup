...
source_url: https://dontstarve.fandom.com/wiki/Tackle_Receptacle
---
...
| --- |
| Driftwood Piece**×1** Electrical Doodad**×1** Bone Shards**×1** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Prototypers & Stations Filter Structures Filter Fishing Filter | Science Machine |

Perk

|  |
| --- |
| Grants access to the [Fishing Tab](/wiki/Fishing_Tab "Fishing Tab"). |
...
**“**I shall create a fishing weapön like nö öther!**”**
...
**“**Not to brag, but I do have my fishing badge.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Fishing is so bothersome, it takes so much time and preparation!**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Tackle Receptacle** is a craftable [Structure](/wiki/Structure "Structure") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It requires 1 [Driftwood Piece](/wiki/Driftwood_Piece "Driftwood Piece"), 1 [Bone Shards](/wiki/Bone_Shards "Bone Shards"), and 1 [Electrical Doodad](/wiki/Electrical_Doodad "Electrical Doodad") to craft.

Like other Prototypers, When standing close to a Tackle Receptacle, the players are able to prototype recipes for all Spoon and Spinnerbait [Lures](/wiki/Lures "Lures") and all [Floats](/wiki/Floats "Floats").

## Trivia[]

* The Tackle Receptacle was introduced in the *[Hook, Line, and Inker](/wiki/Return_of_Them#Hook,_Line,_and_Inker "Return of Them")* update.
* Before *[She Sells Sea Shells](/wiki/She_Sells_Sea_Shells "She Sells Sea Shells")* it required 4 [Driftwood Pieces](/wiki/Driftwood_Piece "Driftwood Piece"), 1 [Spoiled Fish](/wiki/Spoiled_Fish "Spoiled Fish"), and 1 [Electrical Doodad](/wiki/Electrical_Doodad "Electrical Doodad") to craft.
* When hammered or burned, the Tackle Receptacle drops everything needed to make a new one, making it technically portable.
* Before the [March 2022 QoL update](/wiki/Don%27t_Starve_Together/Version_History#March_24,_2022_-_March_2022_QoL_Update "Don't Starve Together/Version History"), players had to stand next to the Tackle Receptacle every time they had to craft. Also, [Adverts](/wiki/Advert "Advert") had to be inserted into the Tackle Receptacle in order to craft that Advert's recipe.

## Gallery[]

Tackle Receptacle Burnt.png (23 KB)

A burnt Tackle Receptacle.
