...
source_url: https://dontstarve.fandom.com/wiki/Thulecite_Club
---
...
| --- |
| Living Log**×3** Thulecite**×4** Nightmare Fuel**×4** |
...
| --- |
| 59.5  44.6 WendyWes  ---  74.4 Wigfrid  ---  29.8WolfgangDon't Starve/44.6WolfgangDon't Starve Together/59.5Wolfgang/119 Wolfgang  ---  29.8 Wanda (elderly) |
...
|  |
| --- |
| Summon Shadow Tentacles on hit (20% chance)  Increases movement speed by 10% |

## Sources

### Dropped by

Ornate Chest (Slotmachine X Marks The Spot Shipwrecked icon)
...
**“**That fascinating dark energy has amplified the brutality of this weapon.**”**
...
**“**Know a few scallywags I'd like to introduce this to.**”**
...
**“**All those years playing stick ball will finally come in handy.**”**
...
**“**I was never great at baseball... but maybe I would be with a bat like this!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's a bit unwieldy, don't you think?**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Thulecite Club** is a craftable [Item](/wiki/Item "Item") found in the [Ancient Tab](/wiki/Ancient_Tab "Ancient Tab"). It requires 3 [Living Logs](/wiki/Living_Log "Living Log"), 4 [Thulecite](/wiki/Thulecite "Thulecite"), 4 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel") and an [Ancient Pseudoscience Station](/wiki/Ancient_Pseudoscience_Station "Ancient Pseudoscience Station") to craft. It also has a 8.3% chance to be found inside a [Large Ornate Chest](/wiki/Large_Ornate_Chest "Large Ornate Chest"). Like all items from the Ancient Tab, Thulecite Clubs cannot be prototyped and [Characters](/wiki/Characters "Characters") always need to be near an Ancient Pseudoscience Station to craft them again.

When equipped in the hand slot, the Thulecite Club can be used as a [Weapon](/wiki/Weapon "Weapon") that deals 59.5 damage per hit and increases movement [speed](/wiki/Player_Speed "Player Speed") by 10%. The Thulecite Club loses 0.5% of its [Durability](/wiki/Durability "Durability") with each hit, meaning it has 200 uses before breaking. This Is twice as much as the [dark sword](/wiki/Dark_Sword "Dark Sword").

When attacking with a Thulecite Club, there is a 20% chance that a [Shadow Tentacle](/wiki/Shadow_Tentacle "Shadow Tentacle") will spawn from the ground, which lasts for 9 seconds attacking enemies within its range. Shadow Tentacles have the same stats as normal [Tentacles](/wiki/Tentacles "Tentacles"), except for a more limited attack range. Shadow Tentacles lower [Sanity](/wiki/Sanity "Sanity") by 40 Sanity per minute when close just like normal ones. The Shadow Tentacles cannot be targeted.

Since Thulecite is not renewable, only a limited number of Thulecite Clubs can be crafted in the base game.

## Gift Icon Downloadable Content[]

In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, Thulecite Clubs, along with [Thulecite Crowns](/wiki/Thulecite_Crown "Thulecite Crown") and [Thulecite Suits](/wiki/Thulecite_Suit "Thulecite Suit"), can be obtained from the [Slot Machine](/wiki/Slot_Machine "Slot Machine") as a possible reward. An [X Marks the Spot](/wiki/X_Marks_the_Spot "X Marks the Spot") treasure chest found through a [Message in a Bottle](/wiki/Message_in_a_Bottle "Message in a Bottle") also has a chance to contain these items. Since [Dubloons](/wiki/Dubloons "Dubloons") required to obtain loot from the Slot Machine are renewable, Thulecite equipment is also renewable in *Shipwrecked*.

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, [Thulecite](/wiki/Thulecite "Thulecite") is renewable by [Ruins](/wiki/Ruins "Ruins") regeneration and by feeding [Amberosia](/wiki/Amberosia "Amberosia") to [Dust Moths](/wiki/Dust_Moth "Dust Moth"), thus making Thulecite Clubs renewable.

## Prototype Tips[]

* Shadow Tentacles are stationary and have a limited attack range. That means that they will not be very useful against fast moving enemies, but will provide a good advantage against slow or stationary ones.
* Since they're both top-tier Weapons, the Thulecite Club and [Dark Sword](/wiki/Dark_Sword "Dark Sword") are often compared with each other. While the Dark Sword does more direct damage than the Thulecite Club, the total damage from the Club and the Shadow Tentacles can potentially be higher. The Thulecite Club will also last longer than a Dark Sword (200 uses versus 100 in durability, although more expensive) and the Shadow Tentacles drain more Sanity than the sword, but only if the player is standing close to them.
* A way to gain sanity in DST is to combine a Thulecite Club with a [Bee Queen Crown](/wiki/Bee_Queen_Crown "Bee Queen Crown"), because the Crown will convert the Sanity loss of the Shadow Tentacles into +20 sanity per minute (Instead of -40 per minute), and it also provides defense (70%) at the same time.

## Placeholder Trivia[]

* The Thulecite Club was added in the *[The Stuff of Nightmares](/wiki/Version_History#The_Stuff_of_Nightmares "Version History")* update.
* The Thulecite Club is very similar to an Aztec weapon called the [macuahuitl](https://en.wikipedia.org/wiki/macuahuitl "wikipedia:macuahuitl"), which has been reported to cut off a horse's head in a single blow due to the sharpness of its obsidian blades. Many of the Ruins items appear to be based around Aztec or Olmec art.
...
Ghost tentacle.png (84 KB)

A spawned Shadow Tentacle.

Thulecite Club In-Game.png (181 KB)

Wolfgang wielding a Thulecite Club.

BuggedThuleciteClub.jpg (31 KB)

A bugged Thulecite Club with 101% durability.

Shipwrecked Thulecite Set.png (1.63 MB)

Wilson holding a Thulecite Club, while wearing a [Thulecite Crown](/wiki/Thulecite_Crown "Thulecite Crown"), and a [Thulecite Suit](/wiki/Thulecite_Suit "Thulecite Suit").
