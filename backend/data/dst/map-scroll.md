...
source_url: https://dontstarve.fandom.com/wiki/Map_Scroll
---
...
|  |
| --- |
| Allows [Map](/wiki/Map "Map") sharing with other players. |
...
**“**It's not a map yet, but it will be in the future.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Map Scroll** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It requires 1 [Feather Pencil](/wiki/Feather_Pencil "Feather Pencil") and 1 [Papyrus](/wiki/Papyrus "Papyrus") to craft and is found in the [Cartography Filter](/wiki/Cartography_Filter "Cartography Filter"). This filter can only be accessed while standing next to a [Cartographer's Desk](/wiki/Cartographer%27s_Desk "Cartographer's Desk"), therefore the Map Scroll can not be prototyped.

Upon examination, the character will say who drew the Map Scroll and on which day. The Map Scroll contains the data of the preparing player's [Map](/wiki/Map "Map") at the time of the scroll's creation. When used by another player, the knowledge in the scroll will be added to the user's Map. Therefore, players can organize map exploration and gain quicker access to full map knowledge.

If the Map Scroll is created on the surface, it will not transfer any [Caves](/wiki/Caves "Caves") map data and vice versa. Map Scrolls must be in the Caves to transfer cave map data and on the surface to transfer surface map data.

## Trivia[]

* Map Scrolls were added in the *[A Little Fixer Upper](/wiki/A_New_Reign#September_1,_2016_-_A_Little_Fixer_Upper "A New Reign")* update.

## Gallery[]

Dropped Map Scroll.jpg (15 KB)

A Map Scroll dropped on the ground.

Dropped Cave Map Scroll.jpg (32 KB)
