...
source_url: https://dontstarve.fandom.com/wiki/Bucket-o-poop
---
...
| Health |
| --- |
| +2 (Wormwood) +3 (Don't Starve TogetherWormwood) |
...
The **Bucket-o-poop** is a craftable [item](/wiki/Item "Item") from the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* and *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC. It is crafted using 4 [Logs](/wiki/Log "Log"), 2 [Bone Shards](/wiki/Bone_Shards "Bone Shards"), and 3 [Manure](/wiki/Manure "Manure") and requires an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.
...
* [3 The Gorge](#The_Gorge)
* [4 Trivia](#Trivia)

## Usage[]

The Bucket-o-poop is used to maximize the uses of Manure as [fertilizer](/wiki/Farming#Fertilizers "Farming"). It has ten uses; each use decreases its durability by 10%. Despite Manure being able to be used as fuel, the Bucket-o-poop is unable to fuel fires; however, it can still extinguish smoldering objects.

### Don't Starve TogetherHamlet Don't Starve Together & Hamlet[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* and the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC, [Wormwood](/wiki/Wormwood "Wormwood") can use the Bucket-o-poop to restore [Health](/wiki/Health "Health") (3 Health per use in *DST*, 2 Health per use in *Hamlet*).

In *DST*, the Bucket-o-poop can also be used on [Farm Soil Turf](/wiki/Farm_Soil_Turf "Farm Soil Turf") to add [Nutrients](/wiki/Nutrient "Nutrient") (+16 Manure).
...
In [The Gorge](/wiki/The_Gorge "The Gorge") event for *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, a Bucket-o-poop can be acquired by giving 10 [Logs](/wiki/Log "Log") to the [Swamp Pig Elder](/wiki/Swamp_Pig_Elder "Swamp Pig Elder").

## Trivia[]

* The Bucket-o-poop utilizes previously unused game textures of a [Bucket](/wiki/Unimplemented_Features#Unimplemented_Items "Unimplemented Features").
