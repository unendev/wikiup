...
source_url: https://dontstarve.fandom.com/wiki/Telelocator_Staff
---
...
**“**I WILL CALL IT THE MINION\_MOVER\_3000.**”**
...
**“**It's a bit clunky, but it'll do for now.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Telelocator Staff** is a magical item created from the [Magic](/wiki/Magic "Magic") tab. It requires a [Shadow Manipulator](/wiki/Shadow_Manipulator "Shadow Manipulator") to prototype, and costs 2 [Living Logs](/wiki/Living_Logs "Living Logs"), 4 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"), and 2 [Purple Gems](/wiki/Purple_Gem "Purple Gem") to craft. The Telelocator Staff has 5 uses. Each use costs 50 [Sanity](/wiki/Sanity "Sanity").

## Icon Tools Usage[]

The Telelocator Staff is used to teleport the player or [Mob](/wiki/Mob "Mob") (including Bosses) to a random location on the map. When used on a mob, [Lightning](/wiki/Lightning "Lightning") will strike the mob where it was standing before being teleported (possibly setting it on fire). When used on the player, lightning will strike them at the location used and also at the location they are teleported to (potentially causing fires both times). Each use will increase world's moisture, that when high enough can start [Rain](/wiki/Rain "Rain").

Using a Telelocator Staff in [Caves](/wiki/Caves "Caves") will not teleport the target (even if a Telelocator Focus was built underground), but will cause [Rocks](/wiki/Rocks "Rocks") and [Gems](/wiki/Gems "Gems") to fall at the location where the spell was used (similar to an [Earthquake](/wiki/Earthquake "Earthquake")). Note that falling [Minerals](/wiki/Minerals "Minerals") can cause damage to players and mobs.

## Telelocator Focus Telelocator Focus[]

If the player built a [Telelocator Focus](/wiki/Telelocator_Focus "Telelocator Focus") in the world and stocked it with three Purple Gems, the Telelocator Staff will teleport its target to the point at which the focus is placed instead of to a random location. This consumes the gems.
...
In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, when using the Staff on a mob, lightning may strike the player instead. [WX-78](/wiki/WX-78 "WX-78") will always be hit, even when standing next to a [Lightning Rod](/wiki/Lightning_Rod "Lightning Rod") (causing both the character and the rod to be struck).

In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, Mobs in the ocean cannot be teleported.

In the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC, [Pugalisk](/wiki/Pugalisk "Pugalisk") cannot be teleported.

## Strategy[]

The Telelocator Staff can be used to provide a quick escape for the player, to teleport enemies away from the player (including bosses like [Deerclops](/wiki/Deerclops "Deerclops")), to commence [Rain](/wiki/Rain "Rain") at will (particularly useful during Summer), or to activate [WX-78](/wiki/WX-78 "WX-78")'s [SYSTEM OVERLOAD](/wiki/WX-78#SYSTEM_OVERLOAD "WX-78") perk on demand. When self-teleporting, this may leave the player lost, as the destination will be random unless a [Telelocator Focus](/wiki/Telelocator_Focus "Telelocator Focus") has been placed and charged, so using the staff this way may be risky. If the player teleports to a densely flammable area, the effects of the lightning can cause large amounts of damage.

WX-78 can activate their SYSTEM OVERLOAD by either casting the spell on themselves or by casting on any mob, regardless of whether a Telelocator Focus has been crafted or not. It is worth noting that the beneficial effects of multiple strikes will stack, lasting for approximately 0.735 days per lightning strike. For example using 10 Telelocator Staves will grant approximately 1 full year of system overload. However, WX-78 will NOT gain the health bonus normally associated with lightning strikes. Sanity loss is tremendous from the staff and both lightning strikes. The Telelocator Staff can provide WX-78 with enormous benefit; it is always recommended, however, to have protection from the rain which will follow (unless used during Winter) and means of restoring lost sanity. If casting on oneself, however, a player is able to negate the effects of the second strike by equipping insulated clothing such as the [Rain Coat](/wiki/Rain_Coat "Rain Coat") or the [Eyebrella](/wiki/Eyebrella "Eyebrella") (provided this is done fast enough), note that this will prevent stacking of SYSTEM OVERLOAD.

## Placeholder Trivia[]

* The word "Telelocator" defines something which is able to locate at a distance.
* When using the staff, any followers the player had at the moment (including [Chester](/wiki/Chester "Chester")) will teleport off-screen near the player's teleported location.
* The Telelocator Staff used to be a [Gemology](/wiki/Gemology "Gemology") Tab item.

## Blueprint Gallery[]

Wilson and 2 ts.jpg (6 KB)

Wilson holding a Telelocator Staff.

Wilson with a ts.jpg (5 KB)

Wilson using the Telelocator Staff.

Telelocator Focus ready.png (264 KB)

Telelocator Focus - ready to go!

Telelocator Staff Jump Distance Example.png (565 KB)

Telelocator Staff teleport distance example.
