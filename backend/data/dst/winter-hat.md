...
source_url: https://dontstarve.fandom.com/wiki/Winter_Hat
---
...
The Sow's Ear Hat Shop (Oinc ×10) Hamlet icon
...
**“**A knitted hat constructed from silk and grass.**”**
...
**“**Keeps me noggin' from freezin'.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**KEEP'TH SHIVERIES AWAY**”**
...
**“**I'll wear it and think of summer.**”**
...
**“**What a funny little fuzzy hat. Mind if I try it on?**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Winter Hat** is a wearable [Dress](/wiki/Dress "Dress") item. It requires 4 [Beefalo Wool](/wiki/Beefalo_Wool "Beefalo Wool") and 4 [Silk](/wiki/Silk "Silk") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. The [Sewing Kit](/wiki/Sewing_Kit "Sewing Kit") repairs 50% of its durability.

It restores 1.33 [Sanity](/wiki/Sanity "Sanity") per minute while worn.

It is a *tier 2* warm clothing, increasing the time a character can be without a fire during the [Winter](/wiki/Winter "Winter") before [Freezing](/wiki/Freezing "Freezing"). It has an [insulation factor](/wiki/Freezing#Mechanics "Freezing") of 120.

The Winter Hat can be given to a [Pig](/wiki/Pig "Pig") or [Bunnyman](/wiki/Bunnyman "Bunnyman") to wear, which provides no effect. It will still lose durability while worn.

## Gift Icon Downloadable Content[]

In the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, Winter Hats can be bought for 10 [Oincs](/wiki/Oinc "Oinc") at [The Sow's Ear Hat Shop](/wiki/The_Sow%27s_Ear_Hat_Shop "The Sow's Ear Hat Shop") in the [Pig City](/wiki/Pig_City "Pig City").

## Placeholder Trivia[]

* The Winter Hat was added in the *[Long Live the Queen](/wiki/Version_History#Long_Live_the_Queen "Version History")* update.
* The Winter Hat was used to start a snowing effect, with no practical use besides the visuals. This effect was removed as of *[A Winter's Tale](/wiki/Version_History#A_Winter's_Tale "Version History")* update, when Winter became a feature. Its crafting description during this time was "*There must be some magic in it...*".
* The Winter Hat used to cost 100 points under the old [Research Points](/wiki/Research_Points_List "Research Points List") system. Adding it into a Science Machine or Alchemy Engine would give the player 10 points.
* [Klei Entertainment](/wiki/Klei_Entertainment "Klei Entertainment") made a [product](https://shop.klei.com/product/dont-starve-winter-hat-replica-blue/) themed after the winter hat. It also comes in [dark grey](https://shop.klei.com/product/dont-starve-winter-hat-replica/) and two versions of pink: [one](https://shop.klei.com/product/dont-starve-winter-hat-klei-logo-version-2-0-pink/) has a Klei logo, while the [other](https://shop.klei.com/product/dont-starve-pink-winter-hat-replica/) has a *Don't Starve* logo. They all include codes to unlock the corresponding colored Winter Hat [Skins](/wiki/Skins "Skins") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*.
* In Rhymes with Play Ep. 53, Kelly said that for the design of the hat, she was based on her father's hat from the 70s, which she found in the basement [[1]](#cite_note-1)

## Blueprint Gallery[]

A Winter's Tale.jpg (725 KB)

A Winter Hat-wearing Wilson prominently featured in the *[A Winter's Tale](/wiki/Version_History#A_Winter's_Tale "Version History")* update poster.

Long Live the Queen.jpg (166 KB)

Winter Hat as seen in the poster for the *[Long Live the Queen!](/wiki/Don%27t_Starve/Version_History#December_19,_2012_–_Long_Live_the_Queen! "Don't Starve/Version History")* update.

Winter RoG poster.jpg (600 KB)

Winter Hat as seen in the [Winter](/wiki/Winter#Reign_of_Giants "Winter") promo for *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")*.

Christmasbetapromo png.png (735 KB)

Winter Hat as seen in the *Winter's Feast* update poster.

The Starver's Carol.png (4.95 MB)

Winter Hat in the *[Winter's Feast](/wiki/Winter%27s_Feast "Winter's Feast")* update poster.

Winter Hat Replica.jpg (1.45 MB)

Blue Winter Hat replica.

Winter Hat Replica Dark Grey.jpg (1.42 MB)

Dark grey Winter Hat replica.

Winter Hat Replica Pink Klei Logo.jpg (1.73 MB)

Pink Winter Hat replica with Klei logo.

Winter Hat Replica Pink Don't Starve Logo.png (2.98 MB)

Pink Winter Hat replica with *Don't Starve* logo.

* Expand slideshow

  [Wilson](/wiki/Wilson "Wilson") wearing a Winter Hat.
* Expand slideshow

  [Willow](/wiki/Willow "Willow") wearing a Winter Hat.
* Expand slideshow

  [Wolfgang](/wiki/Wolfgang "Wolfgang") wearing a Winter Hat.
* Expand slideshow

  [Wendy](/wiki/Wendy "Wendy") wearing a Winter Hat.
* Expand slideshow

  [WX-78](/wiki/WX-78 "WX-78") wearing a Winter Hat.
* Expand slideshow

  [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing a Winter Hat.
* Expand slideshow

  [Woodie](/wiki/Woodie "Woodie") wearing a Winter Hat.
* Expand slideshow

  [Wes](/wiki/Wes "Wes") wearing a Winter Hat.
* Expand slideshow

  [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing a Winter Hat.
* Winter Hat Wagstaff.png

  [Wagstaff](/wiki/Wagstaff "Wagstaff") wearing a Winter Hat.
* Expand slideshow

  [Wigfrid](/wiki/Wigfrid "Wigfrid") wearing a Winter Hat.
* Expand slideshow

  [Webber](/wiki/Webber "Webber") wearing a Winter Hat.
* Expand slideshow

  [Walani](/wiki/Walani "Walani") wearing a Winter Hat.
* Expand slideshow

  [Warly](/wiki/Warly "Warly") wearing a Winter Hat.
* Expand slideshow

  [Wilbur](/wiki/Wilbur "Wilbur") wearing a Winter Hat.
* Expand slideshow

  [Woodlegs](/wiki/Woodlegs "Woodlegs") wearing a Winter Hat.
* Expand slideshow

  [Wilba](/wiki/Wilba "Wilba") wearing a Winter Hat.
* Expand slideshow

  [Wormwood](/wiki/Wormwood "Wormwood") wearing a Winter Hat.
* Expand slideshow

  [Wheeler](/wiki/Wheeler "Wheeler") wearing a Winter Hat.
* Expand slideshow

  [Winona](/wiki/Winona "Winona") wearing a Winter Hat.
* Expand slideshow

  [Wortox](/wiki/Wortox "Wortox") wearing a Winter Hat.
* Expand slideshow

  [Wurt](/wiki/Wurt "Wurt") wearing a Winter Hat.

1/22

## References[]

1. [↑](#cite_ref-1) [Rhymes with Play Ep. 53 (14:14)](https://youtu.be/AHRN7cDZqbk?t=854). Re-uploading an old stream to YouTube
