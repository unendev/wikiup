...
source_url: https://dontstarve.fandom.com/wiki/Guardian's_Horn
---

## Guardian's Horn

Guardian's Horn Build
...
**“**It's emitting strange wavelengths of energy.**”**
...
**“**Harumph. It doesn't even spiral.**”**
...
**“**This is amazing! A real monster horn!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I'm glad I managed to not meet my end at the business end of this horn.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Guardian's Horn** is an [Item](/wiki/Item "Item") dropped by [Ancient Guardian](/wiki/Ancient_Guardian "Ancient Guardian"), which is found in the [Ruins](/wiki/Ruins "Ruins"). The horn can be used to craft a [Houndius Shootius](/wiki/Houndius_Shootius "Houndius Shootius").

It is similar to the [Deerclops Eyeball](/wiki/Deerclops_Eyeball "Deerclops Eyeball"): it does not spoil, drains the same amount of [Sanity](/wiki/Sanity "Sanity") when eaten, restores the same amount of [Health](/wiki/Health "Health") and [Hunger](/wiki/Hunger "Hunger") when eaten, and is dropped by a boss [mob](/wiki/Mob "Mob").

As it is a [Meat](/wiki/Meat "Meat") item, [Pigs](/wiki/Pig "Pig") and [Spiders](/wiki/Category:Spiders "Category:Spiders") will try to eat a Guardian's Horn, and [Bunnymen](/wiki/Bunnyman "Bunnyman") will be hostile to players carrying it in their inventory.
...
* With the *[Scrappy Scavengers](/wiki/Scrappy_Scavengers "Scrappy Scavengers")* update, the Guardian's Horn became stackable in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*.
