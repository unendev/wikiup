...
source_url: https://dontstarve.fandom.com/wiki/Slanty_Shanty
---
...
[Pig City](/wiki/Pig_City "Pig City") (Swinesbury)

Perk

|  |
| --- |
| Sanity Meter +6.25/min (being inside) |
...
The **Slanty Shanty** is a building exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is an abandoned housing structure which spawns in [Swinesbury City](/wiki/Pig_City "Pig City"), and can be unlocked and bought as one's home by purchasing the [Deed of home ownership](/wiki/Deed_of_home_ownership "Deed of home ownership") at [Swinesbury City Hall](/wiki/Swinesbury_City_Hall "Swinesbury City Hall") for 50 [Oincs](/wiki/Oinc "Oinc").

Once unlocked, the building will become the player's house, a place where one can set up a base, and a permanent protection from [Charlie](/wiki/Charlie "Charlie")'s attacks, due to the presence of a light source. It also protects the player from the elements, as [rain](/wiki/Rain "Rain") or [fog](/wiki/Fog "Fog"), and from attacks of every sort (excluding [Shadow Creatures](/wiki/Shadow_Creatures "Shadow Creatures") and [Krampus](/wiki/Krampus "Krampus")). It doesn't protect the player from starvation though, so exploration is still needed.

The Slanty Shanty can also be crafted in the [City Planning Tab](/wiki/City_Planning_Tab "City Planning Tab") when the player is holding the [Key to the City](/wiki/Key_to_the_City "Key to the City"). It can be crafted for 4 [Boards](/wiki/Boards "Boards"), 3 [Cut Stone](/wiki/Cut_Stone "Cut Stone"), and 30 [Oincs](/wiki/Oinc "Oinc"), making it cheaper than buying the Deed of home ownership when built in either a Hamlet or even a vanilla Don't Starve or Reign Of Giants world. It will be unlocked immediately after placing.
...
Upon unlocking and entering the Shanty, the player is greeted with two [Charcoal](/wiki/Charcoal "Charcoal") scattered on the floor.

The default interior consists of Wood Paneling and Flooring, a Cinderblock Bookshelf, a Tasteful Fish Mounting and a Rope Light. The interior and exterior can be renovated and replaced with the [Renovate Tab](/wiki/Renovate_Tab "Renovate Tab").

## Prototype Tips[]

* The Slanty Shanty makes for a good base, given that most utility structures can be placed inside and it can be expanded infinitely using [House Expansion Permits](/wiki/House_Expansion_Permit "House Expansion Permit") and [Doors](/wiki/Doors_Tab "Doors Tab"), as well as having protection from most outside elements.
* If the house catches on fire or is destroyed, nearby [Pig Workers](/wiki/Worker "Worker") or even the player can rebuild it with a [Hammer](/wiki/Hammer "Hammer"). The player's items inside will not be lost. The only way to destroy the house is by using the [Executive Hammer](/wiki/Executive_Hammer "Executive Hammer") or a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff").
* There is a major sanity aura when inside the house. It may be stacked with the sanity aura of a recruited [Royal Guard](/wiki/Royal_Guard "Royal Guard").
* Even if the House protects the player from most environmental hazards, it does not protect them from [Hay Fever](/wiki/Hay_Fever "Hay Fever"), [Freezing](/wiki/Freezing "Freezing") and [Overheating](/wiki/Overheating "Overheating").
* Even if the player hasn't yet bought a Deed of home ownership yet, it is best to prepare for once the player does buy it by planting [farms,](/wiki/Farm "Farm") a Crock Pot, [Evergreen](/wiki/Evergreen "Evergreen") and [Birchnut](/wiki/Birchnut_Tree "Birchnut Tree") trees, and Berry Bushes for income from [Ushers](/wiki/Pig_Traders/Usher "Pig Traders/Usher").

## Mosquito Bugs[]

* Entering another room while an item is on fire will not spawn [Ash](/wiki/Ash "Ash").
* Entering another room while a [Chest](/wiki/Chests "Chests") catches on fire will delete all items in the Chest, including ones that are unrenewable.

## Placeholder Trivia[]

* The Slanty Shanty can also be crafted using 3 [Tenpiece Oincs](/wiki/Oinc "Oinc") or 1 [Centapiece Oinc](/wiki/Centapiece_Oinc "Centapiece Oinc"). If using Centapiece Oinc, one will be returned 7 Tenpiece Oincs.

## Blueprint Gallery[]

Interior wes.jpg (431 KB)

The interior of the Shanty.

Interior wickerbottom.jpg (492 KB)

A decorated Shanty.

RWP 237 Hamlet Player House concepts.png (759 KB)

Concept art of the House Upgrades for the Slanty Shanty from *Rhymes With PLay* #237.
