...
source_url: https://dontstarve.fandom.com/wiki/Glass_Cutter
---
...
| --- |
| Boards**×1** Moon Shard**×6** |

| [Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Celestial Filter | Celestial AltarCelestial TributeCelestial Sanctum |

Combat attributes

| [Damage](/wiki/Damage "Damage") |
| --- |
| 68  51 WendyWes  ---  85 Wigfrid  ---  51Wolfgang/68Wolfgang/136 Wolfgang  ---  34 Wanda (elderly) |
...
**“**Oh, I'm sure I'll have fun with this. Hyuyu!**”**
...
**“**The air around it tingles with potential.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Glass Cutter** is a craftable [Weapon](/wiki/Weapon "Weapon") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It can be crafted with 1 [Board](/wiki/Board "Board") and 6 [Moon Shards](/wiki/Moon_Shard "Moon Shard"), however doing so requires that the player be near a [Lunar Altar](/wiki/Lunar_Altars "Lunar Altars"). It deals 68 damage per hit, equivalent to a [Dark Sword](/wiki/Dark_Sword "Dark Sword").

Durability loss is halved when using the Glass Cutter to attack [Shadow Creatures](/wiki/Shadow_Creature "Shadow Creature"), the [Shadow Pieces](/wiki/Shadow_Pieces "Shadow Pieces"), Maxwell's [Shadow Tab](/wiki/Shadow_Tab "Shadow Tab") minions, the [Ancient Fuelweaver](/wiki/Reanimated_Skeleton "Reanimated Skeleton") or its minions (both Woven Shadows and Unseen Hands), or [Ink Blights](/wiki/Ink_Blight "Ink Blight"). This means the Glass Cutter can be used a total of 150 times if it is used exclusively to attack shadows.

## Don't Starve Together Skins[]

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Glass\_Cutter](/wiki/Belongings#Glass_Cutter "Belongings")*
...
* Paired with [Volt Goat Chaud-Froid](/wiki/Volt_Goat_Chaud-Froid "Volt Goat Chaud-Froid") and [Chili Flakes](/wiki/Chili_Flakes "Chili Flakes") on a wet target with no damage modification, a Glass Cutter deals 204 damage per hit, making it more powerful than [Gunpowder](/wiki/Gunpowder "Gunpowder"). If the player is playing as [Wolfgang](/wiki/Wolfgang "Wolfgang") in his Mighty form, it is possible to deal up to 408 damage per hit.

## Trivia[]

* The Glass Cutter was introduced in the *[Turn of Tides](/wiki/Return_of_Them#Turn_of_Tides "Return of Them")* update.
