...
source_url: https://dontstarve.fandom.com/wiki/Metal_Potato_Thing
---

*Exclusive to:* Don't Starve

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 See also: [Wooden Potato Thing](/wiki/Wooden_Potato_Thing "Wooden Potato Thing") and [Relic Thing](/wiki/Relic_Thing "Relic Thing")*
...
The **Metal Potato Thing** is one of four [Things](/wiki/Things "Things") used on the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") to travel to the next world. It spawns naturally in every world in its own [Set Piece](/wiki/Set_Piece "Set Piece"). It is located near some [Basic Farms](/wiki/Basic_Farm "Basic Farm"), which are surrounded by some [Grass](/wiki/Grass "Grass") and [Twigs](/wiki/Twigs "Twigs"), a [Shovel](/wiki/Shovel "Shovel"), and unpicked [Carrots](/wiki/Carrots "Carrots").

There are two versions of it, one that spawns in [Survival Mode](/wiki/Survival_Mode "Survival Mode") and one in [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode"). The only other difference is the color scheme. Player can craft a [Divining Rod](/wiki/Divining_Rod "Divining Rod") to help them track the Metal Potato Thing.

The only purpose of the Metal Potato Thing is to be used on the Wooden Thing. It's an important gameplay item and as such it cannot be destroyed or stolen by [Mobs](/wiki/Mobs "Mobs") (e.g. [Krampus](/wiki/Krampus "Krampus"), [Splumonkeys](/wiki/Splumonkeys "Splumonkeys") etc.)

## Trivia[]

* The Metal Potato Thing is actually a robotic [Maxwell's](/wiki/Maxwell_(NPC) "Maxwell (NPC)") head. Calling it a potato may just be making fun of the game's antagonist, though being near a farm makes the potato similarities more obvious.
* It's the reason why the Wooden Thing, when fully constructed, is more commonly referred to as the 'Teleportato'.
* It may be a reference to the game *[Portal 2](https://en.wikipedia.org/wiki/Portal_2 "wikipedia:Portal 2")*, in which deuteragonist Wheatley puts the antagonist GLaDOS into a potato battery. This is reinforced by WX-78's quote, as seen above.
* Although exclusive to the original *Don't Starve*, some of the files for *Don't Starve Together* contain quotes from exclusive characters.

## Gallery[]

Metal Potato Thing Set Piece.jpg (111 KB)

The Metal Potato Thing's Set Piece.

Metal Potato Thing Placed.png (415 KB)

Metal Potato Thing added to the Wooden Thing.

|  |  |
| --- | --- |
| **Teleportato Pieces** [view](/wiki/Template:Navbox "Template:Navbox") | |
| **[Things](/wiki/Things "Things")** | [Crank Thing](/wiki/Crank_Thing "Crank Thing") • [Box Thing](/wiki/Box_Thing "Box Thing") • [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") • [Ring Thing](/wiki/Ring_Thing "Ring Thing") • **Metal Potato Thing**  (*[Grassy Thing](/wiki/Grassy_Thing "Grassy Thing") • [Screw Thing](/wiki/Screw_Thing "Screw Thing") • [Wooden Platform Thing](/wiki/Wooden_Platform_Thing "Wooden Platform Thing") • [Wooden Potato Thing](/wiki/Wooden_Potato_Thing "Wooden Potato Thing")* Don't Starve: Shipwrecked) (*[Lever Thing](/wiki/Lever_Thing "Lever Thing") • [Rock Thing](/wiki/Rock_Thing "Rock Thing") • [Stone Thing](/wiki/Stone_Thing "Stone Thing") • [Iron Thing](/wiki/Iron_Thing "Iron Thing") • [Relic Thing](/wiki/Relic_Thing "Relic Thing")* Don't Starve: Hamlet) |
