...
source_url: https://dontstarve.fandom.com/wiki/Telebrella
---
...
"A revolutionary walker."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Electrical Doodad**×1** Pretty Parasol**×1 (Wagstaff)** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| **Tinkering Tab** | Always available |
...
35% resistance Reign of Giants iconShipwrecked iconHamlet icon
...
|  |
| --- |
| Allows teleportation to nearest [Telipad](/wiki/Telipad "Telipad"). |
...
**“**Bumber-shoot me away from here!**”**

–[Wilson](/wiki/Wilson "Wilson"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Smells like ozone and space travel.**”**

–[Willow](/wiki/Willow "Willow"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Wolfgang saved from mighty walk.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Momentarily relieves my weariness.**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I AM NOT FOOLED BY ITS UMBRELLA IMITATION**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Not as good at rain protection as it is at teleportation.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This'll save some time.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's like walking without the exertion.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A short range, aerial teleportation antenna in convenient-to-carry umbrella form.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Aids me in my battle against walking!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A zoomy umbrella!**”**

–[Webber](/wiki/Webber "Webber"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Good for when I don't feel like walking. Which is always.**”**

–[Walani](/wiki/Walani "Walani"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I hope it doesn't cook me when I use it.**”**

–[Warly](/wiki/Warly "Warly"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Saves the wood in ol'Woodleg's wooden legs.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS THE BRELLA O' ZOOMIES**”**

–[Wilba](/wiki/Wilba "Wilba"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Not rain taker**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining the Telebrella

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Great as a teleporter. Horrible as an umbrella.**”**

–[Wheeler](/wiki/Wheeler "Wheeler"), when examining the Telebrella

The **Telebrella** is a [Character](/wiki/Characters "Characters")-exclusive [Item](/wiki/Item "Item") craftable only by [Wagstaff](/wiki/Wagstaff "Wagstaff"). It is found in the [Tinkering Tab](/wiki/Tinkering_Tab "Tinkering Tab"), and requires a [Electrical Doodad](/wiki/Electrical_Doodad "Electrical Doodad") and a [Pretty Parasol](/wiki/Pretty_Parasol "Pretty Parasol") to craft.

When equipped in the hand slot, a prompt to "Use Gadget" appears where the cursor is on the field, and right-clicking will teleport the character to the nearest [Telipad](/wiki/Telipad "Telipad") within range.
...
The Telebrella can also be used as a [melee weapon](/wiki/Category:Weapons#Melee_Weapons "Category:Weapons"), but this is not recommended as it deals only 17 damage and breaks after 10 uses.
...
In the [DLCs](/wiki/DLC "DLC"), the Telebrella has a 35% [Wetness](/wiki/Wetness "Wetness") protection.

## PrototypeTips[]

* It is impractical to build a [Telelocator Focus](/wiki/Telelocator_Focus "Telelocator Focus") while having access to the Telebrella (with a Telipad). Even though the Telebrella has a limited range, it's a lot cheaper to use it instead of the Telelocator Focus (The Telebrella costs an Electrical Doodad and a [Pretty Parasol](/wiki/Pretty_Parasol "Pretty Parasol") to craft, and a Telipad to use, while the Telelocator Focus costs 4 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"), 4 [Living Logs](/wiki/Living_Logs "Living Logs") and 8 [Gold Nuggets](/wiki/Gold_Nuggets "Gold Nuggets") to craft, needing 3 [Purple Gems](/wiki/Purple_Gem "Purple Gem") and a [Telelocator Staff](/wiki/Telelocator_Staff "Telelocator Staff") to use it).
* If the player gets struck by [lightning](/wiki/Lightning "Lightning") while equipping the Telebrella, it would force the umbrella to activate even when there aren't any Telipads present in the world, resulting in a loss of 1 use. This activation could be exploited because it can help the player teleport to the Telipad even if they aren't within range. Potentially, the player can teleport a further distance with the help of [Thunderbirds](/wiki/Thunderbird "Thunderbird") to get back to base or another important place at the cost of some HP.
