...
source_url: https://dontstarve.fandom.com/wiki/Pig_Traders/Farmer
---
...
Gives 1x Oinc for Cut GrassTwigs once a day
...
The **Farmer** is a [Pig Trader](/wiki/Pig_Traders "Pig Traders") [Mob](/wiki/Mob "Mob") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. He stands around the farms near the Pig Village. The player can sell [Cut Grass](/wiki/Cut_Grass "Cut Grass") or [Twigs](/wiki/Twigs "Twigs") to him for an Oinc only once a day. If the player harvests [Berry Bushes](/wiki/Berry_Bushes "Berry Bushes"), [Grass](/wiki/Grass "Grass"), [Twigs](/wiki/Twigs "Twigs") or [Farms](/wiki/Farm "Farm") near the Farmer, a [Pig Guard](/wiki/Pig_Guard "Pig Guard") will attack.

As [Farm Houses](/wiki/Farm_House "Farm House") cannot be built by the player, even with the [Key to the City](/wiki/Key_to_the_City "Key to the City"), Farmers are one of the few Pig Traders that cannot be brought to the [Constant's](/wiki/Don%27t_Starve "Don't Starve") [mainland](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants") or the [Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked") worlds.
