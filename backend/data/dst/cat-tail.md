...
source_url: https://dontstarve.fandom.com/wiki/Cat_Tail
---
...
'The Sty' Oddities Emporium (Oinc ×4) Hamlet icon
...
**“**It's a tall tail! Or, I guess more of a bushy one... never mind.**”**
...
The **Cat Tail** is an [Item](/wiki/Item "Item") from the *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* DLC. It is dropped by [Catcoons](/wiki/Catcoon "Catcoon") and can be used to craft a [Cat Cap](/wiki/Cat_Cap "Cat Cap").

## Hamlet icon Hamlet[]

Cat Tails are also included in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, however, Catcoons are not present. Instead, Cat Tails can be bought at [‘The Sty’ Oddities Emporium](/wiki/Pig_Shops "Pig Shops") for 4 [Oincs](/wiki/Oinc "Oinc"), making them renewable.

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Cat Tails are also part of the [Tail o' Three Cats](/wiki/Tail_o%27_Three_Cats "Tail o' Three Cats"), as the name suggests, three of them are required. They can also be used to adopt a [Kittykit](/wiki/Critters#Kittykit "Critters") at the [Rock Den](/wiki/Rock_Den "Rock Den"), along with some [Fishsticks](/wiki/Fishsticks "Fishsticks").
