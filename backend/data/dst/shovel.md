...
source_url: https://dontstarve.fandom.com/wiki/Shovel
---
...
| --- | --- | --- |
| **Tools Tab** | Tools Filter | Science Machine |
...
What terrible secrets might be uncovered with this? (DST)**”**
...
**“**It is amazing what some twigs and flint can build.**”**
...
I'd prefer a ship burial, but it might have its uses. (DST)**”**
...
**“**Good for digging things. And whacking things.**”**
...
**“**I could dig a hole where I belong!**”**
...
**“**You never know what you'll find if you do a little digging.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**My clocksmith hands weren't made for this kind of work...**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Shovel** is a [Tool](/wiki/Tool "Tool") that can be used to dig up [Plants](/wiki/Plants#Collectible_Plants "Plants") and other objects in the *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")* world. It requires 2 [Twigs](/wiki/Twig "Twig") and 2 [Flint](/wiki/Flint "Flint") to craft and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. It has 25 uses, and each use will take 4% of its durability. Shovel can also be used as a weapon, dealing 17 damage per strike. Each hit as a weapon will consume one use.

### Don't Starve Together Skins[]

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Shovel](/wiki/Belongings#Shovel "Belongings")*
...
"Lasts longer, digs the same stuff."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Twigs**×4** Gold Nugget**×2** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| **Tools Tab** | Tools Filter | Alchemy Engine |
...
X Marks The Spot [Ocean](/wiki/Ocean "Ocean") (Trawl Net) Shipwrecked icon
...
One might as well dig with style. (DST)**”**
...
**“**Strangely more durable than its stone counterpart.**”**
...
**“**Perfect for buryin' me treasures.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS BIG SHOVEL O' SHINY**”**
...
**“**Luxuriously unnecessary! Hyuyu!**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Fancy tool for digging in dirt.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Instead of digging up gold, I can dig with gold!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**If I have to spend time digging holes, I can at least be fancy.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Regal Shovel**is a variant of the normal Shovel that has four times as much durability and requires Gold instead of Flint. It requires 2 [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget") and 4 [Twigs](/wiki/Twig "Twig") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. Regal Shovel has 100 uses, 4 times as many as regular shovel. It deals the same 17 damage on each strike as the normal Shovel.

## Icon Tools Usage[]

To dig up an [item](/wiki/Item "Item") with the Shovel, right-click it from the inventory to equip it and right-click on the object. The player will dig up the object and an item will appear on the ground.

Shovels can be used to dig up Plants such as [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), [Grass](/wiki/Grass "Grass"), and [Saplings](/wiki/Sapling "Sapling") in order to replant them in a more desirable location (usually closer to a base camp).

Shovels can also uproot Tree stumps for 1 [Log](/wiki/Log "Log"), regardless of their size, and chopped [Mushtrees](/wiki/Mushtrees "Mushtrees"), also for 1 Log. They can dig up [Rabbit Holes](/wiki/Rabbit_Hole "Rabbit Hole"), but doing so will permanently remove the hole and prevent any more rabbits from spawning at that particular spot. Additionally, the Shovel can be used to dig up [Graves](/wiki/Grave "Grave") to acquire [Gravedigger Items](/wiki/Gravedigger_Items "Gravedigger Items") at the cost of -10 [Sanity](/wiki/Sanity "Sanity") per Grave dug.
...
*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Regal\_Shovel](/wiki/Belongings#Regal_Shovel "Belongings")*
...
* The Shovel was added in the *[Turf!](/wiki/Version_History#Turf! "Version History")* update. Shovels were previously used to dig up [Turf](/wiki/Turfs "Turfs"), but this is now done by the [Pitchfork](/wiki/Pitchfork "Pitchfork").
* The Shovel used to cost 30 [Science Points](/wiki/Research_points_list "Research points list") to craft and had a value of 1-10 Science Points, depending on its durability, while the Regal Shovel used to cost 200 Science Points to craft and had a value of 1-35 Science Points.
* In reality, gold is not a practical metal to be used in tools or weapons as it's a soft metal; it would easily deform and break. This is often remarked when [examined](/wiki/Character_quotes "Character quotes") by some [Characters](/wiki/Characters "Characters").

## Blueprint Gallery[]

Wilson Shovel.png (333 KB)

Wilson wielding a Shovel.

Wilson Golden Shovel.png (335 KB)

Wilson wielding a Regal Shovel.

Turf!.jpg (112 KB)

The poster for the *Turf!* update, featuring a Shovel.

WX-78 figure.png (932 KB)

WX-78 figurine with a Shovel.
