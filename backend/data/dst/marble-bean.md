...
source_url: https://dontstarve.fandom.com/wiki/Marble_Bean
---
...
| --- | --- |
| Refined Materials Filter | Alchemy Engine |
...
|  |
| --- |
| Can be planted to grow a Marble Shrub. |
...
**“**Big bean, made of marble.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Glargh! Ith chippf'd my toof...**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I'm pretty sure it's just a rock.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**That bean looks fossilized.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Marble Bean** is an [item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It can be crafted from the [Refined Materials Filter](/wiki/Refined_Materials_Filter "Refined Materials Filter"), is prototyped with an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine"), and requires 1 [Marble](/wiki/Marble "Marble") to craft. Marble Beans can be planted to grow into [Marble Shrubs](/wiki/Marble_Shrub "Marble Shrub"), making Marble renewable. Marble Beans can be planted everywhere [Pine Cones](/wiki/Pine_Cone "Pine Cone") can.

## Placeholder Trivia[]

* When Marble Beans were initially released in the *[Cute Fuzzy Animals](/wiki/A_New_Reign#November_3rd,_2016_-_Cute_Fuzzy_Animals "A New Reign")* update, two of them could be crafted with one Marble. This was changed in a later update.
* This item seems to be inspired by the magic bean in the *[Jack and the Beanstalk](https://en.wikipedia.org/wiki/Jack_and_the_Beanstalk "wikipedia:Jack and the Beanstalk")* fairy tale. This is supported by multiple characters' quotes.
* While the change log for the [March 2022 QoL update](/wiki/Don%27t_Starve_Together/Version_History#March_24,_2022_-_March_2022_QoL_Update "Don't Starve Together/Version History") noted that the Marble Bean was moved to the Alchemy Engine, this was already the case before the update.

## Blueprint Gallery[]

DSTupdate cutefuzzyanimals.png (2.56 MB)

Marble Bean as seen in the poster for the *[Cute Fuzzy Animals](/wiki/A_New_Reign#November_3,_2016_-_Cute_Fuzzy_Animals "A New Reign")* update.

Marble Sprout.png (4 KB)

A Marble Sprout grown from a bean.

Marble Sprout outdated.png (5 KB)

The old texture of the Marble Sprout.
