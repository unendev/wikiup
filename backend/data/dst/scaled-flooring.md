...
source_url: https://dontstarve.fandom.com/wiki/Scaled_Flooring
---
...
| --- | --- |
| Scales**×1** Cut Stone**×1** | 4 |

| [Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Decorations FilterSummer Items Filter | Alchemy Engine |
...
**Scaled Flooring** is a type of craftable [Turf](/wiki/Turfs "Turfs") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together").* It is crafted with [Scales](/wiki/Scales "Scales") and a [Cut Stone](/wiki/Cut_Stone "Cut Stone"), which makes four items. Like all other turfs, and in spite of its fireproof qualities, Scaled Flooring can be used as fuel and can be lit on fire if left on the ground as an item.

Scaled Flooring helps decrease the amount of heat an object or structure absorbs from open fire sources, therefore slowing the spread of fire. However, this effect does not stop things from being ignited in the heat or manually lit on fire (such as with a torch). The effect is also only extended to objects and structures which are placed fully on top of them. It does not block heat; thermal stones and players will still heat up at normal distances from heat sources.

## Tips[]

* Scaled Flooring can be used to duplicate Scales by using a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff"), since four Scaled Flooring are made each batch. This can be used to mass-produce Scales from at least one Scales.

## Gallery[]

Dragonfly Turf Texture.png (215 KB)

Scaled Flooring texture.

WigfridScaledTiles.png (154 KB)

[Wigfrid](/wiki/Wigfrid "Wigfrid") standing on Scaled Flooring.

[<https://dontstarve.fandom.com/wiki/File:ScaledFlooring.webm>](https://static.wikia.nocookie.net/dont-starve-game/images/8/86/ScaledFlooring.webm/revision/latest?cb=20230416191217)
