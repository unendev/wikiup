...
source_url: https://dontstarve.fandom.com/wiki/Dragoon_Den
---
...
"Enter the Dragoon's Den."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Dragoon Heart**×1** Rocks**×5** Obsidian**×4** |
...
**“**D'ya think 'tis full o'treasure?**”**
...
**Dragoon Dens** are naturally spawning [Structures](/wiki/Structure "Structure") introduced in the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC. They are found inside the [Volcano](/wiki/Volcano "Volcano") and spawn [Dragoons](/wiki/Dragoons "Dragoons"). They can also be crafted, requiring 1 [Dragoon Heart](/wiki/Dragoon_Heart "Dragoon Heart"), 5 [Rocks](/wiki/Rocks "Rocks") and 4 [Obsidian](/wiki/Obsidian "Obsidian") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. Dragoon Dens cannot be [Hammered](/wiki/Hammer "Hammer"), but they can be deconstructed using explosives, such as [Gunpowder](/wiki/Gunpowder "Gunpowder"), [Coconade](/wiki/Coconade "Coconade"), [Slurtle Slime](/wiki/Slurtle_Slime "Slurtle Slime"), [Dragoon Egg](/wiki/Dragoon_Egg "Dragoon Egg") summoned by the [Volcano Staff](/wiki/Volcano_Staff "Volcano Staff") or the [Joy of Volcanology](/wiki/Joy_of_Volcanology "Joy of Volcanology"). It takes 2, 1, 14 and 1 of each, respectively, to deconstruct a Den. Note that if using Slurtle Slime, it must be placed around the Den in 14 separate stacks.

They can house 3 to 4 Dragoons at a time. During the [Day](/wiki/Day "Day"), one will leave the Den every 30 seconds, returning at Dusk. If a Dragoon dies, it takes 2 minutes for the Den to regenerate it.

## Blueprint Gallery[]

Schermafbeelding 2016-02-05 om 19.07.12.png (218 KB)

A Dragoon spawning from its Den.
