...
source_url: https://dontstarve.fandom.com/wiki/Flare
---
...
"Light the way for your trusted friends."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Cut Grass**×1** Twigs**×1** Nitre**×1** |
...
|  |
| --- |
| Creates a temporary marking on the [Map](/wiki/Map "Map") that is visible to all players. |
...
**“**Mortals get lost sometimes, hyuyu.**”**
...
**“**It's a signal, only to be used in an emergency.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It'll show everyone where I am, when I am is another story.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Flare** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It is found in the [Tools Filter](/wiki/Tools_Filter "Tools Filter"), requires [Cut Grass](/wiki/Cut_Grass "Cut Grass"), [Twigs](/wiki/Twigs "Twigs") and [Nitre](/wiki/Nitre "Nitre") to craft, and does not need to be prototyped.

When placed on the ground and lit with a [Torch](/wiki/Torch "Torch") or a [Lighter](/wiki/Willow%27s_Lighter "Willow's Lighter"), the Flare will shoot up into the sky. It will then cause all other players to make an announcement about the flare and create a marking on the [Map](/wiki/Map "Map") that is near, but not on, the launch site, for 15 seconds that is visible to all players.
...
* The Flare was introduced in the *[Turn of Tides](/wiki/Return_of_Them#Turn_of_Tides "Return of Them")* update.
* Wigfrid's quote is a reference to a common saying in the Dungeons and Dragons community, alluding to how often adventuring parties fall apart or perish when members split up or go off on their own.

## Blueprint Gallery[]

Placed Flare.png (50 KB)

A placed Flare.

Flare Map Icon.png (6 KB)

The mark caused by a lit Flare on the Map.
