...
source_url: https://dontstarve.fandom.com/wiki/Magiluminescence
---
...
| --- |
| Thulecite**×2** Nightmare Fuel**×3** Yellow Gem**×1** |
...
|  |
| --- |
| Provides light while worn. Raises [Sanity](/wiki/Sanity "Sanity") over time.  Increases speed by 20%. |

## Sources

### Dropped by

Ancient Pseudoscience Station (Slotmachine Shipwrecked icon)
...
**Magiluminescence** is a craftable [Item](/wiki/Item "Item") found in the [Ancient Tab](/wiki/Ancient_Tab "Ancient Tab"). It requires 2 [Thulecite](/wiki/Thulecite "Thulecite"), 3 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel") and 1 [Yellow Gem](/wiki/Yellow_Gem "Yellow Gem"), and at least a broken [Ancient Pseudoscience Station](/wiki/Ancient_Pseudoscience_Station "Ancient Pseudoscience Station") to craft. It can also drop from an Ancient Pseudoscience Station when the latter is damaged with a [Hammer](/wiki/Hammer "Hammer"), [Gunpowder](/wiki/Gunpowder "Gunpowder"), etc. Like all items from the Ancient Tab, Magiluminescences cannot be prototyped, and can only be crafted near another Ancient Pseudoscience Station.

While equipped in the chest slot, it will provide a small amount of light around the player (similar to that of a [Torch](/wiki/Torch "Torch")), preventing attacks from [Charlie](/wiki/Charlie "Charlie"), and grant a 20% bonus to movement [speed](/wiki/Player_Speed "Player Speed"). It will also provide the Character with a passive +2 Sanity per minute.

The Magiluminescence will slowly lose durability while equipped, and it will last for 8 minutes (1 [Day](/wiki/Day "Day")). That said, it can be refueled with [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"), which will increase its durability by 37.5% (3 minutes) per every 1 Nightmare Fuel.

Since Yellow Gems are not renewable in the base game, only a limited number of Magiluminescence can be crafted. In [Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together"), Yellow Gems are renewable, making the Magiluminescence a renewable item.

## Gift Icon Downloadable Content[]

In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, players have a 0.01% chance of finding Yellow Gems inside [Tumbleweeds](/wiki/Tumbleweed "Tumbleweed").

In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, Yellow Gems can also be found in [X Marks the Spot](/wiki/X_Marks_the_Spot "X Marks the Spot") [Chests](/wiki/Chest "Chest"), while the Magiluminescence has a chance to come out of the [Slot Machine](/wiki/Slot_Machine "Slot Machine").

These make Magiluminescences renewable in both DLCs.

## Prototype Tips[]

* The speed bonus stacks with the [Walking Cane](/wiki/Walking_Cane "Walking Cane") or [The Lazy Explorer](/wiki/The_Lazy_Explorer "The Lazy Explorer"), for a total increase of 45% movement speed (88.5% on [Roads](/wiki/Road "Road")). This can be further stacked with overloaded [WX-78](/wiki/WX-78 "WX-78")'s
  + In *Shipwrecked*, the bonus will also work while on [Boats](/wiki/Boats "Boats") and will stack with the [Sleek Hat](/wiki/Sleek_Hat "Sleek Hat")'s, [Sails](/wiki/Sails "Sails")' and [Wilbur](/wiki/Wilbur "Wilbur")'s speed boosts.
  + In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the speed multiplier is the product of all multipliers of equipped items and roads and characters.
* Unlike [Lanterns](/wiki/Lantern "Lantern"), [Miner Hats](/wiki/Miner_Hat "Miner Hat") etc., Magiluminescences are destroyed when durability reaches 0%, so extra care is needed to prevent their loss.
* If players plan on keeping a Magiluminescence equipped at all times for the speed boost, it will cost them roughly 2.7 Nightmare Fuel per day. That means a stack of 40 for seasons that last 15 days, and 54 for those that last 20. That said, it is not advised to keep it equipped while not traversing big distances, like when crafting multiple items or harvesting from [Farms](/wiki/Farms "Farms"), since the advantage in movement speed is negligible for too much cost.

## Placeholder Trivia[]

* When placed on the ground, the Magiluminescence used to glow and not lose any durability. As of the *[A Moderately Friendly Update](/wiki/Version_History#A_Moderately_Friendly_Update "Version History")*, they will no longer glow when dropped on the ground.
* The Magiluminescence shares the same in-game model with the [Nightmare Amulet](/wiki/Nightmare_Amulet "Nightmare Amulet"), but its gem is yellow instead of purple.
* This is the only light-emitting item that can be equipped in the chest slot.
* Before the *[Release the Quacken](/wiki/Don%27t_Starve:_Shipwrecked#February_25,_2016_-_Release_the_Quacken_Update "Don't Starve: Shipwrecked")* update for *Shipwrecked*, Magiluminescence could not be refueled with Nightmare Fuel. This change was applied to the other game versions too.
  + Magiluminescence has been refuelable with Nightmare Fuel in *Don't Starve Together* since the update Rev. 172848 on April 7, 2016.
* [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") states the amulet glows at "mid 530 nanometer wavelength." However, a wavelength of ~535 nm is a green light, not yellow, mid 530 means that the brightness peaks at around 530, and other wavelengths of light, mostly red, are also mixed in, resulting in yellow.
* Magiluminescence, along with several other items from Don't Starve Together, appears in the game **Terraria** in the crossover update with Don't Starve Together.
* [Willow](/wiki/Willow "Willow") states that it appears that the Magiluminescence is absorbing darkness, but since darkness is the absence of light rays, that is impossible. This means that either Willow's statement is wrong, or that [The Constant](/wiki/The_Constant "The Constant") has fundamentally different laws of physics compared to our world

## Blueprint Gallery[]

* Expand slideshow

  [Wilson](/wiki/Wilson "Wilson") wearing a Magiluminescence.
* Expand slideshow

  [Willow](/wiki/Willow "Willow") wearing a Magiluminescence.
* Expand slideshow

  [Wolfgang](/wiki/Wolfgang "Wolfgang") wearing a Magiluminescence.
* Expand slideshow

  [Wendy](/wiki/Wendy "Wendy") wearing a Magiluminescence.
* Expand slideshow

  [WX-78](/wiki/WX-78 "WX-78") wearing a Magiluminescence.
* Expand slideshow

  [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing a Magiluminescence.
* Expand slideshow

  [Woodie](/wiki/Woodie "Woodie") wearing a Magiluminescence.
* Expand slideshow

  [Wes](/wiki/Wes "Wes") wearing a Magiluminescence.
* Expand slideshow

  [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing a Magiluminescence.
* Magiluminescence Wagstaff.png

  [Wagstaff](/wiki/Wagstaff "Wagstaff") wearing a Magiluminescence.
* Expand slideshow

  [Wigfrid](/wiki/Wigfrid "Wigfrid") wearing a Magiluminescence.
* Expand slideshow

  [Webber](/wiki/Webber "Webber") wearing a Magiluminescence.
* Expand slideshow

  [Walani](/wiki/Walani "Walani") wearing a Magiluminescence.
* Expand slideshow

  [Warly](/wiki/Warly "Warly") wearing a Magiluminescence.
* Expand slideshow

  [Wilbur](/wiki/Wilbur "Wilbur") wearing a Magiluminescence.
* Expand slideshow

  [Woodlegs](/wiki/Woodlegs "Woodlegs") wearing a Magiluminescence.
* Expand slideshow

  [Wilba](/wiki/Wilba "Wilba") wearing a Magiluminescence.
* Expand slideshow

  [Wormwood](/wiki/Wormwood "Wormwood") wearing a Magiluminescence.
* Expand slideshow

  [Wheeler](/wiki/Wheeler "Wheeler") wearing a Magiluminescence.
* Expand slideshow

  [Winona](/wiki/Winona "Winona") wearing a Magiluminescence.
* Expand slideshow

  [Wortox](/wiki/Wortox "Wortox") wearing a Magiluminescence.
* Expand slideshow

  [Wurt](/wiki/Wurt "Wurt") wearing a Magiluminescence.
* Expand slideshow
