...
source_url: https://dontstarve.fandom.com/wiki/Rocks
---
...
SinkholeStalagmite Spilagmite BoulderGold Vein (Pickaxe)  
Relic Stone Wall (Hammer)  
[Earthquakes](/wiki/Earthquake "Earthquake") (75%)

### Don't Starve

Mini Glacier (Pickaxe)
...
Stone Slab  
Artichoke Boulder (Pickaxe)  
Gnat Mound (≈100% Pickaxe)

### Don't Starve Together

Lavae (Ice Staff)

Moonrock boulder Smooth Meteor Boulder Petrified Tree Sea Stack Salt Formation (Pickaxe)  
Stone Fruit (34% Pickaxe)  
Rockjaw×3-5

### Sold by

Pigg and Pigglet's General Store (Oinc ×1), Swinesbury Mineral Exchange (Oinc ×1) Hamlet
...
**“**A bunch of projectiles. Just sitting there on the ground.**”**
...
**“**Maybe they're boulders and I just grew really big.**”**
...
**“**Maybe I could make a fire pit.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A handful of stones, absolutely thrilling!**”**

–[Wanda](/wiki/Wanda "Wanda")

**Rocks** are a resource which can be found in limited amounts on the surface but are unlimited in [Caves](/wiki/Caves "Caves"). They are used to craft several [Items](/wiki/Item "Item") and [Structures](/wiki/Structure "Structure"), and can also be [Refined](/wiki/Refine "Refine") to [Cut Stones](/wiki/Cut_Stone "Cut Stone").

Rocks are generally obtained by mining [Boulders](/wiki/Boulders "Boulders") with a [Pickaxe](/wiki/Pickaxe "Pickaxe"), but they can sometimes be found lying on the ground. They can also be obtained by deconstructing some structures, such as a [Fire Pit](/wiki/Fire_Pit "Fire Pit") or a [Rundown House](/wiki/Rundown_House "Rundown House"), with a [Hammer](/wiki/Hammer "Hammer") or [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff").

Underground, Rocks can be mined from [Stalagmites](/wiki/Stalagmite "Stalagmite") or dropped by [Rock Lobsters](/wiki/Rock_Lobster "Rock Lobster"). They also fall from the ceiling during [Earthquakes](/wiki/Earthquake "Earthquake"). Additionally, they can drop from [Relics](/wiki/Relics "Relics") after smashing them. [Slurtles](/wiki/Slurtles "Slurtles") and [Snurtles](/wiki/Snurtles "Snurtles") will attempt to eat Rocks, and Slurtles will attack a player holding Rocks if there are no minerals on the ground for them to eat.

## Downloadable Content[]

In the *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* DLC, [Moleworms](/wiki/Moleworm "Moleworm") will eat any Rocks lying on the ground. However, their [Burrows](/wiki/Burrow "Burrow") can be used to renew rocks easily, along with other minerals (excluding [Marble](/wiki/Marble "Marble") and [Gems](/wiki/Gems "Gems")). When dug up using a [Shovel](/wiki/Shovel "Shovel"), the burrow drops either Rocks, [Flint](/wiki/Flint "Flint"), [Nitre](/wiki/Nitre "Nitre") or a [Gold Nugget](/wiki/Gold_Nugget "Gold Nugget"). The Moleworm residing there goes off to make a new Burrow. Rocks may also be obtained by mining [Mini Glaciers](/wiki/Mini_Glacier "Mini Glacier").

In the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, Rocks can also be obtained by digging [Magma Piles](/wiki/Magma_Pile "Magma Pile") and [Sandy Piles](/wiki/Sandy_Pile "Sandy Pile"). They are renewable if acquired by harvesting [Dragoon Eggs](/wiki/Dragoon_Egg "Dragoon Egg"), [Lava Pools](/wiki/Lava_Pool "Lava Pool"), and [Trawl Nets](/wiki/Trawl_Net "Trawl Net") used in [Shallow Ocean](/wiki/Ocean "Ocean"). Rocks are also obtainable from the [Slot Machine](/wiki/Slot_Machine "Slot Machine") as a random drop.

## Don't Starve Together Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Mini Glaciers do not drop rocks. [Lavae](/wiki/Lavae "Lavae") spawned by the [Dragonfly](/wiki/Dragonfly "Dragonfly") can be [frozen](/wiki/Ice_Staff "Ice Staff") and killed, resulting in a couple of rocks. Rocks can also be mined from [Petrified Trees](/wiki/Petrified_Tree "Petrified Tree") and [Stone Fruits](/wiki/Stone_Fruit "Stone Fruit"), and drop from [Rockjaws](/wiki/Rockjaw "Rockjaw").

New boulders will also form from falling meteors during a [Meteor](/wiki/Meteor "Meteor") shower.

[Wilson](/wiki/Wilson "Wilson") can craft Rocks with 2 [Flint](/wiki/Flint "Flint") if he had learned the [Transmute Ore I](/wiki/Transmute_Ore_I "Transmute Ore I") skill.
...
Earthquaking.png (387 KB)

Rocks on the ground after an Earthquake.

Wall repair prompt.png (128 KB)

Rocks can be used to repair Stone [Walls](/wiki/Wall "Wall").
