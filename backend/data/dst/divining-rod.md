...
source_url: https://dontstarve.fandom.com/wiki/Divining_Rod
---
...
|  |
| --- |
| Helps locate [Things](/wiki/Things "Things") and [Maxwell's Door](/wiki/Maxwell%27s_Door "Maxwell's Door") |
...
**“**She'll help ol'Woodlegs sniff out treasures.**”**
...
**“**What this weird box thingy?**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Hey! This looks a lot like that radio!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Reminds me of a radio my nana once had.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Divining Rod** is a [Science](/wiki/Science "Science") item used for locating the [Things](/wiki/Things "Things") and [Maxwell's Door](/wiki/Maxwell%27s_Door "Maxwell's Door"). It requires 1 [Twig](/wiki/Twigs "Twigs"), 4 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel") and 1 [Gear](/wiki/Gears "Gears") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

The Rod increases in pitch and speed depending how close a Thing or the Door is. It also radiates rings of different colors, again depending on how far away the target item is. In [Sandbox Mode](/wiki/Sandbox_Mode "Sandbox Mode"), it may take some time to locate Maxwell's Door, as the Rod may find a Thing first. If held during a storm, there is a small chance the Rod can be struck by [lightning](/wiki/Lightning "Lightning"). For a short time, this will cause the Rod to react as if a Thing or the Door were very close by.

In [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode"), the Divining Rod is in a Divining Rod Holder directly next to where the character spawns. Once the character takes the Rod, the Holder will disappear a few seconds later. It also acts as a key to unlock a complete [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") and [Nightmare Lock](/wiki/Nightmare_Lock "Nightmare Lock"), requiring the player to take the Divining Rod from the holder in the beginning.

The Divining Rod is also an item that [Krampus](/wiki/Krampus "Krampus") or [Splumonkeys](/wiki/Splumonkeys "Splumonkeys") can't steal and [Eyeplants](/wiki/Eyeplant "Eyeplant") will not eat. Also, it can't be taken through Maxwell's Door. If it's one of the items chosen to travel with the player, it will be converted into [Ashes](/wiki/Ashes "Ashes") after the player uses the Wooden Thing. However, the ingredients can still be taken and it can be remade immediately.

## Placeholder Trivia[]

* The Divining Rod was added in *[The End of the Beginning](/wiki/Version_History#The_End_of_the_Beginning "Version History")* update.
* Its design utilizes the [Voxola PR-76 Radio](/wiki/Radio "Radio") that Maxwell used to communicate with Wilson in *[Forbidden Knowledge](/wiki/Animated_shorts_and_trailers#Forbidden_Knowledge "Animated shorts and trailers")*.
  + [Wagstaff](/wiki/Wagstaff "Wagstaff") invented the Radio, but he seems to have had no involvement with the creation of the Divining Rod as his quotes show that he is surprised to see his radio used on it. However, he does recognize the Divining Rod Holder as "one of [his]."[[1]](#cite_note-1)
* [Divining Rods](https://en.wikipedia.org/wiki/Dowsing "wikipedia:Dowsing") in real life are branched twigs that were claimed to be used to locate sources of ground water and mineral ores.
* The Divining Rod's sound effects are made by a [tanpura](https://en.wikipedia.org/wiki/Tanpura_(instrument) "wikipedia:Tanpura (instrument)"), an Indian string instrument used to create drone sounds.
* The Divining Rod's description, "There must be some way out of here...", is a reference to the Bob Dylan song "[All Along the Watchtower](https://en.wikipedia.org/wiki/All_Along_the_Watchtower "wikipedia:All Along the Watchtower")".
* The Divining Rod is the only non-magical and non-ancient item that requires Nightmare Fuel as part of its recipe.
* In *Don't Starve Together*, Divining Rod can still be obtained using the c\_give or c\_spawn command.

## Blueprint Gallery[]

White Rings.PNG (48 KB)

If the rings are white, then the Thing/door is somewhere nearby.

Yellow Rings.PNG (54 KB)

If the rings are yellow, then the Thing/door is closer.

Red Rings.PNG (49 KB)

If the rings are red, the Thing/door is very close.

Divining Rod and Holder ingame with Maxwell.png (64 KB)

Divining Rod in the holder.

Divining Rod Ranges.png (1.75 MB)
...
A model Divining Rod collectible.

Radio Thing in Terraria.png (543 bytes)

Divining Rod in Terraria

## References[]

1. [↑](#cite_ref-1) [Wagstaff quotes](/wiki/Wagstaff_quotes "Wagstaff quotes"): Divining Rod in Holder (Start Adventure Mode): "Interesting. A PR-76. Did it come in with me?" / Divining Rod Holder (Generic) "Is this one of mine!? It looks like one of mine!"
