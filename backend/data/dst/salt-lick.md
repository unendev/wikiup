...
source_url: https://dontstarve.fandom.com/wiki/Salt_Lick
---

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 See also: [Gourmet Salt Lick](/wiki/Gourmet_Salt_Lick "Gourmet Salt Lick") (Don't Starve Together)*

## Salt Lick

Salt Lick

"Keep your livestock content."
...
| --- | --- | --- |
| Tools Tab | Structures FilterBeefalo Riding Filter | Alchemy Engine |
...
|  |
| --- |
| Keeps [Beefalo](/wiki/Beefalo "Beefalo") domestication from reducing over time. |
...
**“**Imagine getting so distracted by a chunk of salt.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Salt Lick** is a craftable [Structure](/wiki/Structure "Structure"). It requires 2 [Boards](/wiki/Board "Board") and 4 [Nitre](/wiki/Nitre "Nitre") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.
...
When certain animals are within 4[m](/wiki/Distance "Distance") of a Salt Lick, they will each lick every 60 second until the Salt Lick is depleted. Each [Beefalo](/wiki/Beefalo "Beefalo") consumes 2 uses per lick and their domestication level loss is paused. Each [Koalefant](/wiki/Koalefant "Koalefant") consumes 4 uses per lick. Each [Grass Gator](/wiki/Grass_Gator "Grass Gator") consumes 4 uses per lick. Each [Volt Goat](/wiki/Volt_Goat "Volt Goat") consumes 1 use per lick. Each [No-Eyed Deer](/wiki/No-Eyed_Deer "No-Eyed Deer") consumes 1 use per lick.
...
* The Salt Lick was first introduced to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It was later added to *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")* in the *[Quality of Life](/wiki/Don%27t_Starve/Version_History "Don't Starve/Version History")* update.
* Salt Licks are considered to be part of *[A New Reign](/wiki/A_New_Reign "A New Reign")*, even though they were introduced before the official start of the beta branch.
* [Salt licks](https://en.wikipedia.org/wiki/Mineral_lick) are real-life tools used particularly in zoos to give the ungulates all the minerals they normally obtain from mineral swamps.
...
* Contrary to its name, the Salt Lick is made with Nitre, not [Salt Crystals](/wiki/Salt_Crystals "Salt Crystals"). This may be to ensure that the Salt Lick is available for players to use before they have access to Salt Crystals, or because Salt Crystals were added to the game after the Salt Lick.

## Gallery[]

Salt Lick Stages.png (31 KB)

The stages of a Salt Lick.

Burnt Salt Lick.png (5 KB)

A burnt Salt Lick.

Maxwell next to destroyed salt lick.jpg (80 KB)

[Maxwell](/wiki/Maxwell "Maxwell") next to a destroyed Salt Lick.
