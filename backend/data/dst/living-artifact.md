...
source_url: https://dontstarve.fandom.com/wiki/Living_Artifact
---
...
|  |
| --- |
| Immune to [Poison](/wiki/Poison "Poison"), [Freezing](/wiki/Freezing "Freezing"), [Overheating](/wiki/Overheating "Overheating"), [Fog](/wiki/Fog "Fog") and [Hay Fever](/wiki/Hay_Fever "Hay Fever"). Offers Night vision. |
...
**“**An ancient war machine! I must appraise its funtionality! [sic]**”**
...
**“**A Man o' War o' tha land!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA HATH GREATNESS THRUST 'PON HER!**”**
...
The **Living Artifact** is a craftable [Item](/wiki/Item "Item") exclusive to the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC. In order to craft it, the player must obtain a [Blueprint](/wiki/Blueprint "Blueprint") from the [Large Iron Hulk](/wiki/Large_Iron_Hulk "Large Iron Hulk"). It requires 6 [Infused Irons](/wiki/Infused_Iron "Infused Iron") and a [Magic Water](/wiki/Magic_Water "Magic Water") to craft.
...
When used, the [Inventory](/wiki/Inventory "Inventory") and [Crafting Tabs](/wiki/Game_Tabs "Game Tabs") will be removed from the screen, and all items the player has will drop onto the ground, similar to the [Werebeaver](/wiki/Werebeaver "Werebeaver") transformation. Hunger, health and sanity will also be removed, replaced by the Living Artifact's durability, which decreases by 1 every second, lasting a total of three minutes. When attacked while in the suit, no penalty will be taken, save for a brief stun. The Suit also gives full night vision and a speed boost. The Artifact also has full use of a [Machete](/wiki/Machete "Machete") (2×efficiency), [Pickaxe](/wiki/Pickaxe "Pickaxe") (3×efficiency), [Axe](/wiki/Axe "Axe") (4×efficiency), [Shovel](/wiki/Shovel "Shovel") (1×efficiency) and [Hammer](/wiki/Hammer "Hammer") (3×efficiency). While in the suit, the Iron Hulk soundtrack will play.
...
* It is recommended to use the Living Artifact for [Boss Monster](/wiki/Category:Boss_Monsters "Category:Boss Monsters") battles as it is extremely powerful; it not only grants invincibility with the ability to deal hundreds of damage in seconds, it also makes the player immune to any negative effects and night vision for late fights.

## Trivia[]

* The Living Artifact could be inspired by [Iron Man's](https://en.wikipedia.org/wiki/Iron_Man) armor suit.

## Gallery[]

Activated Living Artifact.png (87 KB)

The activated Living Artifact suit

Hamlet Final Launch Trailer Living Artifact stinger.png (405 KB)

An activated Living Artifact as seen in the final launch trailer for *Hamlet*.

Living Artifact Activate.gif (5.53 MB)

[Wheeler](/wiki/Wheeler "Wheeler") activating the Living Artifact.
