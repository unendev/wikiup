...
source_url: https://dontstarve.fandom.com/wiki/Smelter
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Smelter?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |

## Smelter

Smelter

"Turn Iron into Alloy"

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Cut Stone**×6** Boards**×4** Red Gem**×1** |
...
**“**Magnificent! Perhaps I can build a factory here as well.**”**
...
**“**I'll just let that do all the work for me.**”**
...
**“**A cannon fer makin' metals.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**TIS FWOOSHY MACHINES.**”**
...
**“**It takes the heavy metal and makes it heavier.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Smelter** is a craftable [Structure](/wiki/Structure "Structure") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is found in the [Science Tab](/wiki/Science_Tab "Science Tab"), requires 6 [Cut Stones](/wiki/Cut_Stone "Cut Stone"), 4 [Boards](/wiki/Boards "Boards"), and 1 [Red Gem](/wiki/Red_Gem "Red Gem") to craft, and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. Upon interacting with the Smelter, a UI will appear that is similar to that of the [Crock Pot](/wiki/Crock_Pot "Crock Pot"). It will only accept [Iron Ore](/wiki/Iron_Ore "Iron Ore") or items made from Iron Ore, and once 4 Ore is placed inside, it will create a bar of [Alloy](/wiki/Alloy "Alloy"). Items made from iron can be smelted in the Smelter.

In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, the Smelter can be [flooded](/wiki/Flooding "Flooding").

## Blueprint Gallery[]

Smelter Burnt.png (17 KB)
