...
source_url: https://dontstarve.fandom.com/wiki/Old_Beefalo
---
...
**Meat×2** (Slaughter Tools), Manure (periodic)
...
The **Old Beefalo** is a mob exclusive to the *[The Gorge](/wiki/The_Gorge "The Gorge")* event in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It is an old, hairless, domesticated variant of the [Beefalo](/wiki/Beefalo "Beefalo"). They can be found wandering around the starting area near the [Altar of Gnaw](/wiki/The_Altar_of_Gnaw "The Altar of Gnaw"). They occasionally drop [Manure](/wiki/Manure "Manure").

They can be killed using [Slaughter Tools](/wiki/Slaughter_Tools "Slaughter Tools") and they drop two [Meat](/wiki/Meat "Meat"), or three Meat if they are killed by [Wigfrid](/wiki/Wigfrid "Wigfrid"). After the player kills one, the rest will start running away, making a subsequent kill difficult. After some time, they will calm down, and can be killed without too much struggle.
...
Beefaolds Game.png (486 KB)

Old Beefalos in game
