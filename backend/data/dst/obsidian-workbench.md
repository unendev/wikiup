...
source_url: https://dontstarve.fandom.com/wiki/Obsidian_Workbench
---
...
|  |
| --- |
| Grants access to the [Volcanic Tab](/wiki/Volcanic_Tab "Volcanic Tab"). |

## Sources

### Common Biomes

[Volcano](/wiki/Volcano/Biome "Volcano/Biome")
...
The **Obsidian Workbench** is a naturally spawning [Structure](/wiki/Structure "Structure") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is found inside the [Volcano](/wiki/Volcano "Volcano"). It functions similarly to the [Ancient Pseudoscience Station](/wiki/Ancient_Pseudoscience_Station "Ancient Pseudoscience Station"), and allows players to craft items from the [Volcanic Tab](/wiki/Volcanic_Tab "Volcanic Tab") while they are near the workbench. If the player is wearing a [Brain of Thought](/wiki/Brain_of_Thought "Brain of Thought"), they can craft Volcanic items without being near the workbench.

## Craftable Items[]

The following Items can be crafted at the Obsidian Workbench:

Obsidian Machete (4 KB)
