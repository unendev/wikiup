...
source_url: https://dontstarve.fandom.com/wiki/Inviting_Formation
---
...
Celestial Altar Base (Inviting Formation Base)  

Celestial Altar Orb (Inviting Formation Orb)  
Celestial Altar Idol (Inviting Formation Idol)
...
|  |
| --- |
| `"moon_altar_rock_glass" "moon_altar_rock_seed" "moon_altar_rock_idol"` |
...
**“**There's definitely something stuck in there. I wonder...",**”**

–[Wanda](/wiki/Wanda "Wanda")

**Inviting Formations** are naturally spawning objects exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. One of each type will spawn on the [Lunar Island](/wiki/Lunar_Island "Lunar Island") in the [Lunar Mine](/wiki/Lunar_Mine "Lunar Mine") biome.

They can be mined to obtain the different pieces of the [Celestial Altar](/wiki/Celestial_Altar "Celestial Altar").

Their positions can be indicated by the [Astral Detector](/wiki/Astral_Detector "Astral Detector").

## Placeholder Trivia[]

* The Inviting Formations were introduced in the *[Turn of Tides](/wiki/Return_of_Them#Turn_of_Tides "Return of Them")* update.
