...
source_url: https://dontstarve.fandom.com/wiki/The_'Sea_Legs'
---
...
"Go do some pirate stuff."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Boards**×4** Dubloons**×4** Boat Cannon**×1** |
...
|  |
| --- |
| **Sailing Speed: 6**   Equipped with a low-damage Boat Cannon with infinite uses. -50% acceleration. |
...
**The 'Sea Legs'** is a craftable [Boat](/wiki/Boats "Boats") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, exclusive to [Woodlegs](/wiki/Woodlegs "Woodlegs"). It can be found in the [Nautical Tab](/wiki/Nautical_Tab "Nautical Tab") and requires 4 [Boards](/wiki/Boards "Boards"), 4 [Dubloons](/wiki/Dubloons "Dubloons"), and 1 [Boat Cannon](/wiki/Boat_Cannon "Boat Cannon") to craft. The 'Sea Legs' begins with 500 durability, which will deplete if damaged or over time as it is used. It can be repaired with the [Boat Repair Kit](/wiki/Boat_Repair_Kit "Boat Repair Kit") or [Sea Yard](/wiki/Sea_Yard "Sea Yard"). It does not allow attachments, however it comes with a Boat Cannon that does 50 damage and has infinite uses. It also comes with a [Sail](/wiki/Sail "Sail"), allowing the player to hold a lit [Torch](/wiki/Torch "Torch") while moving.

When in motion, it loses [Durability](/wiki/Durability "Durability") at a rate of 1 per 3.84 seconds, lasting a total of 4 [Days](/wiki/Day "Day"). It has an above average “hit immunity” time of 1 second and a map reveal bonus of 2.
...
* The infinite uses of the cannon allows the player to easily kill sea life, such as [Jellyfish](/wiki/Jellyfish "Jellyfish") and [Dogfish](/wiki/Dogfish "Dogfish"), collecting large amounts of [Food](/wiki/Food "Food") with very little effort.
  + This can be really useful for killing [Blue Whales](/wiki/Whale/Blue_Whale "Whale/Blue Whale") and [White Whales](/wiki/Whale/White_Whale "Whale/White Whale"), as creatures damaged with a Boat Cannon will not aggro the player.
* The infinite uses of the cannon can also be used to mine [Boulders](/wiki/Boulders "Boulders") and [Coral Reefs](/wiki/Coral_Reef "Coral Reef"), as well as digging [Sand](/wiki/Sand "Sand") and [X Marks the Spot](/wiki/X_Marks_the_Spot "X Marks the Spot").
  + Care should be taken when mining coral reefs, because hitting a cannon shot on an already mined coral reef will result it in being hammered down, yielding [Limestone](/wiki/Limestone "Limestone") and [Coral Nubbin](/wiki/Coral_Nubbin "Coral Nubbin").
...
* Spawning The 'Sea Legs' using the [Console](/wiki/Console "Console") will spawn it without the cannon and sail, even if the player is playing as Woodlegs.

## Blueprint Gallery[]

Legs.jpg (45 KB)

[Woodlegs](/wiki/Woodlegs "Woodlegs") and The 'Sea Legs'.

Legs sea.png (227 KB)

Sailing on the [Ocean](/wiki/Ocean#Shipwrecked "Ocean").
