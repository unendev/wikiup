...
source_url: https://dontstarve.fandom.com/wiki/Rock_Den
---
...
|  |
| --- |
| Unlocks the [Critters Tab](/wiki/Critters_Tab "Critters Tab"). |

## Sources

### Common Biomes

[Mosaic](/wiki/Mosaic "Mosaic")
...
**“**Ooo, I'd like a partner in pranks.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**See something moving inside, florp.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**What's wrong Woby? Is something in there?**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Shadow creatures! No, wait a tick, it's something else...**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Rock Den** is a naturally spawning object exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It is a small cave with two eyes looking out and is frequently found in the [Mosaic](/wiki/Mosaic "Mosaic") Biome.

It works similar to crafting stations like [Ancient Pseudoscience Stations](/wiki/Ancient_Pseudoscience_Station "Ancient Pseudoscience Station"), unlocking the [Critters Tab](/wiki/Critters_Tab "Critters Tab") and allowing players to adopt various [Critters](/wiki/Critters "Critters") such as Kittykits, Varglings, Ewelets, Broodlings, Glomgloms and Giblets. These pets will follow the player and avoid combat. Each player is only allowed to keep one pet at a time, so trying to adopt another one will not work unless the player chooses to abandon the previous one. This can also be done standing close to the Rock Den. [Walter](/wiki/Walter "Walter") already has a pet, and cannot use the Rock Den.

The Rock Den itself is not flammable and cannot be destroyed by any means.

## Placeholder Trivia[]

* The Rock Den was introduced in the *[Cute Fuzzy Animals](/wiki/A_New_Reign#November_3,_2016_-_Cute_Fuzzy_Animals "A New Reign")* update.

## Blueprint Gallery[]

Rock Den Overworld.PNG (238 KB)

The Rock Den in the Mosaic biome.

Art Stream 4 Critters.png (623 KB)

The Rock Den in a drawing from Art Stream # 4.
