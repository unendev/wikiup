...
source_url: https://dontstarve.fandom.com/wiki/Morning_Star
---
...
| --- |
| Volt Goat Horn**×1** Electrical Doodad**×2** Nitre**×2** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| **Fight Tab** | Light Sources Filter Weapons Filter | Alchemy Engine |

Combat attributes

| [Damage](/wiki/Damage "Damage") |
| --- |
| 43.35  32.5 WendyWes  ---  54.2 Wigfrid  ---  21.7WolfgangDon't Starve/32.5WolfgangDon't Starve Together/43.35Wolfgang/86.7 Wolfgang  ---  21.7 Wanda (elderly) - 72.25 (on wet targets)  54.2 WendyWes  ---  90.3 Wigfrid  ---  36.1WolfgangDon't Starve/54.2WolfgangDon't Starve Together/72.25Wolfgang/144.5 Wolfgang  ---  36.1 Wanda (elderly) |
...
**“**Speak softly and carry a bright stick.**”**
...
The **Morning Star** is a [melee weapon](/wiki/Weapon "Weapon") from the *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* DLC. It requires 1 [Volt Goat Horn](/wiki/Volt_Goat_Horn "Volt Goat Horn"), 2 [Electrical Doodads](/wiki/Electrical_Doodad "Electrical Doodad"), and 2 [Nitre](/wiki/Nitre "Nitre") to craft and an Alchemy Engine to prototype. Unlike most other weapons, the Morning Star doesn't lose durability when it strikes. Instead, it loses durability constantly while held. It also emits light while equipped. The Morning Star can do either 43.35 or 72.25 damage.

## Tips[]

* Striking an uncharged [Volt Goat](/wiki/Volt_Goat "Volt Goat") with the Morning Star will charge it. This can be useful if the player is hunting for [Electric Milk](/wiki/Electric_Milk "Electric Milk").
* Because of the wetness modifier, this weapon is most useful during Spring, due to the abundance of rain.
* During [Spring](/wiki/Spring "Spring"), the Morning Star can prove very useful in the [Caves](/wiki/Caves "Caves") and [Ruins](/wiki/Ruins "Ruins") as it provides light and does a high amount of damage.
* In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the following enemies are permanently wet, making the Morning Star the strongest melee weapon against them regardless of weather:
  + [Depths Worms](/wiki/Depths_Worm "Depths Worm");
  + All varieties of [Tentacles](/wiki/Tentacle "Tentacle");
...
* In the real world, [morning stars](https://en.wikipedia.org/wiki/Morning_star_(weapon) "wikipedia:Morning star (weapon)") are medieval spiked clubs resembling maces.
* The Morning Star's base damage is 28.9, but since it's electrical, it gains a 1.5x modifier, bringing it to 43.35 damage. Additionally, if the target the player is attacking is wet (has a [Wetness](/wiki/Wetness "Wetness") prefix), there will be an *additional* 1x modifier for a total of 2.5x. This means that the Morning Star can do either 43.35 or 72.25 damage (when used by characters with normal damage modifiers).
* The spawn code for a Morning Star is "nightstick". In real life, a nightstick is a police officer's club or billy.

## Gallery[]

Wolfgang Morning Star.png (244 KB)

[Wolfgang](/wiki/Wolfgang "Wolfgang") wielding a Morning Star. Note the light radius.
