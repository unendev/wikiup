...
source_url: https://dontstarve.fandom.com/wiki/Ashes
---
...
|  |
| --- |
| Disappears if left on the ground for 20 seconds. |
...
Red Hound  
(Ash TreeLava PoolSlotmachine Shipwrecked icon)
...
**Ashes** are an [Item](/wiki/Item "Item") dropped after a flammable object has been burnt by [Fire](/wiki/Fire "Fire") (some exceptions such as [Trees](/wiki/Trees "Trees")), including the remnants of a [Campfire](/wiki/Campfire "Campfire") and a destroyed [Pig Torch](/wiki/Pig_Torch "Pig Torch") or [Fire Pit](/wiki/Fire_Pit "Fire Pit"). Ashes will also replace any item that is not allowed to be carried through to the next [World](/wiki/World "World") via the [Teleportato](/wiki/Wooden_Thing "Wooden Thing") (e.g. the [Eye Bone](/wiki/Eye_Bone "Eye Bone") or [Webber's Skull](/wiki/Webber%27s_Skull "Webber's Skull")). Ashes are also an ingredient for crafting [Healing Salve](/wiki/Healing_Salve "Healing Salve"). Moleworms will take them like minerals such as rocks or flint.

[Mobs](/wiki/Mobs "Mobs") that are killed by fire will drop Ashes in place of any flammable item in their loot table or the cooked version of their [Meats](/wiki/Meats "Meats"). [Red Hounds](/wiki/Red_Hound "Red Hound") always drop 3 Ashes when killed. Ashes are blown away by the wind after being on the ground for 20 seconds (picking it up and then dropping it again resets the timer). Burning a stack of items will yield the same amount of Ashes. For example, burning 40 [Twigs](/wiki/Twigs "Twigs") will result in 40 Ashes.
...
In the *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* DLC, the [Dragonfly](/wiki/Dragonfly "Dragonfly") will burn any flammable objects to turn them into Ashes to eat. After eating 20 Ashes, she will fall asleep.

In the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, Ashes can be obtained when [Ash Trees](/wiki/Ash_Tree "Ash Tree") are chopped in the [Volcano](/wiki/Volcano "Volcano") or when a [Lava Pool](/wiki/Lava_Pool "Lava Pool") is allowed to extinguish naturally. Ashes are required to fertilize [Coffee Plants](/wiki/Coffee_Plant "Coffee Plant") and [Elephant Cacti](/wiki/Elephant_Cactus "Elephant Cactus"). Additionally, any [flammable](/wiki/Category:Flammable_Objects "Category:Flammable Objects") items put inside of fire [Packim Baggims](/wiki/Packim_Baggims "Packim Baggims") will be turned into Ashes upon closing and opening it again.

In the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, Ashes are required to craft [Cultivated Turf](/wiki/Cultivated_Turf "Cultivated Turf") and [Dense Turf](/wiki/Dense_Turf "Dense Turf").
...
In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* (DST), Ashes can be acquired by touching the burnt [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush") included in the Dragonfly [Set Piece](/wiki/Set_Piece "Set Piece").
...
* Due to their abundance and minimal use, [Pine Cones](/wiki/Pine_Cone "Pine Cone") and [Jungle Tree Seeds](/wiki/Jungle_Tree_Seed "Jungle Tree Seed") are good candidates to burn and get Ashes.
* In DST, they can be farmed by setting a [Mush Gnome](/wiki/Mush_Gnome "Mush Gnome") on fire where it will spawn multiple Lunar Spores that will quickly burn and turn into Ashes.
