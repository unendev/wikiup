...
source_url: https://dontstarve.fandom.com/wiki/Lunar_Forest
---
...
|  |
| --- |
| Stone Fruit BushMoon GlassMini GlacierMoon ShardMoon RockShattered Spider HoleCarratCelestial Fissure |

**“**I didn't know trees grew on the moon.**”**

–[Wilson](/wiki/Wilson "Wilson")

The **Lunar Forest** is a [Biome](/wiki/Biomes "Biomes") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It is covered in [Moon Crater Turf](/wiki/Moon_Crater_Turf "Moon Crater Turf") and can only be found as part of the [Lunar Island](/wiki/Lunar_Island "Lunar Island") area amidst the [Ocean](/wiki/Ocean "Ocean").

Lunar Forest is mostly composed of [Lune Tree](/wiki/Lune_Tree "Lune Tree"). Between trees there is [Lunar Sapling](/wiki/Sapling "Sapling") and few [Stone Fruit Bush](/wiki/Stone_Fruit_Bush "Stone Fruit Bush") and [Moon Glass](/wiki/Moon_Glass "Moon Glass").

[Carrat](/wiki/Carrat "Carrat") are planted in the ground looking like [Carrot](/wiki/Carrot "Carrot"). The Biome contains multiple [Shattered Spider Holes](/wiki/Shattered_Spider_Hole "Shattered Spider Hole").

Sometimes a [Moon Glass Axe](/wiki/Axe#Moon_Glass_Axe "Axe") or [Hot Spring](/wiki/Hot_Spring "Hot Spring") will spawn insides a cluster of Lune Trees.

## Placeholder Trivia[]

* The Lunar Forest Biome was introduced in the *[Turn of Tides](/wiki/Return_of_Them#Turn_of_Tides "Return of Them")* update.
