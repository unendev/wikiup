...
source_url: https://dontstarve.fandom.com/wiki/Harp_Statue
---
...
The **Harp Statue** is a [Structure](/wiki/Structure "Structure") that can be mined with a [Pickaxe](/wiki/Pickaxe "Pickaxe") for 2-3 [Marble](/wiki/Marble "Marble"). It looks like a headless angel with a harp in its hands.

Players may find a Harp Statue around the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") in [Sandbox Mode](/wiki/Sandbox_Mode "Sandbox Mode") and easily in the [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode") world, *The Game is Afoot*, as there is a large [Chess Biome](/wiki/Chess "Chess") there.

## Don't Starve Together iconOvergrown Statue[]

Overgrown Statue is a variation of Harp Statue. Sometimes they can spawn instead of all Harp Statues. He also appears in the structure with 4 [briars](/wiki/Briar_Wolf "Briar Wolf").

## Placeholder Trivia[]

* There is a head included in the [TEX](/wiki/TEX "TEX") files. However, it's not used in-game.

## Blueprint Gallery[]

Harp mined.png (24 KB)

The Harp Statue when mined.

Harp broken.png (22 KB)

The Harp Statue when mined, almost broken.

Harp Statue Head.png (23 KB)

Statue with its head as found in the game's files.
