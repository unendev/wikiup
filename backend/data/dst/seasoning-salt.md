...
source_url: https://dontstarve.fandom.com/wiki/Seasoning_Salt
---
...
|  |
| --- |
| Increases the [Health](/wiki/Health "Health") value of [Crock Pot](/wiki/Crock_Pot "Crock Pot") dishes by 25%. |
...
**“**This sand taste good!**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It helps makes camp food a bit less bland. [sic]**”**
...
**Seasoning Salt** is an [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. They can only be crafted by [Warly](/wiki/Warly "Warly") in the [Seasonings Tab](/wiki/Seasonings_Tab "Seasonings Tab") using three [Salt Crystal](/wiki/Salt_Crystals "Salt Crystals") rocks at the [Portable Grinding Mill](/wiki/Portable_Grinding_Mill "Portable Grinding Mill").

Seasoning Salt can be added to [Crock Pot](/wiki/Crock_Pot "Crock Pot") dishes in a [Portable Seasoning Station](/wiki/Portable_Seasoning_Station "Portable Seasoning Station") for a 25% boost to their healing effects. Dishes seasoned with Seasoning Salt gain the adjective *Salty* before their names.
...
* Seasoning salt can be used to counteract some of Warly's food benefit penalty. [Pierogi](/wiki/Pierogi "Pierogi") can be seasoned with salt to heal 50 Health; as he eats more, salted pierogi will heal 45, 40, 32.5, 25, and finally 15 Health.
* Seasoning Salt does not affect the secondary healing effects of food like [Jellybeans](/wiki/Jellybeans "Jellybeans"), so use other Seasonings or leave them unseasoned.

## Placeholder Trivia[]

* Seasoning Salt was introduced in the *[Salty Dog](/wiki/Return_of_Them#Version_History "Return of Them")* update.
...
Seasoning Salt (Overlay).png (3 KB)

Overlay for dishes seasoned with Seasoning Salt.

Salty Meatballs Ground.png (64 KB)

Dishes seasoned with Seasoning Salt appear with a plate on the ground.
