...
source_url: https://dontstarve.fandom.com/wiki/Dock_Kit
---
...
"Get ready for your pier review."

Crafting

| [Recipe](/wiki/Crafting "Crafting") | Amount produced |
| --- | --- |
| Boards**×4** Cut Stone**×1** Stinger**×2** Palmcone Scale**×1** | 4 |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Decorations Filter Seafaring Filter Structures Filter | Rare Blueprint |
...
**“**Everything I need to build a dock for my boat.**”**

–[Wilson](/wiki/Wilson "Wilson")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It'll be nice to cover up the water with some nice, flammable wood.**”**

–[Willow](/wiki/Willow "Willow")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Wolfgang will build mighty dock, worthy of boat!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I will build it, but no one will come.**”**

–[Wendy](/wiki/Wendy "Wendy")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I HAVE TRIUMPHED OVER THE OCEAN**”**

–[WX-78](/wiki/WX-78 "WX-78")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Some essential materials for constructing a wharf.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I can see it now, the whole ocean covered in beautiful timber...**”**

–[Woodie](/wiki/Woodie "Woodie")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**So I'm to be a dock builder now, am I?**”**

–[Maxwell](/wiki/Maxwell "Maxwell")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I shall make a harbor worthy of my vessel.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**We've decided we're going to be a dock spider now.**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Everything one might need to whip up a dock.**”**

–[Warly](/wiki/Warly "Warly")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Makes home for Floaties**”**

–[Wormwood](/wiki/Wormwood "Wormwood")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Leave the dock buildin' to me.**”**

–[Winona](/wiki/Winona "Winona")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It would a-pier I have some work to do.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Will build nice sleeping spot for boat.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Neat, I can build a dock for my boat!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Can't someone with more time on their hands set it up?**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Dock Kit** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* introduced in [The Curse of Moon Quay](/wiki/The_Curse_of_Moon_Quay "The Curse of Moon Quay") update. Once the kit is crafted, it can be placed on [Coastal Ocean](/wiki/Ocean#Coastal "Ocean") tiles (light-colored water) to create **Docks** adjacent to land or other Docks.

A blueprint for learning the recipe can be obtained from the [Queen of Moon Quay](/wiki/Queen_of_Moon_Quay "Queen of Moon Quay").

## Docks[]

**Docks** are pieces of land that can be walked on or have structures built on. Each Dock segment has a [durability](/wiki/Durability "Durability") of 300 units and can be destroyed by collisions with a [Boat](/wiki/Boat "Boat"), [Cannon](/wiki/Cannon_Kit#Cannon "Cannon Kit") shots, explosions (such as those caused by [Gunpowder)](/wiki/Gunpowder "Gunpowder") and being disconnected from land (when a line of docks loses all contact with the coast, a domino effect begins destroying remaining dock tiles, thus making dock "islands" unfeasible).

Docks cannot be set on fire (although they can be destroyed by explosions).

Docks are also found naturally as part of [Moon Quay](/wiki/Moon_Quay "Moon Quay").

## Prototype Tips[]

* Their recipe and return per investment make them more effective than [Boat](/wiki/Boat "Boat")s as bridges (not even counting anchors' cost to keep those in place). However, unlike Boats, docks can only be placed in Coastal tiles.
* In world creation, there are no [Sea Stacks](/wiki/Sea_Stack "Sea Stack") or deep water on the shortest route between the main land and the [Lunar Island](/wiki/Lunar_Island "Lunar Island"). It is therefore possible to use docks to create a direct bridge there.
* Docks can be used to better collect the [Figs](/wiki/Fig "Fig") of planted [Above-Average Treetrunks](https://dontstarve.fandom.com/wiki/Knobbly_Tree#Above-Average_Tree_Trunk), or just to make better use of its canopy.

## Blueprint Gallery[]

RWP Moon Quay Concept Art 5.png (268 KB)

Concept art of Dock Kit shown in Rhymes With Play stream.

Dock Farm.png (398 KB)

Usage of docks to close in two landmasses in order to farm bunnymen using catapults.

Dock map.png (505 KB)

Docks as they appear in the map.
