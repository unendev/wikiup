...
source_url: https://dontstarve.fandom.com/wiki/Scorpion
---
...
| --- |
| -25/min  (-18.75/min Wendy) (-22.5/min Walani) (-27.5/min Wolfgang) |
...
**“**Yöur pöinty tail is nö match för me!**”**
...
**Scorpion** is a [Mob](/wiki/Mob "Mob") exclusive to the *[Don't Starve: Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC.

It can be found in [Ruins](/wiki/Ancient_Pig_Ruins "Ancient Pig Ruins"), under [Stone Slabs](/wiki/Stone_Slab "Stone Slab"), or from chopped [Rainforest Trees](/wiki/Tree/Rainforest_Tree "Tree/Rainforest Tree"). It can also spawn in all sorts of caves, such as [Cave Clefts](/wiki/Cave_Cleft "Cave Cleft") or [Mant Hills](/wiki/Mant_Hill "Mant Hill"), or falling from above during a Cave-in.

It is a very aggressive [Mob](/wiki/Mob "Mob") and will attack nearly everything that crosses its path, with the ability to inflict [poison](/wiki/Poison "Poison") when attacking with its sting. It also has the ability after being hit to reel back against it's attacker and charge again shortly after, thus making difficult to kite in tight spaces. The charge cannot poison, however and it must attack within melee range in order to inflict the status.
...
Scorpions can be caught in [Traps](/wiki/Traps "Traps"), killing them instantly and giving their drops as if they had died in combat.

## PlaceholderTrivia[]

* It appears to use the same model of behavior as the [Spider](/wiki/Spider "Spider"), as they do the same death, eat, hit, and sleep action.
...
Scorpion Sleeping.png (83 KB)

A sleeping Scorpion.

Scorpion Dead.png (67 KB)
