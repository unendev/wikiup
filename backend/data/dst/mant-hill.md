...
source_url: https://dontstarve.fandom.com/wiki/Mant_Hill
---
...
**Mant Hills** are structures exclusive to the [*Hamlet*](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet") DLC which are found in the [Deep Rainforest](/wiki/Deep_Rainforest "Deep Rainforest") [biome](/wiki/Biomes "Biomes"). By default, three Mant Hill entrances are generated on the starting island.

On the outside, a Mant Hill entrance resembles a large nest with a hole in the center where the player can enter. On the inside, the Mant Hill consists of a series of tunnels that go from room to room, similar to the [Ancient Pig Ruins](/wiki/Ancient_Pig_Ruins "Ancient Pig Ruins"). Each Mant Hill is connected to the two others via the underground rooms.

The various rooms may contain [Lamps](/wiki/Lamp "Lamp"), Giant Grubs, [Honey Chests](/wiki/Honey_Chest "Honey Chest"), [Stalagmites](/wiki/Stalagmites "Stalagmites"), or [Antcomb Homes](/wiki/Antcomb_Home "Antcomb Home") (where the [Mants](/wiki/Mant "Mant") spawn as larvae). All of these structures can be [hammered](/wiki/Hammer "Hammer") or [mined](/wiki/Pickaxe "Pickaxe"), though they are not renewable. Mants will not become aggressive upon mining/hammering these structures. The [Queen Womant](/wiki/Queen_Womant "Queen Womant") Den entrance is also to be found in here with multiple [Warrior Mants](/wiki/Warrior_Mant "Warrior Mant") guarding it.

When being inside Mant Hills, there is no loss of [Sanity](/wiki/Sanity "Sanity") in darkness. Mant Hills spawn up to 4 [Mants](/wiki/Mant "Mant"). Each killed Mant take 120 seconds to regen and 30 seconds to release.
...
Mant born.gif (428 KB)

A Mant larvae spawning from an Antcomb Home.

Queen Womant den entrance.PNG (305 KB)

Entrance to Queen Womant den.

Mant Hill map.PNG (1.88 MB)

Example map of a fully explored Mant Hill.

Ant cave floor.png (115 KB)

Ant cave floor.

Ant cave wall.png (79 KB)
