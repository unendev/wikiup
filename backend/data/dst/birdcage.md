...
source_url: https://dontstarve.fandom.com/wiki/Birdcage
---
...
Rotten EggRot (Misshapen BirdMoonblind Crow Don't Starve Together)
...
**“**No parrot o'mine could bear a cagin'.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA WAS'T ENCAGE'D ONCE**”**
...
**“**Now we just need to catch a bird!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**All it needs now is a little cuckoo bird.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Birdcage** is a craftable [Structure](/wiki/Structure "Structure") that allows the domestication of [Birds](/wiki/Birds "Birds") ([Redbirds](/wiki/Redbird "Redbird"), [Crows](/wiki/Crow "Crow"), [Snowbirds](/wiki/Snowbird "Snowbird"), [Canaries](/wiki/Canary "Canary"), Parrots, Pirate Parrots, Toucans, Kingfishers, Pigeons, etc.) It requires 6 [Gold Nuggets](/wiki/Gold_Nuggets "Gold Nuggets"), 2 [Papyrus](/wiki/Papyrus "Papyrus"), and 2 [Seeds](/wiki/Seeds "Seeds") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

Use a [Bird Trap](/wiki/Bird_Trap "Bird Trap") to catch a bird and imprison it in the cage. There is no functional difference between most types of bird.

Feeding the caged bird [Meats](/wiki/Meats "Meats") makes it produce [Eggs](/wiki/Egg "Egg"). Birds eat all meat [Items](/wiki/Items "Items"), including [Monster Meat](/wiki/Monster_Meat "Monster Meat") and [Crock Pot](/wiki/Crock_Pot "Crock Pot") dishes regardless of their freshness. Birds will not eat Eggs.

Birds sleep at [night](/wiki/Night "Night"). To feed a sleeping bird, it can be taken out of the cage and imprisoned again. It can then be fed up to 5 items before it goes back to sleep again.

Imprisoned birds will slowly [waste away](/wiki/Food#Perish_Times "Food") in the *Birdcage*, lasting for roughly 20 [Days](/wiki/Day "Day") before dying, depending on ambient temperature. Similar to dying in inventory or chest, a bird dying in a *Birdcage* will be changed into a [Morsel](/wiki/Morsel "Morsel"), which will be fresh at the moment the bird dies, and will spoil at its normal spoiling rate. Leaving the dead bird in the *birdcage* will eventually turn it into a skeleton, mucking out which will yield one [Rot](/wiki/Rot "Rot"). Unlike starving in inventory or being killed, a caged bird will never yield its [Feather](/wiki/Feather "Feather").

Examining the Birdcage when the captured bird is hungry or starving will make the character say different [Quotes](/wiki/Quotes "Quotes"). The hungry bird will have an additional animation, alerting the player that it needs to be fed. Any item the bird can eat ([Seeds](/wiki/Seeds "Seeds"), [Fruits](/wiki/Fruit "Fruit"), [Vegetables](/wiki/Vegetable "Vegetable"), or [Meat](/wiki/Meat "Meat")) will restore the bird to full hunger.

### Don't Starve Don't Starve[]

In *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")*, feeding a caged bird a [Farm](/wiki/Farming#Farms "Farming") vegetable/fruit makes it produce one generic seed plus 1-2 crop-specific seeds (of the same type it was fed). Feeding it a seed returns a fresh seed of the same type.

### Don't Starve Together Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, feeding the caged bird a [Garden](/wiki/Farm_Plant "Farm Plant") vegetable/fruit makes it produce a seed of the same type of plant. Feeding it a seed makes the bird produce [Guano](/wiki/Guano "Guano").

Imprisoning a [Canary](/wiki/Canary "Canary") in the [Caves](/wiki/Caves "Caves") for 6-12 minutes when [Toadstool](/wiki/Toadstool "Toadstool") is alive causes it to get sick and become [volatile](/wiki/Birds#Canary_(Volatile) "Birds").

[Misshapen Birds](/wiki/Misshapen_Bird "Misshapen Bird") and [Moonblind Crows](/wiki/Moonblind_Crow "Moonblind Crow") can only produce [Rotten Eggs](/wiki/Rotten_Egg "Rotten Egg") or Rot.

## Tips[]

* Spoiling Meats can be saved from turning into [Rot](/wiki/Rot "Rot") or [Rotten Eggs](/wiki/Rotten_Egg "Rotten Egg") by converting them into fresh Eggs.
* The bird can be used to convert meats that are not accepted by the [Pig King](/wiki/Pig_King "Pig King") into Eggs, which are accepted in exchange for Gold Nuggets.
* In *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")*, normal spoiling seeds can be given to a caged bird to get fresh seeds in return, making it possible to keep seeds from ever spoiling.
* The Birdcage is good for [Winter](/wiki/Winter "Winter"), when food resources are limited, as the player can feed the bird an easy-to-acquire [Cooked Monster Meat](/wiki/Cooked_Monster_Meat "Cooked Monster Meat") or spoiled meat items to get fresh Eggs in return, which can be eaten or further be used in Crock Pot recipes.
...
* In older versions of *Don't Starve*, the Birdcage cost 100 [Research Points](/wiki/Research_points_list "Research points list").
* Initially, only Crows were worth keeping in Birdcages because Redbirds would die in [Winter](/wiki/Winter "Winter") and Snowbirds would die in [Summer](/wiki/Summer "Summer"). This was changed soon after.
* When *Reign of Giants* was released, caged birds needed to be fed to keep them alive just like if they were kept in the inventory. Because there was no "fuel" system to keep the birds fed for a few days, players had to manually feed them every day or return to an empty cage. Rather than add a feed tube, [Klei](/wiki/Klei "Klei") removed the feeding requirement for caged birds.
* The image of a bird in a gilded cage as a metaphor for being trapped in a luxury prison was first popularised in the song "[A Bird in a Gilded Cage](https://en.wikipedia.org/wiki/A_Bird_in_a_Gilded_Cage "wikipedia:A Bird in a Gilded Cage")", published in 1900.
...
* Imprisoning a [Parrot Pirate](/wiki/Parrot_Pirate "Parrot Pirate") will result in a normal parrot. This means that Pirate Parrots are impossible to keep around for [Sanity](/wiki/Sanity "Sanity").
...
* In a vanilla or *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* world without being compatible with *Shipwrecked* or *Hamlet* DLC, an imprisoned bird of any type may appear to be wearing a small pirate hat despite not being a [Parrot Pirate](/wiki/Parrot_Pirate "Parrot Pirate").

## Gallery[]

Burnt Birdcage.png (39 KB)

Burnt Birdcage

Redbird in bird cage.png (125 KB)

[Redbird](/wiki/Redbird "Redbird") imprisoned in Birdcage.

Crow in bird cage.png (124 KB)

[Crow](/wiki/Crow "Crow") imprisoned in a Birdcage.

Birdcagewinter.jpg (120 KB)

[Snowbird](/wiki/Snowbird "Snowbird") imprisoned in a Birdcage.

Birdcage imprison.png (60 KB)

"Imprison" option when holding a bird over an empty Birdcage.

Seeds prompt.jpeg (7 KB)

Giving a Redbird [Seeds](/wiki/Seeds "Seeds").

Sleepy birdy.png (104 KB)

A sleeping [Snowbird](/wiki/Snowbird "Snowbird") in a Birdcage.

Seeds and Eggs.jpg (24 KB)

A [Crow](/wiki/Crow "Crow") with several eggs.

20171202174948 1.jpg (27 KB)

An easter egg in vanilla *Don't Starve* where placing a bird in a birdcage may result in it having a small pirate hat.

Recently Dead.png (317 KB)

A recently deceased Crow in *Don't Starve Together*.

Skeleton of a Bird.png (364 KB)

The skeleton of an unknown bird in *Don't Starve Together*.

Clean out.png (340 KB)
...
Birdcage as seen in the poster for the *[Naughty and Nice](/wiki/Don%27t_Starve/Version_History#December_11,_2012_–_Naughty_and_Nice "Don't Starve/Version History")* update.
