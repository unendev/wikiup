...
source_url: https://dontstarve.fandom.com/wiki/Dung_Beetle
---
...
Rides a [Dung Ball](/wiki/Dung_Ball "Dung Ball").
...
**“**Such agility! The way he's able to navigate on that sphere of poop!**”**
...
**“**Swell. A giant bug on a giant ball of poop.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Dung Beetle** is a passive [Mob](/wiki/Mob "Mob") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is a bug riding a [Dung Ball](/wiki/Dung_Ball "Dung Ball"). Chasing it into a [Tree](/wiki/Tree "Tree"), [Boulder](/wiki/Boulder "Boulder"), or [Structure](/wiki/Structure "Structure") will cause it to fall on its back and become unable to move for a short period. Dung Beetles will go to the nearest [Dung Pile](/wiki/Dung_Pile "Dung Pile") and form a new Dung Ball if they lost their previous Dung Ball.

Dung Beetles will generally move away from the player when approached by [Day](/wiki/Day "Day"), but will sleep on top of their Dung Balls at [Night](/wiki/Night "Night"), making them easy to hunt at this time. Dung Beetles can also be outsped and chased down with a [Stalking Stick](/wiki/Stalking_Stick "Stalking Stick"). They are considered innocent creatures and killing one adds to the player's [Naughtiness](/wiki/Naughtiness "Naughtiness"), which can cause [Krampus](/wiki/Krampus "Krampus") to appear.

Similar to [Tumbleweeds](/wiki/Tumbleweed "Tumbleweed"), the [Dung Ball](/wiki/Dung_Ball "Dung Ball") can be harvested by the player and will drop three items, the most common ones being [Manure](/wiki/Manure "Manure"), [Rocks](/wiki/Rocks "Rocks"), [Flint](/wiki/Flint "Flint").

## Blueprint Gallery[]

Dung Beetle.png (12 KB)

A Dung Beetle without its Dung Ball.

Dung Beetle Sleeping 1.png (21 KB)

A sleeping Dung Beetle.

Dung Beetle Sleeping 2.png (11 KB)

A sleeping Dung Beetle without its Dung Ball.

Dung Beetle Dead.png (14 KB)

A dead Dung Beetle.

RWP 236 Dung Beetle Concept Art.jpg (141 KB)

Concept art for the Dung Beetle from *Rhymes with Play* #236.

Art Stream 74 Dung Beetle.png (904 KB)

Dung Beetles as seen in a drawing from Art Stream # 74.
