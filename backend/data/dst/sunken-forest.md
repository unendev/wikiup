...
source_url: https://dontstarve.fandom.com/wiki/Sunken_Forest
---
...
|  |
| --- |
| EvergreenGrass TuftSaplingLight FlowerFern  (Twiggy TreeDon't Starve Together icon) |

Occasional

|  |
| --- |
| Rabbit HutchCarrotBerry BushMushroomsSpider DenFrog Pond  (Juicy Berry BushDon't Starve Together icon) |
...
The **Sunken Forest** is a [Biome](/wiki/Biome "Biome") found in the [Caves](/wiki/Cave "Cave"). The ground is mainly composed of [Grass](/wiki/Grass_Turf "Grass Turf") and [Forest](/wiki/Forest_Turf "Forest Turf") [Turf](/wiki/Turf "Turf"), with the surrounding area usually covered in mud and fog. [Saplings](/wiki/Saplings "Saplings"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), and [Evergreens](/wiki/Evergreen "Evergreen") can be found here. These plants thrive in a [Cave Light](/wiki/Cave_Light "Cave Light") which filters from [Surface World](/wiki/Surface_World "Surface World"), though it disappears when [Night](/wiki/Day-Night_Cycle "Day-Night Cycle") comes.

[Mobs](/wiki/Mobs "Mobs") cannot naturally be found in this biome, though [Gobblers](/wiki/Gobblers "Gobblers") can spawn by picking the Berry Bushes and [Treeguards](/wiki/Treeguard "Treeguard") can spawn after chopping the Evergreens. Both Mobs will behave as they do in the [Surface World](/wiki/Surface_World "Surface World").

### Don't Starve Together Don't Starve Together[]

*[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* includes many other sunken set pieces which appear in the [Slimy Biome](/wiki/Slimy_Biome "Slimy Biome") and a few that appear in the Green [Mushtree Forest](/wiki/Mushtree_Forest "Mushtree Forest"). Each looks like a tiny version of the surface world illuminated by a [Cave Light](/wiki/Cave_Light "Cave Light"). They can spawn as a small circular or oval [Set Piece](/wiki/Set_Piece "Set Piece") or small room (rooms only in the Slimy Biome). In addition to a sunken forest, there are:

* A Savannah or grassy sinkhole packed with [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft")
* A mini "oasis" grassland set-piece with a pond and berry bush(es) (Slimy Biome only)
* A sparse, sprawling [Evergreen](/wiki/Evergreen "Evergreen") forest
* [Bunnyman](/wiki/Bunnyman "Bunnyman") areas: Loose village, Town, or City

## Blueprint Gallery[]

Group of Sunken Forest.png (707 KB)

A Group of Sunken Forests as seen on the [Map](/wiki/Map "Map").

Sunken Forest at daytime.png (418 KB)

Sunken Forest at Daytime in a Cave.

Cave Banana Trees icons.png (105 KB)
