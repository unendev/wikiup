...
source_url: https://dontstarve.fandom.com/wiki/Palace
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Palace?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
The **Palace** is a [Structure](/wiki/Structure "Structure") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC which spawns in a [Pig City](/wiki/Pig_City "Pig City") on a separate island from the starting island. To get to the second island the player must go through the palace [Pig Ruins](/wiki/Ancient_Pig_Ruins "Ancient Pig Ruins") (The one with a pig on the top). The Palace is surrounded by four elegant-looking [Watch Towers](/wiki/Watch_Tower "Watch Tower"). The Watch Towers can be deconstructed using a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff") for 4 [Pig Skins](/wiki/Pig_Skin "Pig Skin"), 2 [Halberds](/wiki/Halberd "Halberd") and 3 [Cut Stones](/wiki/Cut_Stone "Cut Stone").

## Contents

* [1 Interior](#Interior)
* [2 Royal Gallery Exhibit](#Royal_Gallery_Exhibit)
* [3 Bugs](#Bugs)
* [4 Gallery](#Gallery)
...
Upon entering the Palace, the player will find [Queen Malfalfa](/wiki/Pig_Queen "Pig Queen") wandering about her Throne Room as well as an exit door. To the left is a room containing the Royal Gallery. A second room to the left, serving as a Souvenir Shop, contains multiple [Post Cards of the Royal Palace](/wiki/Post_Card_of_the_Royal_Palace "Post Card of the Royal Palace") on shelves, multiple silver crown replicas (currently titled "Queen Malfalfa") in glass displays and, if the player has not already unlocked her, [Wilba](/wiki/Wilba "Wilba"). This third room also contains an exit, which leads to the same exit as the one in the Throne Room.
...
Key to the City Can of Silly String Executive Hammer

[Code](/wiki/Console "Console")

|  |
| --- |
| `"shelves_queen_display_1", "shelves_queen_display_2" "shelves_queen_display_3"` |
...
**“**A glass case displaying invaluable objects behind a hefty lock.**”**
...
**“**OPEN, LOCKS, WHOEVER KNOCKS, AND HATH THE KEY**”**
...
**“**A tribute to someone else's adventures.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

Three **Royal Gallery Exhibits** can be found in the second room of the Palace, containing the [Key to the City](/wiki/Key_to_the_City "Key to the City"), the [Can of Silly String](/wiki/Trinkets#Can_of_Silly_String "Trinkets") and the [Executive Hammer](/wiki/Executive_Hammer "Executive Hammer"). They can each be unlocked using one [Royal Gallery Key](/wiki/Royal_Gallery_Key "Royal Gallery Key"), obtained from giving the [Pig Queen](/wiki/Pig_Queen "Pig Queen") a [Royal Crown](/wiki/Royal_Crown "Royal Crown"), [Regal Scepter](/wiki/Regal_Scepter "Regal Scepter"), [The Blue Sow](/wiki/Lost_Relics#The_Blue_Sow "Lost Relics") or [The Jeweled Truffle](/wiki/Lost_Relics#The_Jeweled_Truffle "Lost Relics"), to access the objects within.
...
Queen Malfalfa in the Throne Room of the Palace.

Palace interior 2.png (1.01 MB)

The Royal Gallery displaying the Key to the City, the Can of Silly String and the Executive Hammer.

Palace interior 3.png (840 KB)

The Palace's third room contains a Souvenir Shop.
