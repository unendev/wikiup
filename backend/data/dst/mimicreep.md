...
source_url: https://dontstarve.fandom.com/wiki/Mimicreep
---
...
|  |
| --- |
| An annoying little creep that just wants to be held by you. Stomp it out quickly, before it does more creeping. |

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Well that's inconvenient.**”**

–[Wilson](/wiki/Wilson "Wilson"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Burned again!**”**

–[Willow](/wiki/Willow "Willow"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Fool Wolfgang, shame on you!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It was the evil twin.**”**

–[Wendy](/wiki/Wendy "Wendy"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**DECEPTION**”**

–[WX-78](/wiki/WX-78 "WX-78"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I knew it.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Don't say it, Lucy!**”**

–[Woodie](/wiki/Woodie "Woodie"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I'm losing my touch.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Infernal trickster.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Aw, I guessed wrong!**”**

–[Webber](/wiki/Webber "Webber"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Thought it smelled off.**”**

–[Warly](/wiki/Warly "Warly"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Wrong friend!**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I knew it felt funny.**”**

–[Winona](/wiki/Winona "Winona"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Can't stand it! Left empty-handed!**”**

–[Wortox](/wiki/Wortox "Wortox"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Bad tricker!**”**

–[Wurt](/wiki/Wurt "Wurt"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Oops!**”**

–[Walter](/wiki/Walter "Walter"), when an equipped Mimicreep is revealed.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Next time I'll choose the right one.**”**

–[Wanda](/wiki/Wanda "Wanda"), when an equipped Mimicreep is revealed.

The **Mimicreep** is a [mob](/wiki/Mob "Mob") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in the *[From Beyond](/wiki/From_Beyond "From Beyond")* updates. When killed, it drops one [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel").
...
Mimicreeps can only spawn after [Shadow Rifts](/wiki/Shadow_Rifts "Shadow Rifts") are open. They will be wandering around the [Ruins](/wiki/Ruins "Ruins"), but can also spawn in the darkness when items are left on the ground. Mimicreeps are lurking for equipable [items](/wiki/Items "Items") left on the ground to mimic them, except containers like a [Backpack](/wiki/Backpack "Backpack") or stackable items like the [Brightshade Bomb](/wiki/Brightshade_Bomb "Brightshade Bomb"). The mimicked item will have the exact same stats as the copied item and can be collected and equipped by [characters](/wiki/Characters "Characters"). When trying to use an mimicked item or getting hit while it is equipped, the Mimicreep will reveal itself and run away, draining 10 of the character's [Sanity](/wiki/Sanity "Sanity"). When not picked up or revealed, a Mimicreep will turn back to its original form after 10-12 minutes.

Mimicreeps cannot mimic items left on a [Boat](/wiki/Boat "Boat").

## Strategy[]

To kill a Mimicreep, a character just has to step on it.

Mimicreeps cannot be trapped with [walls](/wiki/Wall "Wall"), as they can creep beneath them.

## Usage[]

Some mimicked items will have one use before the Mimicreep reveals itself. This can be useful for this items:

| Item | Effects |
| --- | --- |
| Life Giving Amulet | Revives the player on usage without using the real amulet. |
| Construction Amulet | One free use to craft an item for half the price. |
| Bone Armor | one free shot by an enemy without taking damage. |

Wearable mimicked items will grant the effects of its original for up to 12 minutes or until the player gets hit. This can be interesting for following items:

| Item | Effects |
| --- | --- |
| Bee Queen Crown | Transforms insanity auras to sanity auras. |
| Bone Helm | Pacifying [Shadow Creatures](/wiki/Shadow_Creature "Shadow Creature") and putting the character insane. |
| Red FuncapGreen FuncapBlue Funcap | Produces [Mushroom Spores](/wiki/Mushroom_Spore "Mushroom Spore") over time. -25% [hunger](/wiki/Hunger "Hunger") drain, 20% [wetness](/wiki/Wetness "Wetness") resistance, and 60 points of protection from [overheating](/wiki/Overheating "Overheating"). |
| W.A.R.B.I.S. ArmorW.A.R.B.I.S. Head Gear | Gaining damage and speed boost. |

Mimicked items cannot be used in crafting recipes. They also cannot be deconstructed, but a [Deconstruction Staff](/wiki/Deconstruction_Staff "Deconstruction Staff") will still loose durability when doing so.

## Tips[]

* Mimicked items can be preserved with [Bundling Wraps](/wiki/Bundling_Wrap "Bundling Wrap") to use them later. So if something useful is mimicked, the timer of the reveal of a Mimicreep can be paused in [Bundled Supplies](/wiki/Bundled_Supplies "Bundled Supplies").

## Trivia[]

* The Mimicreep was introduced in the *[Depths of Duplicity](/wiki/Depths_of_Duplicity "Depths of Duplicity")* update.
