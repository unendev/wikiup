...
source_url: https://dontstarve.fandom.com/wiki/Winona's_Spotlight
---
...
| --- |
| Trusty Tape**×1** Gold Nugget**×2** Fireflies**×1 (Winona)** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Filter Light SourcesStructures FilterWinona Filter | Always available. |
...
**Winona's Spotlight** is a [character](/wiki/Character "Character")-exclusive [Structure](/wiki/Structure "Structure") craftable only by [Winona](/wiki/Winona "Winona") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It is found in the [Engineering Tab](/wiki/Engineering_Tab "Engineering Tab") and requires one [Trusty Tape](/wiki/Trusty_Tape "Trusty Tape"), two [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget"), and 1 [Firefly](/wiki/Fireflies "Fireflies") to craft. It requires being near a [Winona's Generator](/wiki/Winona%27s_Generator "Winona's Generator") or a [Winona's G.E.M.erator](/wiki/Winona%27s_G.E.M.erator "Winona's G.E.M.erator") to work.

When in a certain radius (shown by a circle around it when placing it), the Spotlight will follow the player closest to it with a light source. If there are multiple Spotlights however, they will prioritize having different targets from each other.

## Placeholder Trivia[]

* Winona's Spotlight, alongside her other gadgets and the Engineering Tab, was introduced in her [Character Update](/wiki/Don%27t_Starve_Together/Version_History#March_7th,_2019_-_Winona_Character_Update "Don't Starve Together/Version History") as part of the character overhaul for *Don't Starve Together*.

## Blueprint Gallery[]

Spotlight Ingame.png (132 KB)

A Spotlight that is not powered by a Generator.

Spotlight Burned.png (125 KB)

A burned Spotlight.

Winona Character Update Promo.gif (4.36 MB)

Winona's Spotlight featured in a promotional animation for her Character Update.
