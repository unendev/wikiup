...
source_url: https://dontstarve.fandom.com/wiki/Quacken_Drill
---
...
"For deep sea quacking."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Quacken Beak**×1** Gears**×1** Electrical Doodad**×2** |
...
|  |
| --- |
| Can be used to create [Tar Slicks](/wiki/Tar_Slick "Tar Slick"). |
...
**“**Such a simple design. Yet so effectively destructive!**”**
...
**“**This is not a drill! Wait, it totally is.**”**
...
**“**IT PUNCHETH THE GROUND**”**

–[Wilba](/wiki/Wilba "Wilba")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Finds the Gloopy Pools**”**

–[Wormwood](/wiki/Wormwood "Wormwood")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Too bad tar tycoons aren't as rich as oil tycoons.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Quacken Drill** is an [Item](/wiki/Item "Item") exclusive to the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It can be crafted from the [Science Tab](/wiki/Science_Tab "Science Tab"), is prototyped with an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine"), and requires 1 [Quacken Beak](/wiki/Quacken_Beak "Quacken Beak"), 1 [Gears](/wiki/Gears "Gears") and 2 [Electrical Doodads](/wiki/Electrical_Doodad "Electrical Doodad") to craft. Quacken Drills can be planted to create a [Tar Slick](/wiki/Tar_Slick "Tar Slick"), allowing one to farm [Tar](/wiki/Tar "Tar") anywhere in the [Deep or Medium Ocean](/wiki/Ocean#Shipwrecked "Ocean"). Drill is consumed during the drilling process.

## Placeholder Trivia[]

* The Quacken Drill was added to the *Shipwrecked* DLC more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21st,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.
* Despite the image for the Quacken Drill having a bamboo handle, no [Bamboo](/wiki/Bamboo "Bamboo") is needed to craft it.
