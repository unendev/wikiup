...
source_url: https://dontstarve.fandom.com/wiki/Wildbore_House
---
...
| --- |
| Bamboo**×8** Palm Leaf**×5** Pig Skin**×4** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Structures Tab | Alchemy Engine |
...
**Wildbore Houses** replace [Pig Houses](/wiki/Pig_Houses "Pig Houses") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. They are occasionally encountered in the [Beach](/wiki/Beach "Beach") [biome](/wiki/Biome "Biome"). Each house contains a single [Wildbore](/wiki/Wildbore "Wildbore"), which will roam around the house during day time. A new Wildbore will spawn from the house in 4 days, if the previous occupant is killed. Similar to Pig Houses, Wildbore Houses emit light at night if they are occupied, but it will go out if the player gets too close to the house. The houses can be crafted using 8 [Bamboos](/wiki/Bamboo "Bamboo"), 5 [Palm Leaves](/wiki/Palm_Leaf "Palm Leaf"), and 4 [Pig Skins](/wiki/Pig_Skin "Pig Skin"), and requires the [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

Similar to [Pigs](/wiki/Pigs "Pigs"), Wildbores will always head to their houses at dusk, unless they are in combat when the day changes to dusk. Unlike Pigs, Wildbores will attempt to protect their houses if they see the player destroying it with a [Hammer](/wiki/Hammer "Hammer").

If a *Shipwrecked*-compatible world is created, there is a small chance of having several Wildbore Houses spawn within a [Pig Village](/wiki/Pig_Village "Pig Village"), making them accessible in worlds that have not been connected to a *Shipwrecked* world.

## Placeholder Trivia[]

* In the pre-release version of *Shipwrecked*, [Strong Winds](/wiki/Strong_Winds "Strong Winds") could destroy Wildbore Houses. This behavior has been removed from the game in the *[Seas the Day](/wiki/Don%27t_Starve:_Shipwrecked#Version_History "Don't Starve: Shipwrecked")* update.

## Blueprint Gallery[]

Wildbore House Burnt.png (129 KB)

A burnt Wildbore House.

Wildborehouses.jpg (182 KB)
