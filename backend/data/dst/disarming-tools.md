...
source_url: https://dontstarve.fandom.com/wiki/Disarming_Tools
---
...
| --- |
| Iron Ore**×2** Cut Reeds**×2** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| **Treasure Hunting Tab** | Always available |
...
**“**An aid in negotiating those violent booby traps.**”**
...
**“**Those traps won't get me anymore.**”**
...
**“**Now Woodlegs' got the upper hand.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA CAN'ST BEAT-ETH NASTY TRICKY TRAPS NOW**”**

–[Wilba](/wiki/Wilba "Wilba")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Things for tricky walls**”**
...
**Disarming Tools** are craftable [Items](/wiki/Item "Item") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. They are found in the [Treasure Hunting Tab](/wiki/Treasure_Hunting_Tab "Treasure Hunting Tab") and can be crafted with 2 [Iron Ores](/wiki/Iron_Ore "Iron Ore") and 2 [Cut Reeds](/wiki/Cut_Reeds "Cut Reeds"). They do not require prototyping. It is also obtainable by trawling in the [Lily Ponds](/wiki/Lily_Pond "Lily Pond") with a small chance(1.96%).

## Icon Tools Usage[]

Disarming Tools can be used to deactivate traps in the [Ancient Pig Ruins](/wiki/Ancient_Pig_Ruins "Ancient Pig Ruins"):

* They can be used to disarm **[Dart Traps](/wiki/Dart_Trap "Dart Trap")**, giving a [Blow Dart](/wiki/Blow_Dart "Blow Dart") for each trap disarmed.
* They can also be used to disarm **[Pressure Plates](/wiki/Ancient_Pig_Ruins#Pressure_Plates "Ancient Pig Ruins")**, giving nothing.

## Prototype Tips[]

* The [Blow Darts](/wiki/Blow_Dart "Blow Dart") from [Dart Traps](/wiki/Dart_Trap "Dart Trap") can be used to fight [Boss Monsters](/wiki/Boss_Monsters "Boss Monsters").
