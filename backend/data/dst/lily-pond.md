...
source_url: https://dontstarve.fandom.com/wiki/Lily_Pond
---
...
|  |
| --- |
| Reeds Lotus Plant Hippopotamoose Lily Pad |

Occasional

|  |
| --- |
| Mosquito Poison Dartfrog Platapine |
...
The **Lily Pond** is a [Biome](/wiki/Biomes "Biomes") introduced in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is the only biome in this DLC which is completely made of water, and thus the only biome where the player is able to craft a [Boat](/wiki/Boats "Boats") or [Raft](/wiki/Raft "Raft"), or where [Walani](/wiki/Walani "Walani") is able to use her [Surfboard](/wiki/Surfboard "Surfboard"), similar to [Ocean](/wiki/Ocean "Ocean") from *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC.

When the player is [insane](/wiki/Insane "Insane"), being in this biome will spawn [Swimming Horror](/wiki/Swimming_Horror "Swimming Horror") instead of [Crawling Horror](/wiki/Crawling_Horror "Crawling Horror") and [Terrorbeak](/wiki/Terrorbeak "Terrorbeak").

[Lotus Flowers](/wiki/Lotus_Flower "Lotus Flower") and [Reeds](/wiki/Reeds "Reeds") can be collected in this biome, [Lily Pads](/wiki/Lily_Pad "Lily Pad") also appear here (though they cannot be collected), and in the Dusk and Night [Mosquitoes](/wiki/Mosquito "Mosquito") will spawn above the water. This biome is also where [Hippopotamoose](/wiki/Hippopotamoose "Hippopotamoose") can be found. They cause [Waves](/wiki/Waves "Waves") to spread across the water when they jump in.

When a Lotus Flower is picked out of a [Lotus Plant](/wiki/Lotus_Plant "Lotus Plant"), there is a great chance that a [Platapine](/wiki/Platapine "Platapine") will spawn, darting out of or across the water and consuming the other Lotus Flowers nearby.

[BFB](/wiki/BFB "BFB") hardly enters this biome. During [Lush Season](/wiki/Lush_Season "Lush Season"), [Brambles](/wiki/Bramble "Bramble") seem to avoid spawning in this biome. There are also no birds that spawn and land on this biome.

## Blueprint Gallery[]

Lily Pond Terrain Texture.png (221 KB)

Terrain texture used for Lily Ponds.

Hamlet Waterfall.png (881 KB)

Waterfalls form where Lily Ponds are situated next to the map border.
