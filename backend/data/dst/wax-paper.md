...
source_url: https://dontstarve.fandom.com/wiki/Wax_Paper
---
...
**Wax Paper** is a craftable [Item](/wiki/Item "Item") found in the [Refine Tab](/wiki/Refine_Tab "Refine Tab"). It requires 1 [Beeswax](/wiki/Beeswax "Beeswax") and 1 [Papyrus](/wiki/Papyrus "Papyrus") to craft, and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. It can be used to craft [Bundling Wrap](/wiki/Bundling_Wrap "Bundling Wrap"). When unwrapping [Bundled Supplies](/wiki/Bundled_Supplies "Bundled Supplies"), the Wax Paper is returned.

Since Honeycomb is not renewable in the single-player *Don't Starve*, only a limited number of Wax Paper can be crafted.
...
In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* (DST), Wax Paper is prototyped at the [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine"). Beeswax is a renewable item as honeycombs are renewable from the [Gigantic Beehive](/wiki/Gigantic_Beehive "Gigantic Beehive"), making Wax Paper renewable as well. Additionally, after defeating [Klaus](/wiki/Klaus "Klaus"), the player should receive the [Stag Antler](/wiki/Stag_Antler "Stag Antler") to open the [Loot Stash](/wiki/Loot_Stash "Loot Stash") and retrieve 4 wrapped bundles, which each return 1 Wax Paper when unwrapped.
