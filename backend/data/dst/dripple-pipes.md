...
source_url: https://dontstarve.fandom.com/wiki/Dripple_Pipes
---
...
**“**I'm gonna play some sweet jams on this baby.**”**
...
**“**A flute ta play a lil diddy.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA PLAY THE FOOD O' LOVE**”**
...
The **Dripple Pipes** is a craftable musical instrument introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It can be found in the [Magic Tab](/wiki/Magic_Tab "Magic Tab"). It requires a [Piratihatitator](/wiki/Piratihatitator "Piratihatitator") to prototype, and can be crafted using 1 [Horn](/wiki/Horn "Horn"), 2 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"), and 1 [Rope](/wiki/Rope "Rope"). It has 5 uses. When used, it creates a light [Rain](/wiki/Rain "Rain") for a half-day (4 minutes), unless it is [Winter](/wiki/Winter "Winter"), in which it will create a light [Snow](/wiki/Snow "Snow") instead.

The Dripple Pipes will not function if used in [Caves](/wiki/Caves "Caves") or [Ruins](/wiki/Ruins "Ruins").
...
In the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, the Dripple Pipes crafting recipe is unavailable, however, a [Blueprint](/wiki/Blueprint "Blueprint") for it can be bought with 100 [Oincs](/wiki/Oinc "Oinc") from [The Tinkerer's Tower](/wiki/The_Tinkerer%27s_Tower "The Tinkerer's Tower"). The Horn is available at ['The Sty' Oddities Emporium](/wiki/%27The_Sty%27_Oddities_Emporium "'The Sty' Oddities Emporium"). When used in [Humid](/wiki/Seasons/Humid "Seasons/Humid") Season, it creates [Heavy Fog](/wiki/Heavy_Fog "Heavy Fog") instead.

## Prototype Tips[]

* Rain will allow [Mushrooms](/wiki/Mushroom "Mushroom") to grow.
* In rain, [Farm](/wiki/Farm "Farm") crops grow up to 300% faster.
* Rain will cause [Flowers](/wiki/Flower "Flower") to spawn.
* Bringing it to a *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* world through the [Skyworthy](/wiki/Skyworthy "Skyworthy") is a good way to make it rain to allow [Nettle Vines](/wiki/Nettle_Vine "Nettle Vine") to grow.
* Bringing it to a [*Reign of Giants*](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants") world through the [Seaworthy](/wiki/Seaworthy "Seaworthy") is a good way to prevent wildfires during [Summer](/wiki/Summer "Summer").
* Dripple Pipes work well with the [Morning Star](/wiki/Morning_Star "Morning Star"), as they make enemies wet.

## Placeholder Trivia[]

* Dripple Pipes were introduced in the *[Release the Quacken](/wiki/Don%27t_Starve:_Shipwrecked#February_25,_2016_-_Release_the_Quacken_Update "Don't Starve: Shipwrecked")* update.
* It shares an animation with the pan flute.

## Blueprint Gallery[]

Dropped dripplepipe.png (202 KB)

[Walani](/wiki/Walani "Walani") standing next to dropped Dripple Pipes.

Dripplepipeplay.gif (8.29 MB)

Walani playing the Dripple Pipes.
