...
source_url: https://dontstarve.fandom.com/wiki/Lune_Tree
---
...
Log×4 Lune Tree Blossom×2 (tall)  

Log×3 Lune Tree Blossom×1.25 (medium)  
Log×2 Lune Tree Blossom×0.5 (short)

### Spawns

Moon Moth×1.5 (tall chopped)  

Moon Moth (medium chopped)
...
**Lune Trees** are [Trees](/wiki/Tree "Tree") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. They are found exclusively in the [Lunar Forest](/wiki/Lunar_Forest "Lunar Forest") and [Lunar Baths](/wiki/Lunar_Baths "Lunar Baths") [Biome](/wiki/Biomes "Biomes") on the [Lunar Island](/wiki/Lunar_Island "Lunar Island").

Chopping a small Lune Tree gives 2 [Logs](/wiki/Log "Log") and a 50% chance to get a [Lune Tree Blossom](/wiki/Lune_Tree_Blossom "Lune Tree Blossom"); the resulting stumps can be dug for one Log.

Chopping a normal Lune Tree gives 3 Logs, 1 Lune Tree Blossom plus a 25% chance to get an extra one, and spawn one [Moon Moth](/wiki/Moon_Moth "Moon Moth"). The resulting stumps can be dug for 2 Logs.
...
Moon Moths can be caught with a [Bug Net](/wiki/Bug_Net "Bug Net") and planted to make a Lune Tree Sapling.

## Tips[]

* These can be a slightly better source for wood than [Evergreens](/wiki/Evergreen "Evergreen") or [Birchnut Trees](/wiki/Birchnut_Tree "Birchnut Tree") as they give up to 6 Logs instead of 4.

## Trivia[]

* Lune Trees were introduced in the *[Turn of Tides](/wiki/Return_of_Them#Turn_of_Tides "Return of Them")* update.
* Lune Trees are probably modeled after [Adansonia Baobab](https://en.wikipedia.org/wiki/Adansonia_Baobab "wikipedia:Adansonia Baobab") or [desert rose](https://en.wikipedia.org/wiki/Adenium_obesum "wikipedia:Adenium obesum") trees.
* The fact that, similar to [Butterflies](/wiki/Butterfly "Butterfly"), Moon Moths are used to plant Lune Tree implies that they're oversized [Flowers](/wiki/Flower "Flower"), rather than actual trees.

## Gallery[]

Lune Tree stages.png (544 KB)

All growth stages of the Lune Tree.

Lune Tree Sapling.png (13 KB)

A Lune Tree Sapling.

Lune Tree burnt.png (76 KB)

Burnt Lune Trees.

Lune Tree Stumps Burnt.png (30 KB)

Unused burnt Lune Tree stumps.

Lune Tree Forest.png (1.93 MB)

Lune Trees as found in the Lunar Forest.
