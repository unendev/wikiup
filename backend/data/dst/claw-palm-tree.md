...
source_url: https://dontstarve.fandom.com/wiki/Claw_Palm_Tree
---
...
|  |
| --- |
| `"clawpalmtree_tall" "clawpalmtree_short" "clawpalmtree_normal"` |
...
The **Claw Palm Tree** is a tree type exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. When chopped down with an [Axe](/wiki/Axe "Axe"), it will yield up to 3 [Cork](/wiki/Cork "Cork"), and like most other trees, the stump can be [dug up](/wiki/Shovel "Shovel") to yield an additional Cork.

Unlike other trees, it does not yield any seeds that can be replanted to grow another tree. Instead, the player will have to manually craft the [Sapling](/wiki/Claw_Palm_Sapling "Claw Palm Sapling") using one Cork and one [Manure](/wiki/Manure "Manure") (prototyping it requires a [Science Machine](/wiki/Science_Machine "Science Machine")).

Claw Palm Trees have a chance to be [Peculiar](/wiki/Peculiar_Objects "Peculiar Objects"), making them investigable with a [Magnifying Glass](/wiki/Magnifying_Glass "Magnifying Glass") or [Wagstaff](/wiki/Wagstaff "Wagstaff")'s [Spectoggles](/wiki/Spectoggles "Spectoggles").

## Trivia[]

* Claw Palm Trees originally had red leaves, but the color was changed in the *[Quality of Life](/wiki/Don%27t_Starve:_Hamlet#Version_History "Don't Starve: Hamlet")* update to make them more distinguishable from [Rainforest Trees](/wiki/Tree/Rainforest "Tree/Rainforest").
...
Claw Palm Tree Old.png (206 KB)

The old design of the Claw Palm Tree.
