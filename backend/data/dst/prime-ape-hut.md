...
source_url: https://dontstarve.fandom.com/wiki/Prime_Ape_Hut
---
...
**“**What treasures have these curious creatures amassed!**”**
...
**“**Where'd they take all my things?!**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Prime Ape Huts** are naturally spawning [Structures](/wiki/Structure "Structure") found in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. They are found in the [Jungle](/wiki/Jungle "Jungle") biome, and spawn [Prime Apes](/wiki/Prime_Ape "Prime Ape"). They can also be crafted using 10 [Twigs](/wiki/Twig "Twig"), 3 [Bananas](/wiki/Banana "Banana") and 4 [Manure](/wiki/Manure "Manure"), and require an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. Each hut supports 3 or 4 Prime Apes, and new Prime Apes will spawn after 120 seconds to replace any that are killed.

As with any other craftable structure, Prime Ape Huts, including naturally occurring ones, can be [Hammered](/wiki/Hammer "Hammer") to return half of the resources needed to craft it, as well as a [Gnome](/wiki/Gnome "Gnome") (1% of the time), or a [Tarnished Crown](/wiki/Tarnished_Crown "Tarnished Crown") (10% of the time if [Wilbur](/wiki/Wilbur "Wilbur") is not unlocked). When Hammered, one or two Prime Apes may also escape before the hut is destroyed, and become aggressive towards the player, throwing Manure.

If a Prime Ape Hut is built in the [Ruins](/wiki/Ruins "Ruins"), the Prime Apes spawned from it will be affected by the Nightmare Cycle.

## Placeholder Trivia[]

* A [Purple Gem](/wiki/Purple_Gem "Purple Gem"), [Spoiled Fish](/wiki/Spoiled_Fish "Spoiled Fish"), [Dubloons](/wiki/Dubloons "Dubloons"), a [Hound's Tooth](/wiki/Hound%27s_Tooth "Hound's Tooth"), a [coconut](/wiki/Coconut "Coconut") and a [Banana](/wiki/Banana "Banana") Peel can all be seen inside of the hut if one looks closely.
* Its old crafting description was "Wanna monkey around?".
* The Prime Ape Hut's spawn code is similar to that of the [Splumonkey Pod](/wiki/Splumonkey_Pod "Splumonkey Pod") which used to be a barrel in reference to the phrase "more fun than a barrel of monkeys".
