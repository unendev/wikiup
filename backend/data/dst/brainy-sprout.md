...
source_url: https://dontstarve.fandom.com/wiki/Brainy_Sprout
---
...
**“**A neurological network of nautical knowledge!**”**
...
**“**Sure it has a bigger brain than me, but I have the bigger heart.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Brainy Sprout** is a [Plant](/wiki/Plants "Plants") spawning near [Coral Reefs](/wiki/Coral_Reef "Coral Reef") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. When picked, it will yield [Brainy Matter](/wiki/Brainy_Matter "Brainy Matter"), and will grow back 20 days after being picked.

If not picked, it will glow at [Dusk](/wiki/Dusk "Dusk") and [Night](/wiki/Night "Night"), providing enough light to ward off [Charlie](/wiki/Charlie "Charlie"). While glowing it also has a [Sanity](/wiki/Sanity "Sanity") aura.

The sprout can be permanently destroyed with a hammer for two [Limestone](/wiki/Limestone "Limestone") and a Brainy Matter if it is not already picked.

## Prototype Tips[]

* The Brainy Sprout’s sanity aura has a very short range requiring the player to sail directly adjacent to it in order to benefit from the bonus sanity. If planning to build a [Sea Yard](/wiki/Sea_Yard "Sea Yard") nearby, it would need to be very close to the sprout for its repair range to overlap with the sanity aura.
* It is useful to store Brainy Matter in a [Bundling Wrap](/wiki/Bundling_Wrap "Bundling Wrap") to prevent it from spoiling.

## Placeholder Trivia[]

* Their brain shape and the fact that they spawn in the reef [biome](/wiki/Biome "Biome") could be a reference to [brain coral](https://en.wikipedia.org/wiki/Diploria_labyrinthiformis "wikipedia:Diploria labyrinthiformis") (*Diploria labyrinthiformis*).

## Blueprint Gallery[]

Brainy Sprout Picked.png (15 KB)

A picked Brainy Sprout.

Minimap Brainy Sprout.png (3 KB)

The Brainy Sprout's map icon.
