...
source_url: https://dontstarve.fandom.com/wiki/Log
---
...
Evergreen Birchnut Tree Mushtree Cave Banana Tree Jungle Tree Palm Tree Rainforest Tree Tea Tree

Lune Tree (Axe Luxury AxePick/AxeLucy the Axe)  
StalagmiteTall (0.05%) (Pickaxe Opulent PickaxePick/Axe)  
(Debris Build (Hammer) Slotmachine Shipwrecked icon)  
(A Smashing Pot (Hammer) (7%) Hamlet icon)  
(Palmcone Tree DST icon)
...
**“**Cross-section of a tree. For fuel and construction purposes.**”**
...
**“**Thet's me legs' brother.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS BIG, HEAVY AND'ST WOOD**”**
...
**“**A piece of what was once a tree.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Can we make campfire?**”**
...
**“**It came from a tree, as you'd expect.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Logs** are basic building materials with multiple purposes. They can be [Refined](/wiki/Refined "Refined") into [Boards](/wiki/Boards "Boards"), which opens up more recipes.

Logs are dropped from [Evergreens](/wiki/Evergreens "Evergreens"), [Mushtrees](/wiki/Mushtree "Mushtree"), [Cave Banana Trees](/wiki/Cave_Banana_Tree "Cave Banana Tree") and [Birchnut Trees](/wiki/Birchnut_Tree "Birchnut Tree") after cutting the trees with an [Axe](/wiki/Axe "Axe"). The larger the [Tree](/wiki/Tree "Tree"), the more logs are dropped. There are three evergreen tree sizes, which yield 1, 2 or 3 logs depending on the size.

[Tree Stumps](/wiki/Tree_Stump "Tree Stump") from cut Evergreens and Mushtrees can be dug using a [Shovel](/wiki/Shovel "Shovel") to get one extra log. [Spiky Trees](/wiki/Spiky_Tree "Spiky Tree") can also be cut with a chance of getting a log and another one when dug up. Mining full [Tall Stalagmites](/wiki/Stalagmite "Stalagmite") may also yield a log.

In Werebeaver form, [Woodie](/wiki/Woodie "Woodie") can eat Logs to replenish his Log meter.
...
In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* Logs can be crafted by Wilson at the cost of 3 [Twigs](/wiki/Twigs "Twigs") as long as he has the "[Transmutation](https://dontstarve.fandom.com/wiki/Wilson/Don%27t_Starve_Together#Transmutation)" skill.

Logs can also be obtained by chopping down [Palmcone Trees](/wiki/Palmcone_Tree "Palmcone Tree") available in [Moon Quay Island](/wiki/Moon_Quay_Island "Moon Quay Island").

## Downloadable Content[]

In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, Birchnut Trees drop Logs.

https://static.wikia.nocookie.net/dont-starve-game/images/9/9a/Log %28Shipwrecked%29.png/revision/latest?cb=20190423230316

In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, Logs can be obtained by chopping down [Palm Trees](/wiki/Tree/Palm_Tree "Tree/Palm Tree"), [Jungle Trees](/wiki/Tree/Jungle "Tree/Jungle"), as well as by rolling three carrots at the [Slot Machine](/wiki/Slot_Machine "Slot Machine"). Logs take on a more saturated coloration in this DLC.

https://static.wikia.nocookie.net/dont-starve-game/images/0/07/Log %28Hamlet%29.png/revision/latest?cb=20190418234919

In the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC, Logs can be obtained from [Rainforest Trees](/wiki/Rainforest_Tree "Rainforest Tree"), or [Tea Trees](/wiki/Tea_Tree "Tea Tree"), as well as by hammering [A Smashing Pot](/wiki/A_Smashing_Pot "A Smashing Pot"). Logs take on a brighter color in this DLC.

## Crafting Crafting Recipes[]

[**Tools**](/wiki/Tools_Tab "Tools Tab"):
...
* A very effective method of harvesting Logs in the *Reign of Giants* DLC is to summon [Bigfoot](/wiki/Old_Bell "Old Bell") and let it stomp on a group of tightly planted Evergreens or Birchnut Trees.

## Bugs[]

* There are actually two types of logs in the *Hamlet* DLC ("Rainforest Log" and "Teatree Log"). For some reason, the log icon in the inventory is "Teatree Log" instead of "Rainforest Log" since March 18, 2019 update; this also explains why the logs in the inventory are so different from those on the ground. The original "Rainforest Log" icon has been removed for no reason.

## Gallery[]

Diseased Log.png (3 KB)

Unused artwork for a [Diseased](/wiki/Disease "Disease") Log in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*.

GroundSWLog.png (9 KB)

Log on the ground in the *Shipwrecked* DLC

GroundRainforestLog.png (10 KB)

Rainforest Log on the ground in the *Hamlet* DLC

GroundTeatreeLog.png (10 KB)

Unused Teatree Log on the ground in the *Hamlet* DLC
