...
source_url: https://dontstarve.fandom.com/wiki/Cartographer's_Desk
---
...
"Show everyone exactly where you've been."
...
| --- | --- |
| Prototypers & Stations FilterStructures Filter | Science Machine |

Perk

|  |
| --- |
| Grants access to the [Cartography Filter](/wiki/Cartography_Filter "Cartography Filter"). |
...
**“**I could make maps to anywhere and nowhere.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Mermfolk don't need a map!**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**We're mapping out the wilderness!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**We'll be able to explore a lot faster if we map out where we've already been.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Cartographer's Desk** is a *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* exclusive [Structure](/wiki/Structures "Structures"), introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It can be found in the [Prototypers & Stations Filter](/wiki/Prototypers_%26_Stations_Filter "Prototypers & Stations Filter") and [Structures Filter](/wiki/Structures_Filter "Structures Filter"), requires a [Compass](/wiki/Compass "Compass"), and four [Boards](/wiki/Boards "Boards") to craft, and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. The Cartographer's Desk can be used to access the [Cartography Filter](/wiki/Cartography_Filter "Cartography Filter") and craft [Map Scrolls](/wiki/Map_Scroll "Map Scroll"). The Cartographer's Desk grants the ability to add what others have already discovered on the [Map](/wiki/Map "Map").

The Cartographer's Desk also has the ability to erase [Blueprints](/wiki/Blueprint "Blueprint"), Tackle Adverts, [Sketches](/wiki/Sketch "Sketch"), Costume Patterns, and [Recipe Cards](/wiki/Recipe_Card "Recipe Card"), turning them into one [Papyrus](/wiki/Papyrus "Papyrus"), each.
...
* There are [Mods](/wiki/Mod "Mod") that make the Cartographer's Desk and Map Scrolls redundant. Therefore, players should be cautious on modded servers to avoid building redundant structures.

## Trivia[]

* The Cartographer's Desk was added in the *[A Little Fixer Upper](/wiki/A_New_Reign#September_1,_2016_-_A_Little_Fixer_Upper "A New Reign")* update.
* [Cartography](https://en.wikipedia.org/wiki/Cartography "wikipedia:Cartography") is the science and practice of making maps. A person who makes maps is called a cartographer.

## Gallery[]

Cartographer's Desk Burnt.png (43 KB)

A burnt Cartographer's Desk.

Cartographer's Desk and Feather Pencil.PNG (121 KB)

A Cartographer's Desk and a [Feather Pencil](/wiki/Feather_Pencil "Feather Pencil").
