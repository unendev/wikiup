...
source_url: https://dontstarve.fandom.com/wiki/Maxwell_Statue
---
...
Pickaxe Opulent Pickaxe Pick/Axe Gunpowder  
Old Bell Weather Pain Slurtle Slime

### Resources

Marble x2-3  
(Sketch Don't Starve Together)
...
|  |
| --- |
| Unlocks Sketch for Chess Pieces(TumbleweedDon't Starve Together) |
...
**“**It's fashioned for the man who trapped me here.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**He's kind of a jerk, eh?**”**
...
**“**I'd know thet scallywag's face anywheres!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS A MR. MEANY PANTS MADE O' STONE**”**
...
The **Maxwell Statue** is a naturally-spawning [Structure](/wiki/Structure "Structure") that can be found in all worlds of [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode") and rarely in [Sandbox Mode](/wiki/Sandbox_Mode "Sandbox Mode") in various [Set Pieces](/wiki/Set_Piece "Set Piece"). It can be mined with a [Pickaxe](/wiki/Pickaxe "Pickaxe"), Opulent Pickaxe or [Pick/Axe](/wiki/Pick/Axe "Pick/Axe") to obtain [Marble](/wiki/Marble "Marble"). [Gunpowder](/wiki/Gunpowder "Gunpowder") and [Slurtle Slime](/wiki/Slurtle_Slime "Slurtle Slime") can also be used for the same effect. It is also used by [Maxwell](/wiki/Maxwell_(NPC) "Maxwell (NPC)") to lock [Wes](/wiki/Wes "Wes") in an invisible chamber.

If the player destroys the Maxwell Statue that is present in the final chapter of Adventure Mode *(Epilogue: Checkmate*), 3-4 [Clockwork Monsters](/wiki/Category:Clockwork_Monsters "Category:Clockwork Monsters") will spawn around the statue, and the player's sanity level will drop to 0 immediately. The player must kill all the [mobs](/wiki/Mob "Mob") to restore sanity.
...
In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, the Maxwell Statue is more common in Sandbox Mode and is usually found in small [Chess Biome](/wiki/Chess "Chess") Set Pieces guarded by Clockwork Monsters. The [Old Bell](/wiki/Old_Bell "Old Bell") and the [Weather Pain](/wiki/Weather_Pain "Weather Pain") can also be used to destroy the Statue.
...
**“**He's actually quite a sweet boy when you peel away the ego.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I'm gonna make fun of him for this later, eh?**”**
...
**“**My old imp friends would like this, I think.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Look sort of like fragile scale-less man.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I'm starting to think that Maxwell guy might be a bit full of himself.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**"Someone" had far too much time on his hands...**”**

–[Wanda](/wiki/Wanda "Wanda")

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, mining the Maxwell Statue will additionally drop a [Sketch](/wiki/Sketch "Sketch") for [Sculpting](/wiki/Potter%27s_Wheel "Potter's Wheel") a [Kingly Figure](/wiki/Chess_Pieces "Chess Pieces"). Mining the statue also unlocks the chess piece in the world, allowing [Tumbleweeds](/wiki/Tumbleweed "Tumbleweed") to drop the sketch. Because of the [Story Line](/wiki/Story_Line "Story Line") progressing, characters have different quotes for the statue. Also, instead of the usual statue, an overgrown statue of Maxwell may appear

## Placeholder Trivia[]

* This structure was added in *[A Little Rain Must Fall](/wiki/Version_History#A_Little_Rain_Must_Fall "Version History")* Update, but only naturally generated following the *[Doorway to Adventure](/wiki/Version_History#Doorway_to_Adventure "Version History")* Update.

## Blueprint Gallery[]

Statue mined.png (66 KB)

Maxwell Statue when mined.

Statuebroken.png (48 KB)

Maxwell Statue when mined, almost broken.

Sandbox Maxwell Statue.jpg (263 KB)

Maxwell Statue in the [Maxwell's Cemetery](/wiki/Set_Piece#Maxwell.27s_Cemetery "Set Piece") Set Piece in Sandbox Mode.

World 6 Maxwell Statue Before Mined.png (1.73 MB)

Maxwell Statue in the Locked Wes Set Piece in Adventure Mode.

World 6 Maxwell Statue After Mined.png (1.74 MB)

The Statue spawning Clockwork Bishops after being mined.

The End is Nigh.jpg (1.66 MB)

*The End is Nigh* artwork with a Maxwell Statue.

Trailer DST Maxwell Statue.png (1.06 MB)

A Maxwell Statue, as seen in the *A New Reign* cinematic.

DST Nightmare Wallpaper.jpg (353 KB)

A Maxwell Statue as seen on the Steam "Nightmare" wallpaper.
