...
source_url: https://dontstarve.fandom.com/wiki/Cutlass_Supreme
---
...
"Fish were harmed in the making of this."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Dead Swordfish**×1** Gold Nugget**×2** Twigs**×1** |
...
| --- |
| 68 (102 Sealnado)  51 (85 Sealnado) WendyWes  ---  85 (119 Sealnado) Wigfrid  ---  31-136 (65-170 Sealnado) Wolfgang |
...
|  |
| --- |
| Deals additional 34 damage against [Sealnado](/wiki/Sealnado "Sealnado"). |

## Sources

### Dropped by

Blue Whale Carcass White Whale Carcass

### Sold by

The Boar's Tusk Weapon Shop (Oinc ×50) Hamlet icon
...
The **Cutlass Supreme** is a craftable [Weapon](/wiki/Weapon "Weapon") introduced in the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC. It requires a dead [Swordfish](/wiki/Swordfish "Swordfish"), two [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget") and a [Twig](/wiki/Twig "Twig") to craft, and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. A Cutlass Supreme deals 68 damage on hit, the same amount of damage as the [Dark Sword](/wiki/Dark_Sword "Dark Sword"), minus the sanity drain, and has 150 uses, making it more durable. It deals an additional 34 damage against [Sealnado](/wiki/Sealnado "Sealnado").

## Hamlet icon Hamlet[]

The Cutlass Surpreme is also included in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, however, it cannot be crafted. Instead, it can be bought for 50 [Oincs](/wiki/Oinc "Oinc") at [The Boar's Tusk Weapon Shop](/wiki/The_Boar%27s_Tusk_Weapon_Shop "The Boar's Tusk Weapon Shop") in the [Pig City](/wiki/Pig_City "Pig City").

## Placeholder Trivia[]

* The Cutlass Supreme shares its name with an [Oldsmobile](https://en.wikipedia.org/wiki/Oldsmobile_Cutlass_Supreme) model.
* The Cutlass Supreme deals the highest melee damage tied for the first place with the [Dark Sword](/wiki/Dark_Sword "Dark Sword") among all [Weapons](/wiki/Weapon "Weapon") for the base damage. Only four melee weapons situationally do more damage: the [Morning Star](/wiki/Morning_Star "Morning Star") when used on wet [Mobs](/wiki/Mobs "Mobs"), the [Obsidian Spear](/wiki/Obsidian_Spear "Obsidian Spear") (starts out at 51 but charges up to 102), the [Trident](/wiki/Trident "Trident") when used while on a [Boat](/wiki/Boats "Boats"), and the [Alarming Clock](/wiki/Alarming_Clock "Alarming Clock") when fueled.
...
* It is one of the only melee weapons with a special attack noise, the others being the Dark Sword, the [Halberd](/wiki/Halberd "Halberd"), the [Tail o' Three Cats](/wiki/Tail_o%27_Three_Cats "Tail o' Three Cats"), and the [Alarming Clock](/wiki/Alarming_Clock "Alarming Clock").

## Blueprint Gallery[]

WXFM.png (206 KB)

[WX-78](/wiki/WX-78 "WX-78") holding a Cutlass Surpreme.

Cutlass Supreme Boat.jpg (55 KB)

Warly holding a Cutlass Supreme on a Boat during night.
