...
source_url: https://dontstarve.fandom.com/wiki/Alchemy_Engine
---
...
| --- |
| Boards**×4** Cut Stone**×2** Gold Nugget**×6 Don't Starve** **Boards×4 Cut Stone×2 Electrical Doodad×2** https://static.wikia.nocookie.net/dont-starve-game/images/f/f8/Reign of Giants icon.png/revision/latest?cb=20140408110712HamletShipwreckedDon't Starve Together |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| Science Tab | Prototypers & Stations Filter Structures Filter | Science Machine |

Perk

|  |
| --- |
| Unlock additional crafting recipes |
...
**“**Even more scienc-y than the last one!**”**
...
**“**Even alchemy operates differently here.**”**
...
**“**Alright machine, tell me something I don't know.**”**
...
**“**They never taught us about alchemy in school.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It turns out that science is a lot easier than I thought!**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Alchemy Engine** is the tier 2 [Science](/wiki/Science "Science") station. It requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype for all characters except [Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), and costs 4 [Boards](/wiki/Boards "Boards"), 2 [Cut Stones](/wiki/Cut_Stone "Cut Stone"), and 6 [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget") to craft. Prototyping an [Item](/wiki/Item "Item") using the Alchemy Engine will increase [Sanity](/wiki/Sanity "Sanity") by 15.

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 See also: [Crafting](/wiki/Crafting "Crafting")*

## Downloadable Content[]

In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")*, *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")*, and *[Hamlet](/wiki/Hamlet "Hamlet")* DLCs, as well as *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, the 6 Gold Nuggets in the crafting recipe are replaced by 2 [Electrical Doodads](/wiki/Electrical_Doodad "Electrical Doodad").

In the *Shipwrecked* DLC, the Alchemy Engine can be [flooded](/wiki/Flooding "Flooding").

## Tips[]

* An easy way to gather the crafting materials for an Alchemy Engine is to hammer down [Pig Houses](/wiki/Pig_House "Pig House") for Boards and Cut Stones, and to mine [Gold Vein Boulders](/wiki/Boulder "Boulder") for Gold.
...
* Since Wickerbottom has Tier 2 items unlocked with the Science Machine, this machine is only necessary for crafting her book [On Tentacles](/wiki/On_Tentacles "On Tentacles").

## Trivia[]

* In the [early Beta](/wiki/Version_History "Version History") version of *[Don't Starve](/wiki/Don%27t_Starve "Don't Starve")*, the game used a "[Research Points](/wiki/Research_points_list "Research points list")" system, instead of prototyping. Crafting this station cost 200 Research Points.
* As of the *[Hungry For Your Hunger](/wiki/New_Features#July_23.2C_2013_-_Hungry_For_Your_Hunger "New Features")* update, Tier 3 recipes crafted using the [Shadow Manipulator](/wiki/Shadow_Manipulator "Shadow Manipulator") have been moved to the Alchemy Engine, due to the separation of Science and [Magic](/wiki/Magic "Magic").

## Gallery[]

Researchlab 2.gif (283 KB)

The Alchemy Engine's animation when the player is nearby.

Alchemy engine animation when used.gif (2.13 MB)

Animation of the Alchemy Engine when prototyping a recipe.

Alchemy Engine Open Gift Animation.gif (1.85 MB)

Animation of the Alchemy Engine when opening a gift.

Alchemy Engine Burnt.png (31 KB)

A burnt Alchemy Engine from the *Reign of Giants* DLC.

Valentines 2018 2.png (7.03 MB)

Alchemy Engine as seen on the 2018 Valentine Cards.

Dont Starve research machines gif by Kelly.gif (988 KB)

Dont Starve research machines gif by Kelly [[1]](#cite_note-1)
