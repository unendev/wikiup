...
source_url: https://dontstarve.fandom.com/wiki/Skyworthy
---
...
"Hop on board. What could possibly go wrong?"
...
| --- |
| Nightmare Fuel**×4** Living Log**×4** Can of Silly String**×1** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Magic Tab | Shadow Manipulator |

[Code](/wiki/Console "Console")

|  |
| --- |
| `"porkland_exit" (in Hamlet world), "porkland_entrance" (out of Hamlet world)` |

* [In Hamlet world](#)
* [Outside Hamlet world](#)

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Looks like an exit-ing ride!**”**

–[Wilson](/wiki/Wilson "Wilson"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I should get out of here.**”**

–[Willow](/wiki/Willow "Willow"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is fun flying machines.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Shall I leave this mortal coil?**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**EXIT PORT**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**An egress.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It goes somewhere else.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**An exit but not a way out.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Another innovation that runs on dark fuel!**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Öutward tö adventure!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**That leads somewhere else.**”**

–[Webber](/wiki/Webber "Webber"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Sweet ride!**”**

–[Walani](/wiki/Walani "Walani"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Any good restaurants in there?**”**

–[Warly](/wiki/Warly "Warly"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'tis not a boat, but ye c'n sail it.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**THAT WAY MADNESS LIES**”**

–[Wilba](/wiki/Wilba "Wilba"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Where to?**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Does it actually fly?!**”**

–[Wheeler](/wiki/Wheeler "Wheeler"), when examining in Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Good clean family amusement.**”**

–[Wilson](/wiki/Wilson "Wilson"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**That looks... fun.**”**

–[Willow](/wiki/Willow "Willow"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is fun flying machines.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Another world, another hardship.**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**ENTRY PORT**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Leads to adventure.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Feel like goin' on a trip, Lucy?**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Off to another adventure?**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I must learn how to harness the dark fuel into a teleportation device!**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Onward to adventure!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I hope it goes somewhere cool.**”**

–[Webber](/wiki/Webber "Webber"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Where's that go?**”**

–[Walani](/wiki/Walani "Walani"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A whole new world of ingredients.**”**

–[Warly](/wiki/Warly "Warly"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Fer sailin' the skies.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**THAT WAY MADNESS LIES**”**

–[Wilba](/wiki/Wilba "Wilba"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Where to?**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining out of Hamlet world

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I've my doubts it'll actually fly, but I'm desperate.**”**

–[Wheeler](/wiki/Wheeler "Wheeler"), when examining out of Hamlet world

The **Skyworthy** is the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC's equivalent of [*Shipwrecked*'s](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked") [Seaworthy](/wiki/Seaworthy "Seaworthy"). It is found in the [Magic Tab](/wiki/Magic_Tab "Magic Tab"), requires 4 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"), 4 [Living Logs](/wiki/Living_Log "Living Log"), and the [Can of Silly String](/wiki/Trinkets#Can_of_Silly_String "Trinkets") to craft, and a [Shadow Manipulator](/wiki/Shadow_Manipulator "Shadow Manipulator") to prototype.

The Skyworthy allows the player to travel to both a *Shipwrecked* or vanilla/*[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* world (if DLCs are installed). It may be crafted again to travel back to the *Hamlet* world. In *Shipwrecked* or vanilla/*Reign of Giants* worlds, the required [Can of Silly String](/wiki/Can_of_Silly_String "Can of Silly String") may be found by [hammering](/wiki/Hammer "Hammer") a [Wicker Basket](/wiki/Wicker_Basket "Wicker Basket") which is generated somewhere in the world. Can of Silly String can also be obtained in the [Royal Gallery](/wiki/Palace "Palace") in the *Hamlet* world. Once traveled to a different world, the player can also find/craft the [Seaworthy](/wiki/Seaworthy "Seaworthy") to use for travel between *Shipwrecked* and *Reign of Giants* worlds.

## Prototype Tips[]

* A Skyworthy tends to prioritize linking to another Skyworthy in another connected world (the same applies to the Seaworthy). With this mechanism, a player can utilize it for quick travel in a *Hamlet*-compatible world. For example, with a *Hamlet*-compatible *Shipwrecked* world, the player can build a Skyworthy in their main base and then build a Seaworthy near a [Slot Machine](/wiki/Slot_Machine "Slot Machine") in a different island. To quick travel to the Slot Machine the player must have a connected vanilla/*Reign of Giants* (RoG) world with a Skyworthy and a Seaworthy built next to each other (the player must obtain the Sea Worther and the Can of Silly String to craft them). Use the Skyworthy to go to the vanilla/RoG world, then use the Seaworthy, and upon entering the *Shipwrecked* world the player would be on the Slot Machine Island.
* If a player have spent more than 61 days in *Reign of Giants* or *Shipwrecked* world before entering a new *Hamlet* world by Skyworthy, the *Hamlet* world will be locked in [Aporkalypse](/wiki/Aporkalypse "Aporkalypse") state when the player arrive until the player reverse the [Aporkalypse Calendar](/wiki/Aporkalypse_Calendar "Aporkalypse Calendar"). So it is recommended to bring everything needed for reaching the Aporkalypse Calendar before using Skyworthy in the circumstance.

## Placeholder Trivia[]

* When the *Shipwrecked* DLC is not installed, the structure itself refers *Hamlet* world as "a deeply dangerous jungle".

## Blueprint Gallery[]

WilsonSkyworthy.png (549 KB)

[Wilson](/wiki/Wilson "Wilson") next to the Skyworthy.

RoG to HAM.gif (6.87 MB)

[Wilson](/wiki/Wilson "Wilson") using the Skyworthy in a RoG world.
