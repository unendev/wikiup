...
source_url: https://dontstarve.fandom.com/wiki/X_Marks_the_Spot
---

*Exclusive to:* Shipwrecked

:   *For the [Hamlet](/wiki/Hamlet "Hamlet") exclusive [Masked Pig](/wiki/Masked_Pig "Masked Pig") stash, see [Secret Bandit Camp](/wiki/Secret_Bandit_Camp "Secret Bandit Camp").*
:   *For the [Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together") exclusive version, see [Pirate Stash](/wiki/Pirate_Stash "Pirate Stash").*
...
**Bone Shards×2, X Marks the Spot**

### Renewable?

No (Yes when playing as Woodlegs)
...
**X Marks the Spot** is an object in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC that appears only after its location has been revealed by reading a [Message in a Bottle](/wiki/Message_in_a_Bottle "Message in a Bottle"). It appears as two X-crossed bones over disturbed soil. It can be dug up with a [Shovel](/wiki/Shovel "Shovel") or shot with a [Boat Cannon](/wiki/Boat_Cannon "Boat Cannon") to reveal [Bone Shards](/wiki/Bone_Shards "Bone Shards") and a [Chest](/wiki/Chest "Chest") containing several pieces of treasure. Players should be cautious as one treasure preset spawns 3 [Snakes](/wiki/Snake "Snake") when dug up.

When worn, [Woodlegs'](/wiki/Woodlegs "Woodlegs") [Lucky Hat](/wiki/Lucky_Hat "Lucky Hat") creates a new X Marks the Spot every 800 seconds (slightly more than 1 Day and a half). If worn by an NPC, such as a [Wildbore](/wiki/Wildbore "Wildbore") or a [Prime Ape](/wiki/Prime_Ape "Prime Ape"), it only has a 66% chance to spawn a treasure.

During a [Volcano](/wiki/Volcano/Object "Volcano/Object") eruption in [Dry Season](/wiki/Dry_Season "Dry Season"), if a [Dragoon Egg](/wiki/Dragoon_Egg "Dragoon Egg") happens to fall on an X Marks the Spot, it will be dug up, burning the Chest and all flammable Items it contained.

## Possible Treasure[]

There are fixed presets of the treasure chest loot, mixed with some random loot plus some chance loot.

If the buried treasure is spawned by Woodleg's [Lucky Hat](/wiki/Lucky_Hat "Lucky Hat"), it sometimes contains [Slot Machine](/wiki/Slot_Machine "Slot Machine") loot instead.
If the buried treasure is found on the "skull island", it will contain 3 Obsidian [Coconades](/wiki/Coconade "Coconade").
...
Red GemBlue GemPurple GemPapyrus"Ballphin Free" TunaBlueprintGold NuggetGearsRope
...
| **Snake ×3, Dubloons ×3** | **Blue Gem (~35.7%), Red Gem (~35.7%), Purple Gem (~0.07%),Green Gem (~0.07%), Orange Gem (~0.07%), Yellow Gem (~0.07%)** |  |
| **Gold Nugget ×3** | **Standard** | **Purple Gem (50%)Orange Gem (25%) Yellow Gem (25%) Green Gem (25%)** |
| **Dubloons ×5,Booty Bag ×1** | **Red Gem (~45.5%), Blue Gem (~45.5%), Purple Gem (~0.9%)** |  |
| **Dubloons** |  |  |
| **Dubloons ×3** |  |  |
| **Dubloons ×10** |  |  |
| **Dubloons ×5,Super Spyglass,Boat Lantern,Poison Spear** | **Standard** |  |
| **Dubloons ×5, Miner Hat, Obsidian Axe** | **Standard** |  |
| **Dubloons ×5, Spyglass, Life Jacket, Captain Hat** | **Standard** |  |
| **Dubloons ×5,"Ballphin Free" Tuna ×5** | **Standard** | **Standard** |
| **One True Earring (Trinket)** | **Standard** | **Standard** |
| **Dubloons ×2, Peg Leg** | **Standard** | **Standard** |
| **Dubloons ×6, Volcano Staff** | **Standard** | **Standard** |
| **Dubloons ×2, Football Helmet, Spear, Seashell Suit** | **Standard** |  |
| **Dubloons, Luxury Axe, Regal Shovel, Opulent Pickaxe** | **Standard** | **Standard** |
| **Dubloons ×4, Boat Lantern, Sea Trap** | **Standard** | **Standard** |
| **Dubloons ×3, Compass, Bone Shards ×2, Empty Bottle, Sand** | **Standard** |  |
| **Dubloons ×3, Electrical Doodad, Gunpowder ×3, Thermal Stone** | **Standard** | **Standard** |
| **Dubloons, Dark Sword, Life Giving Amulet** | **Standard** | **Standard** |
| **Dubloons ×2, Obsidian Axe, Gunpowder ×2** | **Standard** | **Standard** |
| **Dubloons ×4, Cloth Sail, Boat Repair Kit, Boat Lantern** | **Standard** | **Standard** |
| **Dubloons ×3, Coconade ×3, Boat Cannon** | **Standard** | **Standard** |
| **Dubloons, Snakeskin Hat, Snakeskin Jacket, Spear Gun ×6** | **Standard** | **Standard** |
| **Dubloons ×5, Gold Nugget ×5, Purple Gem ×2, Red Gem ×4, Blue Gem ×2** | **Standard** |  |
| **Dubloons ×5, Thulecite Club, Thulecite Crown, Thulecite Suit, Blue Gem ×2** | **Standard** |  |
| **Dubloons, Spyglass, Pirate Hat, Boat Cannon** | **Standard** | **Standard** |
| **Dubloons ×3, Boomerang, Snakeskin ×3, Straw Hat** | **Standard** | **Standard** |
| **Dubloons, Particulate Purifier, Venom Gland ×3, Poison Spear** | **Standard** | **Standard** |
| **Dubloons ×2, Coconade ×2, Obsidian Coconade, Gunpowder ×2** | **Standard** | **Standard** |
| **Dubloons ×4, Luxury Machete, Top Hat, Rope ×3, Spyglass** | **Standard** |  |
| **Dubloons ×6, Spear Gun ×4, Blubber Suit** | **Standard** | **Standard** |
| **Dubloons ×4, Bone Shards ×3, Nightmare Fuel ×4, Purple Gemx2, Gold Nugget ×3** | **Standard** |  |
| **Dubloons, Gears ×4, Electrical Doodad ×2, Spyglass, Gold Nugget ×2** | **Standard** |  |
| **Dubloons ×4, Pirate Hat, Boat Cannon** | **Standard** | **Standard** |
| **Dubloons, Captain Hat, Life Jacket, "Ballphin Free" Tuna, Trawl Net** | **Standard** |  |
| **Dubloons ×4, Windbreaker, Obsidian Machete** | **Standard** | **Standard** |
| **Dubloons ×4, Divining Rod** | **Standard** | **Standard** |
| **Dubloons ×3, Boomerang, Tooth Trap ×2** | **Standard** | **Standard** |
| **Dubloons ×6, Gold Nugget ×5** | **Standard** | **Standard** |
| **Dubloons ×2, Obsidian Spear, Obsidian Armor** | **Standard** | **Standard** |

## Blueprint Gallery[]

UnluckyTreasureChest.jpg (132 KB)

[Wickerbottom](/wiki/Wickerbottom "Wickerbottom") being especially unlucky.
