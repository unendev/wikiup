...
source_url: https://dontstarve.fandom.com/wiki/Thulecite_Crown
---
...
1200 hp  
840 hp Don't Starve Together   
933.3 [true hp](/wiki/Armor/DST#True_durability "Armor/DST")Don't Starve Together
...
|  |
| --- |
| Absorbs 90% of physical damage Triggers protective force field |

## Sources

### Dropped by

Large Ornate Chest **(17% chance)**  
(Slotmachine Chest of the Depths X Marks The Spot Shipwrecked icon)
...
**“**A crown you can wear anywhere. Even fighting monsters.**”**
...
**“**I'm the king! You have to listen to what I say!**”**
...
The **Thulecite Crown** is a craftable [Item](/wiki/Items "Items") found in the [Ancient Tab](/wiki/Ancient_Tab "Ancient Tab"). It requires 4 [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"), 4 [Thulecite](/wiki/Thulecite "Thulecite") and an [Ancient Pseudoscience Station](/wiki/Ancient_Pseudoscience_Station "Ancient Pseudoscience Station") to craft. It also has a 33% chance to be found inside a [Large Ornate Chest](/wiki/Large_Ornate_Chest "Large Ornate Chest"). Like all items from the Ancient Tab, Thulecite Crowns cannot be prototyped and can only be crafted when near an [Ancient Pseudoscience Station](/wiki/Ancient_Pseudoscience_Station "Ancient Pseudoscience Station").

The Thulecite Crown is head [Armor](/wiki/Armor "Armor") that will absorb 90% of physical damage and has 1200 durability. When the wearer takes damage from an attack, it has a 33% chance to create a force field. The force field lasts for 4 seconds, preventing all damage from attacks (except for [Fire](/wiki/Fire "Fire")) and granting stun immunity. While the force field is active, 5% of incoming damage is reduced from [Sanity](/wiki/Sanity "Sanity"). The force field cannot occur more than once every 9 seconds. Unequipping the Crown will disable an active force field, even though the animation remains. The Crown's force field emits enough light to protect the player from [Charlie](/wiki/Charlie "Charlie").

## Gift Icon Downloadable Content[]

In the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC, players have a small chance of finding [Green Gems](/wiki/Green_Gem "Green Gem") inside [Tumbleweeds](/wiki/Tumbleweed "Tumbleweed"), thus making Thulecite Crown renewable, since more Thulecite can be gained with the use of [Construction Amulets](/wiki/Construction_Amulet "Construction Amulet") and [Deconstruction Staffs](/wiki/Deconstruction_Staff "Deconstruction Staff").

In the *[Shipwrecked](/wiki/Shipwrecked "Shipwrecked")* DLC, Thulecite Crowns can be obtained as a possible reward from the [Slot Machine](/wiki/Slot_Machine "Slot Machine") and [X Marks the Spot](/wiki/X_Marks_the_Spot "X Marks the Spot") treasure [Chests](/wiki/Chest "Chest"). It also can always be found in a [Chest of the Depths](/wiki/Chest_of_the_Depths "Chest of the Depths") left behind by the [Quacken](/wiki/Quacken "Quacken") after its death, making Thulecite Crowns renewable also in *Shipwrecked*.

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Thulecite is renewable by killing the [Ancient Fuelweaver](/wiki/Ancient_Fuelweaver "Ancient Fuelweaver") to reset the [Ruins](/wiki/Ruins "Ruins") and by feeding [Amberosia](/wiki/Amberosia "Amberosia") to [Dust Moths](/wiki/Dust_Moth "Dust Moth"). Therefore, an unlimited amount of Thulecite Crowns can be crafted.

## Prototype Tips[]

* As it is clear from its perk, the Thulecite Crown is more suited for [tanking](/wiki/Glossary#T "Glossary") enemies instead of [kiting](/wiki/Glossary#K "Glossary") them.
* The Crown is really useful when facing big groups of Mobs like [Spiders](/wiki/Spider "Spider"), [Hounds](/wiki/Hounds "Hounds"), and [Birchnutters](/wiki/Birchnutter "Birchnutter"), as the force field will protect the players from being stunlocked.
* The force field will protect from the special effects of enemy attacks, such as those of [Frogs](/wiki/Frogs "Frogs").
* The Crown is a great armor for [Willow](/wiki/Willow "Willow"), [Maxwell](/wiki/Maxwell "Maxwell"), and [Wigfrid](/wiki/Wigfrid "Wigfrid") (Reign of Giants icon only) since these characters can regain their sanity easily.
  + On the other hand, the Crown is not efficient when used on [Woodlegs](/wiki/Woodlegs "Woodlegs") Shipwrecked icon, since his maximum sanity value is lower than other characters and drops constantly when on land.
* It is generally advised to also wear disposable body armor to increase the life of the Thulecite Crown. In *Don't Starve Together*, the [Log Suit](/wiki/Log_Suit "Log Suit") can absorb roughly 47% of already absorbed damage, effectively increasing the life of the Thulecite Crown from 840 to 1585.
* In the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, since the Thulecite Crown only triggers its force field when the wearer takes damage, the [Vortex Cloak](/wiki/Vortex_Cloak "Vortex Cloak") will prevent it from activating when both are worn simultaneously and the Thulecite Crown is the [primary armor](/wiki/Armor#Calculations "Armor").[Verification Needed] If the Vortex Cloak is the primary armor, the Thulecite Crown will not lose durability but also will not trigger the force field. If the Vortex Cloak is at 0% durability, the Thulecite Crown will activate its force field. As such, using both pieces of equipment in combat at the same time is ill-advised in favor of something more disposable such as a [Football Helmet](/wiki/Football_Helmet "Football Helmet").

## Placeholder Trivia[]

* The Thulecite Crown was added in *[A Moderately Friendly Update](/wiki/Version_History#September_10.2C_2013_-_A_Moderately_Friendly_Update "Version History")*.
* Although the crown showcases a [Red Gem](/wiki/Red_Gem "Red Gem"), one does not need it to craft the crown.

## Blueprint Gallery[]

Thulecite Crown force field.jpg (32 KB)

The Thulecite Crown's force field.

Shipwrecked Thulecite Set.png (1.63 MB)

Wilson wearing a Thulecite Crown and a [Thulecite Suit](/wiki/Thulecite_Suit "Thulecite Suit"), while holding a [Thulecite Club](/wiki/Thulecite_Club "Thulecite Club").

* Expand slideshow

  [Wilson](/wiki/Wilson "Wilson") wearing a Thulecite Crown.
* Expand slideshow

  [Willow](/wiki/Willow "Willow") wearing a Thulecite Crown.
* Expand slideshow

  [Wolfgang](/wiki/Wolfgang "Wolfgang") wearing a Thulecite Crown.
* Expand slideshow

  [Wendy](/wiki/Wendy "Wendy") wearing a Thulecite Crown.
* Expand slideshow

  [WX-78](/wiki/WX-78 "WX-78") wearing a Thulecite Crown.
* Expand slideshow

  [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing a Thulecite Crown.
* Expand slideshow

  [Woodie](/wiki/Woodie "Woodie") wearing a Thulecite Crown.
* Expand slideshow

  [Wes](/wiki/Wes "Wes") wearing a Thulecite Crown.
* Expand slideshow

  [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing a Thulecite Crown.
* Thulecite Crown Wagstaff.png

  [Wagstaff](/wiki/Wagstaff "Wagstaff") wearing a Thulecite Crown.
* Expand slideshow

  [Wigfrid](/wiki/Wigfrid "Wigfrid") wearing a Thulecite Crown.
* Expand slideshow

  [Webber](/wiki/Webber "Webber") wearing a Thulecite Crown.
* Expand slideshow

  [Walani](/wiki/Walani "Walani") wearing a Thulecite Crown.
* Expand slideshow

  [Warly](/wiki/Warly "Warly") wearing a Thulecite Crown.
* Expand slideshow

  [Wilbur](/wiki/Wilbur "Wilbur") wearing a Thulecite Crown.
* Expand slideshow

  [Woodlegs](/wiki/Woodlegs "Woodlegs") wearing a Thulecite Crown.
* Expand slideshow

  [Wilba](/wiki/Wilba "Wilba") wearing a Thulecite Crown.
* Expand slideshow

  [Wormwood](/wiki/Wormwood "Wormwood") wearing a Thulecite Crown.
* Expand slideshow

  [Wheeler](/wiki/Wheeler "Wheeler") wearing a Thulecite Crown.
* Expand slideshow

  [Winona](/wiki/Winona "Winona") wearing a Thulecite Crown.
* Expand slideshow

  [Wortox](/wiki/Wortox "Wortox") wearing a Thulecite Crown.
* Expand slideshow

  [Wurt](/wiki/Wurt "Wurt") wearing a Thulecite Crown.
