...
source_url: https://dontstarve.fandom.com/wiki/Moon_Dial
---
...
| --- |
| Blue Moonlens**×1** Moon Rock**×2** Ice**×2** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Shadow Magic Filter Structures Filter | Prestihatitator |

Perk

|  |
| --- |
| Shows the current [moon phase](/wiki/Moon_Cycle "Moon Cycle"). |
...
The **Moon Dial** is a craftable structure exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*, found in the [Shadow Magic Filter](/wiki/Shadow_Magic_Filter "Shadow Magic Filter") and [Structures Filter](/wiki/Structures_Filter "Structures Filter"). It can be used to see the [Moon Cycle](/wiki/Moon_Cycle "Moon Cycle"), which are reflected in the water inside the structure.
...
The Moon Dial can be useful when playing as [Woodie](/wiki/Woodie "Woodie"), as it can be a more obvious indicator of when a Full Moon is about to occur.

When the [Mysterious Energy](/wiki/Mysterious_Energy "Mysterious Energy") is summoned, the Moon Dial will glass over. After the [Celestial Champion](/wiki/Celestial_Champion "Celestial Champion") is defeated, the Moon Dial will drop a [Moon Shard](/wiki/Moon_Shard "Moon Shard").
...
* The Moon Dial was introduced in the *[Arts and Crafts](/wiki/A_New_Reign#October_13,_2016_-_Arts_and_Crafts "A New Reign")* update.
* Curiously, [Wolfgang](/wiki/Wolfgang "Wolfgang")'s quote says he cannot see his own reflection in the pool, while [Wortox](/wiki/Wortox "Wortox") says he can.

## Blueprint Gallery[]

DSTupdate artsandcrafts.png (2.54 MB)

Moon Dial as seen in the poster for the *[Arts and Crafts](/wiki/A_New_Reign#October_13,_2016_-_Arts_and_Crafts "A New Reign")* update.

20161015111322 1.jpg (15 KB)

The Moon Dial as seen in the game. Note that the half moon is reflected on the Moon Dial.

Moondial as seen on the map.jpg (5 KB)

The Moon Dial as seen on the map.

Moon Dial Quarter Animation.gif (551 KB)

The Moon Dial on a waxing crescent.

Moon Dial Half Animation.gif (526 KB)

The Moon Dial on a waxing half moon.

Moon Dial Threequarter Animation.gif (501 KB)

The Moon Dial on a waxing gibbous.

Moon Dial Full Animation.gif (727 KB)

The Moon Dial on a full moon.

Moon Dial Glassed Animation.gif (936 KB)

The Moon Dial on a moonstorm.

RWP280 Dial test animation.gif (507 KB)

Dial test animation from *Rhymes With Play* #280.

RWP280 Dial animations Concept Art.png (491 KB)

Dial animations Concept Art from *Rhymes With Play* #280.
