...
source_url: https://dontstarve.fandom.com/wiki/Dung_Pile
---
...
A **Dung Pile** is a naturally spawning object introduced in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC, which can mostly be found in [Tall Grass](/wiki/Tall_Grass "Tall Grass") biome.

Each Dung Pile will yield up to 3 items when dug. To obtain them, the player can either use their bare hands, or a [shovel](/wiki/Shovel "Shovel"):

* **If using bare hands**, it will take 3 hits for the Dung Pile to be completely dug, and the player will lose 10 [Sanity](/wiki/Sanity "Sanity") at each hit, for a total of -30 sanity per Pile.
* **If using a Shovel**, the 3 items will be yielded (and the Dung Pile completely dug) at once, without any Sanity loss.

## Resources[]

[Manure](/wiki/Manure "Manure") and [Rocks](/wiki/Rocks "Rocks") are the two most common items found in a Dung Pile, and at least one of these will be found each time a pile is dug. [Bone Shards](/wiki/Bone_Shards "Bone Shards") is also a common resource. More rarely, one can find [Flint](/wiki/Flint "Flint"), [Grass](/wiki/Grass "Grass") or [Twigs](/wiki/Twigs "Twigs").

The Dung Pile can spawn a [Dung Beetle](/wiki/Dung_Beetle "Dung Beetle"), along with its [Dung Ball](/wiki/Dung_Ball "Dung Ball"), which makes Rocks and Flint renewable. Be careful though: even if the first spawn doesn't destroy the Dung Pile, if a Dung Beetle is deprived of its Dung Ball, it will return to the closest Dung Pile, destroying it to make a new Dung Ball out of it.

It's a flammable object, and will yield an [Ash](/wiki/Ash "Ash") if set on fire.

## Prototype Tips[]

* While the Dung pile is renewable only via [BFB](/wiki/BFB "BFB") spawning, it's better to let the Dung Pile in place and wait for a [Dung Ball](/wiki/Dung_Ball "Dung Ball") to spawn if there's any need of rocks or manure.
* If the player digs in a dung pile when playing as [Wormwood](/wiki/Wormwood "Wormwood") the player will gain 10 sanity per dig for a total of 30 sanity per dung pile.

## Blueprint Gallery[]

Art Stream 74 Dung Beetle.png (904 KB)

A Dung Pile as seen in a drawing from Art Stream # 74.
