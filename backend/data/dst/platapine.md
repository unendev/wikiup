...
source_url: https://dontstarve.fandom.com/wiki/Platapine
---
...
| [Damage](/wiki/Mobs#Mob_Characteristics "Mobs") | Attack Range |
| --- | --- |
| 17  (12.75 Wigfrid) | 3 |
...
The **Platapine** is a neutral [Mob](/wiki/Mobs "Mobs") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC which spawns in the [Lily Pond](/wiki/Lily_Pond "Lily Pond") [Biome](/wiki/Biomes "Biomes"). Similar to how [Gobblers](/wiki/Gobbler "Gobbler") spawn from [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), they will spawn when a [Lotus Plant](/wiki/Lotus_Plant "Lotus Plant") is picked, and will proceed to consume the [Flowers](/wiki/Lotus_Flower "Lotus Flower") of all nearby Lotus Plants if not stopped. They defend themselves with a spinning dash that allows them to flee or inflict damage on enemies. They are stunlockable and will help each other.

## Placeholder Trivia[]

* The name of the creature is a portmanteau of 'platypus' and 'porcupine'.
* The fast speed and spinning attack in a blue porcupine-like creature are all likely references to *[Sonic the Hedgehog](https://en.wikipedia.org/wiki/Sonic_the_Hedgehog "wikipedia:Sonic the Hedgehog")*, a popular Sega platforming game.

## Blueprint Gallery[]

Platapine Sleeping.png (148 KB)

A sleeping Platapine.

Platapine Dead.png (204 KB)
