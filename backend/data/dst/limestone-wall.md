...
source_url: https://dontstarve.fandom.com/wiki/Limestone_Wall
---
...
The **Limestone Wall** is a type of wall introduced in the *Shipwrecked* DLC. They are crafted with two pieces of [Limestone](/wiki/Limestone "Limestone") and require an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. They are slightly stronger than Stone Walls with 500 maximum health. When hammered, Limestone Walls will drop one or two pieces of [Coral](/wiki/Coral "Coral") depending on their health. They can not be repaired with Limestone or Coral.

## Blueprint Gallery[]

Limestone Wall tiers .PNG (193 KB)

The 5 tiers of a Limestone Wall.
