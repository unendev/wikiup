...
source_url: https://dontstarve.fandom.com/wiki/Wooden_Flooring
---
...
| --- | --- |
| Boards**×1** | 1 4 Don't Starve Together |
...
**“**I missed the comforting creak of floorboards beneath my feet.**”**

–[Wanda](/wiki/Wanda "Wanda")

**Wooden Flooring** is a craftable [Turf](/wiki/Turf "Turf") [Item](/wiki/Item "Item"). It requires 1 [Board](/wiki/Board "Board") to craft and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype. It can also be found underneath a [Pig King](/wiki/Pig_King "Pig King") or near [Touch Stones](/wiki/Touch_Stone "Touch Stone"). Like other Turfs, it can be placed on any bare ground tile or used as [fuel](/wiki/Fire#Fuel "Fire"). To place the wooden flooring (or any kind of flooring), you will need to use a [pitchfork](/wiki/Pitchfork "Pitchfork") to plow the ground where you want to place it.

[Eyeplants](/wiki/Lureplant#Eyeplant "Lureplant") cannot spawn on this Turf, making it the cheapest artificial way of protecting oneself from [Lureplants](/wiki/Lureplants "Lureplants"). Plants like [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Saplings](/wiki/Sapling "Sapling"), [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), [Pine Cones](/wiki/Pine_Cone "Pine Cone"), and [Birchnuts](/wiki/Birchnut "Birchnut") can't be planted on these turfs, unless these were planted before the turfs were placed.

When placed on the [Surface World](/wiki/Surface_World "Surface World") in a large enough area, Crows are the only [Birds](/wiki/Birds "Birds") that will spawn and land on these turfs.

Despite being made out of wood, Wooden Flooring is not flammable when placed, meaning the player can place [Campfires](/wiki/Campfires "Campfires") and [Fire Pits](/wiki/Fire_Pits "Fire Pits") on it as normal.

In the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, this Turf will not spawn [Puddles](/wiki/Flooding "Flooding"). Expanding Puddles can still flood this Turf, however.

## Placeholder Trivia[]

* It is one of four craftable Turfs (the others being [Cobblestones](/wiki/Cobblestones "Cobblestones"), [Carpeted Flooring](/wiki/Carpeted_Flooring "Carpeted Flooring") and [Checkerboard Flooring](/wiki/Checkerboard_Flooring "Checkerboard Flooring")).
* Wooden Flooring strongly resembles the flooring in Wilson's own home as seen in *[Forbidden Knowledge](/wiki/Animated_Shorts_and_Trailers#Forbidden_Knowledge "Animated Shorts and Trailers")*.

## Blueprint Gallery[]

Wood Floor Texture.png (251 KB)

Wooden Flooring Texture.

Pig king.png (222 KB)

Pig King on some placed Wooden Flooring with an insane Wilson.
