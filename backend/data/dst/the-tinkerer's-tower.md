...
source_url: https://dontstarve.fandom.com/wiki/The_Tinkerer's_Tower
---
...
**The Tinkerer's Tower** is a naturally spawning [Pig Shop](/wiki/Pig_Shops "Pig Shops") [Structure](/wiki/Structures "Structures") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is found in the [Palace Pig City](/wiki/Pig_City "Pig City") and sells a variety of [Blueprints](/wiki/Blueprint "Blueprint") to the player, as well as various [Crafting](/wiki/Crafting "Crafting") materials. Blueprints sold in this building are only way to unlock crafting the specific items as they are not available via [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine").

If the player obtains the [Key to the City](/wiki/Key_to_the_City "Key to the City"), The Tinkerer's Tower also becomes craftable in the [City Planning Tab](/wiki/City_Planning_Tab "City Planning Tab") using two [Magnifying Glasses](/wiki/Magnifying_Glass "Magnifying Glass") and four [Pig Skins](/wiki/Pig_Skin "Pig Skin").
...
Upon entering The Tinkerer's Tower, the player will find a variety of [Items](/wiki/Items "Items") that are sold in exchange for [Oincs](/wiki/Oinc "Oinc"). A [Worker Pig](/wiki/Worker_Pig "Worker Pig") shopkeeper works at the desk.

The following items can be found on displays in the center of the shop which will be restocked by the shopkeeper:

| Item | Name | Oinc |
| --- | --- | --- |
| Blueprint (Walking Cane) | [Walking Cane](/wiki/Walking_Cane "Walking Cane") Blueprint | **500** |
| Blueprint (Eyebrella) | [Eyebrella](/wiki/Eyebrella "Eyebrella") Blueprint | **300** |
| Blueprint (Scaled Chest) | [Scaled Chest](/wiki/Scaled_Chest "Scaled Chest") Blueprint | **200** |
| Blueprint (Scalemail) | [Scalemail](/wiki/Scalemail "Scalemail") Blueprint | **200** |
| Blueprint (Weather Pain) | [Weather Pain](/wiki/Weather_Pain "Weather Pain") Blueprint | **100** |
| Blueprint (Dripple Pipes) | [Dripple Pipes](/wiki/Dripple_Pipes "Dripple Pipes") Blueprint | **100** |
| Blueprint (Insulated Pack) | [Insulated Pack](/wiki/Insulated_Pack "Insulated Pack") Blueprint | **100** |
| Blueprint (Moggles) | [Moggles](/wiki/Moggles "Moggles") Blueprint | **30** |
| Blueprint (Hibearnation Vest) | [Hibearnation Vest](/wiki/Hibearnation_Vest "Hibearnation Vest") Blueprint | **50** |
| Blueprint (Trawl Net) | [Trawl Net](/wiki/Trawl_Net "Trawl Net") Blueprint | **30** |
...
| --- | --- | --- | --- |
| Papyrus | [Papyrus](/wiki/Papyrus "Papyrus") | **1** | **1** |
| Charcoal | [Charcoal](/wiki/Charcoal "Charcoal") | **1** | **2** |
| Nitre | [Nitre](/wiki/Nitre "Nitre") | **1** | **1** |

## Placeholder Trivia[]

* The Tinkerer's Tower was added in the March 18, 2019 update.

## Blueprint Gallery[]

The Tinkerer's Tower interior.png (1.06 MB)

The interior of a The Tinkerer's Tower.
