...
source_url: https://dontstarve.fandom.com/wiki/Savanna
---
...
|  |
| --- |
| Grass TuftRabbit HoleCrowRedbird |

Occasional

|  |
| --- |
| BoulderGold VeinMini GlacierBurrowBeefaloFireflies |

Rare

|  |
| --- |
| Spider DenWalrus CampSinkholeWorm Hole |

**“**It smells like a barn.**”**

–[Maxwell](/wiki/Maxwell "Maxwell")

The **Savanna** is a [Biome](/wiki/Biome "Biome") rich with [Grass](/wiki/Grass "Grass") and [Mobs](/wiki/Mobs "Mobs"), while containing little flora. It's the only Biome where [Beefalo](/wiki/Beefalo "Beefalo") spawn, but is also home to many [Rabbits](/wiki/Rabbit "Rabbit"), [Redbirds](/wiki/Redbird "Redbird"), and [Crows](/wiki/Crow "Crow"). [Spider Dens](/wiki/Spider_Dens "Spider Dens") may also rarely appear. [Flowers](/wiki/Flower "Flower") are sometimes found, which spawn [Butterflies](/wiki/Butterfly "Butterfly").

While many [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft") grow on this terrain, [Evergreens](/wiki/Evergreens "Evergreens") don't spawn on a Savanna. However, it is possible to manually plant Trees there.

## Prototype Tips[]

* Savanna is usually a very good Biome to settle in due to the abundance of Grass, and renewable food sources, while other essential renewable resources such as [Twigs](/wiki/Twigs "Twigs") and Evergreens can be easily transplanted from other Biomes, as long as it is big enough to settle a camp in.
