...
source_url: https://dontstarve.fandom.com/wiki/Moon_Rock_Idol
---
...
**“**It looks a bit like a key, doesn't it?**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Moon Rock Idol** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It is found in the [Celestial Tab](/wiki/Celestial_Tab "Celestial Tab"), and requires a [Moon Rock](/wiki/Moon_Rock "Moon Rock") and a [Purple Gem](/wiki/Purple_Gem "Purple Gem") to be crafted.

Moon Rock Idols can be offered to the [Celestial Portal](/wiki/Celestial_Portal "Celestial Portal"), which despawns the survivor and returns the player to the [Character](/wiki/Characters "Characters") select screen. This effectively allows the player to switch characters.

Doing so will cause the player to drop their entire [Inventory](/wiki/Inventory "Inventory") at the Celestial Portal, however they retain their [Day count](/wiki/Day-Night_Cycle "Day-Night Cycle"), [Map](/wiki/Map "Map") exploration progress, any prototyped [Crafting](/wiki/Crafting "Crafting") recipes, and any adopted [Critters](/wiki/Critters "Critters"). The Moon Rock Idol is consumed in the process.

Certain characters have specific interactions when offering a Moon Rock Idol to the portal:

* Characters with [Insight](/wiki/Insight "Insight") have their skills reset and their Insight fully refunded, allowing the player to return as the same character again with different upgrades from what they had prior.
* If switching from [Woodie](/wiki/Woodie "Woodie"), [Lucy the Axe](/wiki/Lucy_the_Axe "Lucy the Axe") turns into a regular [Axe](/wiki/Axe "Axe") when returning as a different character.
* Changing from [Walter](/wiki/Walter "Walter") despawns [Woby](/wiki/Woby "Woby") without dropping her inventory, making it best to empty Woby's inventory before switching characters.
* As [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") is able to craft [Science](/wiki/Science "Science") [Items](/wiki/Items "Items") with a lower tier [Crafting Station](/wiki/Category:Crafting_Stations "Category:Crafting Stations") than other characters from the start, if the player had crafted any of those recipes, it would appear as not learned when changing from Wickerbottom to another character.

## Placeholder Trivia[]

* When it was first introduced in the [Celestial Update](/wiki/Don%27t_Starve_Together/Version_History#September_27,_2018_-_Celestial_Update "Don't Starve Together/Version History"), changing characters using a Moon Rock Idol reset the player's [Map](/wiki/Map "Map"), Day Count, and Crafting Recipes. This is no longer the case as of [update 288118](/wiki/Don%27t_Starve_Together/Version_History#October_3,_2018 "Don't Starve Together/Version History").
* The Idol glows when it's in proximity to the Celestial Portal.
* It gives off a small amount of light at night, but is not sufficient to ward off [Charlie](/wiki/Charlie "Charlie").
* When the Moon Rock Idol is offered to the Celestial Portal, the Character performs an animation similar to the one used for the [Lazy Deserter](/wiki/The_Lazy_Deserter "The Lazy Deserter").
* The unique [Character quotes](/wiki/Character_quotes "Character quotes") when offering a Moon Rock Idol seem to indicate that using the Celestial Portal is similar to the classic description of death, in which one is said to see a bright light.
* [WX-78](/wiki/WX-78 "WX-78")'s quote, "I SEE THE BLUE SCREEN!" is referencing the "[Stop Error](https://en.wikipedia.org/wiki/Blue_screen_of_death)" screen that appears when a windows computer's operation system crashes.
* [Maxwell](/wiki/Maxwell "Maxwell")'s quote, "Say pal, I don't look so good..." is an altered version of his quote at the beginning of a world in [Don't Starve.](/wiki/Don%27t_Starve "Don't Starve")
...
–[Webber](/wiki/Webber "Webber"), before vanishing.
...
[WX-78](/wiki/WX-78 "WX-78") offering a Moon Rock Idol to the Celestial Portal.

Celestial Glowing Demonstration.png (65 KB)

A Moon Rock Idol glowing in the dark.

Moon Rock Idol Glowing.png (5 KB)

A glowing Moon Rock Idol.
