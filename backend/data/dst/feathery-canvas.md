...
source_url: https://dontstarve.fandom.com/wiki/Feathery_Canvas
---
...
"A fine feathered fabric."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Malbatross Feather**×6** Silk**×1** |
...
**“**I didn't know you could make fabric out of feathers!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Fabric from feathers, what will they think of next?**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Feathery Canvas** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It is found in the [Refined Materials Filter](/wiki/Refined_Materials_Filter "Refined Materials Filter") and is prototyped at the [Think Tank](/wiki/Think_Tank "Think Tank") and Alchemy Engine. It requires six [Malbatross Feathers](/wiki/Malbatross_Feather "Malbatross Feather") and one piece of [Silk](/wiki/Silk "Silk") to craft. Four Feathery Canvases are required to craft the [Winged Sail](/wiki/Winged_Sail "Winged Sail").
...
* Feathery Canvas was introduced in the *[Salty Dog](/wiki/Return_of_Them#Salty_Dog "Return of Them")* update.
