...
source_url: https://dontstarve.fandom.com/wiki/Anchor
---
...
|  |
| --- |
| Can be placed as a [Structure](/wiki/Structure "Structure"). Can be lowered to prevent [Boats](/wiki/Boat_Kit "Boat Kit") from drifting. |
...
|  |
| --- |
| When the anchor hits the bottom of the water, it will cause drag on the boats speed usually stopping it. The deeper the water, the longer the anchor will take to hit the bottom, and longer it will be to wheel it back up. |
...
**“**I guess it might be useful... but I'd rather not to stay in one place for too long.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Anchor Kit** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It is found in the [Seafaring Filter](/wiki/Seafaring_Filter "Seafaring Filter"), requires two [Boards](/wiki/Boards "Boards"), three [Cut Stones](/wiki/Cut_Stone "Cut Stone") and three [Ropes](/wiki/Rope "Rope") to craft, and a [Think Tank](/wiki/Think_Tank "Think Tank") to prototype.

The Anchor Kit can be deployed on a [Boat](/wiki/Boat_Kit "Boat Kit"). The Anchor can then be lowered to prevent the Boat from drifting, or be raised to allow it to move again. The time it takes for the Anchor to rise depends on the depth of the Ocean: 2 seconds on [Coastal Ocean](/wiki/Ocean#Coastal_Ocean "Ocean") and [Brine Shoals](/wiki/Ocean#Brine_Shoals "Ocean"), 6 seconds on [Swell Ocean](/wiki/Ocean#Swell_Ocean "Ocean"), 8 seconds in [Rough Ocean](/wiki/Ocean#Rough_Ocean "Ocean") and 10 seconds in [Hazardous Ocean](/wiki/Ocean#Hazardous_Ocean "Ocean"). The time it takes for it to lower is a third of the raising time.
...
* The Anchor Kit was introduced in the *[Turn of Tides](/wiki/Return_of_Them#Turn_of_Tides "Return of Them")* update.
* If the Anchor is on land it clinks against the ground.

## Gallery[]

Anchor Burnt.png (14 KB)

A burnt Anchor.

Anchor Lowered Stages.png (107 KB)

The stat of a lowered anchor depends on the depth of the ocean. At the right an anchor lowered on land.
