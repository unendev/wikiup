...
source_url: https://dontstarve.fandom.com/wiki/Ancient_Key
---
...
|  |
| --- |
| Activates the [Ancient Gateway](/wiki/Ancient_Gateway "Ancient Gateway"). |
...
**“**The key to that old gateway.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Got it from that big bony hoser.**”**
...
**“**An imp could do mischievous things with this.**”**
...
**“**It's the key to this whole mystery!**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Am I sure I want to take this?**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Ancient Key** is an item exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. Its sole purpose is to activate the [Ancient Gateway](/wiki/Ancient_Gateway "Ancient Gateway") (and therefore is only used in the [Atrium Biome](/wiki/Atrium "Atrium")) by being inserted in its socket.

The Ancient Key can be obtained from a [Large Ornate Chest](/wiki/Large_Ornate_Chest "Large Ornate Chest") after killing the [Ancient Guardian](/wiki/Ancient_Guardian "Ancient Guardian"). The key cannot be transferred between cave levels, and attempting to do so will leave it by the stairs.

The position of the *Ancient Key* is revealed to players with a [Thulecite Medallion](/wiki/Thulecite_Medallion "Thulecite Medallion") in their inventory.

The Ancient Key is required to fight the [Ancient Fuelweaver](/wiki/Reanimated_Skeleton "Reanimated Skeleton").
...
–[Wilson](/wiki/Wilson "Wilson"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Fancy key.**”**

–[Willow](/wiki/Willow "Willow"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is heavy key but Wolfgang strong!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Perhaps I'll be happier in the next world.**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**PASSKEY FOR GATEWAY LINK**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Quite an elaborate key.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Looks important.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Good. I can get out of here.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'Tis the key tö anöther wörld.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I wonder where this takes us.**”**

–[Webber](/wiki/Webber "Webber"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Where's it go?**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Looks like it unlocks somethin' big.**”**

–[Winona](/wiki/Winona "Winona"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Hyuyu! Let us hop away!**”**

–[Wortox](/wiki/Wortox "Wortox"), when examining the Ancient Key in the Gorge

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Ooooh, look important!**”**

–[Wurt](/wiki/Wurt "Wurt"), when examining the Ancient Key in the Gorge

In *[The Gorge](/wiki/The_Gorge "The Gorge")* [event](/wiki/Category:Events "Category:Events"), the Ancient Key can be bought from [Mumsy](/wiki/Mumsy "Mumsy") for 3 [Gnaw's Favors](/wiki/Coin "Coin"). After it's obtained, the players can put it into the [Altar of Gnaw](/wiki/The_Altar_of_Gnaw "The Altar of Gnaw"), which reactivates the [Mossy Gateway](/wiki/Ancient_Gateway#The_Gorge "Ancient Gateway") and allows players to win the game.

## Placeholder Trivia[]

* The Ancient Key was added in the *[Hearts of the Ruins](/wiki/A_New_Reign#February_23rd,_2017_-_Heart_of_the_Ruins_(Part_1) "A New Reign")* update.
* Part of the Mossy Gateway's Ancient Key looks similar to [bloodstone](https://en.wikipedia.org/wiki/Heliotrope_(mineral) "wikipedia:Heliotrope (mineral)").
* In the lore, it's used to open the Ancient Gateway and allow access to Gate Realms, which are the settings for limited-time [Events](/wiki/Events "Events") such as *[The Forge](/wiki/The_Forge "The Forge")* and *[The Gorge](/wiki/The_Gorge "The Gorge")*.
* According to the canon, the ancient key from *[The Gorge](/wiki/The_Gorge "The Gorge")* is charged from the energy of the [Gnaw's favors](/wiki/Coin "Coin").

## Blueprint Gallery[]

Wickerbottom with Ancient Key Forge Cinematic.jpg (389 KB)

Wickerbottom with the Ancient Key as seen in the Forge cinematic.
