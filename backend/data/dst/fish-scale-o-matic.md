...
source_url: https://dontstarve.fandom.com/wiki/Fish_Scale-O-Matic
---

*Exclusive to:* Don't Starve Together

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 See also: [Weight](/wiki/Weight "Weight")*

## Fish Scale-O-Matic

Fish Scale-O-Matic

"Show off your prized catch."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Ice**×4** Boards**×2** Cut Stone**×1** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Decorations FilterFishing Filter | Alchemy Engine |

Perk

|  |
| --- |
| Expose [Weight](/wiki/Weight "Weight") of fishes. |
...
**“**I wonder how my catch of the day will measure up!**”**

–[Wilson](/wiki/Wilson "Wilson"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Who cares about weighing some dumb fish?**”**

–[Willow](/wiki/Willow "Willow"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is scale to measure mightiness of fish!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**If my fish was as heavy as my heart, I'd surely win.**”**

–[Wendy](/wiki/Wendy "Wendy"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A FRIVOLOUS DISTRACTION... I MUST WIN**”**

–[WX-78](/wiki/WX-78 "WX-78"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A place to display only the largest aquatic specimens.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Think it's time for some fishin', eh?**”**

–[Woodie](/wiki/Woodie "Woodie"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Perhaps I might reign again... as the king of fishing!**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I will stand victorious!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Woah! We should find a big fish to put in there!**”**

–[Webber](/wiki/Webber "Webber"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Perhaps I will try my luck?**”**

–[Warly](/wiki/Warly "Warly"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Glub Glub holder**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A challenge, huh?**”**

–[Winona](/wiki/Winona "Winona"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**For a fish it must be quite ideal, to be a prize and not a meal!**”**

–[Wortox](/wiki/Wortox "Wortox"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This good home for fish!**”**

–[Wurt](/wiki/Wurt "Wurt"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Just wait, that biggest fish badge will be mine!**”**

–[Walter](/wiki/Walter "Walter"), examining an empty Fish Scale-O-Matic.

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**That's quite an extravagant fishbowl.**”**

–[Wanda](/wiki/Wanda "Wanda"), examining an empty Fish Scale-O-Matic.

The **Fish Scale-O-Matic** is a craftable [Structure](/wiki/Structure "Structure") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*.

Players can submit a [Fish](/wiki/Fishes "Fishes") to the Fish Scale-O-Matic to display its [Weight](/wiki/Weight "Weight"). If the new Fish is heavier than the current Fish, the new Fish takes its place and the old one is discarded. Examining the Fish Scale-O-Matic gives the name of the player who caught the Fish.

## Placeholder Trivia[]

* The Fish Scale-O-Matic was introduced in the *[Hook, Line, and Inker](/wiki/Return_of_Them#Hook,_Line,_and_Inker "Return of Them")* update.
* The Fish Scale-O-Matic displays the fisher's name. If the fish falls from a mob or structure, it is indicated instead.

## Blueprint Gallery[]

Fish Scale-O-Matic Burnt.png (42 KB)

A burnt Fish Scale-O-Matic.
