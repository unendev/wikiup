...
source_url: https://dontstarve.fandom.com/wiki/Sign
---
...
|  |
| --- |
| Can be seen on the [Map](/wiki/Map "Map"). |
...
**“**A mark is made here, however transient...**”**
...
**“**Curious. It's somehow entangled with my map.**”**
...
**“**Must be somethin' important 'round 'ere.**”**
...
The **Sign** is a craftable [Structure](/wiki/Structure "Structure"). While it cannot be written on, it shows up as an icon on the [Map](/wiki/Map "Map"). As such, it can be used as a marker for areas of interest which do not show up on the Map (such as [Blue Mushrooms](/wiki/Blue_Mushroom "Blue Mushroom") and/or Mushroom Rings, or [Beefalo](/wiki/Beefalo "Beefalo") herds).

The Sign requires 1 set of [Boards](/wiki/Boards "Boards") to craft and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. If it is destroyed, the [Boards](/wiki/Boards "Boards") are returned, allowing the player to build a new Sign elsewhere.

## Don't Starve Together Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Signs can be written on after being placed, much like the [Directional Signs](/wiki/Directional_Sign "Directional Sign"). When writing on a sign, the dialog will give the option to cancel, generate random text, or write to the sign. The text box can also be selected and typed into. There is no restriction on who can write or what can be written on them, but they can only be written on once. When examined, the character whose player examined it will say what is written on the sign. When the sign is burnt, the character will say something about it being burnt, thus losing its written information.

## Trivia[]

* Signs were added in *[A Little Rain Must Fall](/wiki/Version_History "Version History")* update.
* Naturally occurring Signs can be found in [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode"), usually near [Maxwell's Tooth Traps](/wiki/Maxwell%27s_Tooth_Trap "Maxwell's Tooth Trap").
* One can craft Signs for free by clicking the Boards and then crafting a Sign while having the boards still selected.
* Despite [Wolfgang](/wiki/Wolfgang "Wolfgang") not being able to read, in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* he is able to do so.

## Gallery[]

Sign Burnt.png (12 KB)

Burnt Sign.

Marking the mushrooms1.png (955 KB)

A Sign marking a Mushroom ring.

Maxwell's Tooth Trap biome.png (244 KB)

Maxwell's Tooth Traps and a couple of world-spawned Signs.

Metal Potato's Setpiece.jpg (90 KB)

In *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")*, the [Relic Thing](/wiki/Relic_Thing "Relic Thing")'s [Set Piece](/wiki/Set_Piece "Set Piece") contains a Sign.

Old Sign Icon.png (3 KB)

Old Crafting Menu Sign Icon
