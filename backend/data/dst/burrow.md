...
source_url: https://dontstarve.fandom.com/wiki/Burrow
---
...
Rocks 53.3%, Flint 20%, Nitre 20%, Gold Nugget 6.6%, Anything taken by Moleworms
...
**“**I thought they were bigger... my memory must've exaggerated it.**”**

–[Wanda](/wiki/Wanda "Wanda")

A **Burrow** is a [naturally occurring object](/wiki/Category:Naturally_Spawning_Objects "Category:Naturally Spawning Objects") from the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC that randomly spawns in [Grassland](/wiki/Grassland "Grassland") [Biomes](/wiki/Biome "Biome"). [Moleworms](/wiki/Moleworm "Moleworm") will spawn at [Dusk](/wiki/Dusk "Dusk") and [Night](/wiki/Night "Night") from Burrows and start roaming around the area, looking for minerals and other ground-based [items](/wiki/Item "Item") to store inside the Burrows.

Burrows can be dug up with a [Shovel](/wiki/Shovel "Shovel") to randomly yield [Rocks](/wiki/Rocks "Rocks"), [Flint](/wiki/Flint "Flint"), [Nitre](/wiki/Nitre "Nitre"), and [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget"). When dug, Burrows will also drop any item stolen by Moleworms. Burrows can store up to 50 inventory slots; any extra items that moleworm attempt to store, but cannot do so due to filled inventory, will pop out.

If a Burrow is dug up, the Moleworm that inhabited it will make a new one after some time. This makes Burrows renewable as long as the Moleworm is not also killed.

If a Moleworm is killed, the Burrow will spawn a new Moleworm after 2.5 [Days](/wiki/Day "Day"), in the same way [Rabbit Holes](/wiki/Rabbit_Hole "Rabbit Hole") spawn [Rabbits](/wiki/Rabbit "Rabbit"). However, it is worth noting that even if all of the Moleworms and Burrows in a world are killed or destroyed, respectively, they are still renewable through both [Catcoons](/wiki/Catcoon "Catcoon"), [Tumbleweeds](/wiki/Tumbleweed "Tumbleweed") and [Earthquake](/wiki/Earthquake "Earthquake").

Because Burrows drop minerals and Moleworms can create new Burrows, this makes Rocks, Flint, Nitre, and Gold renewable.

If a Moleworm is taken and dropped down in the [Caves](/wiki/Caves "Caves"), it will create a new Burrow down there. Additionally, if so taken without destroying its original Burrow, that Burrow will eventually spawn a new Moleworm in the surface. Burrows are thus not only renewable, but able to be actively expanded by player action into Moleworm farms.
