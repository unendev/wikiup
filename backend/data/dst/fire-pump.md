...
source_url: https://dontstarve.fandom.com/wiki/Fire_Pump
---
...
|  |
| --- |
| Can be placed as a [Structure](/wiki/Structure "Structure"). Extinguish fire. |

[Code](/wiki/Console "Console")

|  |
| --- |
| `"waterpump_item" "waterpump"` |
...
The **Fire Pump** is a craftable [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It is found in the [Seafaring Filter](/wiki/Seafaring_Filter "Seafaring Filter") and requires 2 [Boards](/wiki/Boards "Boards") and 1 [Spittlefish](/wiki/Spittlefish "Spittlefish") to craft and a [Think Tank](/wiki/Think_Tank "Think Tank") to prototype.

The Fire Pump item can be deployed on a [Boat](/wiki/Boat_Kit "Boat Kit"). When operated by a player, it spreads water bubbles within a radius of 7.5 to extinguish [Fires](/wiki/Fire "Fire") and smoldering objects. However, it must be aimed below the sea to properly use it. If the Fire Pump is on land it will not spread any water bubbles.

## Trivia[]

* The Fire Pump was introduced in the *[Troubled Waters](/wiki/Return_of_Them#Troubled_Waters "Return of Them")* update.
* Both Maxwell and Winona's quote, as well as Wilson's quote for the [Spittlefish](/wiki/Ocean_Fishes#Spittlefish "Ocean Fishes"), seem to imply that Wilson is the one who invented the Fire Pump.

## Gallery[]

Fire Pump Animation.gif (583 KB)

Animation of the Fire Pump working.

Fire Pump Burnt.png (11 KB)

A burnt Fire Pump.

RWP 278 Fire Pump Concept Art.gif (758 KB)

Fire pump concept art from *Rhymes With Play* #278.

RWP 278 Fire Pump Concept Art.png (149 KB)
