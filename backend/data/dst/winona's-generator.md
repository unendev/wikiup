...
source_url: https://dontstarve.fandom.com/wiki/Winona's_Generator
---

*Exclusive to:* Don't Starve Together

*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 See also: [Winona's G.E.M.erator](/wiki/Winona%27s_G.E.M.erator "Winona's G.E.M.erator")*
...
"Someone's gotta keep the juice flowing."
...
| --- |
| Trusty Tape**×1** Log**×2** Nitre**×2** (only craftable by link=Winona/Don't Starve Together}}) |

| [Filter](/wiki/Filters "Filters") | [Skill Required](/wiki/Skill "Skill") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| Structures FilterWinona Filter | Portability (for crafting as an item) | Always available (for crafting as an structure) |
...
**“**Hyuyu. Mortals don't know magic.**”**
...
**Winona's Generator** is a [character](/wiki/Character "Character")-exclusive [structure](/wiki/Structure "Structure")/[item](/wiki/Item "Item") craftable only by [Winona](/wiki/Winona "Winona") in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It is found in the [Structures Filter](/wiki/Structures_Filter "Structures Filter") and [Survivor Items Filter](/wiki/Survivor_Items_Filter "Survivor Items Filter") and requires 1 [Trusty Tape](/wiki/Trusty_Tape "Trusty Tape"), 2 [Logs](/wiki/Log "Log"), and 2 [Nitre](/wiki/Nitre "Nitre") to craft. If Winona has mastered the [Portability](/wiki/Portability "Portability") skill, she can craft the Generator as an [item](/wiki/Item "Item") and dismantling already built Generators.

## Contents

* [1 Usage](#Usage)
* [2 Skill Upgrades](#Skill_Upgrades)
* [3 Trivia](#Trivia)
* [4 Gallery](#Gallery)

## Usage[]

Generators are used to power nearby [Catapults](/wiki/Winona%27s_Catapult "Winona's Catapult"), [Spotlights](/wiki/Winona%27s_Spotlight "Winona's Spotlight"), and [Teletransport Stations](/wiki/Teletransport_Station "Teletransport Station"). They can also recharge dropped [Handy Remotes](/wiki/Handy_Remote "Handy Remote"), [Portasols](/wiki/Portasol "Portasol"), and [W.I.N.bots](/wiki/W.I.N.bot "W.I.N.bot").

A full Generator has a charge of 480 (1 day). Each connected structure drains 1 charge per second. If a structure is connected to multiple Generators the drain is divided by the number of connected Generator. A Generator has a minimal drain of 0.075 charge per second. When a Generator is placed by a Winona with the [Energy Saver](/wiki/Energy_Saver "Energy Saver") skill, Winona's structures will not drain power when they are in sleep mode. Dismantling the Generator with the Portability skill will completely pause the energy drain until the Generator is deployed again.

A Generator can be refueled with [Nitre](/wiki/Nitre "Nitre") for 50% full charge per Nitre. Winona with the mastered [Nightmare Generator](/wiki/Nightmare_Generator "Nightmare Generator") or [Pure Horror Generator](/wiki/Pure_Horror_Generator "Pure Horror Generator") skill can also refuel it with one [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel") or [Pure Horror](/wiki/Pure_Horror "Pure Horror") to fully charge it.

## Insight Skill Upgrades[]

Generators can receive different upgrades depending on the skills Winona has mastered:

| Skill | Effect |
| --- | --- |
| Portability [Portability](/wiki/Portability "Portability") | With this skill, Winona can dismantle all her Generators to an item and also craft them as an item. |
| Energy-Saver [Energy-Saver](/wiki/Energy-Saver "Energy-Saver") | Gadgets placed by a Winona with this skill will no longer use energy from Generators while they are in sleep mode. |
| Greater Generator I [Greater Generator I](/wiki/Greater_Generator_I "Greater Generator I") | Generators placed by a Winona with this skill will boost their efficiency by 25%. |
| Greater Generator II [Greater Generator II](/wiki/Greater_Generator_II "Greater Generator II") | Generators placed by a Winona with this skill will boost their efficiency by 50%. |
| Greater Generator III [Greater Generator III](/wiki/Greater_Generator_III "Greater Generator III") | Generators placed by a Winona with this skill will boost their efficiency by 100%. |
| Nightmare Generator [Nightmare Generator](/wiki/Nightmare_Generator "Nightmare Generator") | Winona with this skill can fuel Generators with [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"). |
| Pure Horror Generator [Pure Horror Generator](/wiki/Pure_Horror_Generator "Pure Horror Generator") | Winona with this skill can fuel Generators with [Pure Horror](/wiki/Pure_Horror "Pure Horror"). Catapults in the range of such a Generator will deal 30 physical damage and 17 planar damage, and also +10% damage to [Lunar Aligned](/wiki/Lunar_Aligned "Lunar Aligned") creatures. |

## Trivia[]

* Winona's Generator, alongside her other gadgets and the Engineering Tab, was introduced in her [Character Update](/wiki/Don%27t_Starve_Together/Version_History#March_7th,_2019_-_Winona_Character_Update "Don't Starve Together/Version History") as part of the character overhaul for *Don't Starve Together*.
  + With the *[Skill Spotlight: Wurt & Winona](/wiki/Skill_Spotlight_Update#Wurt_and_Winona "Skill Spotlight Update")* update, build Generators can be dismantled into an item and also be crafted as an item, making them portable (only, if Winona has mastered the Portability skill). Also, some generator-related skills were added.
* In **Rhymes With Play** 228 was showed the concept of a potato battery, but the game itself didn't have a potato at the time.

## Gallery[]

Generator Ingame.png (126 KB)

Winona's Generator ingame.

Generator Burned.png (124 KB)

A burned Generator.

Winona's Generator Place.gif (3.49 MB)

Winona's Generator's placing animation.
