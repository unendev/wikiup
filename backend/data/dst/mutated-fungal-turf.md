...
source_url: https://dontstarve.fandom.com/wiki/Mutated_Fungal_Turf
---
...
"The mutated fungal floor of a cave."

Crafting

| [Recipe](/wiki/Crafting "Crafting") | Amount produced |
| --- | --- |
| Moon Rock**×1** Moon Shroom**×2** | 4 |
...
[Lunar Grotto](/wiki/Lunar_Grotto "Lunar Grotto") tiles (Pitchfork)
...
**Mutated Fungal Turf** is a [Turf](/wiki/Turf "Turf") [Item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It can be found in the [Lunar Grotto](/wiki/Lunar_Grotto "Lunar Grotto") biome. It can be crafted with 1 [Moon Rock](/wiki/Moon_Rock "Moon Rock") and 2 [Moon Shrooms](/wiki/Moon_Shroom "Moon Shroom"), however doing so requires that the player be near the [Celestial Altar](/wiki/Celestial_Altar "Celestial Altar").

Eyeplants cannot spawn on this turf; plants like [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Saplings](/wiki/Sapling "Sapling"), [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), [Pine Cones](/wiki/Pine_Cone "Pine Cone"), and [Birchnuts](/wiki/Birchnut "Birchnut") can be planted on mutated fungal turf.

## PlaceholderTrivia[]

* The Mutated Fungal Turf was introduced in the *[Forgotten Knowledge](/wiki/Return_of_Them#Forgotten_Knowledge "Return of Them")* update.

## Blueprint Gallery[]

Mutated Fungal Turf Texture.png (445 KB)

Mutated Fungal Turf texture.
