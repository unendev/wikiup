...
source_url: https://dontstarve.fandom.com/wiki/Pig_Traders/Collector
---
...
Gives 3× Oinc for StingerSilkMosquito SackChitinFlytrap StalkVenom GlandSpider GlandLotus FlowerPlatapine QuillGravedigger Items).
...
'The Sty' Oddities Emporium, Town House
...
**“**I do wish to chat with him about the history of this area.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Thöst wönders are nöught compared to Valhalla!**”**
...
**“**Whoa, you got some cool stuff in here.**”**
...
**“**Ye be full o' strange treasures!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**HE HATH THE WEIRD STUFF**”**
...
**“**Someone who appreciates the junk I find on my adventures.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Collector** is a [Pig Trader](/wiki/Pig_Traders "Pig Traders") [Mob](/wiki/Mob "Mob") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. He is a pig in a trench coat who buys various animal loot and trinkets for three [Oincs](/wiki/Oinc "Oinc"). There is no limit to the amount trades done in a day.

## Brain Behavior[]

One Collector may spawn from a [Town House](/wiki/Town_House "Town House"), and will wander randomly around their house and eat any edible items left on the ground, including [Pig Skin](/wiki/Pig_Skin "Pig Skin"). Every so often they will drop one Manure where they are standing, and if the player picks up that manure the Collector will approach them and give them one Oinc, along with an accompanying Quote.
