...
source_url: https://dontstarve.fandom.com/wiki/Visor
---
...
| --- |
| Spectoggles**×1** Cut Stone**×1 (Wagstaff)** |
...
|  |
| --- |
| Removes blurriness. Wagstaff Portrait  Absorbs 85% of physical damage. Prevents slowdown from [Heavy Fog](/wiki/Heavy_Fog "Heavy Fog") when body slot items equipped. Hamlet icon |
...
–[Wilson](/wiki/Wilson "Wilson"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**How am I supposed to see what I want to burn?**”**

–[Willow](/wiki/Willow "Willow"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is mighty hat of not seeing.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Everything comes at a price.**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**HEAD PROTECTION AT THE EXPENSE OF VISUAL PERFORMANCE**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Head protection at the expense of periphery vision.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Not really that great for seeing.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**You're going to need that kind of armor if you can't see where you're going.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I designed it so I can study sound reverberations while I'm engaged in combat.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A helm öf bleary sight.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It sounds all echo-ey in there.**”**

–[Webber](/wiki/Webber "Webber"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I guess it's good for banging your head against the wall.**”**

–[Walani](/wiki/Walani "Walani"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Perfect for running around blindly on a battlefield.**”**

–[Warly](/wiki/Warly "Warly"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**T'be like starin' out a port'ole.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**PROTECTETH WILBA HEAD BUT NAUGHT HER EYES**”**

–[Wilba](/wiki/Wilba "Wilba"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Clink eye thing**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining the Visor

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Great armor. Horrible goggles.**”**

–[Wheeler](/wiki/Wheeler "Wheeler"), when examining the Visor

The **Visor** is a [Character](/wiki/Characters "Characters")-specific [Head](/wiki/Category:Hats "Category:Hats") [Armor](/wiki/Armor "Armor") that can only be crafted by [Wagstaff](/wiki/Wagstaff "Wagstaff"). It is found in the [Tinkering Tab](/wiki/Tinkering_Tab "Tinkering Tab"), and requires [Spectoggles](/wiki/Spectoggles "Spectoggles") and [Cut Stone](/wiki/Cut_Stone "Cut Stone") to craft.

The Visor has a [Durability](/wiki/Durability "Durability") of 600 and absorbs 85% of physical damage. They also reduce vision to a smaller rectangle, but for Wagstaff they remove blurriness. For other characters beside Wagstaff, their vision will be compromised by both the rectangle and blurriness, but they can still benefit from the damage absorption. They can be given to a [Pig](/wiki/Pig "Pig") or [Bunnyman](/wiki/Bunnyman "Bunnyman") to wear, which will provide them with the damage absorption effect.

Since Visor's durability only decreases when taking damage, it can be used to negate Wagstaffs blurry view as long as the player avoids taking damage while wearing it.
