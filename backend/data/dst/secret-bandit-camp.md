...
source_url: https://dontstarve.fandom.com/wiki/Secret_Bandit_Camp
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Secret_Bandit_Camp?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
The **Secret Bandit Camp** is an object exclusive to [*Don't Starve: Hamlet*](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet") DLC, which spawns after reading the [Bandit Stash Map](/wiki/Bandit_Stash_Map "Bandit Stash Map"), obtainable by killing a [Masked Pig](/wiki/Masked_Pig "Masked Pig").

After reading the Bandit Stash Map, the player's world map will open and reveal a red mark quite similar to those from *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")*, somewhere near the player (in a specific range).

The camp can be dug with a [Shovel](/wiki/Shovel "Shovel") to spawn a [Chest](/wiki/Chest "Chest") and two [Peagawk Plumes](/wiki/Peagawk_Plume "Peagawk Plume"). If the player opens the chest, they will find rare/valuable items, such as long conservation [food](/wiki/Food "Food"), [Gold](/wiki/Gold_Nugget "Gold Nugget"), [Armor](/wiki/Armor "Armor"), and [Oincs](/wiki/Oinc "Oinc"). The chest will always contain one of 6 combination of items.

## Chest Possible items combinations[]

| Chance | Contents |
| --- | --- |
| 31% | Jerky×2 Oinc×2 Tenpiece Oinc×1 Tuna Can×4 |
| 19% | Jerky×2 Oinc×5 Gold Nugget×4 Alloy×1 |
| 19% | Jerky×1 Oinc×5 Spyglass×1 Old Boot×1 Sewing Kit×1 |
| 13% | Jerky×2 Oincx15 Tenpiece Oincx1 Drumstick x2 |
| 13% | Tin Suit×1 Oinc×15 Fancy Helmet×1 Halberd×1 |
| 6% | Monster Meat×1 Oinc×15 Tenpiece Oinc×2 Tuna Can×1 Drumstick×2 |
...
Bandit Stash Map Range.jpg (95 KB)
