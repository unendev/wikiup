...
source_url: https://dontstarve.fandom.com/wiki/Sea_Chest
---
...
**“**Buoyant storage! This will revolutionize sea-going affairs!**”**
...
**“**Now I don't need to swim back to shore for my stuff.**”**
...
**“**Woodlegs' treasure, buried at sea!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA STUFFS CONTAINETH WITHIN**”**
...
The **Sea Chest** is a craftable [Structure](/wiki/Structure "Structure") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is found in the [Structures Tab](/wiki/Structures_Tab "Structures Tab"), requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype, and 4 [Boards](/wiki/Boards "Boards") and 1 [Tar](/wiki/Tar "Tar") to craft. It works similar to a regular [Chest](/wiki/Chest "Chest"), but can only be placed on the [Ocean](/wiki/Ocean "Ocean").

Because [Krampus](/wiki/Krampus "Krampus") cannot spawn in the sea, he cannot break or steal items from Sea Chests.

## Placeholder Trivia[]

* The Sea Chest was added to *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.
* The Sea Chest shares its appearance with the [Octopus Chest](/wiki/Octopus_Chest "Octopus Chest").
