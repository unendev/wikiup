...
source_url: https://dontstarve.fandom.com/wiki/Lucky_Hat
---
...
| --- |
| Bone Shards**×4** Cloth**×3** Dubloons**×10** |
...
|  |
| --- |
| Periodically creates a new [X Marks the Spot](/wiki/X_Marks_the_Spot "X Marks the Spot") |
...
**“**Incredible. It increases the probability of finding treasure!**”**
...
**“**Does it make me look piratical?**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Lucky Hat** is a craftable [item](/wiki/Item "Item") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked") DLC*, exclusive to [Woodlegs](/wiki/Woodlegs "Woodlegs"). It can be found in the [Nautical Tab](/wiki/Nautical_Tab "Nautical Tab") and requires 4 [Bone Shards](/wiki/Bone_Shards "Bone Shards"), 3 [Cloth](/wiki/Cloth "Cloth") and 10 [Dubloons](/wiki/Dubloons "Dubloons") to be crafted. While equipped, it will reveal a new [X Marks the Spot](/wiki/X_Marks_the_Spot "X Marks the Spot") treasure every 800 seconds (slightly more than 1 Day and a half).

This is based on the changes to the durability, so removing and re-equipping the hat will not reduce or increase this time. If worn by a non player character, such as a [Wildbore](/wiki/Wildbore "Wildbore") or a [Prime Ape](/wiki/Prime_Ape "Prime Ape"), it only has a 66% chance to spawn a treasure. [Sewing Kits](/wiki/Sewing_Kit "Sewing Kit") repair its durability by 50%.

## Mosquito Bugs[]

* Since the spawning of [X Marks the Spot](/wiki/X_Marks_the_Spot "X Marks the Spot") treasure depends on the hat's durability, this mechanic doesn't mix well with the [Sewing Kit](/wiki/Sewing_Kit "Sewing Kit")'s durability restoration: the hat may create a treasure instantly upon being repaired by it, even after just having created another treasure.

## Blueprint Gallery[]

Lucky Hat Woodlegs.png (239 KB)

Woodlegs wearing the Lucky Hat.
