...
source_url: https://dontstarve.fandom.com/wiki/Rockyland
---
...
|  |
| --- |
| BoulderGold VeinRocksFlintCrow |

Occasional

|  |
| --- |
| Mini GlacierGold NuggetSpider DenTallbird NestBuzzard  (BoulderGrass GekkoDon't Starve Together icon) |

Rare

|  |
| --- |
| SinkholeWorm HoleWalrus Camp  (BoulderDon't Starve Together icon) |

**“**Rocks will be ours!**”**

–[Webber](/wiki/Webber "Webber")

**Rockyland** is one of the [Biomes](/wiki/Biome "Biome") in the game.

Rockylands tend to have few things growing on them, although the occasional Evergreen [Tree](/wiki/Tree "Tree"), [Sapling](/wiki/Sapling "Sapling"), or [Grass Tuft](/wiki/Grass_Tuft "Grass Tuft") may sneak in on the edge. [Redbirds](/wiki/Redbird "Redbird") and [Snowbirds](/wiki/Snowbird "Snowbird") do not spawn here, only [Crows](/wiki/Crow "Crow").

This is one of the native habitats of [Tallbirds](/wiki/Tallbird "Tallbird") and their [Nests](/wiki/Tallbird_Nest "Tallbird Nest"). In addition, [Boulders](/wiki/Boulder "Boulder") and [Mini Glaciers](/wiki/Mini_Glacier "Mini Glacier") are plentiful and the ground is covered with a combination of [Rocky Turf](/wiki/Rocky_Turf "Rocky Turf") and barren turf.

Rarely, there is a branch of this biome which is infested with [Spider Dens](/wiki/Spider_Den "Spider Den") packed together, making travel quite dangerous. [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget") may also be found on the ground in this biome branch.

[Berry Bushes](/wiki/Berry_Bush "Berry Bush"), [Saplings](/wiki/Sapling "Sapling"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush") and [Evergreens](/wiki/Evergreen "Evergreen") cannot be planted on Rocky Turf. It must first be removed with a [Pitchfork](/wiki/Pitchfork "Pitchfork") in order to plant. This turf can be combined with 1 [Boards](/wiki/Boards "Boards") to produce [Cobblestones](/wiki/Cobblestones "Cobblestones"), which are placeable [Roads](/wiki/Road "Road").

## Don't Starve Together icon Don't Starve Together[]

In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, [Grass Gekkos](/wiki/Grass_Gekko "Grass Gekko") may spawn in groups in the Rockyland.

## Blueprint Gallery[]

Rockyland terrain.png (638 KB)

Rockyland terrain.

Rockyland Tree.png (206 KB)

A Tree that spawned in Rockyland.

Rocky Map.png (414 KB)
