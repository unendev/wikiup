...
source_url: https://dontstarve.fandom.com/wiki/Petrified_Tree
---
...
Pickaxe Opulent Pickaxe Pick/Axe
...
**“**Fweeheehee! A stone cold tree!**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Rock shaped like tree?**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**What could've turned it to stone?**”**
...
**Petrified Trees** are a variant of [Trees](/wiki/Trees "Trees") found in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. They yield [Rocks](/wiki/Rocks "Rocks"), [Flint](/wiki/Flint "Flint"), or [Nitre](/wiki/Nitre "Nitre") when mined with a [Pickaxe](/wiki/Pickaxe "Pickaxe"), and therefore are alternatives to [Boulders](/wiki/Boulder "Boulder") to obtain these resources.

Petrification process happens to all stages of [Evergreens](/wiki/Tree/Evergreen "Tree/Evergreen"), and each Petrified Tree will yield resources based on its size. A default world can start with them in the place of [boulders](/wiki/Boulders "Boulders") or some of the evergreens in the world will get petrified after a random amount of time. In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* the first petrification takes place between the 44th and 65th day, the following ones take place every 21 to 32 days.

When petrification starts, the [Characters](/wiki/Characters "Characters") will note a noise coming from the trees nearby (provided they are close enough to the area about to be petrified), and shortly after, all the trees in the area will become petrified.

After petrification, trees can no longer be chopped down with an [Axe](/wiki/Axe "Axe"), but can be mined with a [Pickaxe](/wiki/Pickaxe "Pickaxe") instead. Petrified Trees do not grow, so they will stay in the same stage of growth when they had been transformed.

The following table displays the drops from all sizes of Petrified Evergreens.

| Short | Normal | Tall | Old |
| --- | --- | --- | --- |
| https://static.wikia.nocookie.net/dont-starve-game/images/3/3d/Petrified Tree Short.png/revision/latest?cb=20160726215733 | https://static.wikia.nocookie.net/dont-starve-game/images/d/da/Petrified Tree Medium.png/revision/latest?cb=20160519233853 | https://static.wikia.nocookie.net/dont-starve-game/images/f/f3/Petrified Tree.png/revision/latest?cb=20160425180840 | https://static.wikia.nocookie.net/dont-starve-game/images/6/65/Old Petrified Tree.png/revision/latest?cb=20160726215903 |
| * Rocks×1.35 (1 + 35% to get 1 extra) * Flint×0.25 (25% to get 1) * Nitre×0.25 (25% to get 1) | * Rocks×1.75 (1 + 75% to get 1 extra) * Flint×0.25 (25% to get 1) * Nitre×0.40 (40% to get 1) | * Rocks×2.35 (2 + 35% to get 1 extra) * Flint×0.75 (75% to get 1) * Nitre×0.65 (65% to get 1) | * Rocks×1.00 (25% to get 0, 50% to get 1, 25% to get 2) * Flint×0.75 (75% to get 1) * Nitre×0.25 (25% to get 1) |
| DebugSpawn "rock\_petrified\_tree\_short" | DebugSpawn "rock\_petrified\_tree" | DebugSpawn "rock\_petrified\_tree\_tall" | DebugSpawn "rock\_petrified\_tree\_old" |

## Placeholder Trivia[]

* Petrified Trees are considered to be part of *[A New Reign](/wiki/A_New_Reign "A New Reign")*, even though they were introduced before the official start of the beta branch.
* In real life, petrification of trees occurs when a tree gets submerged in mineral-rich water. As the tree rots away, most of the minerals are left behind still in a tree shape. The original wood doesn't become stone, rather, it is replaced.
...
* If the player(s) aren't careful, wood may become very scarce or even go extinct due to this mechanic.
  + However, due to the [Regrowth](/wiki/Regrowth "Regrowth") mechanic, trees will be able to come back from being extinct. Still, it will take at least 50 days for trees to come back, thus making it ideal that the player(s) keep a few pinecones around for emergencies.

## Blueprint Gallery[]

Petrified Stages of Growth.png (87 KB)

Stages of Growth.

Ds1.png (1.38 MB)

A group of Petrified Evergreens.

Nonpetrifiednormal.jpeg (56 KB)

A [Totally Normal Tree](/wiki/Totally_Normal_Tree "Totally Normal Tree") surrounded by Petrified Evergreens.
