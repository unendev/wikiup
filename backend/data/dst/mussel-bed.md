...
source_url: https://dontstarve.fandom.com/wiki/Mussel_Bed
---
...
**“**What fantastic creatures lurk in its depths?**”**
...
**“**What are they doing way down there?**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Mussels** are naturally spawning objects introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. They appear as clusters of three oval shadows in the [Shallow Ocean](/wiki/Ocean#Shipwrecked "Ocean") that the player can move towards in a [Boat](/wiki/Boats "Boats"). In order to harvest them, the player can craft a [Mussel Stick](/wiki/Mussel_Stick "Mussel Stick") and wait a minimum of one day, then the Mussel Stick will be coated in Mussels. When harvested, this results in one, three, or six Mussels, depending on how long the player left the stick in the Mussel Bed. The Mussel Bed and stick are consumed by this.

Alternatively, the player can sail over the Mussel Bed using a [Trawl Net](/wiki/Trawl_Net "Trawl Net") attached to the boat. This will consume the Mussel Bed and place 1 Mussel in the Trawl Net.
...
"Relocate your favorite mollusc."
...
**“**Theoretically, I can farm my own bivalve molluscs here.**”**
...
**“**INSHELL'D MEAT SLEEPETH YONDER**”**
...
**“**Not much use out of the water.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Mussel Bed** is a craftable [Item](/wiki/Item "Item") introduced in the *Shipwrecked* DLC. It is found in the [Food Tab](/wiki/Food_Tab "Food Tab"), requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype, and a [Mussel](/wiki/Mussel "Mussel") and a [Coral](/wiki/Coral "Coral") to craft. It allows the player to plant new Mussel Beds in the [Shallow Ocean](/wiki/Ocean#Shipwrecked "Ocean").

## Placeholder Trivia[]

* The ability to plant new Mussel Beds was added to the *Shipwrecked* DLC more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21st,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.
* As of the *[Hang Ten!](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* update, Mussels attached to a Mussel Stick do not perish. The player can use this to their advantage, saving Mussels in the event of food shortages.

## Blueprint Gallery[]

Mussel Farm underwater.png (32 KB)

A Mussel Bed found in the Shallow Ocean.
