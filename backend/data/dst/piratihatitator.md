...
source_url: https://dontstarve.fandom.com/wiki/Piratihatitator
---
...
**“**A BAD GATEWAY TO UN-SCIENTIFIC EXPERIMENTATION**”**

–[WX-78](/wiki/WX-78 "WX-78")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's a research machine, fueled by the nautical sciences.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**That's a funny lookin' contraption.**”**
...
**“**The schematics in this machine could revolutionize the world!**”**
...
**“**With this pirate hat we'll harness dark, cursed stuff.**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It holds many sea-crets.**”**
...
**“**Makes the Yo Ho magic**”**

–[Wormwood](/wiki/Wormwood "Wormwood")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It pillages the magical knowledge.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Piratihatitator** is the replacement for the [Prestihatitator](/wiki/Prestihatitator "Prestihatitator") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. The Piratihatitator requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype, and costs 1 [Parrot](/wiki/Parrot "Parrot"), 4 [Boards](/wiki/Boards "Boards"), and 1 [Pirate Hat](/wiki/Pirate_Hat "Pirate Hat") to craft.

Using the Piratihatitator to prototype an item has a 10% chance to spawn a [Parrot Pirate](/wiki/Parrot_Pirate "Parrot Pirate") and a [Dubloon](/wiki/Dubloons "Dubloons").

## Prototype Tips[]

* The Piratihatitator can be destroyed when the player has a [Shadow Manipulator](/wiki/Shadow_Manipulator "Shadow Manipulator") available for placement to save resources used to build it.

## Placeholder Trivia[]

* The Piratihatitator shares its burnt model with the Prestihatitator.

## Blueprint Gallery[]

Burnt Prestihatitator.png (57 KB)

A burnt Piratihatitator.
