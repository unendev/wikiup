...
source_url: https://dontstarve.fandom.com/wiki/Basalt
---
...
**“**I made a rock so heavy that even I cannot lift it.**”**

–[Maxwell](/wiki/Maxwell "Maxwell")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Immutable. It mocks my curiosity!**”**
...
**“**It's stronger than my will to break it.**”**
...
**“**Big, big rock, for sure, for sure.**”**
...
**“**I don't think we'll be able to break through that.**”**

–[Walter](/wiki/Walter "Walter")

**Basalts** are large rocks which can't be moved or destroyed. They occur frequently in later worlds of [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode") or sometimes as part of a [Set Piece](/wiki/Set_Piece "Set Piece") in [Sandbox Mode](/wiki/Sandbox_Mode "Sandbox Mode"), and can come in the form of a pillar.

Basalt was added as a placeholder for [Sinkholes](/wiki/Sinkhole "Sinkhole"). Upon the release of the *[Underground](/wiki/Version_History#May_21,_2013_-_Underground.5B1.5D "Version History")* update, all Basalt in [Sandbox Mode](/wiki/Sandbox_Mode "Sandbox Mode") were to be replaced by Plugged Sinkholes.

Apart from decoration or forming an indestructible blockade (similar to the [Tree Clump](/wiki/Tree_Clump "Tree Clump")) it serves no other purpose.

## Prototype Tips[]

* Players can use the Imprisoned Pig Set Piece in which Basalt spawns to trap any kind of mob, even giants in *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")*, and hold them prisoner there without fearing their escape. An easy way to trap them is craft a [Telelocator Focus](/wiki/Telelocator_Focus "Telelocator Focus") inside the "prison" and then use the [Telelocator Staff](/wiki/Telelocator_Staff "Telelocator Staff") on the desired mob. But using the staff near the trap is not advised, because the sanity drain would lower the obelisks, thus allowing the creature to escape.
  + A good use of this would be trapping a [Varg](/wiki/Varg "Varg") and farm the [Hounds](/wiki/Hounds "Hounds") it spawns periodically.

## Placeholder Trivia[]

* Maxwell's quote upon examining Basalt is a direct reference to the [Omnipotence Paradox](https://en.wikipedia.org/wiki/Omnipotence_Paradox "wikipedia:Omnipotence Paradox").

## Blueprint Gallery[]

Basalt Pillar.png (43 KB)

Basalt Pillar.

Basalt Map Icon.png (20 KB)

Basalt and Basalt Pillar on the map.

Pig Cage Set Piece.jpg (74 KB)

Basalt and [Obelisks](/wiki/Obelisk "Obelisk") found surrounding a Pig House in a Set Piece.
