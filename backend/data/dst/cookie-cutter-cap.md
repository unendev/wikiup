...
source_url: https://dontstarve.fandom.com/wiki/Cookie_Cutter_Cap
---
...
"One must always be sharply dressed."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Cookie Cutter Shell**×4** Rope**×1** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Armour Filter Rain Gear Filter | Alchemy Engine |
...
525hp   
725[true hp](/wiki/Armor/DST#True_durability "Armor/DST")
...
**“**With this spiny gear, I've nothing to fear!**”**
...
**“**It's a shellmet! Because it's a helmet, but a shell-- you get it.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**If you step back a good ways and squint, it almost looks fashionable.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Cookie Cutter Cap** is wearable [Armor](/wiki/Armor "Armor") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. It is crafted in the Fight tab. It requires 4 [Cookie Cutter Shell](/wiki/Cookie_Cutter_Shell "Cookie Cutter Shell") and one [Rope](/wiki/Rope "Rope").

It has a Durability of 525 and absorbs 70% of physical damage, as well as granting 35% resistance to [Wetness](/wiki/Wetness "Wetness"), the highest of any protective headgear. Not considering its durability, the Cookie Cutter Cap effectively adds 350 hp to the average survivor.

The Cookie Cutter Cap can be given to a [Pig](/wiki/Pig "Pig") or [Bunnyman](/wiki/Bunnyman "Bunnyman") to wear, which will provide them with the damage absorption effect.

## Placeholder Trivia[]

* The Cookie Cutter Cap was introduced in the *[Salty Dog](/wiki/Return_of_Them#Version_History "Return of Them")* update.

## Blueprint Gallery[]

* Cookie Cutter Cap Wilson.png

  [Wilson](/wiki/Wilson "Wilson") wearing a Cookie Cutter Cap.
* Cookie Cutter Cap Willow.png

  [Willow](/wiki/Willow "Willow") wearing a Cookie Cutter Cap.
* Cookie Cutter Cap Wolfgang.png

  [Wolfgang](/wiki/Wolfgang "Wolfgang") wearing the Cookie Cutter Cap.
* Cookie Cutter Cap Wendy.png

  [Wendy](/wiki/Wendy "Wendy") wearing a Cookie Cutter Cap.
* Cookie Cutter Cap WX-78.png

  [WX-78](/wiki/WX-78 "WX-78") wearing a Cookie Cutter Cap.
* Cookie Cutter Cap Wickerbottom.png

  [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing a Cookie Cutter Cap.
* Cookie Cutter Cap Woodie.png

  [Woodie](/wiki/Woodie "Woodie") wearing a Cookie Cutter Cap.
* Cookie Cutter Cap Wes.png

  [Wes](/wiki/Wes "Wes") wearing a Cookie Cutter Cap.
* Cookie Cutter Cap Maxwell.png

  [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing a Cookie Cutter Cap.
* Cookie Cutter Cap Wigfrid.png

  [Wigfrid](/wiki/Wigfrid "Wigfrid") wearing a Cookie Cutter Cap.
* Cookie Cutter Cap Webber.png

  [Webber](/wiki/Webber "Webber") wearing a Cookie Cutter Cap.
* Expand slideshow

  [Winona](/wiki/Winona "Winona") wearing a Cookie Cutter Cap.
* Cookie Cutter Cap Warly.png

  [Warly](/wiki/Warly "Warly") wearing a Cookie Cutter Cap.
* Expand slideshow

  [Wortox](/wiki/Wortox "Wortox") wearing a Cookie Cutter Cap.
* Expand slideshow

  [Wormwood](/wiki/Wormwood "Wormwood") wearing a Cookie Cutter Cap.
* Expand slideshow

  [Wurt](/wiki/Wurt "Wurt") wearing a Cookie Cutter Cap.
