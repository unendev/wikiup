...
source_url: https://dontstarve.fandom.com/wiki/Crate
---
...
**“**If I burn it, whatever's inside burns too...**”**
...
**Crates** are naturally spawning [structures](/wiki/Structures "Structures") introduced in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. They are occasionally found in the [Beach](/wiki/Beach "Beach") [Biome](/wiki/Biome "Biome"). They can be [Hammered](/wiki/Hammer "Hammer") to yield one random [Item](/wiki/Item "Item") in addition to one [Board](/wiki/Boards "Boards"). Crates have their own [Map](/wiki/Map "Map") icon, allowing them to be easily found later.

The possible random items and their respective chances are as follows:
...
| 21.74% | Empty Bottle |
| 21.74% | Rope |
| 10.87% | "Ballphin Free" Tuna |
| 2.17% | Dubloons |

## Blueprint Gallery[]

Walani crates.png (614 KB)

[Walani](/wiki/Walani "Walani") standing in-between various beached Crates.

Crate smash.png (230 KB)

Walani smashing a Crate, revealing its contents.

Crate map.png (31 KB)

Crates as seen on the [Map](/wiki/Map "Map").
