...
source_url: https://dontstarve.fandom.com/wiki/House_Expansion_Permit
---
...
"Add that den you've always talked about."
...
|  |
| --- |
| Allows the construction of an additional room in the [Slanty Shanty](/wiki/Slanty_Shanty "Slanty Shanty"). |

## Sources

### Sold by

Swinesbury City Hall (Oinc ×50)
...
**“**Paper says Wolfgang can build mighty extension!**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Now I can build a mourning room.**”**
...
**“**More room for my acquisitions.**”**

–[Maxwell](/wiki/Maxwell "Maxwell")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Ah yes! Now I can expand my workshop!**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Another room is mine for the taking!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Cool! What should we put in our other room?**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Cool! I can make a bedroom.**”**
...
**“**Fer buildin' on ta me land ship.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**FOR THE UNDISCOVER'D PANTRY**”**
...
The **House Expansion Permit** is a craftable [Item](/wiki/Item "Item") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is found in the [Renovate Tab](/wiki/Renovate_Tab "Renovate Tab") and requires 50 [Oincs](/wiki/Oinc "Oinc") to obtain. It can also be bought at the [Swinesbury City Hall](/wiki/Swinesbury_City_Hall "Swinesbury City Hall") for 50 Oincs.

By using the House Expansion Permit on a locked [Door](/wiki/Doors_Tab "Doors Tab") in the [Slanty Shanty](/wiki/Slanty_Shanty "Slanty Shanty"), one is able to construct an adjacent empty room. Locked Doors in other rooms will automatically connect to the new room as well if they are facing in the right direction. The House Expansion Permit is consumed in the process. Constructed rooms can be removed from the Slanty Shanty again by using a [Demolition Permit](/wiki/Demolition_Permit "Demolition Permit").

## Placeholder Trivia[]

* The House Expansion Permit can also be crafted using 5 [Tenpiece Oincs](/wiki/Oinc "Oinc") or 1 [Centapiece Oinc](/wiki/Centapiece_Oinc "Centapiece Oinc"). If using Centapiece Oinc, one will be returned 5 Tenpiece Oincs.
