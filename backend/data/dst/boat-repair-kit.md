...
source_url: https://dontstarve.fandom.com/wiki/Boat_Repair_Kit
---

*Exclusive to:* ShipwreckedHamlet

:   *For the* [Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together") *item with a similar function, see [Boat Patch](/wiki/Boat_Patch "Boat Patch").*

## Boat Repair Kit

Boat Repair Kit

"Stay afloat in that boat!"

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Boards**×2** Stinger**×2** Rope**×2** |
...
|  |
| --- |
| Repairs damaged boats |

## Sources

### Dropped by

Debris Build (Hammer) X Marks The Spot
...
**“**This could save a boat from destruction, and me with it.**”**
...
**“**Extends the life of aquatic vessels.**”**
...
**“**Surfboard maintenance is essential!**”**
...
**“**Never set sail wit'out'er.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**'TIS FOR BOAT FIXINGS**”**
...
**“**Swell. Because cork is known for its durability.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Boat Repair Kit** is a craftable [Item](/wiki/Item "Item") can be used to repair [Boats](/wiki/Boats "Boats") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It is crafted using 2 [Boards](/wiki/Boards "Boards"), 2 [Stingers](/wiki/Stinger "Stinger"), and 2 [Ropes](/wiki/Rope "Rope"). It requires the [Science Machine](/wiki/Science_Machine "Science Machine") to prototype and can be found in the [Nautical Tab](/wiki/Nautical_Tab "Nautical Tab").

A Boat Repair Kit can be obtained early in the game by destroying the large piece of [Debris](/wiki/Debris "Debris") at the player's spawn with a [Hammer](/wiki/Hammer "Hammer").

Upon use, it recovers 100 Boat Meter (SW) regardless of what boat it is used on. It can be used 3 times before being completely consumed. The Boat Repair Kit can be used while on the boat by right clicking on the Kit. It can also be used without getting on to the boat by dragging it on to the boat from dry land.

## Gift Icon Downloadable Content[]

The Boat Repair kit is also present in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC.

## Placeholder Trivia[]

* The ability to craft Boat Repair Kit in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC was introduced in the June 7, 2019 update.
