...
source_url: https://dontstarve.fandom.com/wiki/Yaarctopus
---
...
*[See below](#Exchange_Rates)*

### Renewable?

Cannot be killed or attacked

Perk

|  |
| --- |
| Pulls [Octopus Chest](/wiki/Octopus_Chest "Octopus Chest") from the sea. |
...
**“**Intriguing! That sleepy cephalopod wishes to engage in trade!**”**
...
**“**One day I hope to retire to a rock of my own.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Yaarctopus** resides in one of the [Coral Reefs](/wiki/Coral_Reef "Coral Reef") that generally spawn in the [Shallow Ocean](/wiki/Ocean#Shipwrecked "Ocean") [Biome](/wiki/Biomes "Biomes"). He is found lying on a Coral Rock wearing an eyepatch, a small pirate hat, an earring on the side of his head, and a wooden pegleg on one of his tentacles. He is immune to any damage and cannot be attacked. He is the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* equivalent to the [Pig King](/wiki/Pig_King "Pig King").

The player may trade any [Fishes](/wiki/Fishes "Fishes"), [Trinkets](/wiki/Trinkets "Trinkets"), and certain Fish [Crock Pot](/wiki/Crock_Pot "Crock Pot") recipes with the Yaarctopus in exchange for an [Octopus Chest](/wiki/Octopus_Chest "Octopus Chest") anytime except when he sleeps (which happens in night or after giving an item). Attempting to give any other item than the aforementioned ones, to a woken up Yaarctopus will result in them shaking its head. After handing in one viable Item, the Yaarctopus will fall asleep for the rest of the remaining day and cannot again be traded with until he wakes up.

## Dubloons Exchange Rates[]

For each Fish given the chest will always contain one [Dubloon](/wiki/Dubloons "Dubloons") in addition to one of [Seaweed](/wiki/Seaweed "Seaweed") *(33.33%)*, [Seashell](/wiki/Seashell "Seashell") *(20%)*, [Coral](/wiki/Coral "Coral") *(20%)*, [Blubber](/wiki/Blubber "Blubber") (*6.67%),* [Shark Fin](/wiki/Shark_Fin "Shark Fin") *(6.67%)* or [Bioluminescence](/wiki/Bioluminescence "Bioluminescence") *(13.33%)*. If it has not already been obtained and [Woodlegs](/wiki/Woodlegs "Woodlegs") is not unlocked, there is also a chance that the chest will contain the [Golden Key](/wiki/Golden_Key "Golden Key") *(10.00%).*

| Trade Item | Prizes | | | Chance |
| --- | --- | --- | --- | --- |
| Crock Pot | Dubloons **×1** | Seaweed | **×1** | *33.33%* |
| Seashell | *20%* |
| Coral | *20%* |
| Blubber | *6.67%* |
| Shark Fin | *6.67%* |
| Bioluminescence | *13.33%* |
| Golden Key**×1** | | *10.00%* (Woodlegs not unlocked) |

For each Trinket, the chest will only contain a certain number of [Dubloons](/wiki/Dubloons "Dubloons"). Trinket values are as follows:

| Item | Dubloon Value |
| --- | --- |
| Old BootLicense PlateWine Bottle Candle | **Dubloons×5** |
| Orange SodaVoodoo DollSecond-hand Dentures | **Dubloons×7** |
| Brain Cloud PillToy BoatUkulele | **Dubloons×8** |
| Ball and CupGord's KnotMelty MarblesTiny RocketshipQueen MalfalfaPost Card of the Royal Palace | **Dubloons×9** |
| Frazzled WiresGnomeLying RobotCan of Silly String | **Dubloons×10** |
| Ancient VaseBroken AAC DeviceFake KazooSextant | **Dubloons×11** |
| One True EarringDessicated TentacleHardened Rubber BungMismatched Buttons | **Dubloons×12** |

In addition to one [Dubloon](/wiki/Dubloons "Dubloons"), he will also give [Boat](/wiki/Boats "Boats") related items when certain [Crock Pot](/wiki/Category:Crock_Pot_Recipes "Category:Crock Pot Recipes") food is given:
...
It is often useful to set up an easy supply of fish near the Yaarctopus, to allow for easy supplies of gold to make tools. Several [Fish Farms](/wiki/Fish_Farm "Fish Farm"), or a number of planted [Mussel Beds](/wiki/Mussel_Bed "Mussel Bed") with [Mussel Sticks](/wiki/Mussel_Stick "Mussel Stick") can supply a decent amount of fish. (Note: It would take 3 days of continuously trading single fish to earn enough Doubloons to convert into a single gold nugget so this tip is only for those who have nothing better to do.)

## Placeholder Trivia[]

* His name is a portmanteau of "yaar" (a pirate's phrase) and "octopus".

## Mosquito Bugs[]

* A [Coral](/wiki/Coral "Coral") may spawn right on top of the Yaarctopus; this does not hinder the player to turn in fish but can affect the spawning of the Octopus Chest.

## Blueprint Gallery[]

Yaarctopus In-Game.png (479 KB)

[Wolfgang](/wiki/Wolfgang "Wolfgang") with the Yaarctopus.

Screenshot 23.png (371 KB)

[Warly](/wiki/Warly "Warly") with the Yaarctopus.

Yaarctopus Trailer.jpg (352 KB)

The Yaarctopus, as seen in the *Shipwrecked* trailer.
