...
source_url: https://dontstarve.fandom.com/wiki/Magician's_Top_Hat
---
...
| --- |
| Top Hat**×1** Nightmare Fuel**×2** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") |
| --- |
| Maxwell Filter Clothing Filter Shadow Magic Filter Rain Gear Filter |

Effects

| Sanity |
| --- |
| +3.3/min (0/min Maxwell) |
...
**“**That hat just oozes style.**”**

–[Wilson](/wiki/Wilson "Wilson")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Aww, I thought I saw smoke, but it's just Max's shadow gunk.**”**

–[Willow](/wiki/Willow "Willow")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Wolfgang would rather wear something else.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**The darkness has changed it.**”**

–[Wendy](/wiki/Wendy "Wendy")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**EXCELLENT. IT LOOKS MUCH MORE EVIL NOW**”**

–[WX-78](/wiki/WX-78 "WX-78")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It has been imbued with an ectoplasmic residue.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I'll stick to a nice cozy toque, thanks.**”**

–[Woodie](/wiki/Woodie "Woodie")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Tall, dark and dapper.**”**

–[Maxwell](/wiki/Maxwell "Maxwell")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It hath been töuched by dark magic.**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Not quite like father used to wear.**”**

–[Webber](/wiki/Webber "Webber")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I can't think of any occasion I'd wear that to.**”**
...
**“**Max is a little too good at keepin' things under his hat.**”**

–[Winona](/wiki/Winona "Winona")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Hyuyuyu, he's up to his old tricks!**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Glurgh, fancy hat got all gloopy.**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Do you think he can teach me how to pull rabbits out of it?**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A bit drab for my tastes.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Magician's Top Hat** is a clothing item unique to [Maxwell](/wiki/Maxwell "Maxwell") added in *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*. It is crafted from a regular [Top Hat](/wiki/Top_Hat "Top Hat") and two units of [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel") in a unique [Maxwell Filter](/wiki/Maxwell_Filter "Maxwell Filter"). It provides access to the shadow dimension shared by Shadow [Chester](/wiki/Chester "Chester") and the [Magician's Chest](/wiki/Magician%27s_Chest "Magician's Chest"), but only for Maxwell; for other [Characters](/wiki/Characters "Characters"), the headdress is no different from a regular top hat. With default controls, Maxwell players can access the shadow dimension either by right-clicking the hat while equipped, or by holding Alt and right-clicking the hat while unequipped.

The shadow dimension stores up to 12 stacks of items, and items in it spoil at 1.5 times the regular spoilage rate. One shadow dimension exists per shard; thus, surface and [Caves](/wiki/Caves "Caves") worlds will have different shadow dimensions, and the shadow dimension cannot be used to transport items across shards. The loss of any container linked to the shadow dimension does not affect the items stored there, even if there are no such containers left in the world. In this case, the items can be accessed as normal as soon as a new shadow dimension container is created.

## Placeholder Trivia[]

* In the beta test of Maxwell's rework, when using [Codex Umbra](/wiki/Codex_Umbra "Codex Umbra"), in addition to 4 items that were included in the final version of the update, it was possible to select a spell that allows you to turn the Top Hat in your inventory into a Magician's Top Hat
...
Magician's Top Hat Crafting image.png (320 KB)

Magician's Top Hat in Codex Umbra Menu
