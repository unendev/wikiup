...
source_url: https://dontstarve.fandom.com/wiki/Mushroom_Planter
---
...
| --- |
| Rot**×8** Manure**×5** Living Log**×2** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Food & Gardening Filter | Science Machine |

## Properties

### Spawns

Red CapBlue CapGreen CapMoon ShroomRot
...
**“**It needs something to get started.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I'm surprised there's no mushrooms growing out of this rotten log.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Mushroom Planter** is a craftable [Structure](/wiki/Structure "Structure") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It requires 8 [Rot](/wiki/Rot "Rot"), 5 [Manure](/wiki/Manure "Manure"), and 2 [Living Logs](/wiki/Living_Log "Living Log") to craft, and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. After placing it, one can grow [Red](/wiki/Red_Cap "Red Cap"), [Green](/wiki/Green_Cap "Green Cap"), and [Blue Caps](/wiki/Blue_Cap "Blue Cap") or [Spores](/wiki/Mushroom_Spore "Mushroom Spore") on it. [Mushrooms](/wiki/Mushrooms "Mushrooms") can be harvested at any time, and will yield different amounts of the mushroom depending on how much they grew. If a spore was planted, there is a 50% chance that it will release a spore when it hits the max level. [Wormwood](/wiki/Wormwood "Wormwood") can grow [Moon Shrooms](/wiki/Moon_Shroom "Moon Shroom") on it with the Moon Shroom Cloud skill unlocked.

Harvesting the Planter less than one day after planting it will only yield the one mushroom that was planted. Planting a Mushroom can yield a maximum of 4 Mushrooms per harvest, while Mushroom Spores can produce a maximum of 6 Mushrooms. They take 3.75 days to fully grow and can be harvested 4 times before it must be replenished with [Living Logs](/wiki/Living_Log "Living Log").

On the surface, mushrooms can be grown through all seasons except [Winter](/wiki/Winter "Winter"). During Winter, the mushrooms will all turn into [Rot](/wiki/Rot "Rot"). In the [Caves](/wiki/Caves "Caves"), however, mushrooms can be grown all year round; this makes it a reliable and sustainable method of [Mushroom](/wiki/Mushrooms "Mushrooms") farming in [Caves](/wiki/Caves "Caves").

## Prototype Tips[]

* A good method of using Mushroom farming is to make camp near a green and blue [Mushtree Forest](/wiki/Mushtree_Forest "Mushtree Forest"), where one can collect spores of Blue [Mushtrees](/wiki/Mushtree "Mushtree") in Winter and Green Mushtrees in [Spring](/wiki/Spring "Spring"). This method yields lots of Blue Mushrooms for [Health](/wiki/Health "Health") and [Hunger](/wiki/Hunger "Hunger") and Green Mushrooms for [Sanity](/wiki/Sanity "Sanity"), at a continuous cost of Living Logs.
* Each use of [Horticulture, Abridged](/wiki/Books "Books") book increases the mushrooms count in the planter by 1 however the art only updates on 1, 2, 4 and 6 mushrooms.

## Placeholder Trivia[]

* Mushroom Planters were introduced in the *[Arts and Crafts](/wiki/A_New_Reign#October_13,_2016_-_Arts_and_Crafts "A New Reign")* update.
* Maxwell's quote might be in reference to his quote for an [Evergreen](/wiki/Evergreen "Evergreen") "I've heard them described as "piney"." which is itself a reference to Wilson's quote "It's all piney."

## Blueprint Gallery[]

Mushroom Planters Stage 1.png (378 KB)

Mushroom Planters of all colors after one day.

Mushroom Planters Stage 2.png (373 KB)

Mushroom Planters after two days.

Mushroom Planters Stage 3.png (369 KB)

Mushroom Planters after three days.

Mushroom Planters Stage 4.png (444 KB)

Mushroom Planters after four days if a spore was planted.

Refueling Mushroom Planter.png (135 KB)

A spent Mushroom Planter with the option to refuel it using a Living Log.

Mushroom Planter Burnt.png (3 KB)

A burnt Mushroom Planter.
