...
source_url: https://dontstarve.fandom.com/wiki/Thumper
---
...
"A revolutionary harvester."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Gears**×1** Flint**×6** Hammer**×2 (Wagstaff)** |
...
|  |
| --- |
| Creates a shockwave that destroys [Structures](/wiki/Structure "Structure"), rocks and [Trees](/wiki/Tree "Tree") and uproots plants |
...
–[Wilson](/wiki/Wilson "Wilson"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Clears the area without setting things on fire. That's no fun.**”**

–[Willow](/wiki/Willow "Willow"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Is pretty good smasher. But Wolfgang is best.**”**

–[Wolfgang](/wiki/Wolfgang "Wolfgang"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Cold-hearted metallic destruction.**”**

–[Wendy](/wiki/Wendy "Wendy"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**FINALLY SOMETHING THAT UNDERSTANDS ME**”**

–[WX-78](/wiki/WX-78 "WX-78"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I'm not familiar with this type of bird.**”**

–[Wickerbottom](/wiki/Wickerbottom "Wickerbottom"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**I don't care if it's not a real bird, I still don't like it.**”**

–[Woodie](/wiki/Woodie "Woodie"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Does all my hard work for me.**”**

–[Maxwell](/wiki/Maxwell "Maxwell"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Delivers a pragmatic shock wave of ground reverberations.**”**

–[Wagstaff](/wiki/Wagstaff "Wagstaff"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**This metal bird has the förce öf Thör's hammer!**”**

–[Wigfrid](/wiki/Wigfrid "Wigfrid"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Woah! That makes a big boom!**”**

–[Webber](/wiki/Webber "Webber"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Anything that saves me work is all right with me.**”**

–[Walani](/wiki/Walani "Walani"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's like a meat tenderizer for the ground.**”**

–[Warly](/wiki/Warly "Warly"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Fer makin' land waves.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**UNEASY LIES THE HEAD THAT BANGS THE GROUND**”**

–[Wilba](/wiki/Wilba "Wilba"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Thump! Thump!**”**

–[Wormwood](/wiki/Wormwood "Wormwood"), when examining the Thumper

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**A boomer to go with my pew-er.**”**

–[Wheeler](/wiki/Wheeler "Wheeler"), when examining the Thumper

The **Thumper** is a [Character](/wiki/Characters "Characters")-specific [Structure](/wiki/Structure "Structure") craftable only by [Wagstaff](/wiki/Wagstaff "Wagstaff"). It is found in the [Tinkering Tab](/wiki/Tinkering_Tab "Tinkering Tab"), and requires 1 [Gears](/wiki/Gears "Gears"), six [Flint](/wiki/Flint "Flint"), and two Hammers to craft.

The Thumper can be used to destroy nearby Structures, boulders, [Trees](/wiki/Tree "Tree") and uproots plants by creating a shockwave when activated. If the Thumper hits a player or [Mob](/wiki/Mobs "Mobs"), it will do 30 Health in damage.

Thumper's destruction radius is 9 units around itself (2.25 tiles) and damage radius is 5 units (1.25 tiles). In the base game, only a limited number of Thumper can be built per world, as Gears are a non-renewable resource. In DLCs gears are renewable through multiple ways.
...
* Its design and movement are inspired by the [drinking bird](https://en.wikipedia.org/wiki/Drinking_bird "wikipedia:Drinking bird").

## Blueprint Gallery[]

RWP 236 Thumper Concept Art.jpg (156 KB)
