...
source_url: https://dontstarve.fandom.com/wiki/Checkerboard_Flooring
---
...
"Nicely checkered marble tiles."

Crafting

| [Recipe](/wiki/Crafting "Crafting") | Amount produced |
| --- | --- |
| Marble**×1** | 1 4 Don't Starve Together |
...
**“**Strange that marble would make checkered flooring.**”**
...
–[Wanda](/wiki/Wanda "Wanda")
 ...
 https://static.wikia.nocookie.net/dont-starve-game/images/f/fd/Checkerboard Flooring Forest.png/revision/latest?cb=20130314041924 https://static.wikia.nocookie.net/dont-starve-game/images/f/fd/Checkerboard Flooring Forest.png/revision/latest?cb=20130314041924 



 

**Checkerboard Flooring** is a craftable [Turf](/wiki/Turf "Turf") [Item](/wiki/Item "Item"). It requires 1 [Marble](/wiki/Marble "Marble") to craft and an Alchemy Engine to prototype. Like other Turfs, it can be placed on any bare ground tile or used as [fuel](/wiki/Fuel "Fuel").

Checkerboard Flooring spawns around the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing"), in the [Chess](/wiki/Chess "Chess") [biome](/wiki/Biome "Biome"), and in various [Set Pieces](/wiki/Set_Piece "Set Piece").

[Eyeplants](/wiki/Lureplant#Eyeplant "Lureplant") cannot spawn on Checkerboard Flooring, making it an expensive and artificial way of protecting oneself from [Lureplants](/wiki/Lureplants "Lureplants"). Plants like [Berry Bushes](/wiki/Berry_Bush "Berry Bush"), [Grass Tufts](/wiki/Grass_Tuft "Grass Tuft"), [Saplings](/wiki/Sapling "Sapling"), [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), [Pine Cones](/wiki/Pine_Cone "Pine Cone"), and [Birchnuts](/wiki/Birchnut "Birchnut") can't be planted on these turfs, unless they were planted before the turfs were placed.

When placed on the [Surface World](/wiki/Surface_World "Surface World") in a large enough area, Crows are the only [Birds](/wiki/Birds "Birds") that will spawn and land on Checkerboard Flooring.
...
* Checkerboard Flooring was added in the *[A Little Rain Must Fall](/wiki/Version_History#A_Little_Rain_Must_Fall "Version History")* update.
* Despite being crafted from Marble, it can be used as fuel like the other Turfs.
* When walking on Checkerboard Flooring, a distinct ambient sound can be heard, similar to the one near an assembled [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing").

## Blueprint Gallery[]

Chess Turf Texture.png (159 KB)

Checkerboard Flooring Texture.
