...
source_url: https://dontstarve.fandom.com/wiki/Hedge
---
...
|  |
| --- |
| `"hedge_block_item" "hedge_cone_item" "hedge_layered_item"` |
...
|  |
| --- |
| `"hedge_block" "hedge_cone" "hedge_layered"` |
...
**“**Theoretically, they serve the same purpose as hedges at home.**”**
...
**“**Not really one for city landscaping.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

**Hedges** are shaped bushes found in the Pig Villages in the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. They have two forms, cut and grown. Whilst cut, the Hedges cannot be interacted with, but when grown they can be cut either by using a [Razor](/wiki/Razor "Razor") which will result in 1 [Clipping](/wiki/Clippings "Clippings") or by using [Shears](/wiki/Shears "Shears") which will result in 2 Clippings. Hedges will have a 3% chance to grow every 0.5-1.5 days.

Hedges are not affected by [Wickerbottom](/wiki/Wickerbottom "Wickerbottom")'s [Applied Horticulture](/wiki/Books "Books").

Upon obtaining the [Key to the City](/wiki/Key_to_the_City "Key to the City"), the player is also able to craft all variations of Hedges in the [City Planning Tab](/wiki/City_Planning_Tab "City Planning Tab"). Using nine Clippings and some [Nitre](/wiki/Nitre "Nitre") returns three items each which can then be placed similar to [Walls](/wiki/Wall "Wall"). Manual Hedges do not differ in any way from naturally spawning Hedges. Cone Hedge and Layered Hedge can also be used as [Fuel](/wiki/Fuel "Fuel") for [Fire](/wiki/Fire "Fire"), providing the same burning time as [Cut Grass](/wiki/Cut_Grass "Cut Grass").

## Placeholder Trivia[]

* The ability to craft Hedges in the City Planning Tab was introduced in an [unnamed update](/wiki/Don%27t_Starve:_Hamlet#May_24th,_2019 "Don't Starve: Hamlet") after the official release of the *Hamlet* DLC.

## Blueprint Gallery[]

LawnTurf.jpg (267 KB)

Cone Hedges included in a [Set Piece](/wiki/Set_Piece "Set Piece") in the [Pig City](/wiki/Pig_City "Pig City").
