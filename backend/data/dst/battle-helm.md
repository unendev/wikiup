...
source_url: https://dontstarve.fandom.com/wiki/Battle_Helm
---
...
656.2 [true hp](/wiki/Armor/DST#True_durability "Armor/DST")Don't Starve Together
...
**“**I hope it fits over my horns.**”**

–[Wortox](/wiki/Wortox "Wortox")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Will wearing make me strong like Viking lady?**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Maybe Pinetree Pioneers should start wearing helmets instead.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**It's not historically accurate, but I'll just keep that to myself.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Battle Helm** is a wearable [armor](/wiki/Armor "Armor") item for the head slot in the *[Reign of Giants](/wiki/Reign_of_Giants "Reign of Giants")* DLC and *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")* and is exclusive to [Wigfrid](/wiki/Wigfrid "Wigfrid"). Wigfrid starts the game with it in her [inventory](/wiki/Inventory "Inventory") and is the only character able to craft it. It requires 2 [Gold Nuggets](/wiki/Gold_Nugget "Gold Nugget") and 2 [Rocks](/wiki/Rocks "Rocks") to craft.

It absorbs 80% of incoming damage and provides a 20% bonus to [water resistance](/wiki/Wetness "Wetness").

Due to its stats and cheap recipe, the Battle Helm is a great alternative to the [Football Helmet](/wiki/Football_Helmet "Football Helmet") and will secure the head armor slot for a long time for Wigfrid players.
...
*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Battle\_Helm](/wiki/Belongings#Battle_Helm "Belongings")*
...
* In *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, Wigfrid is allowed to give other players the Battle Helm and [Battle Spear](/wiki/Battle_Spear "Battle Spear"), making her a great asset to the team. However, she is the only one allowed to craft it.

## Trivia[]

* In single player, attempting to spawn this item in with a console command or crafting it with a modded crafting recipe when not playing as Wigfrid will result in the item instantly disappearing from the inventory.
* Willow's quote, "It's got a name scratched on the inside... "W", uh..." is a reference to the fact that every character 's name starts with a W, even including [Maxwell](/wiki/Maxwell "Maxwell"), which is in fact his stage name from better days; his real name is William Carter.
* Initially, Moonlight Diaden skin featured a star instead of Alter's symbol. It was changed presumably due to associations with the Star of David. [[1]](#cite_note-1)

## Gallery[]

* Expand slideshow

  [Wilson](/wiki/Wilson "Wilson") wearing a Battle Helm.
* Expand slideshow

  [Willow](/wiki/Willow "Willow") wearing a Battle Helm.
* Expand slideshow

  [Wolfgang](/wiki/Wolfgang "Wolfgang") wearing a Battle Helm.
* Expand slideshow

  [Wendy](/wiki/Wendy "Wendy") wearing a Battle Helm.
* Expand slideshow

  [WX-78](/wiki/WX-78 "WX-78") wearing a Battle Helm.
* Expand slideshow

  [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing a Battle Helm.
* Expand slideshow

  [Woodie](/wiki/Woodie "Woodie") wearing a Battle Helm.
* Expand slideshow

  [Wes](/wiki/Wes "Wes") wearing a Battle Helm.
* Expand slideshow

  [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing a Battle Helm.
* Expand slideshow

  [Wigfrid](/wiki/Wigfrid "Wigfrid") wearing a Battle Helm.
* Expand slideshow

  [Webber](/wiki/Webber "Webber") wearing a Battle Helm.
* Expand slideshow

  [Winona](/wiki/Winona "Winona") wearing a Battle Helm.
* Battle Helm Warly.png

  [Warly](/wiki/Warly "Warly") wearing a Battle Helm.
* Expand slideshow

  [Wortox](/wiki/Wortox "Wortox") wearing a Battle Helm.
* Expand slideshow

  [Wormwood](/wiki/Wormwood "Wormwood") wearing a Battle Helm.
* Expand slideshow

  [Wurt](/wiki/Wurt "Wurt") wearing a Battle Helm.

1/16

Battle Helm Teaser.jpg (111 KB)

The Battle Helm, as seen in the Summer teaser trailer for *Reign of Giants*.

Old Moonlight Diaden.png (140 KB)

Old Moonlight Diaden
