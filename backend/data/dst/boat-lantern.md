...
source_url: https://dontstarve.fandom.com/wiki/Boat_Lantern
---
...
| --- |
| Empty Bottle**×1** Twigs**×2** Fireflies**×1** |
...
|  |
| --- |
| Boat attachment; provides light source |
...
**“**To see the vast nothingness in the black of night.**”**
...
**“**It lends an eerie glow to all around it.**”**

–[Maxwell](/wiki/Maxwell "Maxwell")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**An exemplary application for bioluminescence.**”**
...
**“**I could've used one of these for my balloon.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

A **Boat Lantern** is a craftable [Boat](/wiki/Boats "Boats") attachment in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It requires a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype and 1 [Empty Bottle](/wiki/Empty_Bottle "Empty Bottle"), 2 [Twigs](/wiki/Twigs "Twigs"), and 1 [Firefly](/wiki/Fireflies "Fireflies") to craft, and can be found in the [Light Tab](/wiki/Light_Tab "Light Tab"). It is also a reward from the [Yaarctopus](/wiki/Yaarctopus "Yaarctopus") in exchange for [Surf 'n' Turf](/wiki/Surf_%27n%27_Turf "Surf 'n' Turf").

The Boat Lantern needs to be attached to a boat to function. When it is attached to a Boat, it can be turned on or off at will, and provides light when turned on, protecting the player from [Charlie](/wiki/Charlie "Charlie"). It has a limited durability and will eventually run out if kept on, but it can be refilled with [Bioluminescence](/wiki/Bioluminescence "Bioluminescence") or Fireflies to extend its lifespan.

## PrototypeTips[]

* The [Slot Machine](/wiki/Slot_Machine "Slot Machine") may occasionally drop Fireflies, turning it into a unreliable way to obtain Fireflies, if one has enough [Dubloons](/wiki/Dubloons "Dubloons") and luck.
* If playing in a *Shipwrecked* world that has been connected with a base game world, [Light Bulbs](/wiki/Light_Bulb "Light Bulb") can be used to recharge the Boat Lantern.

## Blueprint Gallery[]

Woodlegs and Tiger Shark at Night Trailer.jpg (326 KB)

Boat Lantern as seen in the *Shipwrecked* trailer.
