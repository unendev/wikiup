...
source_url: https://dontstarve.fandom.com/wiki/Cachebox
---
...
Scrap×1-2, Electrical Doodad×1-2, Doohickey×1-2, Calibrated Perceiver
...
Scrap×1-2, Electrical Doodad×1-2, Gizmo×1-2, Unstable Transmission orUnstable Transmission

* [Cachebox](#)
* [Advanced Cachebox](#)

**“**Sure hope the bossman doesn't mind me borrowing a few things.**”**

–[Winona](/wiki/Winona "Winona"), examining a Cachebox

**“**Jackpot!**”**

–[Winona](/wiki/Winona "Winona"), examining an Advanced Cachebox

**Cacheboxes** are objects exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in the *[Skill Spotlight Updates](/wiki/Skill_Spotlight_Update "Skill Spotlight Update")*. They can only be found and seen by [Winona](/wiki/Winona/Don%27t_Starve_Together "Winona/Don't Starve Together") after learning the [Founder's Keepers I](/wiki/Founder%27s_Keepers_I "Founder's Keepers I") skill and wearing the [Inspectacles](/wiki/Inspectacles "Inspectacles"). When a Cachebox is activated it will drop 1-2 [Scrap](/wiki/Scrap "Scrap"), 1-2 [Electrical Doodads](/wiki/Electrical_Doodad "Electrical Doodad"), 1-2 [Doohickeys](/wiki/Doohickey "Doohickey") and 1 [Calibrated Perceiver](/wiki/Calibrated_Perceiver "Calibrated Perceiver").

After learning the [Founder's Keepers II](/wiki/Founder%27s_Keepers_II "Founder's Keepers II") skill, there is a 25% chance an **Advanced Cachebox** will spawn instead of the default Cachebox. The Advanced Cachebox will drop [Gizmos](/wiki/Gizmo "Gizmo") instead of Doohickeys and one of 2 different [Unstable Transmissions](/wiki/Unstable_Transmission "Unstable Transmission") as long as they have not been scanned.

After activating a Cachebox a new one will spawn after 4 minutes.

### Broken Cachebox[]

When Winona activates a broken Cachebox or Advanced Cachebox, a puzzle will pop-up. To solve the puzzle the parts need to be rotated so that every wire connects to another. When the puzzle is solved, the Cachebox will open and drop the loot.

## Trivia[]

* The Cachebox and Advanced Cachebox were added in the *[Skill Spotlight: Wurt & Winona](/wiki/Skill_Spotlight_Update#Wurt_and_Winona "Skill Spotlight Update")* update.
* Cacheboxes can't be spawned via [console commands](/wiki/Console/Don%27t_Starve_Together_Commands "Console/Don't Starve Together Commands").

## Gallery[]

Cachebox Puzzle.png (750 KB)

A Cachebox puzzle.

Cachebox Puzzle Solved.png (749 KB)

A solved Cachebox puzzle.
