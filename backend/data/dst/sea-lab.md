...
source_url: https://dontstarve.fandom.com/wiki/Sea_Lab
---
...
"Unlock crafting recipes... at sea!"

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Limestone**×4** Sand**×2** Electrical Doodad**×2** |
...
**“**Science on the sea! How marvelous!**”**
...
**“**In the middle of the ocean and I still have to do stuff!**”**
...
**“**Thet b'fer tinkerin' on th'waves!**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA AM HATH BIG-ETH BRAIN**”**
...
**“**Am I sure that bamboo will keep it out of the water?**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Sea Lab** is a craftable [Structure](/wiki/Structure "Structure") in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC. It requires 4 [Limestone](/wiki/Limestone "Limestone"), 2 [Sand](/wiki/Sand "Sand") and 2 [Electrical Doodads](/wiki/Electrical_Doodad "Electrical Doodad") to craft, and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. It works similar to an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") which means it can be used to unlock [Crafting](/wiki/Crafting "Crafting") recipes of the science 2 tier, but it can only be placed on the [Ocean](/wiki/Ocean "Ocean").

## Placeholder Trivia[]

* The Sea Lab was added to the *Shipwrecked* DLC more than a year after its official completion in the *[Home Sea Home](/wiki/Don%27t_Starve:_Shipwrecked#November_21,_2017_-_Home_Sea_Home_Update "Don't Starve: Shipwrecked")* update, after being tested in a beta branch for several months.
