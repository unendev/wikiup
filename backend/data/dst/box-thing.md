...
source_url: https://dontstarve.fandom.com/wiki/Box_Thing
---
...
The **Box Thing** is an [Item](/wiki/Items "Items") and one of four [Things](/wiki/Things "Things") used on the [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") to travel to the next world. It spawns naturally in every world in its own [Set Piece](/wiki/Set_Piece "Set Piece"). It is surrounded by [Stone Walls](/wiki/Stone_Wall "Stone Wall") and [Evil Flowers](/wiki/Evil_Flower "Evil Flower") along with a [Gnome](/wiki/Gnome "Gnome") and [Spear](/wiki/Spear "Spear") on a small patch of [Rocky Turf](/wiki/Rocky_Turf "Rocky Turf").

There are two version of it, one that spawns in [Survival Mode](/wiki/Survival_Mode "Survival Mode") and one in [Adventure Mode](/wiki/Adventure_Mode "Adventure Mode"), that differ from their color schemes. Players can craft a [Divining Rod](/wiki/Divining_Rod "Divining Rod") to help them track the Box Thing.

The only purpose of the Box Thing is to be used on the Wooden Thing. It's an important gameplay Item and as such it cannot be destroyed or stolen by [Mobs](/wiki/Mobs "Mobs"), e.g. [Krampus](/wiki/Krampus "Krampus") or [Splumonkeys](/wiki/Splumonkey "Splumonkey").

## Trivia[]

* The Box Thing's location resembles [Stonehenge](https://en.wikipedia.org/wiki/Stonehenge "wikipedia:Stonehenge").
...
Box Thing Set Piece.png (1.48 MB)

The Box Thing's Set Piece.

Box Thing placed.png (841 KB)

Box Thing added to the Wooden Thing.

|  |  |
| --- | --- |
| **Teleportato Pieces** [view](/wiki/Template:Navbox "Template:Navbox") | |
| **[Things](/wiki/Things "Things")** | [Crank Thing](/wiki/Crank_Thing "Crank Thing") • **Box Thing** • [Wooden Thing](/wiki/Wooden_Thing "Wooden Thing") • [Ring Thing](/wiki/Ring_Thing "Ring Thing") • [Metal Potato Thing](/wiki/Metal_Potato_Thing "Metal Potato Thing")  (*[Grassy Thing](/wiki/Grassy_Thing "Grassy Thing") • [Screw Thing](/wiki/Screw_Thing "Screw Thing") • [Wooden Platform Thing](/wiki/Wooden_Platform_Thing "Wooden Platform Thing") • [Wooden Potato Thing](/wiki/Wooden_Potato_Thing "Wooden Potato Thing")* Don't Starve: Shipwrecked) (*[Lever Thing](/wiki/Lever_Thing "Lever Thing") • [Rock Thing](/wiki/Rock_Thing "Rock Thing") • [Stone Thing](/wiki/Stone_Thing "Stone Thing") • [Iron Thing](/wiki/Iron_Thing "Iron Thing") • [Relic Thing](/wiki/Relic_Thing "Relic Thing")* Don't Starve: Hamlet) |
