...
source_url: https://dontstarve.fandom.com/wiki/Bee_Box
---
...
**“**Oh bees, why can't we be friends...**”**
...
A **Bee Box** is a craftable [Structure](/wiki/Structure "Structure") that uses [Bees](/wiki/Bee "Bee") to accumulate [Honey](/wiki/Honey "Honey") that can be harvested. Bee Boxes are found in the [Food Tab](/wiki/Food_Tab "Food Tab") and require a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype. It takes 1 [Honeycomb](/wiki/Honeycomb "Honeycomb"), 4 Bees, and 2 [Boards](/wiki/Boards "Boards") to build. When destroyed by a [Hammer](/wiki/Hammer "Hammer"), it will return 1 Honeycomb and 1 Boards, and will release any Bees inside the Box.

Bee Boxes are also prime targets for [Bearger](/wiki/Bearger "Bearger") attacks.

## Bee Beehaviour[]

A Bee Box will (re)spawn a new Bee every 120 seconds up to the maximum population of 4 per box. All Bees will return to their box at dusk, but they will leave it during daytime one at a time every 15-30 seconds, depending on the length of daytime. During [Winter](/wiki/Winter "Winter"), they won't leave the Box.

Technically, Bees do not have a fixed role. Instead, the same specimen can act as a worker or a fighter depending on what the current situation calls for. Every time a Bee leaves the hive, the game assigns it a role. When a Bee returns to the hive, that role gets erased. Therefore, the same specimen can fight off a threat as a [Killer Bee](/wiki/Killer_Bee "Killer Bee"), enter the hive, and then re-emerge as a worker to gather pollen.

If a Bee is attacked or caught with a [Bug Net](/wiki/Bug_Net "Bug Net"), all members of the hive still inside the box will emerge immediately as Killer Bees and engage. Additionally, Bees of the same hive, and homeless bees 30[m](/wiki/Distance "Distance") of the attacked or caught bee - killer or otherwise - will join the fight. The combined number of attackers coming to help cannot exceed 10 unless the player attacks again.
...
If the Bee Boxes are more than 80[m](/wiki/Distance "Distance") from the player, the simplified model of Honey production takes over and Honey will be produced at a rate of 1 per day. The bee boxes still require flowers nearby.

[Butterflies](/wiki/Butterfly "Butterfly") can be caught to plant 6 or more flowers near the base of each bee box where bees can find them easily. There may be some advantage to placing boxes next to a natural boundary such as the ocean on the surface world, or the void in the caves.

The [Caves](/wiki/Caves "Caves") have no naturally spawning flowers. Flowers planted under [Cave Lights](/wiki/Cave_Light "Cave Light") will grow normally, but any planted under insufficient *natural* light will wilt in a day and can never be revived. Bees will exit their box during the day when there is sufficient light to ward of Charlie (natural or artificial), but since the flowers need to be near to box to be effective, it's best to locate the whole honey farm under a bright Cave Light.
...
Bee Boxes can contain anywhere between 0 and 6 Honey. Visually they progress through 4 different stages to indicate Honey saturation at 0, 1-2, 3-5 and 6 units respectively. For example, a bee box at stage 3 (almost full) may contain between 3 and 5 pieces of Honey.
 ...
 https://static.wikia.nocookie.net/dont-starve-game/images/2/25/Bee Box phases.png/revision/latest?cb=20121227105004 https://static.wikia.nocookie.net/dont-starve-game/images/2/25/Bee Box phases.png/revision/latest?cb=20121227105004 
...
Players can use any armor to reduce damage from Bees. The [Beekeeper Hat](/wiki/Beekeeper_Hat "Beekeeper Hat") reduces bee-specific damage by 80%.

## Don't Starve Together Hermit Bee Box[]
...
**“**It look full of sweet stuff now!**”**

–[Wurt](/wiki/Wurt "Wurt")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Don't panic Walter, the bees smell your fear...**”**
...
The **Hermit** **Bee Box** is a naturally spawning object exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[Return of Them](/wiki/Return_of_Them "Return of Them")*. One can be found on the [Hermit Island](/wiki/Hermit_Island "Hermit Island").

The Hermit Bee Box works just like a normal bee box, exceptions being that it cannot be destroyed or burned.

## Tips[]

 https://static.wikia.nocookie.net/dont-starve-game/images/7/75/BeeKeeper Hat.jpg/revision/latest?cb=20121119174714 https://static.wikia.nocookie.net/dont-starve-game/images/7/75/BeeKeeper Hat.jpg/revision/latest?cb=20121119174714 
...
* Bees are slow and can easily be outrun if aggravated. Their kite attacks can even create a larger distance between themselves and the player. It will only take a few seconds of running before Bees will lose interest.
  + Equipping a [Walking Cane](/wiki/Walking_Cane "Walking Cane") or building a [Cobblestone](/wiki/Cobblestones "Cobblestones") path to the Bee Box can prove useful. A player can use the increased movement speed to harvest Honey without fear of retaliation if timed correctly.

## Trivia[]

* In the old science system, it used to cost 100 [Research Points](/wiki/Research_points_list "Research points list") to craft.
* The honeycomb slot on top of Bee Boxes will appear to fill with Honey as more Honey is stored within.
* The Hermit Bee Box was introduced to *Don't Starve Together* in the *[She Sells Sea Shells](/wiki/Return_of_Them#She_Sells_Sea_Shells "Return of Them")* update.
...
Bee Box Idle.png (95 KB)

An empty Bee Box.

BeeHivePhases.png (76 KB)

Bee Box Empty (left), Bee Box Ripe (right).

Beeboxbug AM.png (79 KB)

Bees stuck beside their Bee Boxes.

Burnt Bee Box.png (40 KB)

A burnt Bee Box from the *Reign of Giants* DLC.

Hermit Bee Box Burnt.png (17 KB)

A burnt Hermit Bee Box from *Don't Starve Together*.

Art Stream 24 Bearger.png (865 KB)

A Bee Box as seen in a drawing from Art Stream # 24.

RWP 278 Hermit Home Concept Art.png (734 KB)

Hermit Bee Box concept art from *Rhymes With Play* #278.

Busy Bee.jpg (175 KB)

In "Busy Bee" achievement
