...
source_url: https://dontstarve.fandom.com/wiki/Magnifying_Glass
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Magnifying_Glass?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
| --- |
| Iron Ore**×1** Twigs**×1** Blue Gem**×1** |

| [Tab](/wiki/Tabs "Tabs") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| **Treasure Hunting Tab** | Alchemy Engine |

Combat attributes

| [Damage](/wiki/Damage "Damage") |
| --- |
| 4.25  3.2 WendyWes  ---  5.3 Wigfrid  ---  2.1Wolfgang/4.25Wolfgang/8.5 Wolfgang |
...
|  |
| --- |
| Investigates [Peculiar Objects](/wiki/Peculiar_Objects "Peculiar Objects"). Can light things on fire. |
...
**“**It's amazing what you can find with this.**”**
...
**“**'Tis a spyglass o' tha land.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**IT LOOKETH 'PON UNDISCOVER'D STUFFS**”**
...
**“**For finding the tiny hidden treasures. And burning stuff.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Magnifying Glass** is a craftable [Item](/wiki/Item "Item") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC. It is found in the [Treasure Hunting Tab](/wiki/Treasure_Hunting_Tab "Treasure Hunting Tab"), requires an [Iron Ore](/wiki/Iron_Ore "Iron Ore"), a [Blue Gem](/wiki/Blue_Gem "Blue Gem") and [Twigs](/wiki/Twigs "Twigs") to craft, and an [Alchemy Engine](/wiki/Alchemy_Engine "Alchemy Engine") to prototype.

The Magnifying Glass can be used to light burnable objects on fire from a distance, and to craft [The Tinkerer's Tower](/wiki/The_Tinkerer%27s_Tower "The Tinkerer's Tower"). However, its main purpose is to investigate [Peculiar Objects](/wiki/Peculiar_Objects "Peculiar Objects") and Suspicious Cracks in the [Ancient Pig Ruins](/wiki/Ancient_Pig_Ruins "Ancient Pig Ruins"). After using a Magnifying Glass to investigate a Peculiar Object or Suspicious Crack, the Character will state clearly whether or not the Object conceals an item or the Crack conceals a door to a hidden room. In the first case, destroying the Object (e.g. chopping down a [Tree](/wiki/Tree "Tree") and digging up its stump or mining a [Boulder](/wiki/Boulder "Boulder")) will reveal one of the following items:

[Flint](/wiki/Flint "Flint")Flint

[Gold Nugget](/wiki/Gold_Nugget "Gold Nugget")Gold Nugget

[Oinc](/wiki/Oinc "Oinc")Oinc

[Tenpiece Oinc](/wiki/Tenpiece_Oinc "Tenpiece Oinc")Tenpiece Oinc

[Relic Fragment](/wiki/Lost_Relics "Lost Relics")Lost Relics

[Lost Totem](/wiki/Lost_Relics "Lost Relics")Lost Relics

[Lost Idol](/wiki/Lost_Relics "Lost Relics")Lost Relics

[Trinkets](/wiki/Trinkets "Trinkets")Trinkets

[Mants](/wiki/Mant "Mant") are afraid of the Magnifying Glass, and will panic if the player is holding one while nearby.
...
* The magnifying glass,bug net and fishing rod are the weakest weapons in the game, dealing 4.25 damage.
