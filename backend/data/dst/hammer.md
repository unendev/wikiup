...
source_url: https://dontstarve.fandom.com/wiki/Hammer
---
...
| --- |
| Twigs**×3** Rocks**×3** Cut Grass**×6 Twigs×3 Rocks×3 Rope×2 Don't Starve** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| **Tools Tab** | Tools Filter | Always available. (Science Machine Don't Starve) |
...
This hammer does not create... it only destroys... (DST)**”**
...
**“**For use on inanimate objects. Akin to a dissection scalpel.**”**
...
**“**Ye could put quite a 'ole in a boat wit' tis.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**WILBA CAN'ST SMASH NOW!**”**
...
**“**Everyone needs a tool to smash things with.**”**
...
**“**Sometimes you need to break stuff to make stuff.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Sometimes things need undoing.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Hammer** is a [Tool](/wiki/Tool "Tool") that can be used to demolish [Structures](/wiki/Structures "Structures"). The Hammer requires 3 [Rocks](/wiki/Rocks "Rocks"), 3 [Twigs](/wiki/Twigs "Twigs"), and 2 [Rope](/wiki/Rope "Rope") to craft and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype.

Hammers can break down any player-made Structures and most naturally occurring Structures such as [Pig Houses](/wiki/Pig_House "Pig House"), yielding at least 50% of the materials used to create the Structure in most cases.

If the player strikes a container such as a [Chest](/wiki/Chest "Chest") or [Crock Pot](/wiki/Crock_Pot "Crock Pot"), all items within will fly out but remain undamaged. It also can be used on an [Ancient Pseudoscience Station](/wiki/Ancient_Pseudoscience_Station "Ancient Pseudoscience Station") and [Ornate Chest](/wiki/Ornate_Chest "Ornate Chest"), both of which are found in the [Ruins](/wiki/Ruins "Ruins"), to make random effects and objects appear.

## Gift Icon Downloadable Content[]

In all [DLCs](/wiki/DLC "DLC"), the Hammer is tweaked so that it can be crafted without a device to prototype and requires 6 [Cut Grass](/wiki/Cut_Grass "Cut Grass") instead of 2 [Rope](/wiki/Rope "Rope") to craft. This also applies to [Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together").

[Bones](/wiki/Bones "Bones") can be hammered for [Bone Shards](/wiki/Bone_Shards "Bone Shards"), and hammering a [Merm Head](/wiki/Merm_Head "Merm Head"), a [Pig Head](/wiki/Pig_Head "Pig Head"), or a [Wildbore Head](/wiki/Wildbore_Head "Wildbore Head") during a [Full Moon](/wiki/Moon_Cycle "Moon Cycle") will yield [Nightmare Fuel](/wiki/Nightmare_Fuel "Nightmare Fuel"), as well as their usual items. The Hammer can also be used to "whack" [Moleworms](/wiki/Moleworm "Moleworm"), which will stun them.

## Icon Tools Usage[]

 https://static.wikia.nocookie.net/dont-starve-game/images/c/c1/Wilson Hammer.jpg/revision/latest?cb=20130226103446 https://static.wikia.nocookie.net/dont-starve-game/images/c/c1/Wilson Hammer.jpg/revision/latest?cb=20130226103446 

Wilson holding a Hammer.
...
Using the Hammer on a Structure that has "uses" (e.g. the [Tent](/wiki/Tent "Tent")) may return less than 50% of the materials used to craft it, based on how many times the Structure has been used. For structures that have usage, the amount returned for each type of ingredient is:
...
Hammering a structure will always yield at least one of each of the crafting materials, with the exception of [Walls](/wiki/Wall "Wall"), which drop their main component instead. If the main component of the Wall is a [Refined](/wiki/Refine "Refine") item, its base components are dropped instead. For example, a [Sign](/wiki/Sign "Sign") which requires 1 [Boards](/wiki/Boards "Boards") to craft will drop 1 Boards when hammered, a Hay Wall crafted from [Cut Grass](/wiki/Cut_Grass "Cut Grass") and [Twigs](/wiki/Twigs "Twigs") will only drop Cut Grass, and a Wood Wall crafted from Boards and [Rope](/wiki/Rope "Rope") will only drop [Logs](/wiki/Log "Log"). [Light Tab](/wiki/Light_Tab "Light Tab") Structures will drop [Ashes](/wiki/Ashes "Ashes") in addition to their components.
...
*https://static.wikia.nocookie.net/dont-starve-game/images/c/cb/Glommer.png/revision/latest?cb=20231029201751 Main article: [Belongings#Hammer](/wiki/Belongings#Hammer "Belongings")*
...
* The Hammer used to cost 30 [Science Points](/wiki/Science "Science") to craft, and it used to have a value of 1-10 [Science Points](/wiki/Science "Science") depending on its durability when used on a [Science Machine](/wiki/Science_Machine "Science Machine").
* Before the *[Caves](/wiki/Version_History#Underground "Version History")* update, the Hammer was used with a left-click. It was changed to right-click so fewer accidents would happen, such as hammering [Chests](/wiki/Chest "Chest").
* A wooden Hammer is the icon used for the [Structures Tab](/wiki/Structures_Tab "Structures Tab").
...
* In the *Reign of Giants* DLC, it's possible to find a Hammer [Blueprint](/wiki/Blueprint "Blueprint"), which cannot be learned by the player as the recipe for the Hammer is always available.
* Wilson's quote for the item may be a reference to the line "Stop! It's hammer time." (Please confirm original location)
...
Wilson Hammer.jpg (59 KB)

Wilson standing next to a Hammer, while holding one.

Pig Torch hammer.png (301 KB)

Wolfgang standing next to a [Pig Torch](/wiki/Pig_Torch "Pig Torch") with a Hammer prompt.
