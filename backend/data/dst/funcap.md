...
source_url: https://dontstarve.fandom.com/wiki/Funcap
---
...
"It's like eating all kinds of mushrooms."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Blue Cap**×6 / Green Cap×6 / Red Cap×6** |

| [Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Clothing Filter Summer Items Filter | Rare Blueprint |
...
|  |
| --- |
| Reduces hunger loss rate by 25% Periodically spawns [Mushroom Spores](/wiki/Mushroom_Spore "Mushroom Spore") Accelerates spoiling rate of items in inventory and equipment slots |

[Code](/wiki/Console "Console")

|  |
| --- |
| `"blue_mushroomhat" "green_mushroomhat" "red_mushroomhat"` |
...
The **Funcap** is a craftable [item](/wiki/Item "Item") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. There are three variants, crafted from, and matching, various [Mushrooms](/wiki/Mushroom "Mushroom")' colors. They can be crafted after obtaining their Rare [Blueprint](/wiki/Blueprint "Blueprint") by either killing the [Toadstool](/wiki/Toadstool "Toadstool") or as a random drop from [Loot Stash](/wiki/Loot_Stash "Loot Stash"), after killing [Klaus](/wiki/Klaus "Klaus"), using 6 Mushroom Caps with the same color.

## Contents

* [1 Usage](#Usage)
* [2 Crafting Recipes](#Crafting_Recipes)
* [3 Tips](#Tips)
* [4 Trivia](#Trivia)
* [5 Gallery](#Gallery)
...
Funcaps can be equipped in the head slot. When worn, they reduce the rate of [Hunger](/wiki/Hunger "Hunger") loss by 25%, provide 20% [Wetness](/wiki/Wetness "Wetness") resistance and 60 points of protection from [Overheating](/wiki/Overheating "Overheating"). They also periodically spawn [Mushroom Spores](/wiki/Mushroom_Spore "Mushroom Spore") every 60-61 seconds, which can be caught using a [Bug Net](/wiki/Bug_Net "Bug Net"). Like [Garlands](/wiki/Garland "Garland"), they perish over time whether they are worn or not. They take 6 [Days](/wiki/Day "Day") to completely spoil.

Perishable items stored within the player's inventory while a Funcap is equipped will spoil 50% faster, this also applies to equipped items, including the Funcap itself. Items stored within [Backpacks](/wiki/Backpack "Backpack") remain unaffected.
...
* Funcaps can be given to [pigs](/wiki/Pig "Pig") or [bunnymen](/wiki/Bunnyman "Bunnyman"), resulting in them wearing the caps and thus spawning spores. This can give enough spores to have multiple [glowcaps](/wiki/Mushroom_Lights#Glowcap "Mushroom Lights") lit up and you can just use your everyday pig farm to generate the spores.

## Trivia[]

https://static.wikia.nocookie.net/dont-starve-game/images/2/21/Mushroom Hat.png/revision/latest?cb=20181006101248

* Funcaps were added in the *[Warts and All](/wiki/A_New_Reign#September_23rd,_2016_-_Warts_and_All "A New Reign")* update.
* An icon for an unimplemented green Mushroom Hat could be found in the game files, before Funcaps were added to the game.

## Gallery[]

Blue Funcap Wilson.png (306 KB)

[Wilson](/wiki/Wilson "Wilson") wearing a Blue Funcap.

Blue Funcap Willow.png (310 KB)

[Willow](/wiki/Willow "Willow") wearing a Blue Funcap.

Blue Funcap Wolfgang.png (832 KB)

[Wolfgang](/wiki/Wolfgang "Wolfgang") wearing a Blue Funcap.

Blue Funcap Wendy.png (316 KB)

[Wendy](/wiki/Wendy "Wendy") wearing a Blue Funcap.

Blue Funcap WX-78.png (303 KB)

[WX-78](/wiki/WX-78 "WX-78") wearing a Blue Funcap.

Blue Funcap Wickerbottom.png (305 KB)

[Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing a Blue Funcap.

Blue Funcap Woodie.png (313 KB)

[Woodie](/wiki/Woodie "Woodie") wearing a Blue Funcap.

Blue Funcap Wes.png (304 KB)

[Wes](/wiki/Wes "Wes") wearing a Blue Funcap.

Blue Funcap Maxwell.png (304 KB)

[Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing a Blue Funcap.

Blue Funcap Wigfrid.png (283 KB)

[Wigfrid](/wiki/Wigfrid "Wigfrid") wearing a Blue Funcap.

Blue Funcap Webber.png (308 KB)

[Webber](/wiki/Webber "Webber") wearing a Blue Funcap.

[Blue Funcap Warly.png](/wiki/Special:Upload?wpDestFile=Blue+Funcap+Warly.png "Blue Funcap Warly.png")

[Warly](/wiki/Warly "Warly") wearing a Blue Funcap.

Blue Funcap Wormwood.png (1.97 MB)

[Wormwood](/wiki/Wormwood "Wormwood") wearing a Blue Funcap.

Blue Funcap Winona.png (326 KB)

[Winona](/wiki/Winona "Winona") wearing a Blue Funcap.

Blue Funcap Wortox.png (496 KB)

[Wortox](/wiki/Wortox "Wortox") wearing a Blue Funcap.

Blue Funcap Wurt.png (494 KB)

[Wurt](/wiki/Wurt "Wurt") wearing a Blue Funcap.

* Expand slideshow

  [Wilson](/wiki/Wilson "Wilson") wearing a Green Funcap.
* Expand slideshow

  [Willow](/wiki/Willow "Willow") wearing a Green Funcap.
* Expand slideshow

  [Wolfgang](/wiki/Wolfgang "Wolfgang") wearing a Green Funcap.
* Expand slideshow

  [Wendy](/wiki/Wendy "Wendy") wearing a Green Funcap.
* Expand slideshow

  [WX-78](/wiki/WX-78 "WX-78") wearing a Green Funcap.
* Expand slideshow

  [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing a Green Funcap.
* Expand slideshow

  [Woodie](/wiki/Woodie "Woodie") wearing a Green Funcap.
* Expand slideshow

  [Wes](/wiki/Wes "Wes") wearing a Green Funcap.
* Expand slideshow

  [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing a Green Funcap.
* Expand slideshow

  [Wigfrid](/wiki/Wigfrid "Wigfrid") wearing a Green Funcap.
* Expand slideshow

  [Webber](/wiki/Webber "Webber") wearing a Green Funcap.
* Green Funcap Warly.png

  [Warly](/wiki/Warly "Warly") wearing a Green Funcap.
* Expand slideshow

  [Wormwood](/wiki/Wormwood "Wormwood") wearing a Green Funcap.
* Expand slideshow

  [Winona](/wiki/Winona "Winona") wearing a Green Funcap.
* Expand slideshow

  [Wortox](/wiki/Wortox "Wortox") wearing a Green Funcap.
* Expand slideshow

  [Wurt](/wiki/Wurt "Wurt") wearing a Green Funcap.

1/16

* Expand slideshow

  [Wilson](/wiki/Wilson "Wilson") wearing a Red Funcap.
* Expand slideshow

  [Willow](/wiki/Willow "Willow") wearing a Red Funcap.
* Expand slideshow

  [Wolfgang](/wiki/Wolfgang "Wolfgang") wearing a Red Funcap.
* Expand slideshow

  [Wendy](/wiki/Wendy "Wendy") wearing a Red Funcap.
* Expand slideshow

  [WX-78](/wiki/WX-78 "WX-78") wearing a Red Funcap.
* Expand slideshow

  [Wickerbottom](/wiki/Wickerbottom "Wickerbottom") wearing a Red Funcap.
* Expand slideshow

  [Woodie](/wiki/Woodie "Woodie") wearing a Red Funcap.
* Expand slideshow

  [Wes](/wiki/Wes "Wes") wearing a Red Funcap.
* Expand slideshow

  [Maxwell](/wiki/Maxwell_(character) "Maxwell (character)") wearing a Red Funcap.
* Expand slideshow

  [Wigfrid](/wiki/Wigfrid "Wigfrid") wearing a Red Funcap.
* Expand slideshow

  [Webber](/wiki/Webber "Webber") wearing a Red Funcap.
* Red Funcap Warly.png

  [Warly](/wiki/Warly "Warly") wearing a Red Funcap.
* Expand slideshow

  [Wormwood](/wiki/Wormwood "Wormwood") wearing a Red Funcap.
* Expand slideshow

  [Winona](/wiki/Winona "Winona") wearing a Red Funcap.
* Expand slideshow

  [Wortox](/wiki/Wortox "Wortox") wearing a Red Funcap.
* Expand slideshow

  [Wurt](/wiki/Wurt "Wurt") wearing a Red Funcap.

1/16

Blue Funcap texture.png (38 KB)

Blue Funcap Texture.

Green Funcap Texture.png (41 KB)

Green Funcap Texture.

Red Funcap Texture.png (49 KB)

Red Funcap Texture.

DSTupdate wartsandall sm.png (625 KB)

Red Funcap as seen in the poster for the *[Warts and All](/wiki/A_New_Reign#September_23,_2016_-_Warts_and_All "A New Reign")* update.
