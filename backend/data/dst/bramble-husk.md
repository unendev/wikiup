...
source_url: https://dontstarve.fandom.com/wiki/Bramble_Husk
---
...
"Nature's way of saying 'keep away'."

Crafting

| [Recipe](/wiki/Crafting "Crafting") |
| --- |
| Living Log**×2** Bone Shards**×4 (Wormwood) Hamlet Living Log×2 Stinger×4 (Wormwood)Don't Starve Together** |

| Don't Starve[Tab](/wiki/Tabs "Tabs") | Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- | --- |
| **Green Thumb Tab** | Armour Filter Survivor Items Filter | Always available |
...
450 hp Hamlet  
525 hp Don't Starve Together

### [Fuel Value](/wiki/Fire#Fuel_Values "Fire")

360/180 sec Don't Starve Together icon
...
|  |
| --- |
| * Prevents damage from [Brambles](/wiki/Bramble "Bramble"), [Bramble Blooms](/wiki/Bramble_Bloom "Bramble Bloom"), [Bramble Traps](/wiki/Bramble_Trap "Bramble Trap") and [Cactus](/wiki/Cactus "Cactus") without using durability. * Deals 22.6 average damage to every mob around wearer when hit. |
...
**“**Who'd like to give an imp a hug? Hyuyu!**”**
...
**“**No hugging while you're wearing that.**”**

–[Walter](/wiki/Walter "Walter")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**Sometimes it pays to have a prickly exterior.**”**

–[Wanda](/wiki/Wanda "Wanda")

The **Bramble Husk** is a [character](/wiki/Character "Character")-specific [Armor](/wiki/Armor "Armor") [Item](/wiki/Item "Item") craftable only by [Wormwood](/wiki/Wormwood "Wormwood"). In the *[Hamlet](/wiki/Hamlet "Hamlet")* DLC, it is found in the [Green Thumb Tab](/wiki/Green_Thumb_Tab "Green Thumb Tab"), requiring 2 [Living Logs](/wiki/Living_Log "Living Log") and 4 [Bone Shards](/wiki/Bone_Shards "Bone Shards") to craft.

It has 450 durability and absorbs 80% of physical damage. Whenever a [Character](/wiki/Character "Character") wearing the Bramble Husk is attacked by a [Mob](/wiki/Mob "Mob"), 22.6 average damage (23, 23, 22 respectively three hits) is dealt to each Mob within a radius of one tile. This effect is not triggered by things such as ingesting a [Venom Gland](/wiki/Venom_Gland "Venom Gland") or taking damage from [Heat](/wiki/Heat "Heat"), [Cold](/wiki/Cold "Cold") or [Hunger](/wiki/Hunger "Hunger").

It also has the added bonus of preventing damage from [Spiky Bushes](/wiki/Spiky_Bush "Spiky Bush"), [Brambles](/wiki/Bramble "Bramble"), [Bramble Blooms](/wiki/Bramble_Bloom "Bramble Bloom"), and [Bramble Traps](/wiki/Bramble_Trap "Bramble Trap"). This means that one can harmlessly harvest Spiky Bushes, damage Brambles and [Bramble Blooms](/wiki/Bramble_Bloom "Bramble Bloom") without any worry, or stand next to a Bramble Trap when it is triggered and not take any splash damage. Durability of the armor is not decreased when this effect occurs.
...
In the *[Reign of Giants](/wiki/Don%27t_Starve:_Reign_of_Giants "Don't Starve: Reign of Giants")* DLC, the player won't take any damage from harvesting [Cactus](/wiki/Cactus "Cactus") while wearing the Bramble Husk.

### Don't Starve Together Don't Starve Together[]

As of the [WX-78 Character Update](/wiki/Don%27t_Starve_Together/Version_History#April_28.2C_2022_-_WX-78_Character_Update "Don't Starve Together/Version History"), Bramble Husk has its durability increased to 525 and now absorbs 80% physical damage, the same amount as a [Log Suit](/wiki/Log_Suit "Log Suit"). It's recipe was also tweaked, using 4 [Stingers](/wiki/Stinger "Stinger") instead of the 4 Bone Shards.

When wearing a Bramble Husk, the player won't take any damage from picking [Roses](/wiki/Flower#Rose "Flower"). It is flammable and can be used as [Fuel](/wiki/Fuel "Fuel"). Damage multipliers have ***no*** effect on damage dealt (Wigfrid's x1.25 damage multiplier, Warly's spicy foods +20% damage bonus, etc.).
...
* This item is extremely efficient in farming [tentacle spikes](/wiki/Tentacle_Spike "Tentacle Spike") in the caves by killing [tentacle pillars](/wiki/Tentacle "Tentacle"). Its AoE damage kills the tiny tentacles instantly. One husk alone is enough to farm 10 spikes without using helmets, and with minimal lost health, although one should not forget to travel through the tentacle holes, as there is an equal amount of loot on the other side of the hole.
* This item is renewable as the crafting materials are renewable. [Bone shards](/wiki/Bone_Shards "Bone Shards") can be acquired by hammering rotten [wobsters](/wiki/Wobster "Wobster"). [Wobsters](/wiki/Wobster "Wobster") can be acquired by fishing using a [sea fishing rod](/wiki/Sea_Fishing_Rod "Sea Fishing Rod") with no float and no lure, although adding [rot](/wiki/Rot "Rot") as lure will increase the fishing efficiency by a large amount. This process only results in net gain despite the initial crafting cost of [sea fishing rod](/wiki/Sea_Fishing_Rod "Sea Fishing Rod").
...
* Although it shares many similarities with the [Cactus Armor](/wiki/Cactus_Armor "Cactus Armor") included in the *[Shipwrecked](/wiki/Don%27t_Starve:_Shipwrecked "Don't Starve: Shipwrecked")* DLC, the Bramble Husk will not prevent an [Elephant Cactus](/wiki/Elephant_Cactus "Elephant Cactus") from damaging the player.
* Monsters that tend to swarm together, such as [Spiders](/wiki/Spiders "Spiders"), [Baby Tentacles](/wiki/Tentacle "Tentacle"), [Frogs](/wiki/Frog "Frog"), and [Bees](/wiki/Bee "Bee") can find themselves in a great struggle as the AoE attacks plow through the creatures similar to [Abigail](/wiki/Abigail "Abigail").

This effect wont deal damage to followers. Be careful as it could damage [Beefalo](/wiki/Beefalo "Beefalo") in case it has no saddle on by any means so it would be considered a mob and get damaged which will set all domestication progress to 0.

## Trivia[]

* This and the [Beekeeper Hat](/wiki/Beekeeper_Hat "Beekeeper Hat") are the only armor items that have more durability in [Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together") than in [Don't Starve.](/wiki/Don%27t_Starve "Don't Starve")
...
Concept art of Bramble Husk (bottom left) from *Rhymes With Play* #241.
