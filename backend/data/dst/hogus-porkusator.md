...
source_url: https://dontstarve.fandom.com/wiki/Hogus_Porkusator
---
...
|  |  |
| --- | --- |
|  | This article is **incomplete** *because of the evil sabotage by [Maxwell](/wiki/Maxwell/NPC "Maxwell/NPC")...*. Please help to [improve the article](https://dontstarve.fandom.com/wiki/Hogus_Porkusator?action=edit), or discuss the issue with the community on the [comment section](#WikiaArticleComments). |
...
| --- |
| Pig Skin**×4** Boards**×4** Azure Feather**×4** |
...
|  |
| --- |
| Unlocks additional crafting recipes in the [Magic Tab](/wiki/Magic_Tab "Magic Tab"). |
...
**“**A source of arcane knowledge in the form of an amusing air borne pig.**”**
...
**“**Thars a funny little pig.**”**

–[Woodlegs](/wiki/Woodlegs "Woodlegs")

![](data:image/gif;base64,R0lGODlhAQABAIABAAAAAP///yH5BAEAAAEALAAAAAABAAEAQAICTAEAOw%3D%3D)

**“**IT GIVETH WILBA SMARTS**”**
...
**“**It's just teasing me with those wings.**”**

–[Wheeler](/wiki/Wheeler "Wheeler")

The **Hogus Porkusator** is a craftable [Structure](/wiki/Structure "Structure") exclusive to the *[Hamlet](/wiki/Don%27t_Starve:_Hamlet "Don't Starve: Hamlet")* DLC and it is a version of the [Prestihatitator](/wiki/Prestihatitator "Prestihatitator"). It is found in the [Magic Tab](/wiki/Magic_Tab "Magic Tab"), requires 4 [Pig Skins](/wiki/Pig_Skin "Pig Skin"), 4 [Boards](/wiki/Boards "Boards") and 4 [Azure Feathers](/wiki/Feather "Feather") to craft, and a [Science Machine](/wiki/Science_Machine "Science Machine") to prototype.

## Prototype Tips[]

* The Hogus Porkusator can be destroyed when the player has a [Shadow Manipulator](/wiki/Shadow_Manipulator "Shadow Manipulator") available for placement to save resources used to build it.
