...
source_url: https://dontstarve.fandom.com/wiki/Scaled_Furnace
---
...
| --- |
| Red Gem**×2** Charcoal**×10** Scales**×1** |

| Don't Starve Together[Filter](/wiki/Filters "Filters") | [Tier](/wiki/Crafting "Crafting") |
| --- | --- |
| Light Sources Filter Structures Filter Cooking Filter Winter Items Filter | Blueprint |
...
The **Scaled Furnace** is a craftable [Structure](/wiki/Structure "Structure") exclusive to *[Don't Starve Together](/wiki/Don%27t_Starve_Together "Don't Starve Together")*, introduced in *[A New Reign](/wiki/A_New_Reign "A New Reign")*. It can be found in the [Light Sources Filter](/wiki/Light_Sources_Filter "Light Sources Filter"), [Structures Filter](/wiki/Structures_Filter "Structures Filter") and
[Cooking Filter](/wiki/Cooking_Filter "Cooking Filter") after the player obtains the [Blueprint](/wiki/Blueprint "Blueprint") by either killing the [Dragonfly](/wiki/Dragonfly "Dragonfly") or as a random drop from [Loot Stash](/wiki/Loot_Stash "Loot Stash"), after killing [Klaus](/wiki/Klaus "Klaus"). It can then be crafted using 2 [Red Gems](/wiki/Red_Gem "Red Gem"), 10 [Charcoal](/wiki/Charcoal "Charcoal") and 1 [Scales](/wiki/Scales "Scales"). The Furnace provides heat in a wide radius (which can quickly overheat the player), and light in a very small radius, and allows the player to [cook](/wiki/Cooking "Cooking") [Food](/wiki/Food "Food"). It can also be used to remove items permanently from the world by putting them into one of four slots and pressing "Destroy".

The Scaled Furnace affects the player in the same way as the [Magma Pools](/wiki/Magma "Magma") found in the [Desert](/wiki/Desert "Desert") [biome](/wiki/Biome "Biome"), except it won't set the player on fire. The heat from a Scaled Furnace radiates heat 2 tiles as opposed to a single tile from a [Campfire](/wiki/Campfire "Campfire") or [Endothermic Fire](/wiki/Endothermic_Fire "Endothermic Fire") (pit or non-pit versions).

## Tips[]

* Placing [Thermal Stones](/wiki/Thermal_Stone "Thermal Stone") next to the Scaled Furnace is a great way to heat them up efficiently, especially since its heat lasts forever.
* A fully fuelled [Campfire](/wiki/Campfire "Campfire") will heat a thermal stone hotter than the Scaled Furnace.
  + However, 2 Scaled Furnaces next to each other will heat a thermal stone better than a Campfire.

## Trivia[]

* The Scaled Furnace was added in the *[Warts and All](/wiki/A_New_Reign#September_23rd,_2016_-_Warts_and_All "A New Reign")* update.
...
* It used to be unable to cook food before [update 191674](/wiki/Don%27t_Starve_Together/Version_History#September_28,_2016 "Don't Starve Together/Version History").
...
* A Scaled Furnace can ripen [Saladmanders](/wiki/Saladmander "Saladmander").
* The item destroying mechanic was introduced in the *[Scrappy Scavengers](/wiki/Scrappy_Scavengers "Scrappy Scavengers")* update.

## Gallery[]

DSTupdate wartsandall sm.png (625 KB)

Scaled Furnace as seen in the poster for the *[Warts and All](/wiki/A_New_Reign#September_23,_2016_-_Warts_and_All "A New Reign")* update.

Scaled furnace.jpg (163 KB)

[Willow](/wiki/Willow "Willow") next to a Scaled Furnace.

Salad and Scaled Furnace.PNG (355 KB)

The Salad Furnace in comparison to the Scaled Furnace.

E10f3c9a8ae75c7ebc5d28b00bf69f6f15cb72de full.jpg (6 KB)

[Wilson](/wiki/Wilson "Wilson") sitting near the Scaled Furnace at night.

Different skins of Scale Furnaces in the dark.png (174 KB)

Different skins of Scale Furnaces in the dark

Different skins of Scale Furnaces in the light.png (332 KB)

Different skins of Scale Furnaces in the light

Scaled Furnace Icon.png (4 KB)

On the map

Furnace heat distance.png (342 KB)

Scaled Furnace heat vs. distance (observe thermal stones, not thermometers)
